/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\zombies\zombie_assassin_shellshock.gsc
 * Game: Call of Duty: WWII
 * Platform: PC
 * Function Count: 11
 * Decompile Time: 183 ms
 * Timestamp: 10/27/2023 3:14:13 AM
*******************************************************************/

//Function Number: 1
seek_special_ability_use()
{
	return !common_scripts\utility::func_562E(self.specialoverheated) && maps/mp/zombies/zombie_assassin::there_is_close_player(250);
}

//Function Number: 2
activate_special_ability()
{
	thread maps/mp/zombies/zombie_assassin::recharge_special_ability(8);
}
