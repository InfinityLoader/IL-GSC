 ...
 * Timestamp: 10/27/2023 3:11:18 AM
*******************************************************************/
...
func_1455(param_00,param_01)
{
	...
	var_03 = 5;
	var_04 = 1;
	for(var_05 = [];!level.var_3F9D;var_05 = [])
	{
		wait(var_02);
		...
		if(!level.var_AC7C.var_3FCA.var_56B7)
		{
			...
			{
				if(var_08.var_12C["team"] != param_00)
				{
					continue;
				}
				...
				if(var_08 istouching(level.var_AC7C.var_9D5E))
				{
					...
					var_08.var_12C["time"] = var_08.var_99DE;
					var_08 maps\mp\_utility::func_867B(var_08.var_12C["time"]);
					if(isdefined(var_05) && var_05.size > 0 && common_scripts\utility::func_F79(var_05,var_08))
					{
						if(isdefined(var_08.custom_onspawnplayer_func) && var_08.custom_onspawnplayer_func + var_03 * 1000 <= gettime())
						{
							if(var_08 maps\mp\_utility::func_649("specialty_improvedobjectives"))
							{
								var_08 thread maps\mp\_events::func_4C68();
							}

							var_08.custom_onspawnplayer_func = gettime();
						}
					}
					else
					{
						var_08.custom_onspawnplayer_func = gettime() - 1000;
					}
