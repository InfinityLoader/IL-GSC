...
func_987C()
{
	...
	scripts\mp\_utility::func_DEF4("sd",0);
...
func_8136()
{
	...
	var_01 = scripts\mp\_spawnlogic::func_8140(var_00);
...
func_C55E(param_00,param_01,param_02,param_03,param_04)
{
	...
	var_07 = 0;
	if(isdefined(param_01.var_AA08) && param_01.var_AA08)
	{
		param_01 thread scripts\mp\_utility::func_83B4("last_man_kill");
	}
	...
	if(param_00.var_9EE6)
	{
		...
		param_01 thread scripts\mp\_awards::func_8380("mode_sd_plant_save");
		var_07 = 1;
	}
	...
	else if(param_00.var_9DBC)
	{
		...
		scripts\mp\_utility::func_F79E(13,param_01.team,param_01 getentitynumber());
		param_01 scripts\mp\_utility::func_93DF("defends",1);
		param_01 scripts\mp\_persistence::func_10E56("round","defends",param_01.pers["defends"]);
		param_01 thread scripts\mp\_awards::func_8380("mode_sd_defuse_save");
		var_07 = 1;
	}
...
func_8378()
{
	...
	scripts\mp\_utility::func_F79E(16,self.team,self getentitynumber());
