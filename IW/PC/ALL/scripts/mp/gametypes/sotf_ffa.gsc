...
func_987C()
{
	...
	scripts\mp\_utility::func_DF08("sotf_ffa",1);
	setdynamicdvar("scr_sotf_ffa_winlimit",1);
	scripts\mp\_utility::func_DF1A("sotf_ffa",1);
	setdynamicdvar("scr_sotf_ffa_halftime",0);
	scripts\mp\_utility::func_DEF4("sotf_ffa",0);
...
func_C5A4()
{
	...
	scripts\mp\_utility::func_F7C1("allies",var_00);
	scripts\mp\_utility::func_F7C1("axis",var_00);
	if(level.splitscreen)
	{
		scripts\mp\_utility::func_F7C0("allies",var_00);
		scripts\mp\_utility::func_F7C0("axis",var_00);
	}
	else
	{
		scripts\mp\_utility::func_F7C0("allies",var_01);
		scripts\mp\_utility::func_F7C0("axis",var_01);
	}

	scripts\mp\_utility::func_F7BE("allies",var_02);
	scripts\mp\_utility::func_F7BE("axis",var_02);
	func_98CE();
	var_03 = [];
...
func_8136()
{
	var_00 = scripts\mp\_spawnlogic::func_81BA(self.team);
	...
	{
		var_01 = scripts\mp\_spawnscoring::func_8136(var_01);
	}
...
onspawnplayer()
{
	...
	if(!isdefined(self.var_68BC))
	{
		self.var_68BC = scripts\mp\_rank::func_8104("kill");
		scripts\mp\_utility::func_F6FA(self.var_68BC);
	}
	...
	for(;;)
	{
		...
		while(isalive(var_02))
		{
			if(level.var_61C0)
			{
				...
				level thread func_1011A("sotf_crates_incoming");
				wait(var_01);
				continue;
			}
...
func_1044A(param_00)
{
	...
	for(;;)
	{
		...
		if(self.var_485F == "sotf_weapon" && var_03 == getdvarint("scr_sotf_ffa_crategunamount",1))
		{
