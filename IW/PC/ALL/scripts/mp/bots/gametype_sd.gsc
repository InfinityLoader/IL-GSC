/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: scripts\mp\bots\gametype_sd.gsc
 * Game: Call of Duty: Infinite Warfare
 * Platform: PC
 * Function Count: 46
 * Decompile Time: 2320 ms
 * Timestamp: 10/27/2023 12:12:06 AM
*******************************************************************/
...
func_F8DF()
{
	...
	{
		var_03 = getzonenearest(var_02.var_4B2C);
		if(isdefined(var_03))
		{
...
func_2E6E()
{
	...
	if(var_01)
	{
		...
		if(isdefined(level.var_2413) && level.var_2413 == self)
		{
	...
	for(;;)
	{
		...
		if(level.var_2C5C)
		{
			if(isdefined(level.var_F014) && distancesquared(self.origin,level.var_F014.origin) > squared(level.var_DAA3 * 2))
			{
		...
		if(level.var_2C5C && isdefined(level.var_F014) && isdefined(level.var_2C44) && self.var_E67C != "bomb_defuser")
		{
...
func_2415()
{
	...
	{
		level.var_2C47 = level.var_2C7A[randomint(level.var_2C7A.size)];
	}
	...
	{
		self method_804F("scripted");
		if(issdshiphackmap(level.var_B335))
		{
			var_0B = var_0A.var_2EFE;
		}
		else
		{
			var_0B = self method_8045(var_0B.var_2EFE,"node_exposed");
		}
...
{
	self endon("new_role");
	if(level.var_2C5C && isdefined(level.var_F014))
	{
		if(level.var_24B1 == "rush")
		{
			func_552D();
	...
	for(;;)
	{
		...
		else
		{
			...
			if(!isdefined(level.var_2C44) || !isalive(level.var_2C44))
			{
				...
				if(var_19.size > 0 && isdefined(level.var_F014))
				{
...
bot_fixup_bombzone_issues()
{
	...
	{
		if(level.var_2C7A[0].var_2EFE.size < 3)
		{
			var_00 = (492,-132,822);
		...
		if(level.var_2C7A[1].var_2EFE.size < 3)
		{
			var_00 = (-276,2302,989);
