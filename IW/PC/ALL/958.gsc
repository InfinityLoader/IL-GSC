...
main()
{
	...
	self.var_8C98 = "head_bg_var_head_bg_engineering_mate_head_hero_gator_blast_damage";
	self.var_8C43 = "head_bg_engineering_mate_hair_b_black";
