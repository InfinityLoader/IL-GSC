/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\zombies\_zm_weapons.gsc
 * Game: Call of Duty: Black Ops 2
 * Platform: Console
 * Function Count: 108
 * Decompile Time: 270 ms
 * Timestamp: 10/27/2023 3:06:22 AM
*******************************************************************/
...
limited_weapon_below_quota(weapon,ignore_player,pap_triggers)
{
	if(IsDefined(level.limited_weapons[weapon]))
	{
		...
		for(i = 0;i < players.size;i++)
		{
			...
			else if(players[i] has_weapon_or_upgrade(weapon))
			{
				count++;
				if(count >= limit)
				{
...
init_spawnable_weapon_upgrade()
{
	...
	for(i = 0;i < spawnable_weapon_spawns.size;i++)
	{
		...
		else if(!IsDefined(spawnable_weapon.script_noteworthy) || spawnable_weapon.script_noteworthy == "")
		{
