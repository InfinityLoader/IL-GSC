/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\mp_castaway.gsc
 * Game: Call of Duty: Black Ops 2
 * Platform: Console
 * Function Count: 2
 * Decompile Time: 1 ms
 * Timestamp: 10/28/2023 12:13:54 AM
*******************************************************************/
...
main()
{
	...
	spawncollision("collision_physics_64x64x10","collider",(-707,2358,145),VectorScale((1,0,0)));
	spawncollision("collision_clip_64x64x10","collider",(407.5,518,103),VectorScale((1,0,0)));
	...
	spawncollision("collision_clip_64x64x10","collider",(370.5,526,128.5),VectorScale((0,1,0)));
	spawncollision("collision_clip_64x64x10","collider",(357,525,129.5),VectorScale((0,1,0)));
