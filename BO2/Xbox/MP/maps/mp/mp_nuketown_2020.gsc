/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\mp_nuketown_2020.gsc
...
main()
{
	...
	spawncollision("collision_physics_256x256x10","collider",(1067,291,240),VectorScale((0,1,0)));
	...
	spawncollision("collision_clip_32x32x32","collider",(817.5,415,77),VectorScale((0,1,0)));
	spawncollision("collision_clip_32x32x32","collider",(859,430,77.5),VectorScale((0,1,0)));
	spawncollision("collision_clip_32x32x32","collider",(894,439.5,77.5),VectorScale((0,1,0)));
	spawncollision("collision_clip_32x32x32","collider",(926.5,448.5,77.5),VectorScale((0,1,0)));
	spawncollision("collision_clip_32x32x32","collider",(1257.5,489,-68),VectorScale((0,1,0)));
	spawncollision("collision_clip_32x32x32","collider",(1288.5,497.5,-68),VectorScale((0,1,0)));
	spawncollision("collision_missile_128x128x10","collider",(570.655,214.604,-10.5),VectorScale((0,1,0)));
	spawncollision("collision_missile_128x128x10","collider",(558.345,260.896,-10.5),VectorScale((0,1,0)));
	spawncollision("collision_physics_wall_32x32x10","collider",(-1422,40.5,4.5),VectorScale((0,1,0)));
	...
	spawncollision("collision_physics_32x32x10","collider",(1325,532,14),VectorScale((0,1,0)));
	spawncollision("collision_physics_32x32x10","collider",(1369,542.5,14),VectorScale((0,1,0)));
	...
	spawncollision("collision_clip_wall_64x64x10","collider",(1013.5,76.5,42),VectorScale((0,1,0)));
	spawncollision("collision_clip_wall_64x64x10","collider",(-458.5,589,63),(1.3179,341.742,3.9882));
	spawncollision("collision_physics_32x32x10","collider",(653,344.5,147),VectorScale((0,1,0)));
	spawncollision("collision_physics_32x32x10","collider",(653,344.5,98),VectorScale((0,1,0)));
...
#/
	...
	level.endgamemannequin rotateto(90 + VectorScale((0,0,1)),level.endgamemannequin.angles);
	level.endgamemannequin moveto(90 + VectorScale((0,1,0)),level.endgamemannequin.origin);
}
