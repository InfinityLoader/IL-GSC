/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\mp_downhill.gsc
 * Game: Call of Duty: Black Ops 2
 * Platform: Console
 * Function Count: 2
 * Decompile Time: 3 ms
 * Timestamp: 10/28/2023 12:13:55 AM
*******************************************************************/
...
main()
{
	...
	spawncollision("collision_physics_cylinder_32x128","collider",(368,-1378,1015),VectorScale((0,1,0)));
	spawncollision("collision_clip_64x64x64","collider",(1268.5,-2518,1062),VectorScale((0,1,0)));
	spawncollision("collision_clip_64x64x64","collider",(1122.5,583.5,959.5),VectorScale((0,1,0)));
