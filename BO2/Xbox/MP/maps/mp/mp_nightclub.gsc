/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\mp_nightclub.gsc
 * Game: Call of Duty: Black Ops 2
 * Platform: Console
 * Function Count: 3
 * Decompile Time: 53 ms
 * Timestamp: 10/27/2023 3:05:32 AM
*******************************************************************/
...
main()
{
	...
	spawncollision("collision_clip_128x128x128","collider",(-17402.5,2804,-109),VectorScale((0,1,0)));
	spawncollision("collision_clip_128x128x128","collider",(-17350.5,2856,-109),VectorScale((0,1,0)));
	...
	spawncollision("collision_physics_wall_32x32x10","collider",(-19469,355,-86),VectorScale((0,1,0)));
	spawncollision("collision_physics_wall_32x32x10","collider",(-19469,338,-86),VectorScale((0,1,0)));
	spawncollision("collision_clip_wall_64x64x10","collider",(-18273.5,1092.5,-2.5),VectorScale((0,1,0)));
	...
	spawncollision("collision_missile_128x128x10","collider",(-17872,1839,-87),(359.801,315.726,110.7287));
	spawncollision("collision_missile_128x128x10","collider",(-17860,1827,-87),(359.801,315.726,110.7287));
	spawncollision("collision_missile_128x128x10","collider",(-17946,1764,-129),(359.801,315.726,110.7287));
	spawncollision("collision_missile_128x128x10","collider",(-17970,1737,-146),(359.801,315.726,110.7287));
	spawncollision("collision_missile_128x128x10","collider",(-17936,1754,-129),(359.801,315.726,110.7287));
	spawncollision("collision_missile_128x128x10","collider",(-17961,1728,-146),(359.801,315.726,110.7287));
	...
	spawncollision("collision_missile_128x128x10","collider",(-17229,2469,-146),(359.801,135.726,110.7287));
	spawncollision("collision_missile_128x128x10","collider",(-17220,2460,-146),(359.801,135.726,110.7287));
	spawncollision("collision_missile_128x128x10","collider",(-17254,2443,-129),(359.801,135.726,110.7287));
	spawncollision("collision_missile_128x128x10","collider",(-17244,2433,-129),(359.801,135.726,110.7287));
	spawncollision("collision_missile_128x128x10","collider",(-17330,2370,-87),(359.801,135.726,110.7287));
	spawncollision("collision_missile_128x128x10","collider",(-17318,2358,-87),(359.801,135.726,110.7287));
	spawncollision("collision_tvs_anchor_desk01","collider",(-15441,3711,-192),VectorScale((0,1,0)));
	spawncollision("collision_missile_128x128x10","collider",(-16938.5,2314,-226.5),VectorScale((0,1,0)));
	...
	spawncollision("collision_physics_wall_64x64x10","collider",(-18712.5,525,-122.5),VectorScale((0,1,0)));
	spawncollision("collision_physics_wall_64x64x10","collider",(-18712.5,525,-159.5),VectorScale((0,1,0)));
	spawncollision("collision_physics_wall_64x64x10","collider",(-18927.5,1099,-122.5),VectorScale((0,1,0)));
	spawncollision("collision_physics_wall_64x64x10","collider",(-18927.5,1099,-159.5),VectorScale((0,1,0)));
