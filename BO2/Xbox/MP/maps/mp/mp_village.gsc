 ...
 * Function Count: 4
 * Decompile Time: 5 ms
 * Timestamp: 10/28/2023 12:14:02 AM
*******************************************************************/
...
main()
{
	...
	spawncollision("collision_physics_32x32x32","collider",(610,-126,60),VectorScale((1,0,0)));
	spawncollision("collision_physics_32x32x32","collider",(590,-126,67),VectorScale((1,0,0)));
	spawncollision("collision_physics_32x32x32","collider",(602,-233,70),(0,0,0));
	spawncollision("collision_physics_wall_128x128x10","collider",(707,-812,32),VectorScale((0,1,0)));
	spawncollision("collision_physics_wall_128x128x10","collider",(707,-730,32),VectorScale((0,1,0)));
	spawncollision("collision_physics_32x32x128","collider",(-1056,-1294,32),VectorScale((1,0,0)));
	spawncollision("collision_physics_32x32x128","collider",(-960,-1294,32),VectorScale((1,0,0)));
	spawncollision("collision_physics_32x32x128","collider",(-1057,-1294,111),VectorScale((1,0,0)));
	spawncollision("collision_physics_32x32x128","collider",(-964,-1294,111),VectorScale((1,0,0)));
	...
	metalsheet1.angles = VectorScale((0,0,-1));
	...
	spawncollision("collision_physics_32x32x32","collider",(952.701,1488.68,29),VectorScale((0,1,0)));
	spawncollision("collision_physics_32x32x32","collider",(937.299,1522.32,29),VectorScale((0,1,0)));
	spawncollision("collision_physics_256x256x10","collider",(596,-1545,-8),VectorScale((1,0,0)));
	...
	spawncollision("collision_physics_32x32x128","collider",(523,-1672,2),VectorScale((1,0,0)));
	spawncollision("collision_physics_32x32x32","collider",(-1861,-1004,239),VectorScale((0,1,0)));
	spawncollision("collision_physics_32x32x32","collider",(-1867,-1023,239),VectorScale((0,1,0)));
	spawncollision("collision_physics_32x32x32","collider",(-1861,-1324,239),VectorScale((0,1,0)));
	spawncollision("collision_physics_32x32x32","collider",(-1867,-1343,239),VectorScale((0,1,0)));
	spawncollision("collision_physics_32x32x32","collider",(-1876,-1400,239),VectorScale((0,1,0)));
	spawncollision("collision_physics_32x32x32","collider",(-1859,-1411,239),VectorScale((0,1,0)));
	spawncollision("collision_physics_32x32x128","collider",(1335,1029,55),VectorScale((1,0,0)));
	spawncollision("collision_physics_256x256x10","collider",(645,-1562,0),VectorScale((0,0,1)));
