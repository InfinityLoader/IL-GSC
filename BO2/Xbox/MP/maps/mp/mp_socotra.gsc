/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\mp_socotra.gsc
 * Game: Call of Duty: Black Ops 2
 * Platform: Console
 * Function Count: 3
 * Decompile Time: 1 ms
 * Timestamp: 10/28/2023 12:14:00 AM
*******************************************************************/
...
main()
{
	...
	spawncollision("collision_physics_256x256x256","collider",(1998,-256,-26),VectorScale((0,1,0)));
	spawncollision("collision_physics_wall_128x128x10","collider",(-1636,-391,353),VectorScale((0,1,0)));
	spawncollision("collision_physics_128x128x128","collider",(213,3058,745),VectorScale((0,1,0)));
	spawncollision("collision_physics_128x128x128","collider",(6,3052,757),VectorScale((0,1,0)));
	...
	spawncollision("collision_clip_128x128x128","collider",(1631,229,142),VectorScale((0,1,0)));
	spawncollision("collision_clip_128x128x128","collider",(1631,229,270),VectorScale((0,1,0)));
	spawncollision("collision_clip_128x128x128","collider",(1631,229,398),VectorScale((0,1,0)));
	spawncollision("collision_clip_128x128x128","collider",(1631,229,526),VectorScale((0,1,0)));
