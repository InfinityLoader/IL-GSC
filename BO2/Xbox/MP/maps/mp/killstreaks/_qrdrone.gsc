/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\killstreaks\_qrdrone.gsc
 * Game: Call of Duty: Black Ops 2
 * Platform: Console
 * Function Count: 61
 * Decompile Time: 245 ms
 * Timestamp: 10/27/2023 3:04:45 AM
*******************************************************************/
...
createqrdrone(lifeid,owner,streakname,origin,angles,killstreak_id)
{
	...
	qrdrone.numflares = 0;
	qrdrone.flareoffset = VectorScale((0,0,-1));
	...
	qrdrone.emp_fx linkto(self,"tag_origin",VectorScale((0,0,-1)) + AnglesToForward(self.angles) * 6);
...
qrdrone_crash_movement(attacker,hitdir)
{
	...
	self setphysacceleration(VectorScale((0,0,-1)));
	...
	self setvehvelocity(100 + VectorScale((0,0,1)) + vectornormalize(side_dir));
	...
	wait(2);
	self notify("crash_done",velocity,800);
}
