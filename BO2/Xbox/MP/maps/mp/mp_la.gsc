/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\mp_la.gsc
 * Game: Call of Duty: Black Ops 2
 * Platform: Console
 * Function Count: 4
 * Decompile Time: 35 ms
 * Timestamp: 10/27/2023 3:05:29 AM
*******************************************************************/
...
main()
{
	...
	spawncollision("collision_clip_wall_64x64x10","collider",(-698,2945,28),VectorScale((0,1,0)));
	spawncollision("collision_clip_wall_64x64x10","collider",(-698,2984,28),VectorScale((0,1,0)));
	spawncollision("collision_physics_wall_32x32x10","collider",(-1606,3027,154),VectorScale((0,1,0)));
	spawncollision("collision_physics_wall_32x32x10","collider",(-1614,3010,204),VectorScale((0,1,0)));
	spawncollision("collision_physics_wall_64x64x10","collider",(-1610,1860,203),(26,271,17));
	spawncollision("collision_physics_wall_256x256x10","collider",(-849,3145.5,-94.5),VectorScale((0,1,0)));
	spawncollision("collision_physics_wall_256x256x10","collider",(-835,3013.5,-119),VectorScale((0,1,0)));
	spawncollision("collision_physics_128x128x10","collider",(-795.5,3208.5,3.5),VectorScale((0,1,0)));
	spawncollision("collision_physics_128x128x10","collider",(-783,3080.5,3.5),VectorScale((0,1,0)));
	spawncollision("collision_physics_128x128x10","collider",(-767.5,2953.5,15),VectorScale((0,1,0)));
	...
	spawncollision("collision_physics_cylinder_32x128","collider",(-1151.5,1199.5,-31),VectorScale((0,1,0)));
	spawncollision("collision_clip_wall_256x256x10","collider",(-621.5,2114,-176.5),(0,270,-180));
	spawncollision("collision_physics_128x128x128","collider",(807.5,855,-217.5),VectorScale((0,1,0)));
	spawncollision("collision_physics_128x128x128","collider",(886,835.5,-206),VectorScale((0,1,0)));
	spawncollision("collision_physics_128x128x128","collider",(958.277,946.957,-191.5),VectorScale((0,1,0)));
	spawncollision("collision_physics_128x128x128","collider",(1039.22,946.543,-173),VectorScale((0,1,0)));
	spawncollision("collision_physics_128x128x128","collider",(853.93,1147.29,-191.5),VectorScale((0,1,0)));
	spawncollision("collision_physics_128x128x128","collider",(914.57,1214.71,-173),VectorScale((0,1,0)));
	spawncollision("collision_clip_64x64x10","collider",(-1354,2215.5,-206),VectorScale((0,0,-1)));
	...
	spawncollision("collision_physics_wall_128x128x10","collider",(-2067,1390,-102),VectorScale((0,1,0)));
