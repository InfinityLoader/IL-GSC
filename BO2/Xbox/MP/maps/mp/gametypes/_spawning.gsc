/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\gametypes\_spawning.gsc
 * Game: Call of Duty: Black Ops 2
 * Platform: Console
 * Function Count: 53
 * Decompile Time: 222 ms
 * Timestamp: 10/27/2023 3:04:26 AM
*******************************************************************/
...
create_auto_turret_influencer_close(point,parent_team,angles)
{
	...
	projected_point = level.spawnsystem.auto_turret_influencer_close_radius * 0.7 + VectorScale(AnglesToForward(angles));
...
#/
	...
	if(use_new_spawn_system || GetDvarInt(#"BD11226") != 0)
	{
		if(!(spawnoverride))
		{
