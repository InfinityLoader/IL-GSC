/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\gametypes\_weaponobjects.gsc
...
anyobjectsinworld(weapon)
{
	...
	for(i = 0;i < self.weaponobjectwatcherarray.size;i++)
	{
		...
		else if(IsDefined(self.weaponobjectwatcherarray[i].detonate) && self.weaponobjectwatcherarray[i].objectarray.size > 0)
		{
			objectsinworld = 1;
			break;
		}
