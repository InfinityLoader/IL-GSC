 ...
 * Timestamp: 10/27/2023 3:00:29 AM
*******************************************************************/
...
createflag(trigger)
{
	...
	flag = maps/mp/gametypes/_gameobjects::createcarryobject(entityteam,trigger,visuals,VectorScale((0,0,1)),100);
...
#/
	...
	for(index = 0;index < flag_zones.size;index++)
	{
		...
		facing_angle = GetDvarInt(#"F6F112EA");
