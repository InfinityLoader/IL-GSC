/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\mp_raid.gsc
 * Game: Call of Duty: Black Ops 2
 * Platform: PC
 * Function Count: 5
 * Decompile Time: 59 ms
 * Timestamp: 10/27/2023 3:01:52 AM
*******************************************************************/
...
main()
{
	...
	spawncollision("collision_physics_64x64x64","collider",(4127,3741,130),VectorScale((0,1,0)));
	spawncollision("collision_physics_128x128x128","collider",(3136,3590.89,283.276),VectorScale((0,0,-1)));
	spawncollision("collision_physics_128x128x128","collider",(2841,3590.89,283.28),VectorScale((0,0,-1)));
	spawncollision("collision_physics_128x128x128","collider",(2841,3696.89,212.28),VectorScale((0,0,-1)));
	spawncollision("collision_physics_128x128x128","collider",(2841,3804.89,140.28),VectorScale((0,0,-1)));
	...
	spawncollision("collision_physics_128x128x10","collider",(3562,3271.5,186.5),VectorScale((0,1,0)));
	...
	spawncollision("collision_nosight_wall_64x64x10","collider",(2751,4130.5,214.5),VectorScale((0,1,0)));
	spawncollision("collision_nosight_wall_64x64x10","collider",(2751,4099,214.5),VectorScale((0,1,0)));
	spawncollision("collision_clip_wall_64x64x10","collider",(3819,3475,113),VectorScale((0,-1,0)));
	spawncollision("collision_clip_wall_64x64x10","collider",(3819,3598,113),VectorScale((0,1,0)));
	spawncollision("collision_clip_wall_64x64x10","collider",(3570,3834,113),VectorScale((0,1,0)));
