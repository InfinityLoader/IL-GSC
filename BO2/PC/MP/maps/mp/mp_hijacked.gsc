/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\mp_hijacked.gsc
 * Game: Call of Duty: Black Ops 2
 * Platform: PC
 * Function Count: 9
 * Decompile Time: 48 ms
 * Timestamp: 10/27/2023 3:01:46 AM
*******************************************************************/
...
main()
{
	...
	spawncollision("collision_physics_64x64x10","collider",(1660,40,59),VectorScale((0,0,-1)));
	spawncollision("collision_physics_64x64x10","collider",(1633,40,48),VectorScale((0,0,-1)));
	spawncollision("collision_physics_64x64x10","collider",(1660,-42,59),VectorScale((0,0,-1)));
	spawncollision("collision_physics_64x64x10","collider",(1632,-42,48),VectorScale((0,0,-1)));
	...
	spawncollision("collision_physics_cylinder_32x128","collider",(-1055,10,216),VectorScale((0,0,-1)));
	spawncollision("collision_clip_64x64x10","collider",(-1912.65,-245,-76.3463),VectorScale((1,0,0)));
	spawncollision("collision_physics_wall_64x64x10","collider",(-1064,412,254),VectorScale((1,0,0)));
	spawncollision("collision_physics_wall_64x64x10","collider",(-1112,416.5,284),VectorScale((1,0,0)));
