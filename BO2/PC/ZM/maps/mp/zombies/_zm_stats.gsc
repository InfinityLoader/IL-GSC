/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\zombies\_zm_stats.gsc
 * Game: Call of Duty: Black Ops 2
 * Platform: PC
 * Function Count: 45
 * Decompile Time: 280 ms
 * Timestamp: 10/27/2023 3:03:26 AM
*******************************************************************/
...
{
	if(GetDvar(#"C955B4CD") == "" || is_true(level.zm_disable_recording_stats))
	{
		return;
	}
...
update_global_counters_on_match_end()
{
	...
	foreach(player in players)
	{
		...
		specialty_longersprint_drank = specialty_longersprint_drank + player.pers["specialty_longersprint_drank"];
		specialty_rof_drank = specialty_rof_drank + player.pers["specialty_rof_drank"];
		specialty_deadshot_drank = specialty_deadshot_drank + player.pers["specialty_deadshot_drank"];
		specialty_scavenger_drank = specialty_scavenger_drank + player.pers["specialty_scavenger_drank"];
		specialty_flakjacket_drank = specialty_flakjacket_drank + player.pers["specialty_flakjacket_drank"];
		...
		specialty_finalstand_drank = specialty_finalstand_drank + player.pers["specialty_finalstand_drank"];
		specialty_grenadepulldeath_drank = specialty_grenadepulldeath_drank + player.pers["specialty_grenadepulldeath_drank"];
		specialty_nomotionsensor_drank = specialty_nomotionsensor_drank + player.pers["specialty_nomotionsensor" + "_drank"];
		gibs = gibs + player.pers["gibs"];
		...
		zombie_blood_pickedup = zombie_blood_pickedup + player.pers["zombie_blood_pickedup"];
		...
		contaminations_received = contaminations_received + player.pers["contaminations_received"];
		contaminations_given = contaminations_given + player.pers["contaminations_given"];
		...
		prison_tomahawk_acquired = prison_tomahawk_acquired + player.pers["prison_tomahawk_acquired"];
		prison_fan_trap_used = prison_fan_trap_used + player.pers["prison_fan_trap_used"];
		prison_acid_trap_used = prison_acid_trap_used + player.pers["prison_acid_trap_used"];
		prison_sniper_tower_used = prison_sniper_tower_used + player.pers["prison_sniper_tower_used"];
		prison_ee_good_ending = prison_ee_good_ending + player.pers["prison_ee_good_ending"];
		prison_ee_bad_ending = prison_ee_bad_ending + player.pers["prison_ee_bad_ending"];
		prison_ee_spoon_acquired = prison_ee_spoon_acquired + player.pers["prison_ee_spoon_acquired"];
		prison_brutus_killed = prison_brutus_killed + player.pers["prison_brutus_killed"];
		buried_lsat_purchased = buried_lsat_purchased + player.pers["buried_lsat_purchased"];
		buried_fountain_transporter_used = buried_fountain_transporter_used + player.pers["buried_fountain_transporter_used"];
		buried_ghost_killed = buried_ghost_killed + player.pers["buried_ghost_killed"];
		buried_ghost_drained_player = buried_ghost_drained_player + player.pers["buried_ghost_drained_player"];
		buried_ghost_perk_acquired = buried_ghost_perk_acquired + player.pers["buried_ghost_perk_acquired"];
		buried_sloth_booze_given = buried_sloth_booze_given + player.pers["buried_sloth_booze_given"];
		buried_sloth_booze_break_barricade = buried_sloth_booze_break_barricade + player.pers["buried_sloth_booze_break_barricade"];
		buried_sloth_candy_given = buried_sloth_candy_given + player.pers["buried_sloth_candy_given"];
		buried_sloth_candy_protect = buried_sloth_candy_protect + player.pers["buried_sloth_candy_protect"];
		buried_sloth_candy_build_buildable = buried_sloth_candy_build_buildable + player.pers["buried_sloth_candy_build_buildable"];
		buried_sloth_candy_wallbuy = buried_sloth_candy_wallbuy + player.pers["buried_sloth_candy_wallbuy"];
		buried_sloth_candy_fetch_buildable = buried_sloth_candy_fetch_buildable + player.pers["buried_sloth_candy_fetch_buildable"];
		buried_sloth_candy_box_lock = buried_sloth_candy_box_lock + player.pers["buried_sloth_candy_box_lock"];
		buried_sloth_candy_box_move = buried_sloth_candy_box_move + player.pers["buried_sloth_candy_box_move"];
		buried_sloth_candy_box_spin = buried_sloth_candy_box_spin + player.pers["buried_sloth_candy_box_spin"];
		buried_sloth_candy_powerup_cycle = buried_sloth_candy_powerup_cycle + player.pers["buried_sloth_candy_powerup_cycle"];
		buried_sloth_candy_dance = buried_sloth_candy_dance + player.pers["buried_sloth_candy_dance"];
		buried_sloth_candy_crawler = buried_sloth_candy_crawler + player.pers["buried_sloth_candy_crawler"];
		buried_wallbuy_placed = buried_wallbuy_placed + player.pers["buried_wallbuy_placed"];
		buried_wallbuy_placed_ak74u_zm = buried_wallbuy_placed_ak74u_zm + player.pers["buried_wallbuy_placed_ak74u_zm"];
		buried_wallbuy_placed_an94_zm = buried_wallbuy_placed_an94_zm + player.pers["buried_wallbuy_placed_an94_zm"];
		buried_wallbuy_placed_pdw57_zm = buried_wallbuy_placed_pdw57_zm + player.pers["buried_wallbuy_placed_pdw57_zm"];
		buried_wallbuy_placed_svu_zm = buried_wallbuy_placed_svu_zm + player.pers["buried_wallbuy_placed_svu_zm"];
		buried_wallbuy_placed_tazer_knuckles_zm = buried_wallbuy_placed_tazer_knuckles_zm + player.pers["buried_wallbuy_placed_tazer_knuckles_zm"];
		buried_wallbuy_placed_870mcs_zm = buried_wallbuy_placed_870mcs_zm + player.pers["buried_wallbuy_placed_870mcs_zm"];
		tomb_mechz_killed = tomb_mechz_killed + player.pers["tomb_mechz_killed"];
		tomb_giant_robot_stomped = tomb_giant_robot_stomped + player.pers["tomb_giant_robot_stomped"];
		tomb_giant_robot_accessed = tomb_giant_robot_accessed + player.pers["tomb_giant_robot_accessed"];
		tomb_generator_captured = tomb_generator_captured + player.pers["tomb_generator_captured"];
		tomb_generator_defended = tomb_generator_defended + player.pers["tomb_generator_defended"];
		tomb_generator_lost = tomb_generator_lost + player.pers["tomb_generator_lost"];
		tomb_dig = tomb_dig + player.pers["tomb_dig"];
		tomb_golden_shovel = tomb_golden_shovel + player.pers["tomb_golden_shovel"];
		tomb_golden_hard_hat = tomb_golden_hard_hat + player.pers["tomb_golden_hard_hat"];
