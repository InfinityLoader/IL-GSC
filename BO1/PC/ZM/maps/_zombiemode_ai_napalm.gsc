...
napalm_zombie_init()
{
	...
	level.napalmExplodeRadius = 90.0;
	level.napalmExplodeKillRadiusJugs	= 90.0;
	level.napalmExplodeKillRadius = 150.0;
	level.napalmExplodeDamageRadius = 400.0;
	level.napalmExplodeDamageRadiusWet	= 250.0;
...
init_napalm_fx()
{
	...
	level._effect["napalm_fire_trigger"] = LoadFX( "maps/zombie_temple/fx_ztem_napalm_zombie_end2" );
