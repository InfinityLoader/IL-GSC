 ...
 * Timestamp: 10/27/2023 2:44:15 AM
*******************************************************************/
...
handleikevent()
{
	...
	for(;;)
	{
		self waittill("actorik",var_02,var_03,var_04,var_05,var_06,var_07,var_08);
		if(var_02 <= 0.01)
		{
			if(var_01 == 0)
			{
		...
		var_0D[0] = var_08;
		var_0D[1] = var_08 + var_07 * var_0B;
		var_0D[2] = var_06;
		var_0D[3] = var_06 + var_05 * var_0C;
		var_0E[0] = 1;
		var_0E[1] = 1;
		var_0E[2] = 1;
		var_0E[3] = 1;
		var_0F[0] = min(var_0D[0][2],var_0D[1][2]);
		var_0F[1] = min(var_0D[2][2],var_0D[3][2]);
		var_10[0] = 0;
		var_10[1] = 0;
		if(abs(var_0F[0] - var_0F[1]) < 1)
		{
			var_10[0] = 1;
			var_10[1] = 1;
		}
		else if(var_0F[0] < var_0F[1])
		{
			var_10[0] = 1;
		}
		else
		...
		{
			var_13 = var_0D[var_12] + (0,0,30);
			var_14 = var_0D[var_12] - (0,0,30);
			var_15 = self aiphysicstrace(var_13,var_14,1.5,3,1,1,0,1,1,1);
			var_16 = var_13 + 2 * var_15["fraction"] * (0,0,-30);
			var_11[var_12] = var_16[2] - self.origin[2];
		...
		if(var_0E[0] || var_0E[1])
		{
			var_17 = max(var_11[0],var_11[1]);
		}
		else
		{
			var_17 = 0;
		...
		if(var_0E[2] || var_0E[3])
		{
			var_18 = max(var_11[2],var_11[3]);
		}
		else
		{
			var_18 = 0;
		...
		if(var_10[0] == 1 && var_10[1] == 1)
		{
			var_0A = min(var_17,var_18);
		}
		else if(var_10[0] == 1)
		{
			var_0A = var_17;
		...
		var_0A = clamp(var_0A,var_09,0);
		if(var_0A < 0)
		{
			var_19 = var_0A / var_00;
			self setanimlimited(%actor_ik_move_root,var_19 * var_02);
			var_01 = 0;
		}
		else if(var_01 == 0)
		{
...
allies_with_ir()
{
	...
	{
		if(issubstr(self.script_friendname,var_02))
		{
			return 0;
		}
	}
