 ...
 * Timestamp: 10/27/2023 2:43:54 AM
*******************************************************************/
...
init_animset_cover_left()
{
	...
	var_00["alert_idle_twitch"] = [%corner_standl_alert_twitch01,%corner_standl_alert_twitch03,%corner_standl_alert_twitch04,%corner_standl_alert_twitch06,%corner_standl_alert_twitch07];
	...
	var_00["shotgun_reload"] = [%shotgun_corner_standl_reload];
	...
	var_00["exposed_2_alert"] = %h1_cornerstndl_exposedstand_2_alert;
	...
	var_00["AW_to_MW_alert_trans"] = %cornercrouchl_crouchidle_2_alert;
	var_00["1knee_2_2knees"] = %h1_cornercrl_trans_2_2knees;
	var_00["A_to_alert_reload"] = [];
	...
	var_00["reload"] = [%cornercrl_reloadb];
	var_00["shotgun_reload"] = [%shotgun_cornercrl_reload];
