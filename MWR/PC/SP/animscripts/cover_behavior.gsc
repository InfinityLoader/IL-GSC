...
main(param_00)
{
	...
	for(;;)
	{
		...
		{
			calloptionalbehaviorcallback(param_00.mainloopstart,"mainLoopStart");
		}

		if(isdefined(param_00.movetonearbycover))
		{
			if(calloptionalbehaviorcallback(param_00.movetonearbycover,"moveToNearByCover"))
			{
				continue;
			}
		}
...
suppressedbehavior(param_00)
{
	...
	while(animscripts\utility::issuppressedwrapper())
	{
		...
		var_04 = isenemyvisiblefromexposed() || animscripts\utility::cansuppressenemyfromexposed();
		if(var_04 && isdefined(level.throwgrenadeatplayerasap) && isalive(level.player))
		{
			if(trythrowinggrenade(param_00,level.player))
			{
				continue;
		...
		if(var_04 && trythrowinggrenade(param_00,self.enemy))
		{
			var_02 = 1;
			continue;
		}
...
//Function Number: 12
calloptionalbehaviorcallback(param_00,param_01,param_02,param_03,param_04)
{
	...
	{
		var_06 = [[ param_00 ]](param_02,param_03,param_04);
	}
	else if(isdefined(param_03))
	{
		var_06 = [[ param_00 ]](param_02,param_03);
	}
...
coverreload(param_00,param_01)
{
	...
	self.isreloading = 1;
	var_02 = calloptionalbehaviorcallback(param_00.reload,"reload");
	self.isreloading = 0;
	return var_02;
}
...
leavecoverandshoot(param_00,param_01)
{
	...
	var_02 = calloptionalbehaviorcallback(param_00.leavecoverandshoot,"leaveCoverAndShoot");
...
lookforenemy(param_00)
{
	...
	var_01 = calloptionalbehaviorcallback(param_00.look,"look",2 + randomfloat(2));
	if(var_01)
	{
		return 1;
	}

	return calloptionalbehaviorcallback(param_00.fastlook,"fastlook");
}

//Function Number: 17
lookfast(param_00)
{
	var_01 = calloptionalbehaviorcallback(param_00.fastlook,"fastlook");
	if(var_01)
	{
		return 1;
	}

	return calloptionalbehaviorcallback(param_00.look,"look",0);
}
...
idle(param_00,param_01)
{
	...
	if(isdefined(param_00.flinch))
	{
		...
		{
			if(calloptionalbehaviorcallback(param_00.flinch,"flinch"))
			{
				return 1;
			}
		}
...
flinchwhensuppressed(param_00)
{
	...
	self.flinching = 1;
	var_03 = calloptionalbehaviorcallback(param_00.flinch,"flinch");
	self.flinching = 0;
...
trythrowinggrenade(param_00,param_01)
{
	...
	{
		return calloptionalbehaviorcallback(param_00.grenadehidden,"grenadeHidden",param_01);
	}

	return calloptionalbehaviorcallback(param_00.grenade,"grenade",param_01);
}
...
blindfire(param_00)
{
	...
	return calloptionalbehaviorcallback(param_00.blindfire,"blindfire");
}
...
//Function Number: 34
copy_anim_array_to_a_array(param_00)
{
	var_01 = animscripts\utility::lookupanimarray(param_00);
	foreach(var_04, var_03 in var_01)
	{
		self.a.array[var_04] = var_03;
	}
}
