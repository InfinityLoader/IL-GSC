 ...
 * Platform: PC
 * Function Count: 65
 * Decompile Time: 1057 ms
 * Timestamp: 10/27/2023 2:44:31 AM
*******************************************************************/
...
init_animset_pain()
{
	...
	var_00["cover_left_crouch"] = [[%h1_cornercrl_painb_2],[%cornercrl_painb]];
	var_00["cover_right_stand"] = [%corner_standr_pain,%corner_standr_painb,%corner_standr_painc];
	var_00["cover_right_crouch"] = [[%h1_cornercrr_alert_paina_2,%h1_cornercrr_alert_painb_2,%h1_cornercrr_alert_painc_2],[%cornercrr_alert_paina,%cornercrr_alert_painc]];
	var_00["cover_right_stand_A"] = %h1_cornerstndr_pain_2_cover_a;
	var_00["cover_right_stand_B"] = %h1_cornerstndr_pain_2_cover_b;
	var_00["cover_left_stand_A"] = %h1_cornerstndl_pain_2_cover_a;
	var_00["cover_left_stand_B"] = %h1_cornerstndl_pain_2_cover_b;
	var_00["cover_crouch"] = [%covercrouch_pain_front,%covercrouch_pain_left_3];
...
removeblockedanims(param_00)
{
	...
	{
		var_03 = getmovedelta(param_00[var_02],0,1);
...
{
	verifypreh1();
	var_00 = animscripts\utility::array(%run_pain_fallonknee,%run_pain_fallonknee_02,%run_pain_fallonknee_03,%run_pain_stomach,%run_pain_stumble);
	var_00 = removeblockedanims(var_00);
	if(!var_00.size)
	{
		self.a.movement = "stop";
		return getstandpainanim_preh1();
...
weaponanims()
{
	...
	if((isdefined(self.holdingweapon) && !self.holdingweapon) || var_00 == "")
	{
		return "none";
	}

	var_01 = weaponclass(self.weapon);
	switch(var_01)
	{
		case "smg":
		case "mg":
...
getstandpainanim_preh1()
{
	...
	{
		var_01 = self.damagetaken / self.maxhealth;
		if(var_01 > 0.4 && !animscripts\utility::damagelocationisany("left_hand","right_hand","left_foot","right_foot","helmet"))
		{
			var_00[var_00.size] = %exposed_pain_2_crouch;
		}

		if(animscripts\utility::damagelocationisany("torso_upper","torso_lower","left_arm_upper","right_arm_upper","neck"))
		{
			var_00[var_00.size] = %exposed_pain_back;
		}

		if(animscripts\utility::damagelocationisany("right_hand","right_arm_upper","right_arm_lower","torso_upper"))
		{
			var_00[var_00.size] = %exposed_pain_dropgun;
		}

		if(animscripts\utility::damagelocationisany("torso_lower","left_leg_upper","right_leg_upper"))
		{
			var_00[var_00.size] = %exposed_pain_groin;
		}

		if(animscripts\utility::damagelocationisany("left_hand","left_arm_lower","left_arm_upper"))
		{
			var_00[var_00.size] = %exposed_pain_left_arm;
		}

		if(animscripts\utility::damagelocationisany("right_hand","right_arm_lower","right_arm_upper"))
		{
			var_00[var_00.size] = %exposed_pain_right_arm;
		}
		...
		{
			var_00[var_00.size] = %exposed_pain_leg;
		}
...
getcrouchpainanim_preh1()
{
	...
	if(animscripts\utility::damagelocationisany("torso_upper","torso_lower","left_arm_upper","right_arm_upper","neck"))
	{
		var_00[var_00.size] = %exposed_crouch_pain_chest;
	}

	if(animscripts\utility::damagelocationisany("head","neck","torso_upper"))
	{
		var_00[var_00.size] = %exposed_crouch_pain_headsnap;
	}

	if(animscripts\utility::damagelocationisany("left_hand","left_arm_lower","left_arm_upper"))
	{
		var_00[var_00.size] = %exposed_crouch_pain_left_arm;
	}

	if(animscripts\utility::damagelocationisany("right_hand","right_arm_lower","right_arm_upper"))
	{
		var_00[var_00.size] = %exposed_crouch_pain_right_arm;
	}

	if(var_00.size < 2)
	{
		var_00[var_00.size] = %exposed_crouch_pain_flinch;
	}
...
dyingcrawl()
{
	...
	animscripts\death::playdeathanim(var_04,0);
	killwrapper();
	self.a.special = "none";
	self.specialdeathfunc = undefined;
	return 0;
