 ...
 * Platform: PC
 * Function Count: 168
 * Decompile Time: 2799 ms
 * Timestamp: 10/27/2023 2:45:04 AM
*******************************************************************/
...
gettwitchanim(param_00)
{
	...
	var_01 = randomint(param_00.size);
	self.a.lasttwitchanims = param_00[var_01];
...
{
	var_00 = [%casual_stand_idle,%casual_stand_idle_trans_in,%casual_stand_idle_trans_out,%casual_stand_idle_twitch,%casual_stand_idle_twitchb,%casual_stand_v2_idle,%casual_stand_v2_twitch_radio,%casual_stand_v2_twitch_shift,%casual_stand_v2_twitch_talk,%smg_casual_stand_idle_trans_in,%smg_casual_stand_idle_trans_out];
...
follow_enemy_with_laser(param_00,param_01)
{
	...
	if(param_00 method_843E("tag_flash") == -1)
	{
...
//Function Number: 161
checkforturnwithanim(param_00)
{
	var_01 = getanimlength(param_00);
	var_02 = self getanimtime(param_00);
	var_03 = var_02 + 0.05 * self.movetransitionrate / var_01;
	if(var_03 > 1)
	{
		var_03 = 1;
	}

	var_04 = getmovedelta(param_00,var_02,var_03);
	var_05 = length(var_04);
	return self method_8571(var_05);
}

//Function Number: 162
set_run_twitch_animation(param_00)
{
	self.noruntwitch = !param_00;
}

//Function Number: 163
set_team_run_twitch_animation(param_00,param_01)
{
	...
	{
		var_04.noruntwitch = !param_01;
	}

	if(level.h1_team_run_twitch_enabled[param_00] != param_01)
	{
		level.h1_team_run_twitch_enabled[param_00] = param_01;
	}
}
