...
init_animset_cover_right()
{
	...
	var_00["alert_idle_twitch"] = [%corner_standr_alert_twitch01,%corner_standr_alert_twitch04,%corner_standr_alert_twitch05,%corner_standr_alert_twitch06,%corner_standr_alert_twitch07];
	...
	var_00["shotgun_reload"] = [%shotgun_corner_standr_reload];
	...
	var_00["exposed_2_alert"] = %h1_cornerstndr_exposedstand_2_alert;
	...
	var_00["AW_to_MW_alert_trans"] = %cornercrouchr_crouchidle_2_alert;
	var_00["1knee_2_2knees"] = %h1_cornercrouch_trans_2_2knee;
	var_00["A_to_alert_reload"] = [];
	...
	var_00["shotgun_reload"] = [%shotgun_cornercrr_reload_2knee];
