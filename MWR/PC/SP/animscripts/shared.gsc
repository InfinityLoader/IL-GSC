 ...
 * Timestamp: 10/27/2023 2:44:43 AM
*******************************************************************/
...
updateattachedweaponmodels()
{
	...
	{
		var_01[var_01.size] = getweaponforpos(var_00[var_03]);
		var_02[var_02.size] = gettagforpos(var_00[var_03]);
	}

	self updateplayermodelwithweapons(var_01[0],var_02[0],var_01[1],var_02[1],var_01[2],var_02[2],var_01[3],var_02[3]);
	for(var_03 = 0;var_03 < var_00.size;var_03++)
	{
		var_04 = getweaponforpos(var_00[var_03]);
		if(var_04 == "none")
		{
			continue;
		}

		if(self.weaponinfo[var_04].useclip && !self.weaponinfo[var_04].hasclip)
		{
			var_05 = getweaponmodel(var_04);
			self hidepart("tag_clip",var_05);
		}
	}
...
handledropclip(param_00)
{
	...
	if(self.weaponinfo[self.weapon].hasclip)
	{
		...
		if(isdefined(var_01))
		{
			var_02 = getweaponmodel(self.weapon);
			self hidepart("tag_clip",var_02);
