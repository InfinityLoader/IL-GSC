 ...
 * Timestamp: 10/27/2023 2:49:46 AM
*******************************************************************/
...
//Function Number: 23
hintprint(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08)
{
	var_09 = gettime();
	...
	maps\_hud_util::add_hint_background(param_08,param_07);
	var_0F = maps\_hud_util::createclientfontstring("timer",var_0E);
	level.current_hint = var_0F;
	level.hint_breakfunc = param_01;
	thread destroy_hint_on_friendlyfire(var_0F);
	level endon("friendlyfire_mission_fail");
	var_0F.alpha = 1;
	var_0F maps\_hud_util::setpoint("TOP",undefined,0,127 + var_0A);
	var_0F.foreground = 0;
	var_0F.hidewhendead = 1;
	var_0F.hidewheninmenu = 1;
	var_0F settext(param_00);
	...
	{
		var_0F.alpha = 0;
		var_0F fadeovertime(var_0B);
		var_0F.alpha = var_0D;
		hintprintwait(var_0B,level.hint_breakfunc);
	}
	...
	{
		var_11 thread hint_timeout(param_05);
	}
	...
	if(isdefined(level.hint_breakfunc))
	{
		for(;;)
		{
			hintprintwait(var_0C,level.hint_breakfunc);
			if(var_10 == 3)
			{
	...
	maps\_utility::wait_for_buffer_time_to_pass(var_09,param_06);
	var_0F notify("destroying");
...
//Function Number: 28
lerp_player_view_to_tag_smoothly_internal(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07)
{
	...
	var_08 = self gettagorigin(param_01);
	var_09 = self gettagangles(param_01);
	var_0A = param_00 maps\_utility::lerp_player_view_to_position_leave_linked(var_08,var_09,param_02,param_03,param_04,param_05,param_06,param_07);
	param_00 playerlinktodelta(self,param_01,param_03,param_04,param_05,param_06,param_07);
	var_0A delete();
}
