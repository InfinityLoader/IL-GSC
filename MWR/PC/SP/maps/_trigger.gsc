 ...
 * Platform: PC
 * Function Count: 96
 * Decompile Time: 1448 ms
 * Timestamp: 10/27/2023 2:48:53 AM
*******************************************************************/
...
get_load_trigger_classes()
{
	...
	var_00["trigger_multiple_visionset_touch"] = ::trigger_multiple_visionset_touch;
	...
	var_00["trigger_multiple_interval"] = ::trigger_multiple_interval;
	return var_00;
}
...
get_load_trigger_funcs()
{
	...
	var_00["friendly_respawn_clear"] = ::friendly_respawn_clear;
...
//Function Number: 16
trigger_friendly_respawn_preh1(param_00)
{
...
//Function Number: 25
trigger_multiple_interval(param_00)
{
	for(;;)
	{
		param_00 waittill("trigger",var_01);
		var_01 thread trigger_multiple_interval_thread(param_00);
	}
}

//Function Number: 26
trigger_multiple_interval_thread(param_00)
{
	if(!isalive(self))
	{
		return;
	...
	var_01 = self.interval;
	self.interval = float(param_00.script_parameters);
	while(self istouching(param_00))
	{
		wait(0.05);
	}

	self.interval = var_01;
...
trigger_lookat_think(param_00,param_01)
{
	...
	{
		var_08 = !issubstr(param_00.script_parameters,"no_sight");
	}
...
trigger_battlechatter(param_00)
{
	...
	if(battlechatter_dist_check(var_04.origin))
	{
		return;
	}

	var_04 maps\_utility::custom_battlechatter(param_00.script_bctrigger);
}
...
//Function Number: 67
trigger_multiple_visionset_preh1(param_00)
{
	var_01 = 0;
	var_02 = undefined;
	var_03 = undefined;
...
//Function Number: 68
trigger_multiple_visionset(param_00,param_01)
{
	param_00.visionset_trigger_id = param_00 get_new_visionset_trigger_id();
	var_02 = 0;
	var_03 = 0;
	var_04 = undefined;
	var_05 = undefined;
	...
	if(isdefined(param_00.script_visionset))
	{
	}

	if(isdefined(param_00.script_clut))
	{
	}
	...
	if(isdefined(param_00.script_visionset_start) && isdefined(param_00.script_visionset_end))
	{
		...
		if(!isdefined(var_05))
		{
			var_05 = common_scripts\utility::getstruct(param_00.target,"targetname");
		}
		...
		var_05 = var_05.origin;
		var_06 = var_06.origin;
		var_04 = distance(var_05,var_06);
		param_00 init_visionset_progress_trigger();
	}
	...
	for(;;)
	{
		...
		if(var_07 != level.player)
		{
			continue;
		}

		level.player.current_visionset_trigger_id = param_00.visionset_trigger_id;
		var_08 = -1;
		for(;;)
		{
			if(level.player istouching(param_00))
			{
				if(!var_02)
				{
					...
					if(var_03)
					{
						...
						while(level.player istouching(param_00))
						{
							var_09 = maps\_utility::get_progress(var_05,var_06,level.player.origin,var_04);
							var_09 = clamp(var_09,0,1);
							if(var_09 != var_08)
							{
								var_08 = var_09;
								level.player vision_set_fog_progress(param_00,var_09);
							}

							wait(0.05);
						}
					}
					else if(isdefined(param_00.script_visionset))
					{
						level.player maps\_utility::vision_set_fog_changes(param_00.script_visionset,param_00.script_delay);
					}

					if(isdefined(param_00.script_lightset))
					{
						level.player maps\_utility::set_light_set_player(param_00.script_lightset);
					}

					if(isdefined(param_00.script_clut))
					{
						level.player method_848C(param_00.script_clut,param_00.script_delay);
					}
				}
			}
			else
			{
				if(var_02)
				{
					...
					{
						if(var_03 && can_reset_vision_type(param_00,"visionset"))
						{
							if(var_08 < 0.5)
							{
								level.player maps\_utility::vision_set_fog_changes(param_00.script_visionset_start,param_00.script_delay);
							}
							else
							{
								level.player maps\_utility::vision_set_fog_changes(param_00.script_visionset_end,param_00.script_delay);
							}
						}
						else if(isdefined(param_00.script_visionset) && can_reset_vision_type(param_00,"visionset"))
						{
							level.player maps\_utility::vision_set_fog_changes(level.default_visionset,param_00.script_delay);
						}

						if(isdefined(param_00.script_lightset) && can_reset_vision_type(param_00,"lightset"))
						{
							level.player maps\_utility::set_light_set_player(level.default_lightset);
						}

						if(isdefined(param_00.script_clut) && can_reset_vision_type(param_00,"clut"))
						{
							level.player method_848C(level.default_clut,param_00.script_delay);
						}
					}
				}
...
//Function Number: 69
trigger_multiple_visionset_touch(param_00)
{
	trigger_multiple_visionset(param_00,1);
}
...
//Function Number: 71
get_visionset_trigger(param_00)
{
	...
	var_01 = getentarray("trigger_multiple_visionset","classname");
	var_01 = common_scripts\utility::array_combine(var_01,getentarray("trigger_multiple_visionset_touch","classname"));
	foreach(var_03 in var_01)
	{
		if(isdefined(var_03.visionset_trigger_id) && var_03.visionset_trigger_id == param_00)
		{
			return var_03;
		}
	}
...
//Function Number: 72
can_reset_vision_type(param_00,param_01)
{
	var_02 = get_visionset_trigger(level.player.current_visionset_trigger_id);
	if(!isdefined(var_02))
	{
		return 1;
	}
	...
	if(param_01 == "visionset")
	{
		return !isdefined(var_02.script_visionset);
	}
	else if(param_01 == "lightset")
	{
		return !isdefined(var_02.script_lightset);
	}
	else if(param_01 == "clut")
	{
		return !isdefined(var_02.script_clut);
	}
...
init_visionset_progress_trigger()
{
	...
	var_02.sunfogenabled = (isdefined(var_00.sunfogenabled) && var_00.sunfogenabled) || isdefined(var_01.sunfogenabled) && var_01.sunfogenabled;
	...
	if(isdefined(var_00.atmosfogenabled) && isdefined(var_01.atmosfogenabled))
	{
		var_02.atmosfogenabled = var_00.atmosfogenabled;
		var_02.atmosfogsunfogcolor = var_01.atmosfogsunfogcolor - var_00.atmosfogsunfogcolor;
		var_02.atmosfoghazecolor = var_01.atmosfoghazecolor - var_00.atmosfoghazecolor;
		var_02.atmosfoghazestrength = var_01.atmosfoghazestrength - var_00.atmosfoghazestrength;
		var_02.atmosfoghazespread = var_01.atmosfoghazespread - var_00.atmosfoghazespread;
		var_02.atmosfogextinctionstrength = var_01.atmosfogextinctionstrength - var_00.atmosfogextinctionstrength;
		var_02.atmosfoginscatterstrength = var_01.atmosfoginscatterstrength - var_00.atmosfoginscatterstrength;
		var_02.atmosfoghalfplanedistance = var_01.atmosfoghalfplanedistance - var_00.atmosfoghalfplanedistance;
		var_02.atmosfogstartdistance = var_01.atmosfogstartdistance - var_00.atmosfogstartdistance;
		var_02.atmosfogdistancescale = var_01.atmosfogdistancescale - var_00.atmosfogdistancescale;
		var_02.atmosfogskydistance = var_01.atmosfogskydistance - var_00.atmosfogskydistance;
		var_02.atmosfogskyangularfalloffenabled = var_01.atmosfogskyangularfalloffenabled - var_00.atmosfogskyangularfalloffenabled;
		var_02.atmosfogskyfalloffstartangle = var_01.atmosfogskyfalloffstartangle - var_00.atmosfogskyfalloffstartangle;
		var_02.atmosfogskyfalloffanglerange = var_01.atmosfogskyfalloffanglerange - var_00.atmosfogskyfalloffanglerange;
		var_02.atmosfogsundirection = var_01.atmosfogsundirection - var_00.atmosfogsundirection;
		var_02.atmosfogheightfogenabled = var_01.atmosfogheightfogenabled - var_00.atmosfogheightfogenabled;
		var_02.atmosfogheightfogbaseheight = var_01.atmosfogheightfogbaseheight - var_00.atmosfogheightfogbaseheight;
		var_02.atmosfogheightfoghalfplanedistance = var_01.atmosfogheightfoghalfplanedistance - var_00.atmosfogheightfoghalfplanedistance;
	}
...
vision_set_fog_progress(param_00,param_01)
{
	...
	level.lvl_visionset = param_00.script_visionset_end;
	...
	if(isdefined(var_04.atmosfogenabled))
	{
		var_05.atmosfogenabled = var_04.atmosfogenabled;
		var_05.atmosfogsunfogcolor = var_02.atmosfogsunfogcolor + var_04.atmosfogsunfogcolor * param_01;
		var_05.atmosfoghazecolor = var_02.atmosfoghazecolor + var_04.atmosfoghazecolor * param_01;
		var_05.atmosfoghazestrength = var_02.atmosfoghazestrength + var_04.atmosfoghazestrength * param_01;
		var_05.atmosfoghazespread = var_02.atmosfoghazespread + var_04.atmosfoghazespread * param_01;
		var_05.atmosfogextinctionstrength = var_02.atmosfogextinctionstrength + var_04.atmosfogextinctionstrength * param_01;
		var_05.atmosfoginscatterstrength = var_02.atmosfoginscatterstrength + var_04.atmosfoginscatterstrength * param_01;
		var_05.atmosfoghalfplanedistance = var_02.atmosfoghalfplanedistance + var_04.atmosfoghalfplanedistance * param_01;
		var_05.atmosfogstartdistance = var_02.atmosfogstartdistance + var_04.atmosfogstartdistance * param_01;
		var_05.atmosfogdistancescale = var_02.atmosfogdistancescale + var_04.atmosfogdistancescale * param_01;
		var_05.atmosfogskydistance = var_02.atmosfogskydistance + var_04.atmosfogskydistance * param_01;
		var_05.atmosfogskyangularfalloffenabled = int(var_02.atmosfogskyangularfalloffenabled + var_04.atmosfogskyangularfalloffenabled * param_01);
		var_05.atmosfogskyfalloffstartangle = var_02.atmosfogskyfalloffstartangle + var_04.atmosfogskyfalloffstartangle * param_01;
		var_05.atmosfogskyfalloffanglerange = var_02.atmosfogskyfalloffanglerange + var_04.atmosfogskyfalloffanglerange * param_01;
		var_05.atmosfogsundirection = var_02.atmosfogsundirection + var_04.atmosfogsundirection * param_01;
		var_05.atmosfogheightfogenabled = int(var_02.atmosfogheightfogenabled + var_04.atmosfogheightfogenabled * param_01);
		var_05.atmosfogheightfogbaseheight = var_02.atmosfogheightfogbaseheight + var_04.atmosfogheightfogbaseheight * param_01;
		var_05.atmosfogheightfoghalfplanedistance = var_02.atmosfogheightfoghalfplanedistance + var_04.atmosfogheightfoghalfplanedistance * param_01;
	}
...
{
	if(isdefined(param_00.script_fogset_start) && isdefined(param_00.script_fogset_end))
	{
		trigger_fog_preh1(param_00);
		return;
	}
	...
	{
		var_03 = var_02 + common_scripts\utility::vectorscale(param_00.origin - var_02,2);
	}
	...
	for(;;)
	{
		...
		while(level.player istouching(param_00))
		{
			var_07 = maps\_utility::get_progress(var_02,var_03,level.player.origin,var_05);
			if(var_07 < 0)
			{
				var_07 = 0;
			}
			...
			param_00 maps\_art::set_fog_progress(var_07);
			wait(0.05);
		}
