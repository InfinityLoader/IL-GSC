...
//Function Number: 2
setvehiclefx(param_00,param_01,param_02,param_03)
{
	maps\_vehicle::set_vehicle_effect(param_00,param_01,param_02,undefined,param_03);
}

//Function Number: 3
setallvehiclefx(param_00,param_01,param_02)
{
	var_03 = get_trace_types();
	setvehiclefx(param_00,"none",undefined,param_02);
	foreach(var_05 in var_03)
	{
		setvehiclefx(param_00,var_05,param_01,param_02);
	}
}
...
//Function Number: 5
get_surface_types_variation(param_00)
{
	var_01 = [];
	switch(param_00)
	{
