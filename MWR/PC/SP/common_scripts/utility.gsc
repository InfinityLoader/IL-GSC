 ...
 * Platform: PC
 * Function Count: 228
 * Decompile Time: 3825 ms
 * Timestamp: 10/27/2023 2:46:59 AM
*******************************************************************/
...
//Function Number: 7
vectorisnormalized(param_00)
{
	return abs(lengthsquared(param_00) - 1) < 0.002;
}
...
//Function Number: 106
array_combine_reverse_keys(param_00,param_01)
{
	if(!param_00.size)
	{
		return param_01;
	...
	var_03 = array_reverse(var_03);
	for(var_04 = 0;var_04 < var_03.size;var_04++)
	{
		var_05 = var_03[var_04];
		var_02[var_02.size] = param_00[var_05];
	}

	var_03 = getarraykeys(param_01);
	var_03 = array_reverse(var_03);
	for(var_04 = 0;var_04 < var_03.size;var_04++)
	{
		var_05 = var_03[var_04];
		var_02[var_02.size] = param_01[var_05];
	}
...
_enabledetonate(param_00,param_01)
{
	...
	if(self method_84C0(param_00) == param_01)
	{
		return;
	}

	self method_84BF(param_00,param_01);
	if(param_01)
	{
...
//Function Number: 164
play_loopsound_in_space_with_end(param_00,param_01,param_02)
{
	var_03 = play_loopsound_in_space(param_00,param_01);
	if(isdefined(param_02))
	{
...
//Function Number: 177
play_loop_sound_on_entity(param_00,param_01,param_02,param_03)
{
	if(!soundexists(param_00))
	{
		return;
...
set_fog_to_ent_values_dfog(param_00,param_01)
{
	...
	self playersetexpfog(param_00.startdist,param_00.halfwaydist,param_00.red,param_00.green,param_00.blue,param_00.hdrcolorintensity,param_00.maxopacity,param_01,param_00.skyfogintensity,param_00.skyfogminangle,param_00.skyfogmaxangle,param_00.heightfogenabled,param_00.heightfogbaseheight,param_00.heightfoghalfplanedistance);
}
...
{
	thread hide_friendname_waittill_flag_or_notify(param_00);
}

//Function Number: 228
hide_friendname_waittill_flag_or_notify(param_00)
{
