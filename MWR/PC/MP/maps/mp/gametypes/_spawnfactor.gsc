 ...
 * Timestamp: 10/27/2023 2:42:05 AM
*******************************************************************/
...
avoidairstrikelocations(param_00)
{
	...
	var_01 = maps\mp\gametypes\_hardpoints::getairstrikedanger(param_00.origin);
	if(var_01 > 0)
	{
		return 0;
	}
...
avoidenemiesbydistance(param_00)
{
	...
	var_02 = min(param_00.mindistsquared[var_01],3240000);
	var_03 = var_02 / 3240000;
	return var_03 * 100;
}
