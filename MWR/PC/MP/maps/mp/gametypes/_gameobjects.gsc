 ...
 * Timestamp: 10/27/2023 2:41:29 AM
*******************************************************************/
...
useobjectusethink()
{
	...
	for(;;)
	{
		...
		if(var_00 method_8514())
		{
			continue;
		}

		var_01 = var_00 getcurrentprimaryweapon();
		if(!var_00 maps\mp\_utility::isjuggernaut() && maps\mp\_utility::iskillstreakweapon(var_01))
		{
			continue;
		}

		if(isdefined(self.cantuseweapon) && self.cantuseweapon == var_01)
		{
			continue;
		}
		...
		if(isdefined(var_00.weaponusagename) && var_00.weaponusagename == "h1_claymore_mp")
		{
			continue;
		}
...
triggertouchthink(param_00)
{
	...
	param_00 _setnumtouching(var_01,param_00.numtouching[var_01] + 1);
	var_02 = self.guid;
	var_03 = spawnstruct();
	var_03.player = self;
...
//Function Number: 47
_setnumtouching(param_00,param_01)
{
	var_02 = self.numtouching[param_00];
	self.numtouching[param_00] = param_01;
	if(isdefined(self.onnumtouchingchanged))
	{
		[[ self.onnumtouchingchanged ]](param_00,var_02,param_01);
	}
}
...
updateuiprogress(param_00,param_01)
{
	...
	if(!isdefined(level.hostmigrationtimer))
	{
		...
		if(param_00.contesteduiprogress)
		{
			...
			if(!param_01 || param_00.claimteam != self.team)
			{
				var_05 = 0.01;
			}
		...
		if((var_02 == "sd" || var_02 == "sr" || var_02 == "sab" || var_02 == "dd") && isdefined(var_03) && var_03 == "bombZone" || var_03 == "defuseObject")
		{
			if(!param_01)
			{
				var_05 = 0;
	...
	if(param_00.contesteduiprogress)
	{
		...
		else if(!var_04)
		{
			...
			else if(param_00.ownerteam == "neutral" || maps\mp\_utility::is_true(level.captureinsteadofdestroy))
			{
	...
	if((var_02 == "sd" || var_02 == "sr" || var_02 == "sab" || var_02 == "dd") && isdefined(var_03) && var_03 == "bombZone" || var_03 == "defuseObject")
	{
		...
		if(param_00 isfriendlyteam(self.pers["team"]))
		{
...
{
	var_01 = getclaimteam();
	if(isdefined(var_01) && self.ownerteam == "neutral" && var_01 != "none" && var_01 != param_00)
	{
		return 1;
	}
