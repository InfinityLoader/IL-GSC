 ...
 * Timestamp: 10/27/2023 2:36:53 AM
*******************************************************************/
...
agent_damage_finished(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09)
{
	...
	var_0A = self finishagentdamage(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09,0);
	if(isdefined(var_0A))
	{
		thread finishagentdamage_impactfxwrapper(var_0A[0],var_0A[1],var_0A[2],var_0A[3],var_0A[4],var_0A[5],var_0A[6]);
	}
...
finishagentdamage_impactfxwrapper(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	...
	self method_8533(param_00,param_01,param_02,param_03,param_04,param_05,param_06);
}
...
on_agent_generic_damaged(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09)
{
	...
	if(isdefined(param_01) && param_01 != self && param_02 > 0 && !isdefined(param_08) || param_08 != "shield")
	{
		...
		else
		{
			...
			if(isdefined(level.iszombiegame) && level.iszombiegame)
			{
				if(param_05 == "trap_zm_mp")
				{
					var_0C = "none";
				}
				else if(param_02 < self.health)
				{
					switch(param_08)
					{
						case "neck":
