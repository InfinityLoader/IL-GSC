...
monitorflash()
{
	...
	for(;;)
	{
		...
		else if(isdefined(var_04))
		{
			if(var_04 != self)
			{
				var_04 maps\mp\gametypes\_misions::processchallenge("ch_flash");
			}

			var_0B = maps\mp\_utility::getmapname();
			if(var_0B == "mp_crash_snow")
			{
				var_04 maps\mp\gametypes\_misions::processchallenge("ch_wc_tactical");
			}
			else if(var_0B == "mp_farm_spring")
			{
				var_04 maps\mp\gametypes\_misions::processchallenge("ch_stpatty_tactical");
			}
			else if(var_0B == "mp_bog_summer")
			{
				var_04 maps\mp\gametypes\_misions::processchallenge("ch_summer_tactical");
			}
		}
