 ...
 * Timestamp: 10/27/2023 2:40:30 AM
*******************************************************************/
...
script_mover_play_animation(param_00,param_01)
{
	...
	{
		self method_8487(param_00.animname,self.scripted_node.origin,self.scripted_node.angles,"script_mover_anim");
		return;
	}
