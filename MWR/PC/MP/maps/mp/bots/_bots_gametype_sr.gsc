 ...
 * Timestamp: 10/27/2023 2:37:22 AM
*******************************************************************/
...
sr_ally_near_tag(param_00)
{
	...
	var_02 = maps\mp\bots\_bots_gametype_common::get_living_players_on_team(self.team,1);
	foreach(var_04 in var_02)
	{
		if(var_04 != self && isdefined(var_04.role) && var_04.role != "atk_bomber" && var_04.role != "defuser")
		{
