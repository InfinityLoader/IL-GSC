...
setup_bot_dom()
{
	...
	foreach(var_03 in var_00)
	{
		var_03 thread monitor_flag_control();
		var_03 thread monitor_flag_ownership();
		if(var_03.script_label != "_a" && var_03.script_label != "_b" && var_03.script_label != "_c")
		{
		}

		var_03.nodes = maps\mp\bots\_bots_gametype_common::bot_get_valid_nodes_in_trigger(var_03);
...
bot_wait_for_event_flag_swap(param_00)
{
	...
	{
		var_02.nodes = maps\mp\bots\_bots_gametype_common::bot_get_valid_nodes_in_trigger(var_02);
	}
...
bot_allowed_to_3_cap()
{
	...
	var_01 = maps\mp\gametypes\_gamescores::_getteamscore(common_scripts\utility::get_enemy_team(self.team));
	var_02 = maps\mp\gametypes\_gamescores::_getteamscore(self.team);
	var_03 = 200 - var_01;
	var_04 = 200 - var_02;
...
get_specific_flag_by_letter(param_00)
{
	...
	return get_specific_flag_by_label(var_01);
}
