/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: _civ_workvan.gsc
...
{
	maps\_vehicle::build_template("civ_workvan",param_00,param_01,param_02);
	...
	maps\_vehicle::build_light(param_02,"headlight_left","tag_headlight_left","vfx/lights/veh_default_head_light_l","headlights");
	maps\_vehicle::build_light(param_02,"headlight_right","tag_headlight_right","vfx/lights/veh_default_head_light_r","headlights");
	...
	maps\_vehicle::build_light(param_02,"brakelight_set","tag_origin","vfx/lights/veh_civ_workvan_stop_light","brakelights");
