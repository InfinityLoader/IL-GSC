/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: _attack_heli.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 74
 * Decompile Time: 1118 ms
 * Timestamp: 4/22/2024 2:04:33 AM
*******************************************************************/
...
kill_heli_logic(param_00,param_01)
{
	...
	param_00 thread heli_death_monitor();
	param_00 endon("death");
	param_00 endon("heli_players_dead");
...
heli_missiles_think()
{
	...
	for(;;)
	{
		...
		for(var_09 = 0;var_09 < var_00;var_09++)
		{
			...
			var_0A thread missile_earthquake();
			if(var_09 < var_00 - 1)
			{
				wait(var_03);
			}
...
fire_guns()
{
	switch(self.turrettype)
	{
		...
		case "miniguns":
			var_00 = getburstsize(self.etarget);
