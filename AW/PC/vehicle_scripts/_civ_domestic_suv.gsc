/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: _civ_domestic_suv.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 4
 * Decompile Time: 82 ms
 * Timestamp: 4/22/2024 2:04:38 AM
*******************************************************************/

//Function Number: 1
main(param_00,param_01,param_02)
{
	maps\_vehicle::build_template("civ_domestic_suv",param_00,param_01,param_02);
	...
	maps\_vehicle::build_light(param_02,"taillight_scroll_right","tag_brakelight_right","vfx/lights/veh_default_tail_light_r","taillights");
	maps\_vehicle::build_light(param_02,"taillight_scroll_left","tag_brakelight_left","vfx/lights/veh_default_tail_light_l","taillights");
	maps\_vehicle::build_light(param_02,"frontsignal_right","tag_headlight_right","vfx/lights/veh_default_front_signal_light_r","taillights");
	maps\_vehicle::build_light(param_02,"frontsignal_left","tag_headlight_left","vfx/lights/veh_default_front_signal_light_l","taillights");
...
setanims()
{
	...
	var_00[0].idle = %civ_domestic_suv_driving_idle;
	return var_00;
}