/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: _gaz_dshk.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 11
 * Decompile Time: 188 ms
 * Timestamp: 4/22/2024 2:04:51 AM
*******************************************************************/

//Function Number: 1
main(param_00,param_01,param_02)
{
	maps\_vehicle::build_template("gaz_tigr_turret",param_00,param_01,param_02);
	...
	maps\_vehicle::build_light(param_02,"headlight_L","TAG_HEADLIGHT_LEFT","vfx/lights/headlight_gaz","running",0);
	maps\_vehicle::build_light(param_02,"headlight_R","TAG_HEADLIGHT_RIGHT","vfx/lights/headlight_gaz","running",0);
	...
	maps\_vehicle::build_light(param_02,"headlight_L","TAG_HEADLIGHT_LEFT","vfx/lights/headlight_gaz","headlights",0);
	maps\_vehicle::build_light(param_02,"headlight_R","TAG_HEADLIGHT_RIGHT","vfx/lights/headlight_gaz","headlights",0);
...
handle_audio()
{
	...
	for(;;)
	{
		if(!isdefined(self.script_disablevehicleaudio) || !self.script_disablevehicleaudio)
		{
			...
			{
				vehicle_scripts\_gaz_dshk_aud::snd_stop_gaz(var_02);
				var_00 = 0;
				wait(0.1);
			}
		...
		{
			vehicle_scripts\_gaz_dshk_aud::snd_stop_gaz(1);
			var_00 = 0;
		}
...
monitor_death_stop_sounds()
{
	self waittill("death");
	var_00 = 1;
	vehicle_scripts\_gaz_dshk_aud::snd_stop_gaz(var_00);
}
...
setanims_turret()
{
	...
	var_00 = set_vehicle_anims_turret(var_00);
	return var_00;
}
