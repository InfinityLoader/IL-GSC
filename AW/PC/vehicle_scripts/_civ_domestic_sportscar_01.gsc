/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: _civ_domestic_sportscar_01.gsc
...
{
	maps\_vehicle::build_template("civ_domestic_sportscar_01",param_00,param_01,param_02);
	...
	maps\_vehicle::build_deathmodel("vehicle_civ_domestic_sportscar_01","vehicle_civ_domestic_sportscar_01_dstrypv",0);
...
setanims()
{
	...
	var_00[0].idle = %civ_domestic_sportscar_01_driver_idle;
