/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: _littlebird_landing.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 12
 * Decompile Time: 198 ms
 * Timestamp: 4/22/2024 2:05:05 AM
*******************************************************************/
...
littlebird_lands_and_unloads(param_00)
{
	...
	if(isdefined(param_00.custom_landing))
	{
		switch(param_00.custom_landing)
		{
			case "hover_then_land":
				param_00 vehicle_setspeed(10,22,7);
				param_00 thread vehicle_land_beneath_node(32,self,64);
				param_00 waittill("near_goal");
				param_00 notify("hovering");
				wait(1);
				break;
	...
	param_00 thread vehicle_land_beneath_node(16,self);
	param_00 waittill("near_goal");
	badplace_delete(var_01);
	maps\_utility::script_delay();
	param_00 maps\_vehicle::vehicle_unload();
	param_00 maps\_vehicle_code::waittill_stable();
	param_00 vehicle_setspeed(20,8,7);
	wait(0.2);
	param_00 notify("stable_for_unlink");
	wait(0.2);
	...
	param_00 notify("littlebird_liftoff");
}
