/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: _pdrone_player.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 69
 * Decompile Time: 1059 ms
 * Timestamp: 4/22/2024 2:05:18 AM
*******************************************************************/
...
pdrone_deploy_check(param_00,param_01,param_02)
{
	...
	for(var_07 = 0;var_07 <= 5;var_07++)
	{
		...
		{
			case 1:
				var_09 = (-1 * param_02,var_09[1] - param_01,0);
				var_08 = (0,1,0);
				break;

			case 2:
				var_09 = (0,var_09[1] - param_01,0);
				var_08 = (0,0,1);
				break;
		...
		var_0A = var_03 + anglestoforward(var_09) * param_00;
		var_0B = playerphysicstrace(var_03,var_0A);
		var_0C = length(var_0B - var_0A);
		var_04 = var_0C == 0;
	}
