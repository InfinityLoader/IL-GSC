/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\seoul_code_gangnam.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 471
 * Decompile Time: 7715 ms
 * Timestamp: 10/27/2023 1:56:34 AM
*******************************************************************/
...
handle_land_assist_safe_descent_training()
{
	...
	while(!common_scripts\utility::flag("begin_looping_fob_functions"))
	{
		...
		while(!common_scripts\utility::flag("begin_looping_fob_functions") && level.player buttonpressed("BUTTON_X"))
		{
			wait 0.05;
		}
