/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: vehicle_scripts/_x4walker_wheels_turret_aud.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 31
 * Decompile Time: 374 ms
 * Timestamp: 10/27/2023 2:06:51 AM
*******************************************************************/

//Function Number: 1
snd_init_x4_walker_wheels_turret()
{
	soundscripts\_audio_vehicle_manager::avm_register_callback("x4wwt_zvelocity_front_left",::x4wwt_input_callback_wheel_zvelocity_front_left);
	soundscripts\_audio_vehicle_manager::avm_register_callback("x4wwt_zvelocity_front_right",::x4wwt_input_callback_wheel_zvelocity_front_right);
	soundscripts\_audio_vehicle_manager::avm_register_callback("x4wwt_zvelocity_rear_left",::x4wwt_input_callback_wheel_zvelocity_rear_left);
	soundscripts\_audio_vehicle_manager::avm_register_callback("x4wwt_zvelocity_rear_right",::x4wwt_input_callback_wheel_zvelocity_rear_right);
	soundscripts\_audio_vehicle_manager::avm_register_callback("x4wwt_gun_pitch_rate",::x4wwt_input_callback_gun_pitch_rate);
	soundscripts\_audio_vehicle_manager::avm_register_callback("x4wwt_gun_yaw_rate",::x4wwt_input_callback_gun_yaw_rate);
	soundscripts\_audio_vehicle_manager::avm_register_callback("x4wwt_player_driver",::x4wwt_input_callback_player_driver);
	soundscripts\_audio_vehicle_manager::avm_register_callback("x4wwt_gun_pitch_rate2",::x4wwt_input_callback_gun_pitch_rate);
	soundscripts\_audio_vehicle_manager::avm_register_callback("x4wwt_gun_yaw_rate2",::x4wwt_input_callback_gun_yaw_rate);
	soundscripts\_snd::snd_message("snd_register_vehicle","x4walker_wheels_turret",::snd_x4walker_wheels_turret_constructor);
}

//Function Number: 2
snd_start_x4_walker_wheels_turret(param_00)
{
	...
	var_02 = spawnstruct();
	var_02.preset_name = "x4walker_wheels_turret";
	var_02.player_mode = param_00 == "plr";
	soundscripts\_snd::snd_message("snd_start_vehicle",var_02);
	soundscripts\_snd::snd_message("player_enter_walker");
}

//Function Number: 3
snd_x4walker_wheels_turret_constructor()
{
	soundscripts\_audio_vehicle_manager::avm_begin_preset_def("x4walker_wheels_turret");
	soundscripts\_audio_vehicle_manager::avm_begin_loop_data();
	soundscripts\_audio_vehicle_manager::avm_begin_loop_def("x4_turret_idle2");
	...
	soundscripts\_audio_vehicle_manager::avm_begin_loop_def("x4_turret_move");
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("speed",0.65,0.3);
	...
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_loop_def();
	soundscripts\_audio_vehicle_manager::avm_begin_loop_def("x4_turret_move2");
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("speed",0.65,0.8);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_move2_lp_vel2vol");
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("pitch","x4_move2_lp_vel2pch");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("pitch",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("pitch","x4_move_pit2pch","x4_move_pit2pch");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_loop_def();
	soundscripts\_audio_vehicle_manager::avm_begin_loop_def("x4_turret_sub_lp");
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("speed",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_sub_lp_vel2vol","x4_sub_lp_vel2vol");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_loop_def();
	soundscripts\_audio_vehicle_manager::avm_begin_loop_def("x4_turret_rotate_faster");
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("x4wwt_gun_yaw_rate",0.3,0.3);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_turret_rot_fast_vel2vol","x4_turret_rot_fast_vel2vol");
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("pitch","x4_turret_rot_slow_vel2pit","x4_turret_rot_slow_vel2pit");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("speed",0.3,0.3);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_veh_speed_to_turret_rot_vel2vol","x4_veh_speed_to_turret_rot_vel2vol");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("x4wwt_gun_yaw_rate2",0.9,0.9);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_veh_speed_to_turret_rot_gate","x4_veh_speed_to_turret_rot_gate");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_loop_def();
	soundscripts\_audio_vehicle_manager::avm_begin_loop_def("x4_turret_rotate_slow");
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("x4wwt_gun_yaw_rate",0.3,0.3);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_turret_rot_slow_vel2vol","x4_turret_rot_slow_vel2vol");
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("pitch","x4_turret_rot_slow_vel2pit","x4_turret_rot_slow_vel2pit");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("x4wwt_gun_yaw_rate2",1,1);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_veh_speed_to_turret_rot_gate","x4_veh_speed_to_turret_rot_gate");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_loop_def();
	soundscripts\_audio_vehicle_manager::avm_begin_loop_def("x4_turret_elevate");
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("x4wwt_gun_pitch_rate",0.3,0.3);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_turret_pitch_rate_vel2vol","x4_turret_pitch_rate_vel2vol");
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("pitch","x4_turret_pitch_rate_vel2pit","x4_turret_pitch_rate_vel2pit");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("x4wwt_gun_pitch_rate2",1,1);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_turret_pitch_rate_gate","x4_turret_pitch_rate_gate");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_loop_def();
	soundscripts\_audio_vehicle_manager::avm_end_loop_data();
	soundscripts\_audio_vehicle_manager::avm_begin_oneshot_data(0.25);
	soundscripts\_audio_vehicle_manager::avm_begin_oneshot_def("x4_turret_startup","x4_startup_duck_envelope");
	soundscripts\_audio_vehicle_manager::avm_end_oneshot_def();
	soundscripts\_audio_vehicle_manager::avm_begin_oneshot_def("x4_turret_shutoff","xwalk_shutoff_duck_envelope");
	soundscripts\_audio_vehicle_manager::avm_end_oneshot_def();
	soundscripts\_audio_vehicle_manager::avm_begin_oneshot_def("x4_turret_accel_hard","xwalk_accel_duck_envelope");
	...
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_oneshot_def();
	soundscripts\_audio_vehicle_manager::avm_begin_oneshot_def("x4_turret_decel_1","xwalk_stop_duck_envelope",0.5,1,["x4_turret_decel"]);
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("speed",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_break_squeal_vel2vol");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_oneshot_def();
	soundscripts\_audio_vehicle_manager::avm_begin_oneshot_def("x4_turret_decel_2","xwalk_stop_duck_envelope",0.5,1,["x4_turret_decel","x4_turret_stop_squeal"]);
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("speed",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_break_squeal_vel2vol");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_oneshot_def();
	soundscripts\_audio_vehicle_manager::avm_begin_oneshot_def("x4_turret_stop_chuff");
	...
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_oneshot_def();
	soundscripts\_audio_vehicle_manager::avm_begin_oneshot_def("x4_turret_suspen_bump_hard","xwalk_stop_duck_envelope");
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("speed",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_add_param_map_env("volume","x4_suspen_vel2vol");
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_oneshot_def();
	soundscripts\_audio_vehicle_manager::avm_begin_oneshot_def("x4_turret_rotate_stop","xwalk_stop_duck_envelope");
	soundscripts\_audio_vehicle_manager::avm_end_oneshot_def();
	soundscripts\_audio_vehicle_manager::avm_end_oneshot_data();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_data();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_off",::x4wwt_condition_callback_to_state_off);
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_startup",::x4wwt_condition_callback_to_state_startup);
	soundscripts\_audio_vehicle_manager::avm_add_oneshots("x4_turret_startup");
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_shutoff",::x4wwt_condition_callback_to_state_shutoff,["x4wwt_player_driver"]);
	soundscripts\_audio_vehicle_manager::avm_add_oneshots("x4_turret_shutoff");
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_enter_vehicle",::x4wwt_condition_callback_to_state_enter_vehicle,["x4wwt_player_driver"]);
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_idle",::x4wwt_condition_callback_to_state_idle,["speed"]);
	soundscripts\_audio_vehicle_manager::avm_add_loops("ALL");
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_start_move",::x4wwt_condition_callback_to_state_start_move);
	soundscripts\_audio_vehicle_manager::avm_add_oneshots("x4_turret_accel_hard");
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("speed",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_moving",::x4wwt_condition_callback_to_state_moving,["speed"]);
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_breaking",::x4wwt_condition_callback_to_state_breaking);
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("speed",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("pitch",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_stop",::x4wwt_condition_callback_to_state_stopped,["speed"]);
	soundscripts\_audio_vehicle_manager::avm_add_oneshots("x4_turret_stop_chuff");
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_destruct",::x4wwt_condition_callback_to_state_destruct);
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_wheels_neutral",::x4wwt_condition_callback_to_state_wheels_neutral);
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_wheels_bump_impact",::x4wwt_condition_callback_to_state_wheels_bump_impact);
	soundscripts\_audio_vehicle_manager::avm_add_oneshots("x4_turret_suspen_bump_hard");
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("x4wwt_zvelocity_front_left",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("x4wwt_zvelocity_front_right",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("x4wwt_zvelocity_rear_left",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("x4wwt_zvelocity_rear_right",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("speed",0.65,0.3);
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_turret_rotate",::x4wwt_condition_callback_to_state_turret_rotate,["x4wwt_gun_yaw_rate"]);
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_turret_rotate_accel",::x4wwt_condition_callback_to_state_turret_rotate_accel);
	soundscripts\_audio_vehicle_manager::avm_add_oneshots("x4_turret_rotate_stop");
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("x4wwt_gun_yaw_rate",1,1);
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_begin_param_map("speed",0.6,0.6);
	soundscripts\_audio_vehicle_manager::avm_end_param_map();
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_turret_rotate_decel",::x4wwt_condition_callback_to_state_turret_rotate_decel,["x4wwt_gun_yaw_rate"]);
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_turret_stopped",::x4wwt_condition_callback_to_state_turret_stopped,["pitch","x4wwt_gun_yaw_rate"]);
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	soundscripts\_audio_vehicle_manager::avm_begin_behavior_def("to_state_turret_elevate",::x4wwt_condition_callback_to_state_turret_elevate,["x4wwt_gun_pitch_rate"]);
	soundscripts\_audio_vehicle_manager::avm_end_behavior_def();
	...
	soundscripts\_audio_vehicle_manager::avm_end_state_def();
	soundscripts\_audio_vehicle_manager::avm_end_state_group();
	soundscripts\_audio_vehicle_manager::avm_begin_state_group("turret_rotate","state_turret_rotate_accel","to_state_turret_rotate_accel",50,1);
	...
	soundscripts\_audio_vehicle_manager::avm_add_envelope("x4_startup_duck_envelope",[[0,0],[1,0.5],[1.6,1]]);
	soundscripts\_audio_vehicle_manager::avm_add_envelope("xwalk_shutoff_duck_envelope",[[0,1],[0.16,0.4],[1.1,0]]);
	soundscripts\_audio_vehicle_manager::avm_end_preset_def();
}

//Function Number: 4
x4wwt_condition_callback_to_state_off(param_00,param_01)
{
	return 1;
}

//Function Number: 5
x4wwt_condition_callback_to_state_enter_vehicle(param_00,param_01)
{
	var_02 = 0;
...
//Function Number: 6
x4wwt_condition_callback_to_state_exit_vehicle(param_00,param_01)
{
	var_02 = 0;
	var_03 = param_00["x4wwt_player_driver"];
	if(!var_03)
...
//Function Number: 7
x4wwt_condition_callback_to_state_startup(param_00,param_01)
{
	param_01.g_xwalk_pitched_hard = 0;
	param_01.g_xwalk_was_stopped = 1;
	param_01.g_xwalk_time_started_to_move = 0;
	return 1;
}

//Function Number: 8
x4wwt_condition_callback_to_state_shutoff(param_00,param_01)
{
	var_02 = 0;
	var_03 = param_00["x4wwt_player_driver"];
	if(!var_03)
...
//Function Number: 9
x4wwt_condition_callback_to_state_idle(param_00,param_01)
{
	var_02 = 0;
...
//Function Number: 10
x4wwt_condition_callback_to_state_start_move(param_00,param_01)
{
	var_02 = 0;
	var_03 = param_00["speed"];
	...
	{
		var_04 = var_03 - param_01.start_move.prev_velo;
		if(param_01.start_move.accelerating == 0 && var_04 > 0)
		{
			param_01.start_move.accelerating = 1;
			param_01.start_move.acceltime = gettime();
		}
		else if(param_01.start_move.accelerating == 1 && var_04 > 0)
		{
		...
		if(param_01.g_xwalk_pitched_hard == 1 && var_04 > 0)
		{
			var_05 = gettime() - param_01.start_move.strain_accel_last_trigger;
			if(var_05 > 4000)
			{
				var_02 = 1;
				param_01.g_xwalk_time_started_to_move = gettime();
				param_01.start_move.acceltime = 0;
				param_01.start_move.accelerating = 0;
				param_01.start_move.time_accel = 0;
				param_01.g_xwalk_pitched_hard = 0;
		...
		else if(param_01.start_move.time_accel > 400 && var_04 > 0.4)
		{
			var_02 = 1;
			param_01.g_xwalk_time_started_to_move = gettime();
			param_01.start_move.acceltime = 0;
...
//Function Number: 11
x4wwt_condition_callback_to_state_moving(param_00,param_01)
{
	var_02 = 0;
	var_03 = param_00["speed"];
	if(var_03 > 0.1)
...
//Function Number: 12
x4wwt_condition_callback_to_state_breaking(param_00,param_01)
{
	var_02 = 0;
	var_03 = param_00["speed"];
	var_04 = param_00["pitch"];
	var_05 = gettime() - param_01.g_xwalk_time_started_to_move;
...
//Function Number: 13
x4wwt_condition_callback_to_state_stopped(param_00,param_01)
{
	var_02 = 0;
	var_03 = param_00["speed"];
	if(var_03 < 0.1)
...
//Function Number: 14
x4wwt_condition_callback_to_state_destruct(param_00,param_01)
{
	return 0;
}

//Function Number: 15
x4wwt_condition_callback_to_state_wheels_neutral(param_00,param_01)
{
	return 0;
}

//Function Number: 16
x4wwt_condition_callback_to_state_wheels_bump_impact(param_00,param_01)
{
...
//Function Number: 17
x4wwt_condition_callback_to_state_turret_rotate(param_00,param_01)
{
	var_02 = 0;
	return var_02;
}
...
//Function Number: 18
x4wwt_condition_callback_to_state_turret_stopped(param_00,param_01)
{
	var_02 = 0;
	return var_02;
}
...
//Function Number: 19
x4wwt_condition_callback_to_state_turret_rotate_accel(param_00,param_01)
{
	var_02 = 0;
...
//Function Number: 20
x4wwt_condition_callback_to_state_turret_rotate_decel(param_00,param_01)
{
	var_02 = 0;
	return var_02;
}
...
//Function Number: 21
x4wwt_condition_callback_to_state_turret_elevate(param_00,param_01)
{
	var_02 = 0;
	return var_02;
}
...
//Function Number: 26
x4wwt_input_callback_wheel_zvelocity(param_00)
{
	var_01 = soundscripts\_audio_vehicle_manager::avmx_get_vehicle_entity();
	var_02 = var_01 vehicle_scripts\_x4walker_wheels_turret::get_wheel_velocity(param_00);
	var_03 = var_02[2];
	return var_03;
}
...
x4wwt_input_callback_gun_pitch_rate()
{
	...
	var_01 = var_00 vehicle_scripts\_x4walker_wheels_turret::get_gun_pitch_rate();
	return var_01;
}
...
{
	var_00 = soundscripts\_audio_vehicle_manager::avmx_get_vehicle_entity();
	var_01 = var_00 vehicle_scripts\_x4walker_wheels_turret::get_gun_yaw_rate();
	return var_01;
}
