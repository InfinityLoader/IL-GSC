/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: vehicle_scripts/_mil_cargo_truck.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 4
 * Decompile Time: 45 ms
 * Timestamp: 10/27/2023 2:06:22 AM
*******************************************************************/

//Function Number: 1
main(param_00,param_01,param_02)
{
	maps\_vehicle::build_template("mil_cargo_truck",param_00,param_01,param_02);
