/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: _shg_design_tools.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 54
 * Decompile Time: 848 ms
 * Timestamp: 4/22/2024 2:22:34 AM
*******************************************************************/
...
//Function Number: 53
get_standard_glow_text(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07)
{
	var_08 = param_00;
	var_09 = param_05 * param_02 + param_01;
	if(!isdefined(param_06))
	{
		param_06 = (0.8,1,0.8);
	}
	...
	var_0A.alignx = param_03;
	var_0A.aligny = param_04;
	var_0A.horzalign = "center";
	var_0A.vertalign = "middle";
	var_0A.x = var_08;
	var_0A.y = var_09;
	var_0A.fontscale = 1.6;
	var_0A.color = param_06;
	var_0A.font = "objective";
	var_0A.glowcolor = param_07;
	var_0A.glowalpha = 1;
	var_0A.foreground = 1;
