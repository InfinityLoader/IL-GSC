/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: _shg_utility.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 57
 * Decompile Time: 877 ms
 * Timestamp: 4/22/2024 2:22:40 AM
*******************************************************************/
...
setup_player_for_scene(param_00,param_01)
{
	...
	if(isdefined(param_00) && param_00)
	{
		...
		{
			var_02 = maps\_player_exo::player_exo_is_active_single("boost_dash");
			if(var_02)
			{
...
monitorscopechange()
{
	...
	for(;;)
	{
		...
		if(var_08 && !var_06 isreloading() && !var_06 isreloading())
		{
...
{
	if(!isdefined(param_00) && isdefined(level.exo_cinema_disabled))
	{
		param_00 = level.exo_cinema_disabled;
...
scale_3d_hint_button(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	for(;;)
	{
		...
		{
			var_07 = param_02 getusableentity();
...
buttonmash_hint_cleanup(param_00,param_01,param_02,param_03)
{
	...
	level.player notifyonplayercommandremove(param_01,param_02);
	if(isdefined(param_03))
	{
		level.player notifyonplayercommandremove(param_01,param_03);
	}
}
