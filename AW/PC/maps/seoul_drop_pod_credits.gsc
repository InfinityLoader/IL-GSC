 ...
 * Timestamp: 4/22/2024 2:36:54 AM
*******************************************************************/
...
credits_start()
{
	...
	var_00 = 16;
	var_01 = [-350,110,var_00 + 2,"left","middle"];
...
{
	var_04 = 18;
	var_05 = maps\_shg_design_tools::get_standard_glow_text(param_00[0],param_00[1],param_00[2],param_00[3],param_00[4],param_02 * -1,(0.75,0.85,0.87),(0.25,0.25,0.3));
