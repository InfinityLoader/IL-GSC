/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: _car_door_shield.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 47
 * Decompile Time: 671 ms
 * Timestamp: 4/22/2024 2:20:10 AM
*******************************************************************/
...
get_weapon_model(param_00)
{
	...
	switch(param_00)
	{
		case "atlas_suv_door_03_gj":
		case "vm_atlas_suv_door_fl":
			var_01 = "weapon_suv_door_shield_fl";
			break;

		case "atlas_suv_door_04_gj":
		case "atlas_suv_door_02_gj":
		case "vm_atlas_suv_door_fr":
			var_01 = "weapon_suv_door_shield_fr";
			break;

		case "npc_civ_boxtruck_door_fl":
			var_01 = "weapon_boxtruck_door_shield_fl";
			break;

		case "npc_civ_boxtruck_door_fr":
			var_01 = "weapon_boxtruck_door_shield_fr";
			break;
	}
