/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\_teleport.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 59
 * Decompile Time: 904 ms
 * Timestamp: 4/22/2024 2:16:19 AM
*******************************************************************/
...
teleport_onstartgametype()
{
	...
	{
		case "dom":
			var_01 = ::teleport_onstartgamedom;
			break;

		case "ctf":
			var_01 = ::teleport_onstartgamectf;
			break;

		case "hp":
			var_01 = ::teleport_onstartgamehp;
			break;

		case "ball":
			var_01 = ::teleport_onstartgameball;
			break;
	...
	foreach(var_04 in var_01)
	{
		...
		switch(var_04.script_noteworthy)
		{
			case "teleport_origin":
				var_05 = var_04.origin + (0,0,1);
				var_06 = var_04.origin - (0,0,250);
			...
			case "telport_origin_nodrop":
				...
				{
					var_04.script_parameters = "none,axis,allies";
				}
	
				var_08 = strtok(var_04.script_parameters,", ");
				foreach(var_0A in var_08)
				{
					if(!isdefined(param_00.teleport_origins[var_0A]))
					{
						continue;
					}
					...
					var_0B = param_00.teleport_origins[var_0A].size;
					param_00.teleport_origins[var_0A][var_0B] = var_04;
				}
				break;
