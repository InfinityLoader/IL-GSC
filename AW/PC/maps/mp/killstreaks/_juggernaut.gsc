/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\killstreaks\_juggernaut.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 145
 * Decompile Time: 2162 ms
 * Timestamp: 4/22/2024 2:11:51 AM
*******************************************************************/
...
givejuggernaut(param_00,param_01)
{
	...
	switch(param_00)
	{
		...
		default:
			var_02 = 1;
			var_03 = "juggernaut_exosuit";
			if(!isdefined(param_01) || common_scripts\utility::array_contains(param_01,"heavy_exosuit_maniac"))
			{
				var_02 = 1.15;
				var_03 = "juggernaut_exosuit_maniac";
			}
	
			self.juggmovespeedscaler = var_02;
			removeweapons();
			var_04 = isdefined(self.perks["specialty_hardline"]);
			maps\mp\gametypes\_class::giveandapplyloadout(self.pers["team"],var_03,0,0);
			maps\mp\gametypes\_playerlogic::streamclassweapons(0,0,var_03);
			self.isjuggernaut = 1;
