/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\perks\_perks.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 10
 * Decompile Time: 166 ms
 * Timestamp: 4/22/2024 2:12:57 AM
*******************************************************************/
...
cac_modified_damage(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08)
{
	...
	if(isdefined(param_00.lightarmorhp) && isdefined(var_0C))
	{
		switch(var_0C)
		{
			case "exoknife_mp":
			...
			default:
				if(param_03 != "MOD_FALLING" && !maps\mp\_utility::ismeleemod(param_03) && !maps\mp\_utility::isheadshot(var_0C,param_07,param_03,param_01) && !maps\mp\_utility::isfmjdamage(var_0C,param_03,param_01))
				{
					param_00 maps\mp\perks\_perkfunctions::setlightarmorhp(param_00.lightarmorhp - param_02 + var_09);
					param_02 = 0;
					var_09 = 0;
