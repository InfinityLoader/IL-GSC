/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\gametypes\_globallogic.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 9
 * Decompile Time: 160 ms
 * Timestamp: 4/22/2024 2:09:32 AM
*******************************************************************/
...
init()
{
	...
	if(!level.practiceround && maps\mp\_utility::matchmakinggame() || (level.gametype == "horde" || level.gametype == "zombies") && level.onlinegame)
	{
		...
		{
			precacheleaderboards("LB_GB_TOTALXP_AT LB_GB_TOTALXP_LT LB_GB_WINS_AT LB_GB_WINS_LT LB_GB_KILLS_AT LB_GB_KILLS_LT LB_GB_ACCURACY_AT LB_ACCOLADES LB_GB_RANKEDPLAY" + var_01 + var_00);
		}
	}
