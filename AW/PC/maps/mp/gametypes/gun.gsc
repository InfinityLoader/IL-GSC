/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\gametypes\gun.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 23
 * Decompile Time: 384 ms
 * Timestamp: 4/22/2024 2:10:49 AM
*******************************************************************/
...
setguns()
{
	...
	{
		case 1:
			level.gun_guns = var_03;
			break;

		case 2:
			level.gun_guns = var_04;
			break;

		case 3:
			for(var_01 = 0;var_01 < level.gun_guns.size;var_01++)
			{
				level.gun_guns[var_01] = var_03[var_01];
				if(common_scripts\utility::cointoss())
				{
					level.gun_guns[var_01] = var_04[var_01];
				}
			}
			break;
	}
...
assign_random_loot_variant(param_00,param_01)
{
	...
	{
		case 0:
			param_00 = param_00 + "loot0";
			break;

		case 1:
			param_00 = param_00 + "loot1";
			break;

		case 2:
			param_00 = param_00 + "loot2";
			break;

		case 3:
			param_00 = param_00 + "loot3";
			break;

		case 4:
			param_00 = param_00 + "loot4";
			break;

		case 5:
			param_00 = param_00 + "loot5";
			break;

		case 6:
			param_00 = param_00 + "loot6";
			break;

		case 7:
			param_00 = param_00 + "loot7";
			break;

		case 8:
			param_00 = param_00 + "loot8";
			break;

		case 9:
			param_00 = param_00 + "loot9";
			break;
