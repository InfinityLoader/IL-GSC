/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\gametypes\dom.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 39
 * Decompile Time: 605 ms
 * Timestamp: 4/22/2024 2:10:47 AM
*******************************************************************/
...
flagsetup()
{
	...
	var_03 = maps\mp\gametypes\_spawnlogic::getspawnpointarray("mp_dom_spawn");
	foreach(var_05 in var_03)
	{
		var_05.preferreddompoint = undefined;
		if(isdefined(var_05.script_noteworthy))
		{
			if(var_05.script_noteworthy == "a_override")
			{
				var_05.preferreddompoint = 0;
				continue;
			}
			else if(var_05.script_noteworthy == "b_override")
			{
				var_05.preferreddompoint = 1;
				continue;
			}
			else if(var_05.script_noteworthy == "c_override")
			{
				var_05.preferreddompoint = 2;
				continue;
			}
		}
