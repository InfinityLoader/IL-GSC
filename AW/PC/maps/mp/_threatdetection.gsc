/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\_threatdetection.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 38
 * Decompile Time: 583 ms
 * Timestamp: 4/22/2024 2:16:21 AM
*******************************************************************/
...
visitorupdatemarkerpos(param_00,param_01,param_02)
{
	...
	if(var_03 == "vfx_model")
	{
		...
		var_05 = param_00 != self._threatdetection.mark_friendly_model;
		var_06 = self._threatdetection.friendly_pose;
		if(var_05)
		{
			var_04 = var_04 + "_hostile";
			var_06 = self._threatdetection.hostile_pose;
		}
		...
		if(var_06 != var_04)
		{
			...
			if(var_05)
			{
				...
				self._threatdetection.mark_enemy_model = spawnfx(common_scripts\utility::getfx(var_04),self.origin,var_07,var_08);
				self._threatdetection.mark_enemy_model hide();
				self._threatdetection.hostile_pose = var_04;
			}
			else
			{
				self._threatdetection.mark_friendly_model delete();
				self._threatdetection.mark_friendly_model = spawnfx(common_scripts\utility::getfx(var_04),self.origin,var_07,var_08);
				self._threatdetection.mark_friendly_model hide();
				self._threatdetection.friendly_pose = var_04;
			}
		}
