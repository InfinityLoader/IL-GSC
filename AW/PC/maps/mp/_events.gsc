/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\_events.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 105
 * Decompile Time: 1606 ms
 * Timestamp: 4/22/2024 2:15:40 AM
*******************************************************************/
...
killedplayerevent(param_00,param_01,param_02)
{
	...
	switch(param_01)
	{
		...
		case "killstreak_solar_mp":
			var_03 = "map_killstreak_kill";
			break;
	}

	if(var_03 != "kill")
	{
		maps\mp\_utility::incplayerstat(var_03,1);
		maps\mp\gametypes\_missions::ch_streak_kill(var_03);
	}

	if(level.practiceround)
	{
		thread practiceroundkillevent(param_00,var_03,param_01,param_02);
	}

	level thread maps\mp\gametypes\_rank::awardgameevent(var_03,self,param_01,param_00,param_02);
}
...
oneshotkillevent(param_00,param_01,param_02)
{
	...
	if(var_04 == "weapon_shotgun")
	{
		...
		{
			case "iw5_dlcgun4":
				maps\mp\gametypes\_missions::processchallenge("ch_tier2_2_" + var_03);
				break;
