/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\zombies\killstreaks\_zombie_drone_common.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 23
 * Decompile Time: 375 ms
 * Timestamp: 4/22/2024 2:13:03 AM
*******************************************************************/
...
updateshootinglocation(param_00,param_01,param_02)
{
	...
	{
		maps\mp\zombies\_util::playfxontagnetwork(param_01,param_00.targetent,"tag_origin");
	}
...
_cleanupshootinglocationondeath(param_00,param_01)
{
	...
	if(isdefined(param_00.targetent))
	{
		...
		if(isdefined(param_01))
		{
			maps\mp\zombies\_util::stopfxontagnetwork(param_01,var_02,"tag_origin");
		}
...
playerdeleteexhaustfxonvehicledeath(param_00,param_01,param_02)
{
	...
	maps\mp\zombies\_util::killfxontagnetwork(common_scripts\utility::getfx(param_01),param_00,param_02);
}
