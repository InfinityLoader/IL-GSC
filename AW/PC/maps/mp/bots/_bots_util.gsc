/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\bots\_bots_util.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 74
 * Decompile Time: 1184 ms
 * Timestamp: 4/22/2024 2:09:01 AM
*******************************************************************/
...
bot_choose_difficulty_for_default()
{
	...
	var_00 = self.pers["bot_chosen_difficulty"];
	if(!isdefined(var_00))
	{
		var_01 = [];
		var_02 = self.team;
	...
	if(isdefined(var_00))
	{
		self.pers["bot_chosen_difficulty"] = var_00;
	}
...
bot_get_total_gun_ammo()
{
	...
	foreach(var_03 in var_01)
	{
		...
		var_00 = var_00 + self setweaponammostock(var_03);
	}
...
bot_out_of_ammo()
{
	...
	foreach(var_02 in var_00)
	{
		...
		if(self setweaponammostock(var_02) > 0)
		{
			return 0;
		}
	}
		...
		if(self.watch_nodes.size > 0)
		{
			...
			if(!var_1C && var_1A >= var_15)
			{
				...
				for(var_21 = 0;var_21 < self.watch_nodes.size;var_21++)
				{
					...
					if(common_scripts\utility::within_fov(self.origin,self.angles,var_0D.origin,var_1B))
					{
...
bot_leader_dialog(param_00,param_01)
{
	...
	{
		if(!common_scripts\utility::within_fov(self.origin,self.angles,param_01,self botgetfovdot()))
		{
	...
	for(;;)
	{
		...
		foreach(var_03 in level.participants)
		{
			...
			if(var_03 [[ param_00 ]]() && !isdefined(var_01[var_03.team]))
			{
				...
				level.enemy_camp_spots[var_03.team] = var_03 botpredictenemycampspots(1);
