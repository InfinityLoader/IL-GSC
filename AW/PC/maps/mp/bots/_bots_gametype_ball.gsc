/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\bots\_bots_gametype_ball.gsc
...
bot_setup_ball_jump_nodes()
{
	...
	foreach(var_03 in level.ball_goals)
	{
		...
		{
			var_04 = level.ballgoalradius;
		}

		var_05 = getnodesinradius(var_03.origin,var_04,0);
		foreach(var_07 in var_05)
		{
			...
			if(isdefined(level.ballpreventgoaljumpfromtraversals) && level.ballpreventgoaljumpfromtraversals && var_07.type == "Begin")
			{
				continue;
			}

			var_00++;
			if(bot_ball_origin_can_see_goal(var_07.origin,var_03,1))
			{
				var_03.ball_jump_nodes[var_03.ball_jump_nodes.size] = var_07;
			}
		...
		var_09 = 999999999;
		foreach(var_07 in var_03.ball_jump_nodes)
		{
			var_0B = distance2dsquared(var_07.origin,var_03.origin);
			if(var_0B < var_09)
			{
				var_03.nearest_node = var_07;
				var_09 = var_0B;
			}
		}
