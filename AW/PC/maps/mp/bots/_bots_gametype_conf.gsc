/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\bots\_bots_gametype_conf.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 16
 * Decompile Time: 252 ms
 * Timestamp: 4/22/2024 2:08:35 AM
*******************************************************************/
...
bot_is_tag_visible(param_00,param_01,param_02)
{
	...
	if(isdefined(var_03) && var_04 || param_00.on_path_grid)
	{
		...
		if(var_05)
		{
			var_06 = common_scripts\utility::within_fov(self.origin,self.angles,param_00.curorigin,param_02);
			if(var_06)
			{
				if(var_04)
				{
