/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: mp\_utility.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 392
 * Decompile Time: 5728 ms
 * Timestamp: 4/22/2024 2:16:43 AM
*******************************************************************/
	...
	foreach(var_03 in param_01)
	{
		switch(var_03)
		{
			...
			case "turretheadenergy_mp":
				if(issubstr(param_00,"ripped_turret"))
				{
					return var_03;
				}
				break;
...
makegloballyusablebytype(param_00,param_01,param_02,param_03)
{
	...
	_insertintoglobalusablelist(var_04,param_00,param_02,param_03);
	self makeglobalusable(var_04,param_02,param_03);
