/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: _breach.gsc
 * Game: Call of Duty: Advanced Warfare
 * Platform: PC
 * Function Count: 24
 * Decompile Time: 341 ms
 * Timestamp: 4/22/2024 2:20:07 AM
*******************************************************************/
...
breach_think(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	{
		self.closestai = common_scripts\utility::getclosest(self.animent.origin,param_00);
	}
	...
	if(var_0C.size > 0)
	{
		common_scripts\utility::array_thread(var_0C,::breach_enemies_stunned,self);
	}
