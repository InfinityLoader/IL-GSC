 ...
 * Platform: PC
 * Function Count: 86
 * Decompile Time: 1248 ms
 * Timestamp: 4/22/2024 2:23:32 AM
*******************************************************************/
...
init_script_triggers()
{
	...
	for(var_0B = 0;var_0B < 7;var_0B++)
	{
		...
		for(var_0A = 0;var_0A < var_04.size;var_0A++)
		{
			...
			{
				level thread trigger_script_flag_true(var_04[var_0A]);
			}

			if(isdefined(var_04[var_0A].script_flag_false))
			{
				level thread trigger_script_flag_false(var_04[var_0A]);
			}
			...
			{
				level thread maps\_vehicle_code::kill_vehicle_spawner(var_04[var_0A]);
			}
			...
			{
				level thread maps\_load::exploder_load(var_04[var_0A]);
			}

			if(isdefined(var_04[var_0A].ambient))
			{
				var_04[var_0A] thread soundscripts\_audio::trigger_multiple_audio_trigger(1);
			}
			...
			{
				var_04[var_0A] thread soundscripts\_audio::trigger_multiple_audio_trigger();
			}

			if(isdefined(var_04[var_0A].script_triggered_playerseek))
			{
				level thread trigger_playerseek(var_04[var_0A]);
			}
