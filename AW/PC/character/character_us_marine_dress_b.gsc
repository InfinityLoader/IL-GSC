/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: character_us_marine_dress_b.gsc
...
main()
{
	...
	self attach("head_m_gen_asi_lee_marines_dress","",1);
	self.headmodel = "head_m_gen_asi_lee_marines_dress";
	self.voice = "sentinel";
...
precache()
{
	...
	precachemodel("head_m_gen_asi_lee_marines_dress");
}