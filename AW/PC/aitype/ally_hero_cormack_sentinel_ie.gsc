/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: ally_hero_cormack_sentinel_ie.gsc
...
main()
{
	...
	character\character_hero_cormack_sentinel_udt_b::main();
}
...
precache()
{
	character\character_hero_cormack_sentinel_udt_b::precache();
