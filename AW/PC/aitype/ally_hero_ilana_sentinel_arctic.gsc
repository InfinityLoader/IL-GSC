/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: ally_hero_ilana_sentinel_arctic.gsc
...
main()
{
	...
	character\character_hero_ilana_sentinel_arctic::main();
}
...
precache()
{
	character\character_hero_ilana_sentinel_arctic::precache();
