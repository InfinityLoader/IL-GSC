...
getnodeoffset(param_00,param_01)
{
	...
	switch(param_01)
	{
		...
		case "Cover Left 3D":
			...
			{
				var_09 = calculatenodeoffset(var_0A,var_0B,var_02);
			}
			else
			{
				var_09 = calculatenodeoffset(var_0A,var_0B,var_03);
			}
			break;
		...
		case "Cover Right 3D":
			if(param_00 gethighestnodestance() == "crouch")
			{
				var_09 = calculatenodeoffset(var_0A,var_0B,var_04);
			}
			else
			{
				var_09 = calculatenodeoffset(var_0A,var_0B,var_05);
			}
			break;
		...
		case "Cover Stand":
		case "Conceal Stand":
			var_09 = calculatenodeoffset(var_0A,var_0B,var_07);
			break;

		case "Cover Crouch Window":
		case "Cover Crouch":
		case "Conceal Crouch":
			var_09 = calculatenodeoffset(var_0A,var_0B,var_06);
			break;
	}

	param_00.offset = var_09;
	return param_00.offset;
}
