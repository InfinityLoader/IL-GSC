 ...
 * Timestamp: 4/22/2024 2:00:13 AM
*******************************************************************/
...
mainloopstart()
{
	...
	if(self.a.pose == var_00)
	{
		...
		{
			var_02 = animscripts\utility::animarray("alert_idle_back");
		}
		else
		{
			var_02 = animscripts\utility::animarray("alert_idle");
		}

		gotocover(var_02,0.3,0.4);
	}
	else
	{
		if(isdefined(self.animarchetype) && self.animarchetype == "s1_soldier")
		{
			if(var_00 == "crouch_l")
			{
				var_01 = animscripts\utility::lookupanim("combat","trans_to_crouch_l");
				var_00 = "crouch";
			}
			else if(var_00 == "crouch_r")
			{
				var_01 = animscripts\utility::lookupanim("combat","trans_to_crouch_r");
				var_00 = "crouch";
			}
		}
...
getpredictedpathmidpoint(param_00)
{
	...
	return self.covernode.origin + (var_03[0],var_03[1],0);
}
