 ...
 * Platform: PC
 * Function Count: 53
 * Decompile Time: 805 ms
 * Timestamp: 4/22/2024 2:00:45 AM
*******************************************************************/
...
specialpain(param_00)
{
	...
	switch(param_00)
	{
		...
		case "smg_cover_stand_aim":
			var_01 = animscripts\utility::lookupanim("pain",var_02);
			dopainfromarray(var_01);
			var_02 = 1;
			break;
		...
		case "saw":
			...
			pain_setflaggedanimknob("painanim",var_03,1,0.3,1);
			animscripts\shared::donotetracks("painanim");
			var_02 = 1;
			break;
		...
		case "corner_right_martyrdom":
			var_02 = trycornerrightgrenadedeath();
			break;
