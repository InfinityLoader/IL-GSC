 ...
 * Platform: PC
 * Function Count: 157
 * Decompile Time: 1778 ms
 * Timestamp: 4/22/2024 2:03:04 AM
*******************************************************************/
	...
	for(;;)
	{
		...
		if(isdefined(var_2E))
		{
			foreach(var_30 in var_2E)
			{
				...
				{
					var_32 = [];
					foreach(var_34 in level.destructible_type[self.destructibleinfo].destructible_dots[var_31])
					{
						...
						switch(var_35)
						{
							case "trigger_radius":
								...
								var_36 = createdot_radius(self.origin + var_37,var_38,var_39,var_3A);
								var_36.ticks = var_30.ticks;
					...
					level thread startdot_group(var_32);
					continue;
				}

				if(isdefined(var_30))
				{
					if(isdefined(var_30.tag))
					{
						var_30 setdot_origin(self gettagorigin(var_30.tag));
					}

					level thread startdot_group([var_30]);
				}
			}
		...
		{
			var_0D = 1;
			var_3D = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["explode_force_min"];
			var_3E = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["explode_force_max"];
			var_3F = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["explode_angularImpulse_min"];
			var_40 = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["explode_angularImpulse_max"];
			var_41 = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["explode_range"];
			var_42 = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["explode_mindamage"];
			var_43 = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["explode_maxdamage"];
			var_44 = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["continueDamage"];
			var_45 = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["originOffset"];
			var_46 = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["earthQuakeScale"];
			var_47 = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["earthQuakeRadius"];
			var_48 = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["originOffset3d"];
			var_49 = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["delaytime"];
			...
			thread explode(var_0A,var_3D,var_3E,var_41,var_42,var_43,var_44,var_45,var_46,var_47,param_05,var_48,var_49,var_3F,var_40);
		}

		var_4A = undefined;
		if(isdefined(level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["physics"]))
		{
			for(var_10 = 0;var_10 < level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["physics"].size;var_10++)
			{
				var_4A = undefined;
				var_4B = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["physics_tagName"][var_10];
				var_4C = level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["physics_velocity"][var_10];
				var_4D = undefined;
				if(isdefined(var_4C))
				{
					var_4E = undefined;
				...
				{
					var_56 = undefined;
					for(var_57 = 0;var_57 < level.destructible_type[self.destructibleinfo].parts.size;var_57++)
					{
						if(!isdefined(level.destructible_type[self.destructibleinfo].parts[var_57][0].v["tagName"]))
						{
							continue;
						}

						if(level.destructible_type[self.destructibleinfo].parts[var_57][0].v["tagName"] != var_4B)
						{
							continue;
						}
					...
					if(isdefined(var_4A))
					{
						thread physics_launch(var_56,0,var_4A,var_4D);
					}
					else
					{
						thread physics_launch(var_56,0,param_03,var_4D);
					}
				...
				if(isdefined(var_4A))
				{
					thread physics_launch(var_0A,var_19,var_4A,var_4D);
				}
				else
				{
					thread physics_launch(var_0A,var_19,param_03,var_4D);
				}
		...
		if(isdefined(level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v) && isdefined(level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["functionNotify"]))
		{
			self notify(level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["functionNotify"]);
		}

		if(isdefined(level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["function"]))
		{
			self thread [[ level.destructible_type[self.destructibleinfo].parts[var_0A][var_19].v["function"] ]]();
		}
