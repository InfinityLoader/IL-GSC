 ...
 * Timestamp: 4/22/2024 2:03:20 AM
*******************************************************************/
...
convertfogtech(param_00)
{
	if(isdefined(level.exclusive_fog_tech))
	{
		...
		{
			case "dfog":
				if(level.exclusive_fog_tech == "dfog" && param_00.sunfogenabled == 0)
				{
					param_00.sunfogenabled = 1;
					param_00.sunred = 0;
					param_00.sungreen = 0;
					param_00.sunblue = 0;
					param_00.hdrsuncolorintensity = 0;
					param_00.sundir = (0,0,0);
					param_00.sunbeginfadeangle = 0;
					param_00.sunendfageangle = 0;
					param_00.normalfogscale = 1;
				}
				break;

			case "normal_fog":
				if(param_00.sunfogenabled == 1)
				{
					param_00.sunfogenabled = 0;
				}
				break;
