 ...
 * Platform: Console
 * Function Count: 202
 * Decompile Time: 3444 ms
 * Timestamp: 10/27/2023 1:37:40 AM
*******************************************************************/
...
func_839C()
{
	...
	{
		var_00 = self method_82CE(var_01);
	}
	else
	{
		var_00 = self method_82CD(var_01);
	}
...
set_goal_volume()
{
	...
	if(isdefined(var_00.target))
	{
		...
		{
			var_04 = var_01;
			self method_8224(var_04);
		}
		else if(isdefined(var_02))
		{
			var_04 = var_02;
			self method_8225(var_04.origin);
		}
	...
	if(isdefined(self.target))
	{
		self method_8227(var_00);
	}

	self method_8228(var_00);
}
...
func_3D5E(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	if(isdefined(self method_8229()))
	{
		self method_8228(self method_8229());
	}
...
func_8774(param_00)
{
	if(self method_824E() && self.health == 150)
	{
		self.health = 100;
		self.a.disablelongdeath = 1;
	}

	self method_8209(param_00);
	...
	for(;;)
	{
		if(isdefined(level.friendly_wave_trigger) && isdefined(level.friendly_wave_trigger.target))
		{
			...
			while(isdefined(level.friendly_wave_trigger) && level.var_8183 < level.var_5103)
			{
				...
				{
					var_07 = var_03[var_04] method_82CE(var_06);
				}
				else
				{
					var_07 = var_03[var_04] method_82CD(var_06);
				}
				...
				{
					var_07 method_8226(level.player);
				}
...
func_5AD2(param_00,param_01,param_02,param_03,param_04)
{
	...
	param_00 method_8225(param_00.origin);
	param_00 method_8224(param_01);
...
spawnwaypointfriendlies()
{
	...
	if(isdefined(self.var_6BD5))
	{
		var_00 = self method_82CE();
	}
	else
	{
		var_00 = self method_82CD();
	}
...
flood_and_secure_spawner_think(param_00,param_01,param_02)
{
	...
	while(var_03)
	{
		...
		if(isdefined(self.var_6BD5))
		{
			var_07 = self method_82CE(var_06);
		}
		else
		{
			var_07 = self method_82CD(var_06);
		}
...
func_09A0(param_00)
{
	...
	{
		level.var_787A[var_01] = addstruct();
...
flood_and_secure_spawn_goal()
{
	...
	else
	{
		...
		if(isdefined(var_00))
		{
			self method_8225(var_00.origin);
		}
	}
	...
	if(!isdefined(self.var_6BD2) && !isdefined(self method_8229()))
	{
		self.goalradius = level.var_2497;
	}
}
...
{
	level._ai_group[param_00] = addstruct();
...
flood_spawner_think(param_00)
{
	...
	while(self.count > 0)
	{
		...
		if(isdefined(self.var_6BD5))
		{
			var_04 = var_03 method_82CE(var_02);
		}
		else
		{
			var_04 = var_03 method_82CD(var_02);
		}
...
func_7870(param_00)
{
	var_01 = param_00 method_830C();
	var_01 method_826D(#animtree);
...
func_7873(param_00)
{
	...
	var_03 = param_00.spawner method_82CE();
