 ...
 * Timestamp: 10/27/2023 1:39:44 AM
*******************************************************************/
...
missionfail(param_00)
{
	...
	waittillframeend;
	function_0168("hud_missionFailed",1);
	...
	function_0143(level.player.origin,"script_friendlyfire: civilian %d",param_00);
