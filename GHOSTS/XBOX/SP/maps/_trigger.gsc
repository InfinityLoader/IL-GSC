 ...
 * Platform: Console
 * Function Count: 77
 * Decompile Time: 1299 ms
 * Timestamp: 10/27/2023 1:37:44 AM
*******************************************************************/
...
func_8372(param_00)
{
	...
	for(;;)
	{
		...
		if(isplayer(var_02))
		{
			var_02 gsetwatersheeting(1,var_01);
			wait(var_01 * 0.2);
		}
	}
}
...
func_8385(param_00)
{
	...
	for(var_03 = 0;var_03 < var_02.size;var_03++)
	{
		...
		if(isdefined(var_02[var_03].script_triggered_playerseek) && var_02[var_03].script_triggered_playerseek == var_01)
		{
			...
			var_02[var_03] method_8226(level.player);
...
vision_set_fog_progress(param_00,param_01)
{
	...
	self method_82A6(param_00.var_6D01,param_00.var_6CFF,param_01);
...
no_crouch_or_prone_think_for_player(param_00)
{
	for(;;)
	{
		...
		{
			var_01 method_8274(0);
			var_01 method_8273(0);
			wait(0.05);
		}

		var_01 method_8274(1);
		var_01 method_8273(1);
	}
}
