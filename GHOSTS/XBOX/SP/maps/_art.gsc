 ...
 * Timestamp: 10/27/2023 1:39:14 AM
*******************************************************************/
...
func_2886()
{
	...
	{
		function_0168("scr_dof_enable","1");
	}
...
dof_process_ads()
{
	...
	{
		var_15 = var_14 method_83DD();
		var_16 = var_14 method_83DE(var_03);
		if(!var_15 && !var_16)
		{
			continue;
		}
...
tess_update()
{
	for(;;)
	{
		...
		{
			function_0168("r_tessellationCutoffDistance",level.tess.cutoff_distance_current);
		}

		if(var_01 != level.tess.cutoff_falloff_current)
		{
			function_0168("r_tessellationCutoffFalloff",level.tess.cutoff_falloff_current);
		}
	}
}
...
ssao_set_target_over_time_internal(param_00,param_01)
{
	...
	while(var_03 > 0)
	{
		...
		if(var_05 != var_02)
		{
			function_0168("r_ssaoScriptScale",var_02);
		}
	...
	function_0168("r_ssaoScriptScale",param_00);
}
