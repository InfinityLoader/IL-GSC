 ...
 * Timestamp: 10/27/2023 1:39:55 AM
*******************************************************************/
...
func_4FDD()
{
	...
	precachematerial("torpedo_connection_bar");
	precachematerial("torpedo_connection_frame");
...
func_1B74()
{
	...
	{
		if(!var_01 method_81C8(self.var_576D))
		{
			return 0;
		}
	}
...
func_2066()
{
	...
	for(var_02 = 1;var_02 <= var_00;var_02++)
	{
		...
		if(isdefined(var_03) && var_03 != "undefined")
		{
			...
			{
				var_04[var_05] = castint(var_04[var_05]);
			}
...
func_4679(param_00,param_01)
{
	...
	for(var_05 = 0;var_05 < var_02;var_05++)
	{
		...
		param_01.label = castint(var_05 / var_02 * 100);
...
func_6A9F()
{
	foreach(var_01 in level.players)
	{
		...
		var_01 method_81C9(self.var_576D);
	}
...
func_4676(param_00)
{
	...
	{
		if(param_00 != var_05 && var_05 method_81C8(self.var_576D))
		{
			continue;
		}
...
assert_if_identical_origins()
{
	...
	for(var_01 = 1;var_01 < 65;var_01++)
	{
		...
		{
			var_03[var_01] = castint(var_03[var_01]);
		}
