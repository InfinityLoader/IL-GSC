...
func_70C9(param_00)
{
	...
	level.var_4C8A = 0;
	function_0168("player_meleeDamageMultiplier",0.2666667);
...
{
	function_0168("player_meleeDamageMultiplier",0.26);
}
...
func_76BF()
{
	...
	{
		function_0168("player_deathInvulnerableToMelee","1");
		function_0168("ai_accuracy_attackercountDecrease","0.6");
	}
	...
	if(!maps\_utility::is_survival())
	{
		function_0168("player_meleeDamageMultiplier",0.5);
	}
...
func_76BE()
{
	...
	var_00 = 1.35;
	level.var_272D["playerDifficultyHealth"]["normal"] = castint(275 * var_00);
	level.var_272D["playerDifficultyHealth"]["hardened"] = castint(165 * var_00);
	level.var_272D["playerDifficultyHealth"]["veteran"] = castint(138);
}
...
func_7042()
{
	...
	function_0168("ai_accuracyDistScale",[[ var_00 ]]("accuracyDistScale",level.gameskill));
...
apply_difficulty_frac_with_func(param_00,param_01)
{
	...
	self.threatbias = castint([[ param_00 ]]("threatbias",param_01));
	...
	func_869B();
	self.var_3DE2.var_5FAE = castint([[ param_00 ]]("playerGrenadeBaseTime",param_01));
	self.var_3DE2.playergrenaderangetime = castint([[ param_00 ]]("playerGrenadeRangeTime",param_01));
	self.var_3DE2.var_5FA5 = castint([[ param_00 ]]("playerDoubleGrenadeTime",param_01));
	...
	self.deathinvulnerabletime = castint([[ param_00 ]]("player_deathInvulnerableTime",param_01));
	self.criticalbulletdamagedist = castint([[ param_00 ]]("player_criticalBulletDamageDist",param_01));
...
screen_effect_on_open_bottom(param_00,param_01,param_02)
{
	...
	self scaleovertime(0.1,castint(2048 * param_01),castint(1152 * param_01));
	self.y = 100 + var_04;
...
{
	wait(0.05);
	level.var_7CE8["take_cover"] = addstruct();
	level.var_7CE8["take_cover"].text = &"GAME_GET_TO_COVER";
	level.var_7CE8["get_back_up"] = addstruct();
...
func_4055()
{
	...
	if(issplitscreen())
	{
		var_00 setmaterial("vfx_blood_screen_overlay",640,960);
	...
	{
		var_00 setmaterial("vfx_blood_screen_overlay",640,480);
	}
...
add_hudelm_position_internal(param_00)
{
	...
	if(level.console)
	{
		self.var_120C setmaterial("popmenu_bg",650,52);
	}
	else
	{
		self.var_120C setmaterial("popmenu_bg",650,42);
	}
...
auto_adust_zone_complete(param_00)
{
	...
	if(var_0D > 0 && var_09 > 0)
	{
		...
		var_0F = var_0F * 100;
		var_0F = castint(var_0F);
		var_10 = var_0E / var_09;
		var_10 = var_10 * 60;
		var_10 = castint(var_10);
	}
