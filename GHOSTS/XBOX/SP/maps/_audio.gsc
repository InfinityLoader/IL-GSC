 ...
 * Platform: Console
 * Function Count: 58
 * Decompile Time: 912 ms
 * Timestamp: 10/27/2023 1:39:17 AM
*******************************************************************/
...
func_6E7B()
{
	...
	if(func_47DA())
	{
		...
		{
			level.player method_83F4(level.deathsdooroverride,"reverb","mix","filter");
		}

		level.player method_83F4("deathsdoor","reverb","mix","filter");
	}
}
...
level_fadein()
{
	...
	wait(0.05);
	function_019C(1,level._audio.var_4DA4);
}

//Function Number: 26
init_tracks()
{
	level._audio.ambient_track = addstruct();
...
func_6FD2(param_00,param_01,param_02)
{
	...
	if(isdefined(var_03["filter"]))
	{
		if(var_03["filter"] != "")
		{
			...
			level.player method_8285(1,level._audio.filter.var_2F8D);
		}
	}
...
func_6EB5(param_00,param_01)
{
	...
	if(level._audio.filter.current[param_01] != param_00)
	{
		...
		level.player method_8284(param_01);
	}

	func_6E6E(param_01,param_00);
	level.player method_8280(maps\_audio_code::get_map_soundtable(),param_00,param_01);
}
...
init_occlusion()
{
	level._audio.occlusion = addstruct();
...
func_6F38(param_00)
{
	...
	level.player method_8278(maps\_audio_code::get_map_soundtable(),param_00);
}
...
deactivate_occlusion()
{
	...
	level.player method_827A();
}

//Function Number: 48
init_reverb(param_00)
{
	level._audio.var_668D = addstruct();
...
func_6F84(param_00)
{
	...
	level.player method_827C(maps\_audio_code::get_map_soundtable(),param_00,"snd_enveffectsprio_level");
}
...
change_mix(param_00,param_01,param_02)
{
	...
	if(isdefined(param_02))
	{
		level.player method_827D(maps\_audio_code::get_map_soundtable(),param_00,param_02);
	}
	else
	{
		level.player method_827D(maps\_audio_code::get_map_soundtable(),param_00);
	}
...
init_whizby()
{
	level._audio.var_8DE7 = addstruct();
...
func_6FC9(param_00)
{
	...
	level.player method_827F(maps\_audio_code::get_map_soundtable(),param_00);
}

//Function Number: 57
func_45BF()
{
	level._audio.timescale = addstruct();
...
func_6FAC(param_00)
{
	...
	level.player method_827E(maps\_audio_code::get_map_soundtable(),param_00);
}