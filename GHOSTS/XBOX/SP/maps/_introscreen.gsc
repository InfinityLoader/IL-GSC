 ...
 * Timestamp: 10/27/2023 1:39:57 AM
*******************************************************************/
...
func_4785(param_00,param_01,param_02,param_03)
{
	...
	wait(param_02);
	function_0168("com_cinematicEndInWhite",0);
}
...
func_477E(param_00,param_01,param_02,param_03)
{
	...
	var_05.glowalpha = 1;
	var_06 = castint(param_01 * param_02 * 1000 + 4000);
...
func_7CEB(param_00)
{
	...
	for(;;)
	{
		...
		var_02++;
		var_04 = castint(min(var_02,var_01));
...
get_strip_settings(param_00)
{
	...
	if(var_02)
	{
		var_01.x = castint(var_03 + randomintrange(-1,1));
		var_01.y = castint(var_04 + randomintrange(0,7));
...
func_20B6(param_00)
{
	...
	var_02 setmaterial("white",var_06.width,var_06.height);
...
func_7D20(param_00,param_01,param_02,param_03)
{
	...
	var_04 setmaterial("white",1,var_05);
