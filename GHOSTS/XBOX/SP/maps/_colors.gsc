...
func_8778(param_00,param_01)
{
	...
	if(isdefined(param_01))
	{
		...
		{
			wait(1);
			if(self method_823D(param_00.origin,self.fixednodesaferadius))
			{
				continue;
			}

			if(self method_823E(param_01))
			{
				continue;
			}
		}
...
func_3557()
{
	...
	for(;;)
	{
		...
		var_02 = anglestoforward((0,level.player getangles()[1],0));
