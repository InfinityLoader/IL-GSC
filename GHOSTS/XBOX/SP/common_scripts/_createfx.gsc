 ...
 * Timestamp: 10/27/2023 1:38:37 AM
*******************************************************************/
...
createfxlogic()
{
	...
	var_02.y = 200;
	var_02.foreground = 0;
	var_02 setmaterial("black",250,160);
	var_02.alpha = 0;
	...
	{
		var_07 = 0;
		var_08 = anglestoright(level.player getangles());
		var_09 = anglestoforward(level.player getangles());
		var_0A = anglestoup(level.player getangles());
		var_0B = 0.85;
		var_0C = var_09 * 750;
...
func_4664()
{
	...
	func_6EEA("2. Looping FX");
	func_6EEA("3. Looping sound");
	func_6EEA("4. Exploder");
	func_6EEA("5. One Shot Sound");
	func_6EEA("6. Reactive Sound");
	func_6EEA("(c) Cancel >");
	func_6EEA("(x) Exit >");
}
...
{
	var_00 = level.player getangles()[1];
	var_01 = (0,var_00,0);
...
write_log(param_00,param_01,param_02,param_03)
{
	...
	foreach(var_06 in param_00)
	{
		...
		if(var_06.var_880E["type"] == "loopfx")
		{
			cfxprintln(var_04 + "ent = createLoopEffect( \" + var_06.var_880E["fxid"] + "\" );");
		}
