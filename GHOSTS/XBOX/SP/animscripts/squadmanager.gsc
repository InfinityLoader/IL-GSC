 ...
 * Timestamp: 10/27/2023 1:36:36 AM
*******************************************************************/
...
{
	level.var_799C[param_00] = addstruct();
...
func_8735()
{
	for(var_00 = 0;var_00 < level.var_7994.size;var_00++)
	{
		...
		{
			self.var_7996[level.var_7994[var_00].var_7998] = addstruct();
			self.var_7996[level.var_7994[var_00].var_7998].isincontact = 0;
		}
...
func_61A0(param_00,param_01,param_02,param_03)
{
	...
	for(var_04 = 0;var_04 < param_01 * 2;var_04++)
	{
		...
		var_05 = self method_82D1() + (0,0,10) + param_02;
		wait(0.05);
	}
}
...
{
	self.var_799D[param_00] = addstruct();
