 ...
 * Timestamp: 10/27/2023 1:36:34 AM
*******************************************************************/
...
func_8AC9()
{
	...
	if(isdefined(self.var_7439))
	{
		...
		{
			self.var_7445 = self.var_7439 method_82D1();
			wait(0.05);
		}
	}
...
func_74C0()
{
	...
	if(!isdefined(self.var_1FCA) && !self method_81F1())
	{
		return 0;
	}
...
func_3A1A()
{
	if(isdefined(self.enemy) && self method_81F2(self.enemy))
	{
		func_70C2();
	}

	var_00 = self method_8211();
	if(!isdefined(var_00))
	{
...
func_70C5()
{
	...
	var_00 = distancesquared(self method_82D1(),self.var_7445);
...
func_74AA()
{
	...
	var_00 = animscripts/utility::func_69E4(castint(self.origin[1]),10000) + 2000;
	var_01 = castint(self.origin[0]) + gettime();
