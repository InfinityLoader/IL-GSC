 ...
 * Timestamp: 10/27/2023 1:36:11 AM
*******************************************************************/
...
func_799E()
{
	...
	for(;;)
	{
		if(self.team == "allies")
		{
			var_00 = getthreatsovertime(function_016B("axis","team3"),0.5);
		}
		else if(self.team == "team3")
		{
			var_00 = getthreatsovertime(function_016B("allies","axis"),0.5);
		}
		else
		{
			wait(0.5);
			var_00 = function_016B("allies","team3");
