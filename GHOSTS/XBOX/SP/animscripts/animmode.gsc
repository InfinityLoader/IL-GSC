 ...
 * Timestamp: 10/27/2023 1:36:00 AM
*******************************************************************/
...
func_4FDD()
{
	...
	var_06 = self method_824D(var_04);
	if(isdefined(var_06))
	{
		var_04 = var_06;
	}
	...
	{
		self method_81F9(var_04,var_05);
	}
	...
	self method_820D(self._animmode);
	self method_8253(self.root_anim,var_07);
	self method_820E("face angle",var_05[1]);
	var_09 = "custom_animmode";
	self method_826B(var_09,var_03,1,var_08,1);
	...
	for(;;)
	{
		...
		{
			var_03 = level.scr_anim[self._animname][var_01][randomint(var_02)];
			self method_8266(var_09,var_03,1,0.2,1);
			if(isdefined(var_0A))
			{
