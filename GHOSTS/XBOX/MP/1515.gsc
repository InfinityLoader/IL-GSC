...
func_32F7(param_00,param_01,param_02)
{
	...
	var_0C missilesettargetent(param_00);
	var_0C missilesetflightmodedirect();
	var_0D = magicbullet("aamissile_projectile_mp",var_0A + (randomint(500),randomint(500),-75),param_00.origin,self);
	var_0D missilesettargetent(param_00);
	var_0D missilesetflightmodedirect();
	if(param_02)
	{
