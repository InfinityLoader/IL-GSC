 ...
 * Platform: Console
 * Function Count: 68
 * Decompile Time: 1151 ms
 * Timestamp: 10/27/2023 1:34:02 AM
*******************************************************************/

//Function Number: 1
func_44DF()
{
	common_scripts\utility::func_F1B(getentarray("com_wall_fan_blade_rotate_slow","targetname"),::func_31D8,"veryslow");
	common_scripts\utility::func_F1B(getentarray("com_wall_fan_blade_rotate","targetname"),::func_31D8,"slow");
	common_scripts\utility::func_F1B(getentarray("com_wall_fan_blade_rotate_fast","targetname"),::func_31D8,"fast");
	var_00 = [];
	...
	var_00["trigger_multiple_dyn_copier_no_light"] = ::func_5BD6;
	var_00["trigger_radius_motion_light"] = ::motion_light;
	var_00["trigger_radius_dyn_motion_dlight"] = ::func_5A25;
	...
	foreach(var_04, var_02 in var_00)
	{
		...
		common_scripts\utility::func_F1B(var_03,::func_83BD);
		common_scripts\utility::func_F1B(var_03,var_02);
	}

	common_scripts\utility::func_F1B(getentarray("vending_machine","targetname"),::func_8962);
	common_scripts\utility::func_F1B(getentarray("toggle","targetname"),::func_879F);
...
{
	param_00 thread func_6040("veh_mig29_dist_loop");
	while(!func_7F65(param_00,param_01))
	{
		wait(0.05);
	}

	param_00 thread func_6040("veh_mig29_close_loop");
	while(func_7F66(param_00,param_01))
	{
		wait(0.05);
	}

	wait(0.5);
	param_00 thread func_603F("veh_mig29_sonic_boom");
	while(func_7F65(param_00,param_01))
	{
		wait(0.05);
	}
...
//Function Number: 13
func_603F(param_00,param_01,param_02)
{
...
func_8962()
{
	...
	self.hp = 400;
	thread func_8963(self.vm_normal);
...
func_76A9()
{
	...
	var_00 = 1;
	var_01 = var_00 * -999;
	var_02 = castint(-25536);
	var_03 = (castint(var_02 / 2),castint(var_02 / 2),0) - (randomint(var_02),randomint(var_02),0);
...
metal_detector()
{
	...
	for(;;)
	{
		common_scripts\utility::func_8B2A("dmg_triggered","touch_triggered","weapon_triggered");
...
annoyance_tracker()
{
	...
	func_8B31("dmg_triggered","touch_triggered","weapon_triggered",var_02 + 2);
...
//Function Number: 26
func_8B31(param_00,param_01,param_02,param_03)
{
	level endon("game_ended");
	self endon(param_00);
	self endon(param_01);
...
weapon_notify_loop(param_00,param_01)
{
	...
	while(func_48DB(param_00,param_01))
	{
...
func_48DB(param_00,param_01)
{
	...
	if(func_48DC(var_08,var_02,var_03))
	{
		if(func_48DC(var_09,var_04,var_05))
		{
			if(func_48DC(var_0A,var_06,var_07))
			{
				return 1;
			}
		}
...
//Function Number: 31
func_48DC(param_00,param_01,param_02)
{
...
motion_light()
{
	...
	common_scripts\utility::func_5682(["com_two_light_fixture_off","com_two_light_fixture_on"],::precachemodel);
	...
	for(;;)
	{
		...
		while(anythingtouchingtrigger(self))
		{
			...
			if(var_02)
			{
				...
				thread func_5A26(var_00,var_01,10);
			}
...
//Function Number: 40
func_5A26(param_00,param_01,param_02)
{
	self notify("motion_light_timeout");
	self endon("motion_light_timeout");
	wait(param_02);
...
trigger_door()
{
	var_00 = getent(self.target,"targetname");
	self.doorent = var_00;
	self.doorangle = func_3C66(vectornormalize(self getorigin() - var_00 getorigin()));
	var_00.baseyaw = var_00.angles[1];
	var_01 = 1;
	for(;;)
	{
		self waittill("trigger_enter",var_02);
		var_00 thread func_29F7(var_01,getdoorside(var_02));
...
func_5BD6()
{
	level endon("game_ended");
	self endon("death");
	if(common_scripts\utility::func_39CA() == "hamburg")
	{
	}
...
interactive_tv()
{
	...
	if(var_00.size)
	{
		common_scripts\utility::func_5682(["com_tv2_d","com_tv1_d","com_tv1","com_tv2","com_tv1_testpattern","com_tv2_testpattern"],::precachemodel);
	...
	common_scripts\utility::func_F1B(getentarray("interactive_tv","targetname"),::func_8542);
}
...
func_8542()
{
	...
	var_01 = common_scripts\utility::func_37D5(self.origin,level.tv_lite_array,undefined,undefined,64);
	if(var_01.size)
	{
		self.lite = var_01[0];
