 ...
 * Platform: Console
 * Function Count: 381
 * Decompile Time: 6090 ms
 * Timestamp: 10/27/2023 1:30:25 AM
*******************************************************************/
...
initplayerstat(param_00,param_01)
{
	if(!isdefined(self.stats["stats_" + param_00]))
	{
		...
		self.stats["stats_" + param_00] = addstruct();
...
{
	if(isbot(self) || botsentientswap(self))
	{
	}
...
func_870C(param_00,param_01,param_02)
{
	...
	maps\mp\gametypes\_persistence::func_7B26(param_00,castint(var_03 * 1000 / var_04));
}
...
func_870D(param_00,param_01,param_02)
{
	...
	maps\mp\gametypes\_persistence::func_7B27(param_00,castint(var_03 * 1000 / var_04));
}
...
func_4D30(param_00,param_01,param_02,param_03,param_04)
{
	...
	gamedvrsetscreenshotmetadata(var_06,var_07,param_00,2,param_01,param_02,param_03,param_04);
}
...
func_4D35(param_00,param_01,param_02,param_03)
{
	...
	if(isdefined(var_04) && var_04 == "axis" || var_04 == "allies")
	{
		...
		self logmatchdatadeath(var_05,param_00,2,param_01,param_02,param_03);
	}
}
...
func_665A()
{
	...
	{
		_giveweapon(var_02.name,castint(tablelookup("mp/camoTable.csv",1,self.loadoutprimarycamo,0)));
...
func_647B(param_00,param_01)
{
	...
	level.watchdvars[var_02] = addstruct();
...
func_3C4A()
{
	...
	{
		var_00 = castint(getdvar("overtimeTimeLimit"));
		if(isdefined(var_00))
		{
			return var_00;
		}
...
func_3A30(param_00)
{
	...
	var_05 = castint(var_01[0] / param_00.size);
	var_06 = castint(var_01[1] / param_00.size);
	var_07 = castint(var_01[2] / param_00.size);
...
func_7CE9(param_00)
{
	...
	if(isdefined(var_01[1]))
	{
		...
		var_02 = var_02 + castint(var_01[1]) * var_03;
	}
...
initglobals()
{
	...
	{
		level.global_tables["killstreakTable"] = addstruct();
...
func_3AF8(param_00)
{
	return castint(tablelookup(level.global_tables["killstreakTable"].path,level.global_tables["killstreakTable"].ref_col,param_00,level.global_tables["killstreakTable"].enemy_use_dialog_col));
}
...
allowteamchoice()
{
	...
	var_00 = castint(tablelookup("mp/gametypesTable.csv",0,level.gametype,4));
	return var_00;
}
...
allowclasschoice()
{
	var_00 = castint(tablelookup("mp/gametypesTable.csv",0,level.gametype,5));
	return var_00;
}
...
func_488C(param_00,param_01)
{
	...
	var_06 = castint(tablelookup("mp/weaponRankTable.csv",var_03,getweaponclass(param_01),var_04));
	var_07 = tablelookup("mp/weaponRankTable.csv",var_06,param_00,var_02);
	if(var_07 != "")
	{
		if(var_05 >= castint(var_07))
		{
			return 1;
		}
	}
...
func_486C(param_00)
{
	if(isbot(param_00) && param_00.agent_teamparticipant == 1)
	{
		return 1;
	}

	if(botsentientswap(param_00))
	{
		return 1;
	}
...
{
	if(isbot(param_00) && isdefined(param_00.agent_gameparticipant) && param_00.agent_gameparticipant == 1)
	{
		return 1;
	}
...
{
	if(isbot(param_00) && !isdefined(param_00.isactive) || !param_00.isactive)
	{
		return undefined;
	}

	if(isbot(param_00) && !isdefined(param_00.classname))
	{
		return undefined;
	}
