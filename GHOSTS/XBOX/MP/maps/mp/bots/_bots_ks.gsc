 ...
 * Timestamp: 10/27/2023 1:28:40 AM
*******************************************************************/
...
bot_killstreak_drop(param_00,param_01,param_02,param_03,param_04)
{
	...
	if(var_07 == "outside")
	{
		...
		{
			if(markdangerousnodesintrigger(var_0D))
			{
	...
	else if(var_07 == "hidden")
	{
		...
		if(isdefined(var_11))
		{
			...
			{
				if(getnodesintrigger(var_11,var_0D,1))
				{
...
bot_killstreak_choose_loc_enemies(param_00,param_01,param_02,param_03)
{
	...
	var_04 = getzonecount(self.origin);
	if(!isdefined(var_04))
	{
	}
	...
	for(var_0A = 0;var_0A < var_05;var_0A++)
	{
		...
		if(var_0B != var_04 && botflagmemoryevents(var_0B) < 0.25)
		{
			var_0C = botautoconnectenabled(var_0B,self.team,"enemy_predict");
			if(var_0C > var_07)
			{
				var_06 = var_0B;
				var_07 = var_0C;
	...
	if(var_06 >= 0)
	{
		var_0D = getzonepath(var_06);
	}
	else if(var_09.size > 0)
	{
		var_0D = getzonepath(common_scripts\utility::func_6306(var_09));
	}
	else
	{
		var_0D = getzonepath(randomint(level.zonecount));
	}
...
func_16B4()
{
	...
	for(;;)
	{
		...
		{
			var_04 = self geteye();
			if(common_scripts\utility::func_8E18(var_04,self getangles(),var_03.attackarrow.origin,self botgetfovdot()))
			{
...
func_5344(param_00,param_01,param_02)
{
	...
	while([[ param_02 ]](param_00))
	{
		...
		{
			findentrances("",5,param_00,"only_sky");
