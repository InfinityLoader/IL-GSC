 ...
 * Platform: Console
 * Function Count: 109
 * Decompile Time: 1992 ms
 * Timestamp: 10/27/2023 1:28:17 AM
*******************************************************************/
...
func_45F4()
{
	...
	level.zonecount = getnodesonpath();
	func_45F5();
}
...
bot_connect_monitor(param_00,param_01)
{
	...
	for(;;)
	{
		...
		var_04 = setglaregrimematerial(0);
		var_05 = setglaregrimematerial(1);
		var_06 = spawnfxforclient(0);
		var_07 = spawnfxforclient(1);
		var_08 = "allies";
		var_09 = "axis";
		...
		var_21 = castint(min(var_11 - var_13 - var_17,var_04));
		var_22 = castint(min(var_12 - var_14 - var_18,var_05));
		var_23 = 1;
		...
		if(var_03)
		{
			...
			var_2E = castint(min(var_2A - var_2C,var_2B));
			...
			{
				var_27 = castint(var_2F / 2) + var_2F % 2;
				var_28 = castint(var_2F / 2);
			}
			else if(var_2F < 0)
			{
				var_30 = var_2F * -1;
				var_27 = -1 * castint(min(var_30,var_1B));
		...
		{
			var_31 = castint(min(abs(var_27),abs(var_28)));
			if(var_27 > 0)
			{
...
func_93A7(param_00)
{
	...
	if(param_00 setmlgcameradefaults() && isdefined(param_00.team) && param_00.team == "spectator")
	{
		return 1;
	}
...
func_5435(param_00,param_01,param_02,param_03)
{
	foreach(var_05 in level.players)
	{
		...
		if(isdefined(var_05.connected) && var_05.connected && botsentientswap(var_05) && var_05.team == param_01)
		{
...
bots_update_difficulty(param_00,param_01)
{
	foreach(var_03 in level.players)
	{
		...
		if(isdefined(var_03.connected) && var_03.connected && botsentientswap(var_03) && var_03.team == param_00)
		{
...
func_2B33(param_00,param_01)
{
	...
	foreach(var_04 in level.players)
	{
		if(isdefined(var_04.connected) && var_04.connected && botsentientswap(var_04) && !isdefined(param_01) || isdefined(var_04.team) && var_04.team == param_01)
		{
...
{
	var_03 = gettime() + -5536;
	while(!self enablemissileboosting())
	{
		if(gettime() >= var_03)
		{
			kickplayer(self.entity_number,"EXE_PLAYERKICKED_BOT_BALANCE");
	...
	while(level.players.size < maps/mp/bots/_bots_util::bot_get_client_limit() && var_07.size < param_00 && gettime() < var_06)
	{
		...
		if(getdvar("squad_vs_squad") == "1")
		{
			...
			if(isdefined(var_0A))
			{
				...
				var_09 = visionsetpostapply(var_10,var_11,var_12,var_13);
				if(isdefined(var_09))
				{
		...
		else if(getdvar("squad_use_hosts_squad") == "1")
		{
			...
			{
				var_09 = visionsetpostapply("",0,0,0);
			}
		}
		else if(getdvar("squad_match") == "1")
		{
			if(param_01 == "axis")
			{
				var_0E = bbprint("squadHQ","aiSquadMembers",var_08);
				var_10 = bbprint("squadMembers",var_0E,"name");
				var_11 = bbprint("squadMembers",var_0E,"head");
				var_12 = bbprint("squadMembers",var_0E,"body");
				var_13 = bbprint("squadMembers",var_0E,"helmet");
				var_09 = visionsetpostapply(var_10,var_11,var_12,var_13);
				if(isdefined(var_09))
				{
					var_09.pers["squadSlot"] = var_0E;
...
func_5351(param_00)
{
	...
	for(;;)
	{
		...
		if(isdefined(var_01))
		{
			if(getnodesintrigger(var_01,param_00))
			{
...
attack_damage_trigger(param_00)
{
	...
	{
		if(function_0210(param_00.object.origin,self.origin) < 225)
		{
		}
	}
...
func_4F41(param_00,param_01)
{
	...
	if(function_0210(self.origin,var_02) < 100)
	{
...
crate_calculate_on_path_grid(param_00)
{
	...
	else
	{
		...
		{
			var_07 = botdebugdrawtrigger(param_00.origin,var_04);
		}
	...
	for(;;)
	{
		...
		foreach(var_05 in var_03)
		{
			...
			if((!isdefined(var_05.owner) || var_05.owner != self) && !isdefined(var_05.boxtype))
			{
				...
				if(var_0D.size > 0)
				{
					...
					if(isdefined(var_11))
					{
						...
						{
							var_0C = var_0C | getnodesintrigger(var_11,var_13,1);
						}
					}
				}
			}
			...
			if(!var_0C)
			{
				...
				foreach(var_13 in var_05.nearest_nodes)
				{
					var_16 = var_16 | getnodesintrigger(var_07,var_13,1);
				}
...
bot_should_use_scavenger_bag(param_00)
{
	if(maps/mp/bots/_bots_util::func_15E6(0.66))
	{
		...
		{
			if(getnodesintrigger(var_01,param_00.nearest_nodes[0],1))
			{
