 ...
 * Timestamp: 10/27/2023 1:28:47 AM
*******************************************************************/
...
bot_loadout_set(param_00,param_01,param_02)
{
	...
	{
		level.botloadoutsets[var_03] = addstruct();
...
func_4583()
{
	...
	for(;;)
	{
		...
		level.perktable_costs[var_01] = castint(tablelookupbyrow("mp/perktable.csv",var_00,10));
		var_00++;
	}
...
bot_validate_perk(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	var_07 = 0;
	var_08 = castint(getsubstr(param_01,11));
...
{
	var_06 = castint(getsubstr(param_00,5,6)) - 1;
	switch(param_03)
	{
		case "loadoutPrimary":
		...
		case "loadoutPerk2":
		case "loadoutPerk1":
			var_07 = castint(getsubstr(param_03,11));
			...
			var_09 = castint(getsubstr(var_08,0,1));
			var_0A = castint(getsubstr(var_08,1,2));
...
init_bot_camotable()
{
	...
	for(;;)
	{
		...
		if(isdefined(var_05) && castint(var_05))
		{
...
bot_loadout_choose_from_set(param_00,param_01,param_02,param_03,param_04)
{
	...
	foreach(var_09 in param_00)
	{
		...
		if(getsubstr(var_09,0,5) == "class" && castint(getsubstr(var_09,5,6)) > 0)
		{
...
func_161E(param_00)
{
	...
	{
		var_03 = castint(tablelookupbyrow("mp/squadEloTable.csv",var_02,0));
...
bot_loadout_get_difficulty()
{
	...
	{
		var_00 = func_161E(botgetteamdifficulty());
	}
	else
	{
...
bot_loadout_setup_perks(param_00)
{
	...
	foreach(var_08, var_04 in param_00)
	{
		...
		{
			var_05 = castint(getsubstr(var_08,11));
			if(!var_02 && var_05 > 12)
			{
				continue;
			}
...
bot_squad_lookup_enemy(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	if(isdefined(param_06))
	{
		return bbprint("squadMembers",param_01,"loadouts",param_02,param_03,param_04,param_05,param_06);
	}

	if(isdefined(param_05))
	{
		return bbprint("squadMembers",param_01,"loadouts",param_02,param_03,param_04,param_05);
	}

	if(isdefined(param_04))
	{
		return bbprint("squadMembers",param_01,"loadouts",param_02,param_03,param_04);
	}

	return bbprint("squadMembers",param_01,"loadouts",param_02,param_03);
}
...
bot_squadmember_lookup(param_00,param_01,param_02)
{
	if(getdvar("squad_match") == "1" && self.team == "axis")
	{
		return bbprint("squadMembers",param_01,param_02);
	}
...
bot_loadout_copy_from_client(param_00,param_01,param_02,param_03)
{
	...
	if(getdvar("squad_match") == "1" && self.team == "axis")
	{
		self.squad_bot_dog_type = preloadcinematicforall();
	}
	else
	{
		self.squad_bot_dog_type = param_01 getmlgspectatorteam("mp_dog_type");
	}
...
bot_loadout_setup_squad_match(param_00)
{
	...
	if(self.team == "allies")
	{
		if(isdefined(var_01))
		{
			var_07 = var_01 getclanwarsbonusforcurrentplaylist("prestigeLevel");
			self.pers["prestige_fake"] = var_07;
		}
	}
	else if(self.team == "axis")
	{
		self.pers["prestige_fake"] = ishairrunning();
	}
...
func_8FFF(param_00)
{
	...
	if(isdefined(var_01))
	{
		var_04 = var_01 getclanwarsbonusforcurrentplaylist("prestigeLevel");
