 ...
 * Timestamp: 10/27/2023 1:28:34 AM
*******************************************************************/
...
func_945D()
{
	...
	{
		var_03 = getzonecount(var_02.curorigin);
		if(isdefined(var_03))
		{
			botzonegetcount(var_03,game["defenders"]);
		}
	}
...
func_8F9A()
{
	...
	if(self.backstabber_stage == "1_move_to_midpoint")
	{
		...
		var_04 = undefined;
		var_05 = castint(var_03.size * var_03.size + 1 * 0.5);
			...
			if(!level.multibomb && !isdefined(level.sdbomb.carrier))
			{
				...
				if(isdefined(var_05))
				{
					...
					foreach(var_09 in var_07)
					{
						...
						if(var_0B > 0 && var_09.role != "camp_bomb" && isdefined(var_0A) && getnodesintrigger(var_05,var_0A,1))
						{
