 ...
 * Timestamp: 10/27/2023 1:28:21 AM
*******************************************************************/
...
func_1E74()
{
	...
	if(isdefined(level.fireteam_commander["axis"]))
	{
		...
		{
			if(botsentientswap(var_02) && var_02.team == "axis")
			{
	...
	if(isdefined(level.fireteam_commander["allies"]))
	{
		...
		foreach(var_02 in level.players)
		{
			if(botsentientswap(var_02) && var_02.team == "allies")
			{
				var_00 = var_00 + var_02.pers["score"];
			}
		}
...
commander_order_ack()
{
	...
	for(;;)
	{
		...
		{
			if(isdefined(var_06) && isalive(var_06) && botsentientswap(var_06) && isdefined(var_06.team) && var_06.team == self.team)
			{
...
commander_spectate_first_available_bot()
{
	...
	for(;;)
	{
		foreach(var_01 in level.players)
		{
			if(botsentientswap(var_01) && var_01.team == self.team)
			{
...
func_5347()
{
	...
	{
		if(isdefined(var_04) && var_04 != self && botsentientswap(var_04) && isdefined(var_04.team) && var_04.team == self.team && isdefined(var_04.sidelinedbycommander) && var_04.sidelinedbycommander == 1)
		{
...
takeover_flash()
{
	if(!isdefined(self.takeoverflashoverlay))
	{
		...
		self.takeoverflashoverlay setmaterial("combathigh_overlay",640,480);
...
func_16C3()
{
	if(!isdefined(self) || !isplayer(self) || !botsentientswap(self))
	{
	}
