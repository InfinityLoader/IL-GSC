 ...
 * Platform: Console
 * Function Count: 80
 * Decompile Time: 1438 ms
 * Timestamp: 10/27/2023 1:28:44 AM
*******************************************************************/
...
func_64D4()
{
	...
	level.odin_large_rod_radius = getzonenodeforindex("odin_projectile_large_rod_mp");
	level.odin_small_rod_radius = getzonenodeforindex("odin_projectile_small_rod_mp");
	level.vanguard_missile_radius = getzonenodeforindex("remote_tank_projectile_mp");
	...
	{
		if(botflagmemoryevents(var_0E) < 0.25)
		{
	...
	if(var_0A || var_05)
	{
		...
		if(isdefined(var_0B) && var_0B.size > 0)
		{
			if(isdefined(param_04) && param_04)
			{
				...
				{
					if(markdangerousnodesintrigger(var_0E))
					{
						var_0F = getpathdist(var_0E);
						var_10 = 0;
						foreach(var_12 in var_0F)
						{
							if(markdangerousnodesintrigger(var_12))
							{
								var_10++;
							}
						}
	...
	while(self [[ level.bot_ks_funcs["isUsing"]["switchblade_cluster"] ]]() && isdefined(var_01))
	{
		...
		if(isdefined(var_16))
		{
			...
			else if(gettime() - var_08 > 500)
			{
				...
				var_09 = setnojiptime(var_16,var_26);
			}
		...
		var_2B = getzonenodesbydist(var_02).origin;
...
bot_control_vanguard()
{
	...
	while(var_02 && !var_05)
	{
		...
		for(var_0B = 0;var_0B < var_0A.size;var_0B++)
		{
			...
			var_0F = gettime() + 2500;
			while(function_0210(var_0C.origin,self.vehicle_controlling.origin) > var_0D * var_0D)
			{
...
{
	if(markdangerousnodesintrigger(param_00))
	{
...
func_8829()
{
	...
	if(isdefined(var_00) && !markdangerousnodesintrigger(var_00))
	{
		return 0;
	}
...
func_40FD()
{
	...
	while(self [[ level.bot_ks_funcs["isUsing"]["heli_pilot"] ]]())
	{
		...
		if(var_08)
		{
			...
			var_10 = anglestoforward(self getangles());
		...
		var_15 = angleclamp360(self.vehicle_controlling.angles[0]);
		var_16 = angleclamp360(var_14[0]);
		var_17 = castint(var_15 - var_16) % 360;
		if(var_17 > 180)
		{
			var_17 = 360 - var_17;
		}
...
func_1649()
{
	...
	{
		var_04 = getzoneorigin(self.odin.targeting_marker.nearest_node);
	}
	...
	while(self [[ level.bot_ks_funcs["isUsing"][param_00] ]]())
	{
		...
		if(gettime() > var_03 || !isdefined(var_04))
		{
			...
			else
			{
				...
				var_0B = getzonenodesbydist(var_02).origin;
				if(function_0210(self.odin.targeting_marker.origin,var_0B) < 10000)
				{
					var_02 = common_scripts\utility::func_6306(level.outside_zones);
					var_0B = getzonenodesbydist(var_02).origin;
					var_06 = gettime();
...
bot_odin_get_player_target_point(param_00)
{
	...
	if(var_03 > 400)
	{
		...
		{
			self.odin_predicted_loc_for_player[var_01] = setnojiptime(param_00,1.5);
...
bot_odin_should_airdrop_at_marker()
{
	...
	var_00 = getzoneorigin(self.odin.targeting_marker.nearest_node);
	if(!isdefined(var_00))
	{
		return 0;
	}
...
bot_odin_get_visible_outside_players(param_00,param_01,param_02)
{
	...
	foreach(var_07 in var_03)
	{
		...
		if(common_scripts\utility::func_8E18(self.vehicle_controlling.origin,self getangles(),var_07.origin,var_09))
		{
...
func_3261(param_00,param_01)
{
	...
	foreach(var_05 in level.bot_heli_nodes)
	{
		var_06 = function_0210(param_00,[[ level.bot_ks_funcs["heli_node_get_origin"][param_01] ]](var_05));
		if(var_06 < var_03)
		{
			var_02 = var_05;
			var_03 = var_06;
...
func_160D(param_00,param_01,param_02)
{
	...
	foreach(var_06 in var_04)
	{
		...
		if(var_07)
		{
			...
			if(isdefined(var_08) && markdangerousnodesintrigger(var_08))
			{
...
func_3976()
{
	...
	{
		var_03 = botautoconnectenabled(var_02,self.team,"enemy_predict");
		if(var_03 > 0)
		{
	...
	if(var_00.size > 0)
	{
		...
		var_07 = common_scripts\utility::func_6306(getzonenearest(var_06));
	...
	else
	{
		...
		while(var_09 < 10)
		{
			...
			if(markdangerousnodesintrigger(var_0A) && function_0210(var_0A.origin,self.vehicle_controlling.origin) > -3036)
			{
				break;
			}
		}
