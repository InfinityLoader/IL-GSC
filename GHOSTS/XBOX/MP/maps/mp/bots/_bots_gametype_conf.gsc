 ...
 * Timestamp: 10/27/2023 1:28:23 AM
*******************************************************************/
...
func_8FDA(param_00)
{
	if(isdefined(param_00.on_path_grid) && param_00.on_path_grid)
	{
		...
		if(function_0210(param_00.curorigin,var_01) < 144)
		{
...
func_8FFA(param_00,param_01,param_02)
{
	...
	{
		var_05 = var_03 == param_01 || getnodesintrigger(var_03,param_01,1);
		if(var_05)
		{
...
func_8FD6(param_00,param_01,param_02)
{
	...
	if(var_03 == "goal")
	{
		...
		if(isdefined(var_04))
		{
			var_05 = nodeexposedtosky(self.origin);
