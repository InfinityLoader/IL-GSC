 ...
 * Timestamp: 10/27/2023 1:28:30 AM
*******************************************************************/
...
{
	if(abs(param_00[2] - param_01[2]) > 56 && function_0210(param_00,param_01) < 2304)
	{
		return 1;
	}
