 ...
 * Timestamp: 10/27/2023 1:28:49 AM
*******************************************************************/
...
bot_balance_personality()
{
	...
	{
		if(botsentientswap(var_09) && isdefined(var_09.team) && var_09.team == self.team && var_09 != self && isdefined(var_09.has_balanced_personality))
		{
...
func_8699()
{
	...
	if(!maps/mp/bots/_bots_strategy::bot_has_tactical_goal() && !maps/mp/bots/_bots_util::bot_is_remote_or_linked())
	{
		...
		if(var_01)
		{
			...
			{
				var_05 = botzonenearestcount("investigated");
				botmemoryflags(0,gettime() - self.bot_memory_goal_time,1,self.bot_memory_goal,var_04,"kill",var_05,self);
				botmemoryflags(0,gettime() - self.bot_memory_goal_time,1,self.bot_memory_goal,var_04,"death",var_05,self);
...
bot_find_ambush_entrances(param_00,param_01)
{
	self endon("disconnect");
	var_02 = [];
	var_03 = nodeexposedtosky(param_00.origin);
...
find_camp_node_worker()
{
	...
	var_00 = getzonecount(self.origin);
	var_01 = undefined;
	var_02 = undefined;
	var_03 = self.angles;
	if(isdefined(var_00))
	{
		var_04 = botzonesetteam(var_00,self.team,-1,"enemy_predict",">",0,"ally","<",1);
		if(!isdefined(var_04))
		{
			var_04 = botzonesetteam(var_00,self.team,-1,"enemy_predict",">",0);
		}
		...
		if(!isdefined(var_04))
		{
			...
			{
				var_08 = function_0210(getzonepath(var_07),self.origin);
				if(var_08 > var_05)
				{
					var_05 = var_08;
					var_06 = var_07;
		...
		var_09 = getzonenodes(var_00,var_04);
		if(isdefined(var_09) && var_09.size > 0)
		{
			for(var_0A = 0;var_0A <= castint(var_09.size / 2);var_0A++)
			{
				var_01 = var_09[var_0A];
				var_02 = var_09[castint(min(var_0A + 1,var_09.size - 1))];
			...
			{
				var_03 = getzonepath(var_02) - getzonepath(var_01);
	...
	if(isdefined(var_01))
	{
		...
		while(var_0C)
		{
			var_0F = getnodezone(var_01,800 * var_0D,1);
			if(var_0F.size > 1024)
			{
				var_0F = getzonenearest(var_01,0);
			}
			...
			if(var_0F.size > 0)
			{
				var_11 = castint(min(max(1,var_0F.size * 0.15),5));
				if(var_0E)
				{
...
func_325A(param_00,param_01)
{
	...
	if(var_05.size > 0)
	{
		var_07 = castint(max(1,castint(var_05.size * 0.15)));
