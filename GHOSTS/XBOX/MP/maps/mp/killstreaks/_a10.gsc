 ...
 * Timestamp: 10/27/2023 1:31:57 AM
*******************************************************************/
...
onuse(param_00,param_01)
{
	...
	if(calculatestartorientation() < 2)
	{
		return 0;
	}
...
func_785E(param_00,param_01,param_02)
{
	...
	var_03 setgrenadecookscale(self,param_02);
...
createplaneasheli(param_00,param_01,param_02)
{
	...
	var_04 = getcsplinepointtension(param_02,0);
	var_05 = getcsplinepointcorridordims(param_02,0);
...
func_5938(param_00,param_01,param_02)
{
	...
	if(isdefined(var_05))
	{
		...
		var_07 = level.planeconfigs[param_00];
		var_08 botpredictenemycampspots(var_07.sfxmissilefire_1p[var_03]);
...
onfirerocket(param_00)
{
	...
	if(isdefined(var_02))
	{
		...
		self.numrocketsleft--;
		self.owner setclientomnvar("ui_a10_rocket",self.numrocketsleft);
		var_05 botpredictenemycampspots(var_04.sfxmissilefire_1p[self.numrocketsleft]);
		var_05 playloopsound(var_04.sfxmissile);
		self botpredictenemycampspots("a10p_missile_launch");
	}
}
...
a10_missile_set_target(param_00,param_01)
{
	...
	wait(0.2);
	self missilesettargetent(param_00,param_01);
}
...
func_53D8(param_00,param_01)
{
	...
	while(param_01.ammocount > 0)
	{
		...
		param_01 botpredictenemycampspots(var_02.sfxcannonfirestop_1p);
		if(gettime() < var_03)
		{
...
func_5370(param_00,param_01)
{
	...
	for(;;)
	{
		var_02 = castint(clamp(param_01.origin[2],0,16383));
