 ...
 * Timestamp: 10/27/2023 1:32:28 AM
*******************************************************************/
...
func_44DF()
{
	...
	level.ospreysettings["escort_airdrop"] = addstruct();
	...
	level.ospreysettings["osprey_gunner"] = addstruct();
...
func_20C6(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	var_06.attractor = missilecreateattractorent(var_06,level.heli_attract_strength,level.heli_attract_range);
...
func_66A3(param_00,param_01)
{
	...
	self setangles(param_01 gettagangles("tag_player"));
...
airshipflydefense(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	self setspeed(25,10,10);
	self setyawspeed(20,10,10,0.3);
	self setgoalpos(var_0C,1);
	var_0A = gettime();
	self waittill("goal");
	var_0B = gettime() - var_0A * 0.001;
	self.timeout = self.timeout - var_0B;
