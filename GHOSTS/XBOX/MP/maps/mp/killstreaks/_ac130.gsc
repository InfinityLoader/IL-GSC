 ...
 * Platform: Console
 * Function Count: 90
 * Decompile Time: 1433 ms
 * Timestamp: 10/27/2023 1:32:03 AM
*******************************************************************/
...
add_context_sensative_dialog(param_00,param_01,param_02,param_03)
{
	...
	{
		level.scr_sound[param_00][param_01][param_02] = addstruct();
...
add_context_sensative_timeout(param_00,param_01,param_02,param_03)
{
	...
	if(var_04)
	{
		level.context_sensative_dialog_timeouts[param_00][param_01] = addstruct();
	}

	if(isdefined(param_02))
	{
		level.context_sensative_dialog_timeouts[param_00][param_01].groups = [];
		level.context_sensative_dialog_timeouts[param_00][param_01].groups[func_7CDD(param_02)] = addstruct();
...
func_2319()
{
	...
	self.attractor = missilecreateattractorent(self,1000,4096);
	for(;;)
	{
...
attachplayer(param_00)
{
	...
	self setangles(level.ac130 gettagangles("tag_player"));
}
...
context_sensative_dialog_guy_in_sight_check()
{
	...
	for(var_04 = 0;var_04 < var_00.size;var_04++)
	{
		...
		if(common_scripts\utility::func_8E18(level.ac130player geteye(),level.ac130player getangles(),var_00[var_04].origin,level.cosine["5"]))
		{
			return 1;
		}
...
context_sensative_dialog_vehiclespawn(param_00)
{
	...
	while(!common_scripts\utility::func_8E18(level.ac130player geteye(),level.ac130player getangles(),param_00.origin,level.cosine["45"]))
	{
		wait(0.5);
	}
