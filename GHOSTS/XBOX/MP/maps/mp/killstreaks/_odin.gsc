 ...
 * Timestamp: 10/27/2023 1:33:02 AM
*******************************************************************/
...
func_44DF()
{
	...
	level.odinsettings = [];
	level.odinsettings["odin_support"] = addstruct();
	...
	level.odinsettings["odin_support"].weapon["airdrop"] = addstruct();
	...
	level.odinsettings["odin_support"].weapon["marking"] = addstruct();
	...
	level.odinsettings["odin_support"].weapon["smoke"] = addstruct();
	...
	level.odinsettings["odin_support"].weapon["juggernaut"] = addstruct();
	...
	level.odinsettings["odin_assault"] = addstruct();
	...
	level.odinsettings["odin_assault"].weapon["airdrop"] = addstruct();
	...
	level.odinsettings["odin_assault"].weapon["large_rod"] = addstruct();
	...
	level.odinsettings["odin_assault"].weapon["small_rod"] = addstruct();
	...
	level.odinsettings["odin_assault"].weapon["juggernaut"] = addstruct();
...
func_7AEA(param_00)
{
	...
	param_00.odin_overlay_ent = botgetteamlimit(level._effect["odin_fisheye"],self geteye(),self);
	triggerfx(param_00.odin_overlay_ent);
	param_00.odin_overlay_ent setscriptabledamageowner();
...
func_5842()
{
	...
	var_01 = var_00 sethybridscopestate();
...
odin_fireweapon(param_00)
{
	...
	var_03 = anglestoforward(var_01 getangles());
...
domarkingflash(param_00)
{
	...
	foreach(var_09 in level.participants)
	{
		...
		var_0E = anglestoforward(var_09 getangles());
