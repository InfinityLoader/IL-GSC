 ...
 * Timestamp: 10/27/2023 1:32:31 AM
*******************************************************************/
...
droponebomb(param_00,param_01)
{
	...
	var_05 gravitymove(var_04 * var_03.speed / 1.5,3);
...
applygaseffect(param_00,param_01,param_02,param_03,param_04)
{
	...
	{
		param_03 entityradiusdamage(self.origin,1,param_04,param_04,param_00,"MOD_RIFLE_BULLET","gas_strike_mp");
