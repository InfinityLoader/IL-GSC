 ...
 * Timestamp: 10/27/2023 1:33:19 AM
*******************************************************************/
...
func_7AF6(param_00)
{
	var_01 = getnode("startnode","targetname");
	var_02 = getnode("waitnode","targetname");
	self.nodes = getnodearray("info_vehicle_node","classname");
	level.tankinuse = 1;
...
setstandardspeed()
{
	...
	self setspeed(self.standardspeed,10,10);
...
func_7C75()
{
	...
	self setspeed(self.standardspeed,5,6);
}
...
callback_vehicledamage(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09,param_0A,param_0B)
{
	...
	self finishdamage(param_00,param_01,var_0C,param_03,param_04,param_05,param_06,param_07,param_08,param_09,param_0A,param_0B);
}
	...
	for(;;)
	{
		...
		else if(isplayer(var_06))
		{
			...
			if(var_06 maps\mp\_utility::_hasperk("specialty_armorpiercing"))
			{
				...
				self.health = self.health - castint(var_0A);
			}
		}
...
func_497E(param_00)
{
	...
	return self canturrettargetpoint(param_00.origin,1,self);
}
...
setuppaths()
{
	...
	var_02 = [];
	var_03 = [];
	var_04 = getnode("startnode","targetname");
	var_00[var_00.size] = var_04;
	var_01[var_01.size] = var_04;
	while(isdefined(var_04.target))
	{
		var_05 = var_04;
		var_04 = getnode(var_04.target,"targetname");
	...
	var_06 = getnodearray("branchnode","targetname");
	...
	foreach(var_04 in var_00)
	{
		...
		foreach(var_11 in var_02)
		{
			...
			var_11.next = getnode(var_04.targetname,"targetname");
...
func_3B42()
{
	...
	{
		return getnode(self.target,"targetname");
	}
...
func_4639(param_00)
{
	...
	foreach(var_03 in param_00)
	{
		...
		var_08 = getnode(var_03.target,"targetname");
		...
		while(!isdefined(var_08.var_3D93))
		{
			...
			{
				var_08 = getnode(var_08.target,"targetname");
				continue;
			}
		...
		foreach(var_0C in var_03.branchnodes)
		{
			...
			if(var_08.targetname == "branchnode")
			{
				while(!isdefined(var_08.var_3D93))
				{
					if(isdefined(var_08.target))
					{
						var_0D = getnode(var_08.target,"targetname");
					}
					else
					{
						var_0D = var_08.next;
