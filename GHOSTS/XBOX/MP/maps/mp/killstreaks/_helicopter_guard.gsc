 ...
 * Timestamp: 10/27/2023 1:32:40 AM
*******************************************************************/
...
func_44DF()
{
	...
	level.heliguardsettings["littlebird_support"] = addstruct();
...
createlbguard(param_00)
{
	...
	var_08 setspeed(var_08.speed,100,40);
	var_08 setyawspeed(120,60);
	var_08 neargoalnotifydist(512);
	var_08.killcount = 0;
	...
	var_08.attractor = missilecreateattractorent(var_08,var_08.attract_strength,var_08.attract_range);
	var_08.hasdodged = 0;
...
startlbsupport(param_00)
{
	...
	param_00 setgoalpos(param_00.targetpos);
	param_00 waittill("near_goal");
	param_00 setspeed(param_00.speed,60,30);
	param_00 waittill("goal");
	param_00 setgoalpos(param_00.currentnode.origin,1);
	param_00 waittill("goal");
...
func_4D1A()
{
	...
	self.intransit = 1;
	self setgoalpos(self.currentnode.origin + (0,0,100),1);
	self waittill("goal");
	self.intransit = 0;
...
func_4D21(param_00,param_01,param_02,param_03)
{
	...
	for(var_04 = 0;var_04 < param_03.size;var_04++)
	{
		if(isdefined(param_03[var_04]) && !param_02.hasdodged)
		{
			...
			var_05 gravitymove(anglestoright(param_03[var_04].angles) * -1000,0.05);
			...
			for(var_06 = 0;var_06 < param_03.size;var_06++)
			{
				...
				{
					param_03[var_06] missilesettargetent(var_05);
				}
			}

			var_07 = param_02.origin + anglestoright(param_03[var_04].angles) * 200;
			param_02 setspeed(param_02.speed,100,40);
			param_02 setgoalpos(var_07,1);
			wait(2);
			param_02 setspeed(param_02.followspeed,20,20);
			break;
		}
	}
}
...
func_4D22(param_00,param_01,param_02)
{
	...
	if(isdefined(self) && !param_02.hasdodged)
	{
		...
		var_03 gravitymove(anglestoright(self.angles) * -1000,0.05);
		var_03 thread maps\mp\killstreaks\_flares::func_33D0(5);
		self missilesettargetent(var_03);
		var_04 = param_02.origin + anglestoright(self.angles) * 200;
		param_02 setspeed(param_02.speed,100,40);
		param_02 setgoalpos(var_04,1);
		wait(2);
		param_02 setspeed(param_02.followspeed,20,20);
	}
}
