 ...
 * Timestamp: 10/27/2023 1:32:59 AM
*******************************************************************/
...
func_44DF()
{
	...
	level.nukeemptimeremaining = castint(level.nukeemptimeout);
	level.nukeinfo = addstruct();
...
func_29B6(param_00)
{
	...
	level.prevuibombtimer = castint(getomnvar("ui_bomb_timer"));
...
func_575C(param_00)
{
	...
	var_07 = botgetteamlimit(level._effect["nuke_flash"],var_01,param_00,var_06,var_05);
	triggerfx(var_07);
...
{
	level endon("nuke_cancelled");
	etslowmotion(1,0.25,0.5);
	level waittill("nuke_death");
	etslowmotion(0.25,1,2);
}
...
func_5769()
{
	...
	getsquadassaultsquadindex("mpnuke",3);
	maps\mp\gametypes\_hostmigration::func_8B0D(2);
	getsquadassaultsquadindex("nuke_global_flash",0.1);
	setexponentialfog(0,956,0.72,0.61,0.39,0.968,0.85,1,0.298,0.273,0.266,0.25,(0,0,-1),84,118,2.75,0.984,124,100);
	...
	getsquadassaultsquadindex("aftermath_post",0.5);
	level waittill("nuke_death");
...
{
	wait(0.1);
	self method_841C(level.nukevisionset,0);
}
...
func_9453(param_00)
{
	...
	getsquadassaultsquadindex(level.nukevisionset,param_00);
}