...
dolbstrike(param_00,param_01,param_02,param_03)
{
	...
	var_05 setspeed(48,48);
	var_05 setgoalpos(param_02["end"],0);
	var_05 waittill("goal");
	var_05 setmaxpitchroll(30,40);
	var_05 setspeed(32,32);
	var_05 setgoalpos(param_02["start"],0);
	wait(2);
	var_05 setmaxpitchroll(100,60);
	var_05 setspeed(64,64);
	var_05 waittill("goal");
	var_05 notify("gone");
