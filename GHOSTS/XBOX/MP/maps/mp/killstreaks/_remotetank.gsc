 ...
 * Timestamp: 10/27/2023 1:33:10 AM
*******************************************************************/
...
func_44DF()
{
	...
	level.tanksettings = [];
	level.tanksettings["remote_tank"] = addstruct();
...
createtank(param_00)
{
	...
	var_04 = spawn(level.tanksettings[var_02].modelbase,var_02,level.tanksettings[var_02].vehicleinfo,param_00.origin,param_00.angles,var_01);
	if(!isdefined(var_04))
	{
		return undefined;
	}
...
tank_setinactive()
{
	...
	if(isdefined(var_00.using_remote_tank) && var_00.using_remote_tank)
	{
		...
		var_00 maps\mp\_utility::func_1D59();
		var_00 setangles(var_00.restoreangles);
		if(getdvarint("camera_thirdPerson"))
		{
