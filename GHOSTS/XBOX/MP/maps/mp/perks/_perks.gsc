 ...
 * Timestamp: 10/27/2023 1:33:38 AM
*******************************************************************/
...
func_1905(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08)
{
	...
	else if(isexplosivedamagemod(param_03))
	{
		...
		{
			var_09 = var_09 + castint(param_02 * level.thermodebuffmod);
		}
		...
		{
			var_0B = castint(param_02 * level.blastshieldmod);
	...
	else if(param_03 == "MOD_MELEE")
	{
		...
		else if(maps\mp\gametypes\_weapons::func_494E(param_04))
		{
			...
			{
				param_02 = castint(param_00.maxhealth * 0.66);
			}
		}
		else
		{
	...
	{
		if(isbot(param_01) && isdefined(param_01.agent_type) && param_01.agent_type == "dog" && param_00 maps\mp\_utility::isjuggernaut())
		{
	...
	if(param_00 maps\mp\_utility::_hasperk("specialty_combathigh"))
	{
		...
		if(param_04 != "throwingknife_mp" && param_04 != "throwingknifejugg_mp")
		{
			switch(param_03)
			{
				...
				default:
					param_02 = castint(param_02 / 3);
					var_09 = castint(var_09 / 3);
					break;
			}
		}
	}
	...
	{
		param_02 = castint(param_02 + var_09);
	}
