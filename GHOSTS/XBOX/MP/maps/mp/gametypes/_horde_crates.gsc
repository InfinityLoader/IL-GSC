 ...
 * Timestamp: 10/27/2023 1:30:59 AM
*******************************************************************/
...
hordecrateperkthink(param_00)
{
	...
	for(;;)
	{
		...
		if(!var_02 maps\mp\_utility::_hasperk(self.cratetype))
		{
			...
			var_02 setclientomnvar("ui_horde_update_perk",castint(var_04));
			var_05 = var_02.horde_perks.size;
			var_02.horde_perks[var_05]["name"] = var_03;
			var_02.horde_perks[var_05]["index"] = castint(var_04);
		}
...
doubletapthink()
{
	...
	for(;;)
	{
		...
		if(function_0210(var_01.origin,self.origin) < var_00)
		{
...
func_4935(param_00)
{
	...
	{
		var_04 = function_0210(var_03.origin,param_00);
		if(var_04 < 4096)
		{
			var_01 = 1;
			break;
