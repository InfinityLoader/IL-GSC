 ...
 * Timestamp: 10/27/2023 1:30:31 AM
*******************************************************************/
...
onplayerspawned()
{
	...
	for(;;)
	{
		...
		var_01 = "";
		if(!isbot(self) && self cancelmantle())
		{
			var_01 = "w";
		}
...
func_2A0F(param_00,param_01,param_02)
{
	...
	var_04 = !level.istactical || !maps\mp\_utility::_hasperk("specialty_coldblooded") && isbot(self) || self issighted();
	if(param_02 && var_04)
	{
		if(isbot(self) || level.alivecount[var_03] > 3)
		{
			thread dosounddistant(param_00,var_03);
		}
	}

	if(isbot(self) || isdefined(param_01) && param_01)
	{
