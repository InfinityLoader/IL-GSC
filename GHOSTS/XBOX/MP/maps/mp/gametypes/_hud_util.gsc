 ...
 * Timestamp: 10/27/2023 1:31:07 AM
*******************************************************************/
...
func_70A4(param_00,param_01,param_02,param_03,param_04)
{
	...
	if(maps\mp\_utility::func_7CEA(var_06,"_adjustable") == var_05.alignx)
	{
		var_08 = 0;
		var_09 = 0;
	}
	...
	if(maps\mp\_utility::func_7CEA(var_07,"_adjustable") == var_05.aligny)
	{
		var_0A = 0;
		var_0B = 0;
	}
...
func_70A5(param_00,param_01,param_02,param_03)
{
	...
	{
		self.bar.x = self.x - castint(self.width / 2);
	}
...
func_86CE(param_00,param_01)
{
	var_02 = castint(self.width * param_00 + 0.5);
	if(!var_02)
	{
		var_02 = 1;
	}
	...
	self.bar setmaterial(self.bar.shader,var_02,self.height);
...
createserverfontstring(param_00,param_01,param_02)
{
	...
	var_03.y = 0;
	var_03.width = 0;
	var_03.height = castint(level.fontheight * param_01);
	var_03.xoffset = 0;
	var_03.yoffset = 0;
	var_03.children = [];
	var_03 func_708F(level.uiparent);
	var_03.hidden = 0;
	return var_03;
}
...
func_20FC(param_00,param_01,param_02)
{
	...
	{
		var_03 setmaterial(param_00,param_01,param_02);
...
//Function Number: 15
func_211E(param_00,param_01,param_02,param_03)
{
	if(isdefined(param_03))
	{
	...
	var_04.yoffset = 0;
	var_04.children = [];
	var_04 func_708F(level.uiparent);
	var_04.hidden = 0;
	if(isdefined(param_00))
	{
...
//Function Number: 16
func_211C(param_00,param_01,param_02,param_03,param_04,param_05)
{
	if(isdefined(param_04))
	{
	...
	var_06 setmaterial("progress_bar_fill",param_01,param_02);
	var_06.hidden = 0;
	if(isdefined(param_03))
	{
	...
	var_07.color = (0,0,0);
	var_07.alpha = 0.5;
	var_07 func_708F(level.uiparent);
	var_07 setmaterial("progress_bar_bg",param_01,param_02);
	var_07.hidden = 0;
	return var_07;
}
...
createbar(param_00,param_01,param_02,param_03)
{
	...
	var_04 setmaterial("progress_bar_fill",param_01,param_02);
	var_04.hidden = 0;
	if(isdefined(param_03))
	{
	...
	var_05.color = (0,0,0);
	var_05.alpha = 0.5;
	var_05 func_708F(level.uiparent);
	var_05 setmaterial("progress_bar_bg",param_01 + 4,param_02 + 4);
	var_05.hidden = 0;
	return var_05;
}
...
createprimaryprogressbar(param_00,param_01)
{
	...
	var_02 func_70A4("CENTER",undefined,level.primaryprogressbarx + param_00,level.primaryprogressbary + param_01);
	return var_02;
}
...
createprimaryprogressbartext(param_00,param_01,param_02,param_03)
{
	...
	var_06 func_70A4("CENTER",undefined,level.primaryprogressbartextx + param_00,level.primaryprogressbartexty + param_01);
	var_06.sort = -1;
	return var_06;
}
...
func_2127(param_00)
{
	var_01 = func_211C((1,0,0),level.teamprogressbarwidth,level.teamprogressbarheight,undefined,param_00);
	var_01 func_70A4("TOP",undefined,0,level.teamprogressbary);
	return var_01;
}
...
createteamprogressbartext(param_00)
{
	...
	var_01 func_70A4("TOP",undefined,0,level.teamprogressbartexty);
	return var_01;
}
...
//Function Number: 30
func_7051(param_00,param_01)
{
	self setmaterial(self.shader,param_00,param_01);
}
...
func_86D8()
{
	for(var_00 = 0;var_00 < self.children.size;var_00++)
	{
		...
		var_01 func_70A4(var_01.point,var_01.relativepoint,var_01.xoffset,var_01.yoffset);
	}
}
...
func_826A()
{
	...
	{
		self setmaterial(self.shader,self.width,self.height);
	}
...
func_8273(param_00)
{
	switch(self.elemtype)
	{
		...
		case "icon":
			self setmaterial(self.shader,self.width * 6,self.height * 6);
...
//Function Number: 37
func_8269(param_00,param_01)
{
	var_02 = castint(param_00) * 1000;
	var_03 = castint(param_01) * 1000;
	switch(self.elemtype)
	{
		case "timer":
		case "font":
...
//Function Number: 43
getweeklyref(param_00)
{
	for(var_01 = 0;var_01 < 3;var_01++)
	{
		var_02 = self getrankedplayerdata("weeklyChallengeId",var_01);
...
func_3A6F(param_00)
{
	for(var_01 = 0;var_01 < 3;var_01++)
	{
		var_02 = self getrankedplayerdata("dailyChallengeId",var_01);
...
func_1A9F(param_00)
{
	if(level.challengeinfo[param_00]["type"] == 0)
	{
		return self getrankedplayerdata("challengeProgress",param_00);
	}

	if(level.challengeinfo[param_00]["type"] == 1)
	{
		return self getrankedplayerdata("challengeProgress",func_3A6F(param_00));
	}

	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return self getrankedplayerdata("challengeProgress",getweeklyref(param_00));
	}
}
...
ch_getstate(param_00)
{
	if(level.challengeinfo[param_00]["type"] == 0)
	{
		return self getrankedplayerdata("challengeState",param_00);
	}

	if(level.challengeinfo[param_00]["type"] == 1)
	{
		return self getrankedplayerdata("challengeState",func_3A6F(param_00));
	}

	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return self getrankedplayerdata("challengeState",getweeklyref(param_00));
	}
}
...
ch_setprogress(param_00,param_01)
{
	if(level.challengeinfo[param_00]["type"] == 0)
	{
		return self setrankedplayerdata("challengeProgress",param_00,param_01);
	}

	if(level.challengeinfo[param_00]["type"] == 1)
	{
		return self setrankedplayerdata("challengeProgress",func_3A6F(param_00),param_01);
	}

	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return self setrankedplayerdata("challengeProgress",getweeklyref(param_00),param_01);
	}
}

//Function Number: 48
func_1AA8(param_00,param_01)
{
	if(level.challengeinfo[param_00]["type"] == 0)
	{
		return self setrankedplayerdata("challengeState",param_00,param_01);
	}

	if(level.challengeinfo[param_00]["type"] == 1)
	{
		return self setrankedplayerdata("challengeState",func_3A6F(param_00),param_01);
	}

	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return self setrankedplayerdata("challengeState",getweeklyref(param_00),param_01);
	}
}
...
ch_gettarget(param_00,param_01)
{
	if(level.challengeinfo[param_00]["type"] == 0)
	{
		return castint(tablelookup("mp/allChallengesTable.csv",0,param_00,9 + param_01 - 1 * 2));
	}

	if(level.challengeinfo[param_00]["type"] == 1)
	{
		return castint(tablelookup("mp/dailyChallengesTable.csv",0,param_00,9 + param_01 - 1 * 2));
	}

	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return castint(tablelookup("mp/weeklyChallengesTable.csv",0,param_00,9 + param_01 - 1 * 2));
	}
}

//Function Number: 50
ch_isactivechallenge(param_00)
{
	var_01 = 5;
	if(level.challengeinfo[param_00]["type"] == 0)
	{
		...
		{
			var_03 = self getrankedplayerdata("activeChallenges",var_02);
			if(var_03 == param_00)
			{
				return 1;
			}
	...
	else if(level.challengeinfo[param_00]["type"] == 1)
	{
		return 1;
	}
	else if(level.challengeinfo[param_00]["type"] == 2)
	{
		return 1;
	}
