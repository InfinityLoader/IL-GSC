 ...
 * Platform: Console
 * Function Count: 94
 * Decompile Time: 1587 ms
 * Timestamp: 10/27/2023 1:30:54 AM
*******************************************************************/
...
func_8759(param_00,param_01)
{
	...
	for(var_03 = 0;var_03 < var_02.size;var_03++)
	{
		...
		if(param_01)
		{
			var_05 setmaterial(self.worldicons[param_00],level.objpointsize,level.objpointsize);
...
func_720E(param_00)
{
	self.usetime = castint(param_00 * 1000);
}
...
{
	self.teamusetimes[param_00] = castint(param_01 * 1000);
}
