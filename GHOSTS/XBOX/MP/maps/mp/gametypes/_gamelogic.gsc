 ...
 * Platform: Console
 * Function Count: 86
 * Decompile Time: 1581 ms
 * Timestamp: 10/27/2023 1:30:49 AM
*******************************************************************/
...
func_811F(param_00)
{
	setgameendtime(gettime() + castint(param_00 * 1000));
...
func_8700(param_00)
{
	...
	if(level.teambased)
	{
		...
		foreach(var_07 in level.players)
		{
			...
			if(var_02 == "tie")
			{
				var_09 = castint(var_04 * var_01 / 60 * var_08 * var_07.timeplayed["total"] / var_01);
			...
			{
				var_09 = castint(var_05 * var_01 / 60 * var_08 * var_07.timeplayed["total"] / var_01);
...
func_721B(param_00)
{
	...
	for(var_02 = 0;var_02 < var_01.size;var_02++)
	{
		...
		setplayerteamrank(var_03,var_03.clientid,castint(var_04));
	}
}
...
func_1BDB(param_00)
{
	...
	setgameendtime(gettime() + castint(var_01));
	if(var_01 > 0)
	{
	}
...
callback_startgametype()
{
	...
	if(!isdefined(game["gamestarted"]))
	{
		...
		if(level.console)
		{
			if(!level.splitscreen)
			{
				if(maps\mp\_utility::func_92AB() || loadluifile())
				{
...
displayroundend(param_00,param_01)
{
	...
	{
		if(isdefined(var_05.connectedpostgame) || var_05.pers["team"] == "spectator" && !var_05 setmlgcameradefaults())
		{
			continue;
		}
...
displaygameend(param_00,param_01)
{
	foreach(var_03 in level.players)
	{
		if(isdefined(var_03.connectedpostgame) || var_03.pers["team"] == "spectator" && !var_03 setmlgcameradefaults())
		{
			continue;
		}
...
func_2D58()
{
	...
	foreach(var_01 in level.players)
	{
		if(isdefined(var_01.connectedpostgame) || var_01.pers["team"] == "spectator" && !var_01 setmlgcameradefaults())
		{
			continue;
		}
...
func_2D56(param_00,param_01,param_02)
{
	...
	if(maps\mp\_utility::func_50C1())
	{
		...
		setmatchdata("isDedicated",loadluifile());
	}
...
checkforbestweapon()
{
	...
	var_0B = castint(tablelookup("mp/statstable.csv",4,var_01,0));
