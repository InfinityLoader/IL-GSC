 ...
 * Timestamp: 10/27/2023 1:31:21 AM
*******************************************************************/

//Function Number: 1
func_44DF()
{
	precachematerial("objpoint_default");
	level.objpointnames = [];
	level.objpoints = [];
...
createteamobjpoint(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	var_06.isflashing = 0;
	var_06.isshown = 1;
	var_06 setmaterial(param_03,level.objpointsize,level.objpointsize);
...
//Function Number: 5
func_7088(param_00,param_01)
{
	var_02 = getobjpointbyname(param_00);
	var_02 func_870A(param_01);
}
