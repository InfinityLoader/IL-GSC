/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\gametypes\sotf.gsc
 * Game: Call of Duty: Ghosts
 * Platform: Console
 * Function Count: 40
 * Decompile Time: 715 ms
 * Timestamp: 10/27/2023 1:29:30 AM
*******************************************************************/
...
initializematchrules()
{
	...
	maps\mp\_utility::func_6472("sotf",1);
	setdynamicdvar("scr_sotf_winlimit",1);
	maps\mp\_utility::func_647C("sotf",1);
	setdynamicdvar("scr_sotf_halftime",0);
	maps\mp\_utility::func_646A("sotf",0);
...
func_7865(param_00)
{
	...
	{
		var_02 = func_3A4B(var_01);
		level.firstcratedrop = 0;
	}
	else
	{
		var_02 = func_3BBD(var_02);
	}
