 ...
 * Timestamp: 10/27/2023 1:31:31 AM
*******************************************************************/
...
func_44DF()
{
	...
	level.maxrank = castint(tablelookup("mp/rankTable.csv",0,"maxrank",1));
	level.maxprestige = castint(tablelookup("mp/rankTable.csv",0,"maxprestige",1));
	...
	for(var_00 = 0;var_00 <= min(10,level.maxprestige);var_00++)
	{
		...
		{
			precachematerial(tablelookup("mp/rankIconTable.csv",0,var_01,var_00 + 1));
		}
	}
	...
	var_04 = castint(tablelookup("mp/weaponRankTable.csv",0,"maxrank",1));
...
registerscoreinfo(param_00,param_01)
{
	...
	if(param_00 == "kill")
	{
		setomnvar("ui_game_type_kill_value",castint(param_01));
	}
}
...
func_3BC7(param_00)
{
	return castint(level.ranktable[param_00][2]);
}

//Function Number: 8
getweaponrankinfominxp(param_00)
{
	return castint(level.weaponranktable[param_00][1]);
}

//Function Number: 9
func_3BC8(param_00)
{
	return castint(level.ranktable[param_00][3]);
}

//Function Number: 10
getweaponrankinfoxpamt(param_00)
{
	return castint(level.weaponranktable[param_00][2]);
}

//Function Number: 11
func_3BC6(param_00)
{
	return castint(level.ranktable[param_00][7]);
}

//Function Number: 12
getweaponrankinfomaxxp(param_00)
{
	return castint(level.weaponranktable[param_00][3]);
}
...
func_3BC5(param_00)
{
	return castint(tablelookup("mp/rankTable.csv",0,param_00,13));
}
	...
	for(;;)
	{
		...
		if(!isai(var_00))
		{
			if(maps\mp\_utility::func_50C1())
			{
				...
				var_01 = var_00 getclanwarsbonusforcurrentplaylist("prestigeLevel");
...
roundup(param_00)
{
	if(castint(param_00) != param_00)
	{
		return castint(param_00 + 1);
	}
...
giverankxp_regularmp(param_00,param_01,param_02,param_03,param_04,param_05)
{
	self endon("disconnect");
	var_06 = "none";
	if(isdefined(self.owner) && !botsentientswap(self))
	{
	...
	switch(param_00)
	{
		...
		case "destroy":
			if(maps\mp\_utility::func_3ABB() > 0 && param_00 != "shield_damage")
			{
				if(!isdefined(level.skiplivesxpscalar) || !level.skiplivesxpscalar)
				{
					...
					{
						var_11 = max(1,castint(10 / maps\mp\_utility::func_3ABB()));
					}
					else
					{
						var_11 = max(1,castint(5 / maps\mp\_utility::func_3ABB()));
					}
	
					var_08 = castint(var_08 * var_11);
				}
			}
			...
			var_0A = self setcommonplayerdatareservedint();
			if(var_12 > 0)
			{
				var_08 = castint(var_08 * var_12);
			}
			...
			var_08 = castint(var_08 * level.xpscale * var_14);
		...
		case "operation":
			...
			{
				var_09 = var_09 + castint(self getrankedplayerdata("challengeXPMultiplier",0));
			}
			break;
	...
	var_16 = castint(max(var_08 * var_09 - var_08,0));
	var_17 = castint(var_08 * var_0A);
	var_18 = func_3BC9();
...
getxpmultiplier()
{
	...
	for(var_01 = 0;var_01 < 3;var_01++)
	{
		...
		if(var_02 < var_03)
		{
			var_00 = var_00 + castint(self getrankedplayerdata("xpMultiplier",var_01));
		}
	}
...
func_8723()
{
	...
	var_03 = castint(var_02[var_02.size - 1]);
...
func_8E77(param_00,param_01)
{
	...
	var_02 = max(castint(self.bonusupdatetotal / 20),1);
...
getweaponrankforxp(param_00,param_01)
{
	...
	var_03 = castint(tablelookup("mp/weaponRankTable.csv",0,var_02,1));
...
getweaponmaxrankxp(param_00)
{
	...
	var_02 = castint(tablelookup("mp/weaponRankTable.csv",0,var_01,1));
...
func_447D(param_00)
{
	...
	var_02 = castint(clamp(var_02,0,5999));
	if(var_02 >= 3000)
	{
		var_02 = var_02 % 3000;
	...
	var_03 = func_3BC9();
	var_04 = castint(min(var_03,func_3BC6(level.maxrank))) + param_00;
...
func_3BD5(param_00)
{
	...
	var_02 = castint(param_00 * var_01);
...
func_7E32()
{
	...
	if(var_00 >= func_3BC6(level.maxrank))
	{
		...
		if(var_03 == 0)
		{
			...
			var_05 = self getclanwarsbonusforcurrentplaylist("prestigeLevel");
			var_06 = var_05 + 1;
			self getrankedplayerdatareservedint("prestigeLevel",var_06);
