 ...
 * Timestamp: 10/27/2023 1:29:10 AM
*******************************************************************/
...
initfirstzone()
{
	...
	level.grnd_dangercenter = addstruct();
	...
	for(;;)
	{
		...
		foreach(var_01 in level.players)
		{
			if(isdefined(var_01.ingrindzone) && var_01.pers["team"] != "spectator")
			{
				...
				{
					var_01.grndheadicon setmaterial("waypoint_captureneutral_b",14,14);
				...
				{
					var_01.grndheadicon setmaterial("waypoint_defend_b",14,14);
					var_01.grndheadicon setwaypoint(0,1,0,0);
					objective_icon(var_01.grndobjid,"waypoint_defend_b");
					continue;
				}

				var_01.grndheadicon setmaterial("waypoint_capture_b",14,14);
				var_01.grndheadicon setwaypoint(0,1,0,0);
...
adjustzones()
{
	...
	{
		level.grnd_dropzones1[level.grnd_dropzones1.size] = addstruct();
