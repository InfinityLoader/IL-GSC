 ...
 * Platform: Console
 * Function Count: 128
 * Decompile Time: 2197 ms
 * Timestamp: 10/27/2023 1:31:19 AM
*******************************************************************/
...
playerkilled_regularmp(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07)
{
	...
	if(isdefined(param_01))
	{
		param_01.anglesonkill = param_01 getangles();
	}
	...
	if(isdefined(param_04) && issubstr(param_04,"_hybrid"))
	{
		...
		{
			var_08.hybridscopestate = param_01 method_840D(param_04);
		}
		else
		{
...
func_53C4()
{
	...
	for(;;)
	{
		...
		if(maps\mp\_utility::_hasperk("specialty_marathon"))
		{
			...
			var_00 = castint(self.sprintdistthissprint / 120);
