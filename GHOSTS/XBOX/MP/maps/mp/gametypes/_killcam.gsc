 ...
 * Timestamp: 10/27/2023 1:31:12 AM
*******************************************************************/
...
killcam(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09,param_0A,param_0B,param_0C)
{
	...
	else
	{
		...
		{
			var_18 = castint(tablelookup("mp/killCamAbilitiesBitMaskTable.csv",1,var_17[var_14],0));
			if(var_18 == 0)
			{
				continue;
			}

			var_19 = castint(var_18 - 1 / 24);
	...
	if(!isbot(param_0A) && isdefined(param_0A))
	{
	...
	if(isbot(param_0A) || isbot(param_00))
	{
	...
	self setclientomnvar("ui_killcam_end_milliseconds",castint(var_0F.killcamlength * 1000) + gettime());
	if(var_22)
	{
...
dofinalkillcamfx(param_00,param_01,param_02,param_03,param_04)
{
	...
	etslowmotion(1,0.25,var_08);
	wait(var_08 + 0.5);
	etslowmotion(0.25,1,1);
...
{
	var_01 = castint(gettime() - param_00);
