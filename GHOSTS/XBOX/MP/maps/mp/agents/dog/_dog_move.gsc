 ...
 * Timestamp: 10/27/2023 1:27:54 AM
*******************************************************************/
...
func_7AE3()
{
	...
	var_0A = distance2dsquared(var_07);
	self setanimmode("anim deltas");
...
func_3F7E(param_00,param_01,param_02,param_03)
{
	...
	switch(param_00)
	{
		...
		case "footstep_front_left_small":
			...
			self botpredictenemycampspots("dogstep_" + var_05 + "_" + var_04);
			if(issubstr(param_00,"front_left"))
			{
				...
				self botpredictenemycampspots(var_06 + var_08);
				self botpredictenemycampspots(var_07 + var_08);
			}
			return 1;
	}
