 ...
 * Timestamp: 10/27/2023 1:27:52 AM
*******************************************************************/
...
func_2879(param_00)
{
	...
	if(param_00 == 1)
	{
		self botpredictenemycampspots(common_scripts\utility::func_803F(self.biswolf,"mp_wolf_attack_quick_back_npc","mp_dog_attack_quick_back_npc"));
	}
	else
	{
		self botpredictenemycampspots(common_scripts\utility::func_803F(self.biswolf,"mp_wolf_attack_short_npc","mp_dog_attack_short_npc"));
	}
...
func_3107(param_00,param_01,param_02)
{
	...
	var_03 = self.curmeleetarget method_83F9();
	self linkto(var_03);
	self method_83F5(param_00,param_01,param_02);
}
...
func_2A13(param_00,param_01)
{
	...
	self doanimlerp(self.origin,param_00,var_08);
...
func_86F9(param_00,param_01,param_02)
{
	...
	for(;;)
	{
		...
		self doanimlerp(self.origin,var_05,var_03);
	}
}
