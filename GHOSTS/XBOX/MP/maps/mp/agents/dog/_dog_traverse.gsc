 ...
 * Timestamp: 10/27/2023 1:27:57 AM
*******************************************************************/
...
func_4FDD()
{
	...
	if(var_03[2] > 0)
	{
		if(var_08[2] > 0)
		{
			...
			if(var_0A.size > 0)
			{
				...
				self setanimscale(var_0B,var_0C);
				...
				self setanimscale(var_09.xy,var_09.z);
		...
		self doanimlerp(var_04.origin,var_05.origin,var_1F);
	...
	if(var_1F.size > 0)
	{
		...
		if(abs(var_21) > 0)
		{
			...
			self setanimscale(var_1D.xy,var_0C);
	...
	{
		self setanimscale(var_1D.xy,var_1D.z);
