 ...
 * Timestamp: 10/27/2023 1:28:11 AM
*******************************************************************/
...
//Function Number: 3
func_5D4B(param_00,param_01,param_02,param_03)
{
...
playanimnuntilnotetrack(param_00,param_01,param_02,param_03,param_04)
{
	...
	func_8BCA(param_02,param_03,param_00,param_01,param_04);
}
...
playanimnatrateuntilnotetrack(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	func_8BCA(param_03,param_04,param_00,param_01,param_05);
}

//Function Number: 6
func_8BCA(param_00,param_01,param_02,param_03,param_04)
{
	var_05 = gettime();
	var_06 = undefined;
	var_07 = undefined;
...
//Function Number: 7
func_5D44(param_00,param_01)
{
	func_5D47(param_00,0,param_01);
}

//Function Number: 8
func_5D47(param_00,param_01,param_02)
{
	self setanimstate(param_00,param_01);
	wait(param_02);
}
...
getangleindex(param_00,param_01)
{
	...
	if(param_00 < 0)
	{
		return castint(ceil(180 + param_00 - param_01 / 45));
	}

	return castint(floor(180 + param_00 + param_01 / 45));
}
...
//Function Number: 13
canmovepointtopoint(param_00,param_01,param_02)
{
	...
	return self aiphysicstracepassed(var_04,var_05,self.radius,self.height - param_02,1);
}
...
func_3BDE(param_00)
{
	...
	var_03 = func_3C63(self.origin,var_02);
...
//Function Number: 16
func_69E3(param_00,param_01,param_02,param_03)
{
	var_04 = getrandomanimentry(param_00);
	func_69E2(param_00,var_04,param_01,param_02,param_03);
}

//Function Number: 17
func_69E0(param_00,param_01,param_02,param_03,param_04)
{
	var_05 = getrandomanimentry(param_00);
	func_69E1(param_00,var_05,param_01,param_02,param_03,param_04);
}

//Function Number: 18
func_69E1(param_00,param_01,param_02,param_03,param_04,param_05)
{
	self setanimstate(param_00,param_01,param_02);
	func_69E2(param_00,param_01,param_03,param_04,param_05);
}

//Function Number: 19
func_69E2(param_00,param_01,param_02,param_03,param_04)
{
	var_05 = self getanimentry(param_00,param_01);
	var_06 = func_3BDE(var_05);
