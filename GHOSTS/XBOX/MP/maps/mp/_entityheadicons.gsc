...
func_44DF()
{
	...
	precachematerial(game["entity_headicon_allies"]);
	precachematerial(game["entity_headicon_axis"]);
}
...
setheadicon(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09,param_0A)
{
	...
	var_0C.alpha = 0.85;
	var_0C setmaterial(param_02,param_04,param_05);
...
func_70E0(param_00,param_01)
{
	...
	var_03.alpha = 0.8;
	var_03 setmaterial(var_02,10,10);
...
func_7099(param_00,param_01)
{
	...
	var_04.alpha = 0.8;
	var_04 setmaterial(var_03,10,10);
