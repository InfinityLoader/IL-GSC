 ...
 * Timestamp: 10/27/2023 1:29:45 AM
*******************************************************************/
...
func_7200(param_00)
{
	...
	if(vectordot(var_05,var_07) > 0)
	{
		...
		{
			var_0A = func_8874(var_08,vectordot(var_07,var_08));
	...
	if(var_01 > 0)
	{
		...
		if(var_0D < var_01)
		{
			...
			var_0F = func_8874(var_07,var_0C * var_0E - 1 * 0.5);
		}
		else
		{
			var_0E = var_0F / var_03;
			var_0F = func_8874(var_07,var_0C * var_0F - 1 * 0.5);
		}
