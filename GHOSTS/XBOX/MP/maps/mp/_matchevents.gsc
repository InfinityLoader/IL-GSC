 ...
 * Timestamp: 10/27/2023 1:30:01 AM
*******************************************************************/
...
func_4665(param_00)
{
	...
	var_0B setspeed(50,15);
	var_0B setgoalpos(var_01["allies"][0].origin + (0,0,var_03 / 2),1);
	var_0B waittill("goal");
	var_0B setyawspeed(0,1,1);
	var_0B setgoalpos(var_01["allies"][0].origin + (0,0,var_03 / 6),1);
	var_0B waittill("goal");
	...
	var_0B setgoalpos(var_01["allies"][0].origin + (0,0,var_03),1);
	var_0B waittill("goal");
	var_0B setspeed(80,60);
	var_0B setgoalpos(var_09 + (0,0,var_04) + var_07 * 2,1);
	var_0B waittill("goal");
	var_0B setspeed(120,120);
	var_0B setgoalpos(var_09 + (0,0,var_04) + var_07 * 2 + var_05 * -20,1);
	var_0B waittill("goal");
	var_0B delete();
}
...
func_4666(param_00)
{
	...
	var_0B setspeed(50,15);
	var_0B setgoalpos(var_01["axis"][0].origin + (0,0,var_03 / 2),1);
	var_0B waittill("goal");
	var_0B setyawspeed(0,1,1);
	var_0B setgoalpos(var_01["axis"][0].origin + (0,0,var_03 / 6),1);
	var_0B waittill("goal");
	...
	wait(2);
	var_0B setyawspeed(60,40,40,0.3);
	var_0B setgoalpos(var_01["axis"][0].origin + (0,0,var_03),1);
	var_0B waittill("goal");
	var_0B setspeed(80,60);
	var_0B setgoalpos(var_09 + (0,0,var_04) + var_07 * 2,1);
	var_0B waittill("goal");
...
doospreyinsertion()
{
	...
	if(isdefined(var_00))
	{
		...
		var_07 setspeed(20,10);
		var_07 setyawspeed(3,3,3,0.3);
		var_07 setgoalpos(var_06 + (0,0,var_02),1);
		var_0B setspeed(20,10);
		var_0B setyawspeed(3,3,3,0.3);
		var_0B setgoalpos(var_0A + (0,0,var_02),1);
		...
		wait(2);
		var_07 setspeed(80,60);
		var_07 setyawspeed(30,15,15,0.3);
		var_07 setgoalpos(var_06 + (0,0,var_03),1);
		var_0B setspeed(80,60);
		var_0B setyawspeed(30,15,15,0.3);
		var_0B setgoalpos(var_0A + (0,0,var_03),1);
		var_07 waittill("goal");
		...
		var_07 setspeed(120,120);
		var_07 setyawspeed(100,100,40,0.3);
		var_07 setgoalpos(var_06 + (0,0,var_03) + var_04 * -20,1);
		var_0B setspeed(120,120);
		var_0B setyawspeed(100,100,40,0.3);
		var_0B setgoalpos(var_0A + (0,0,var_03) + var_08 * -20,1);
		var_07 waittill("goal");
		var_07 delete();
		var_0B delete();
	}
