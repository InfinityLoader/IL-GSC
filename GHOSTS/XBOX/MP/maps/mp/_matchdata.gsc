 ...
 * Timestamp: 10/27/2023 1:30:00 AM
*******************************************************************/
...
func_4F1D(param_00,param_01)
{
	...
	setmatchdata("killstreaks",var_02,"eventPos",0,castint(param_01[0]));
	setmatchdata("killstreaks",var_02,"eventPos",1,castint(param_01[1]));
	setmatchdata("killstreaks",var_02,"eventPos",2,castint(param_01[2]));
}
...
loggameevent(param_00,param_01)
{
	...
	setmatchdata("events",var_02,"eventPos",0,castint(param_01[0]));
	setmatchdata("events",var_02,"eventPos",1,castint(param_01[1]));
	setmatchdata("events",var_02,"eventPos",2,castint(param_01[2]));
}
...
func_4F27()
{
	...
	{
		var_00 = self method_83FB(self.clientid,self.spawnpos,self.var_78C4,self.var_8C4D);
	}
	else if(issubstr(self.curclass,"custom"))
	{
		...
		var_00 = self method_83FB(self.clientid,self.spawnpos,self.var_78C4,self.var_8C4D,var_02,var_03,var_04,var_05,var_06,var_07,var_08,var_09);
...
func_4F26(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	...
	{
		self logmatchdatalife(param_00,self.clientid,param_01,param_01.clientid,param_04,param_03,maps\mp\_utility::func_48F7(param_04),param_01 maps\mp\_utility::isjuggernaut());
	}

	self logmatchdatalife(param_00,self.clientid,undefined,undefined,param_04,param_03,maps\mp\_utility::func_48F7(param_04),0);
}
