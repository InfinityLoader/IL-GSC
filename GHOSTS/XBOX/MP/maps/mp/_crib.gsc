...
func_62AE()
{
	func_55CD("main","player_view1_start","player_view1_end");
	...
	var_04 = newradialbutton("main","Leaderboards","radial_leaderboards",::func_0805);
	func_55CD("gears","player_view2_start","player_view2_end");
	func_55CD("weapons_primary","player_view3_start","player_view3_end");
	func_55CD("weapons_secondary","player_view3_start","player_view3_end");
	func_55CD("killstreak","player_view4_start","player_view4_end");
	func_55CD("leaderboards","player_view5_start","player_view5_end");
}
...
func_62B2()
{
	foreach(var_01 in level.radial_button_group)
	{
		...
		for(var_02 = 0;var_02 < var_01.size;var_02++)
		{
			...
			{
				var_03 = func_3B2D(var_01[var_02].pos_angle,var_01[var_02 + 1].pos_angle);
				var_01[var_02].end_angle = var_03;
				var_01[var_02 + 1].start_angle = var_03;
				continue;
			}

			var_03 = func_3B2D(var_01[var_02].pos_angle,var_01[0].pos_angle) + 180;
			if(var_03 > 360)
			{
				var_03 = var_03 - 360;
			}
...
func_3989()
{
	...
	for(;;)
	{
		...
		level.rs_angle = castint(var_01[1]);
		wait(0.05);
	}
}

//Function Number: 10
func_55CD(param_00,param_01,param_02)
{
...
func_872A()
{
	...
	for(;;)
	{
		...
		{
			if(func_48E3(var_02.start_angle,var_02.end_angle))
			{
...
draw_radial_buttons(param_00)
{
	...
	{
		var_02 thread func_2A68(param_00);
	}
}
...
func_2A68(param_00)
{
	...
	var_02 = var_01 + func_62AC(self.pos_angle,4);
	for(;;)
	{
		var_03 = (1,0,0);
		if(func_48E3(self.start_angle,self.end_angle))
		{
			var_03 = (1,1,0);
		}
		...
		{
			var_04 = var_01 + func_62AC(level.rs_angle,2);
		}
...
func_8EF5(param_00,param_01)
{
	...
	{
		level.observer func_3D53(level.radial_button_group_info[level.radial_button_previous_group]["view_start"],param_00);
	}
	else
	{
...
{
	level.view_paths = [];
	func_183B("player_view1_start");
	func_183B("player_view2_start");
	func_183B("player_view3_start");
	func_183B("player_view4_start");
	func_183B("player_view5_start");
}
...
go_path_by_targetname(param_00)
{
	if(!isdefined(level.dummy_mover))
	{
		...
		wait(0.05);
		self setangles(level.dummy_mover.angles);
		thread func_34BA();
	}
