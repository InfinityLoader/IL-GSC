...
remotefiring(param_00)
{
	...
	for(;;)
	{
		...
		if(self attackbuttonpressed() && var_01 - var_02 > 3000)
		{
			...
			var_06 = anglestoright(self getangles());
			...
			var_08 missilesettargetent(param_00.targetent);
...
func_64DC(param_00)
{
	...
	for(;;)
	{
		...
		param_00.owner setclientdvar("ui_reaper_targetDistance",castint(var_01 / 12));
		wait(0.05);
	}
}
...
func_7BFE(param_00,param_01)
{
	...
	for(;;)
	{
		...
		if(var_05 < 3000 && param_00.numflares > 0)
		{
			...
			self missilesettargetent(var_06);
			param_00 = var_06;
			if(isdefined(param_00.owner))
			{
			...
			if(isdefined(var_08[var_06]))
			{
				if(var_08[var_06] < 3000 && param_00.numflares > 0)
				{
					...
					for(var_0A = 0;var_0A < param_02.size;var_0A++)
					{
						...
						{
							param_02[var_0A] missilesettargetent(var_09);
						}
					}
