 ...
 * Platform: PC
 * Function Count: 169
 * Decompile Time: 3045 ms
 * Timestamp: 10/27/2023 1:23:24 AM
*******************************************************************/
...
bcs_setup_voice(param_00,param_01,param_02,param_03)
{
	...
	{
		level.var_87B2[param_00][var_04] = spawnstruct();
...
func_604B()
{
	...
	var_00.var_195D[self.squad.var_7998] = spawnstruct();
...
addcalloutresponseevent(param_00,param_01,param_02)
{
	...
	var_03 = "affirm";
	if(!param_01.var_6637 cansee(param_02) && randomint(100) < level.eventchance["response"]["callout_negative"])
	{
		var_03 = "neg";
	}
