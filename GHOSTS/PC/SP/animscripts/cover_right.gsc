...
{
	self.animarrayfuncs = [];
	self.animarrayfuncs["hiding"]["stand"] = ::func_6E43;
	self.animarrayfuncs["hiding"]["crouch"] = ::func_6E3B;
	self endon("killanimscript");
	animscripts/utility::func_4622("cover_right");
	animscripts/corner::func_1F52("right",-90);
}
...
{
	self.var_420F = -90;
	self.a.var_ED8 = animscripts/utility::func_4F5D("cover_right_stand");
	if(isdefined(level.var_62FC))
	{
		self.a.var_ED8["rambo90"] = level.var_62FC.var_1FD0;
		self.a.var_ED8["rambo45"] = level.var_62FC.var_1FCF;
		self.a.var_ED8["grenade_rambo"] = level.var_62FC.coverrightgrenade;
	}
}
...
{
	self.var_420F = -90;
	self.a.var_ED8 = animscripts/utility::func_4F5D("cover_right_crouch");
}