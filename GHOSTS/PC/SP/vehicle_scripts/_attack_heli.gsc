 ...
 * Platform: PC
 * Function Count: 73
 * Decompile Time: 1212 ms
 * Timestamp: 10/27/2023 1:26:20 AM
*******************************************************************/
...
func_13B9(param_00,param_01)
{
	...
	if(level.gameskill == 0 || level.gameskill == 1)
	{
		...
		if(!isdefined(param_00.var_5615))
		{
			...
			{
				param_00.attractor2 = missile_createattractorent(var_02,var_03,10000,level.var_5D60);
			}
		}
	}
...
damage_feedback_setup()
{
	for(var_00 = 0;var_00 < level.players.size;var_00++)
	{
		...
		var_01.var_4310 setshader("damage_feedback",24,48);
	}
}
...
func_8E1B()
{
	...
	var_01 = common_scripts\utility::func_8E18(var_00 geteye(),var_00 getplayerangles(),self.origin,level.cosine["35"]);
	return var_01;
}
