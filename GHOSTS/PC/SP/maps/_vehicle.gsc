 ...
 * Platform: PC
 * Function Count: 92
 * Decompile Time: 1452 ms
 * Timestamp: 10/27/2023 1:26:09 AM
*******************************************************************/
...
func_544C(param_00)
{
	...
	foreach(var_03 in var_01)
	{
		...
		if(isai(var_03))
		{
			var_03 forceteleport(param_00 gettagorigin(var_04.var_7573));
			continue;
		}
...
func_784D()
{
	...
	if(isdefined(self.var_6CB4))
	{
		if(!ishelicopter())
		{
			var_00 vehphys_setspeed(self.var_6CB4);
		}
	}
...
func_8938()
{
	...
	self hide();
	thread lib_0E04::elias_house_attack_wall();
	func_544C(self.modeldummy);
	lib_6A04::func_2C54(self.modeldummy);
	func_5469(self.modeldummy);
	thread lib_4404::func_2C54(self.modeldummy);
	lib_3E04::func_2C54(self.modeldummy);
	lib_3A04::func_2C1F(self.modeldummy);
	self.modeldummyon = 1;
	if(lib_0E04::func_7340())
	{
