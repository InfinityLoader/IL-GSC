 ...
 * Timestamp: 10/27/2023 1:27:36 AM
*******************************************************************/
...
_nextmission()
{
	...
	if(level.var_52F3 func_7585(var_00))
	{
		...
		{
			changelevel(level.var_52F3 func_3B10(var_03),level.var_52F3 func_3AED(var_00),level.var_52F3 func_3AA7(var_00));
		}

		changelevel(level.var_52F3 func_3B10(var_03),level.var_52F3 func_3AED(var_00));
	}

	missionsuccess(level.var_52F3 func_3B10(var_03),level.var_52F3 func_3AED(var_00));
}

//Function Number: 4
updatesppercent()
{
	var_00 = int(func_3C50() * 100);
...
addlevel(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	...
	self.var_4DBC[var_07] = spawnstruct();
