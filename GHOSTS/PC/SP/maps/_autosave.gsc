 ...
 * Timestamp: 10/27/2023 1:27:18 AM
*******************************************************************/
...
autosavethreatcheck(param_00)
{
	...
	foreach(var_03 in var_01)
	{
		...
		{
			if(param_00 || var_03 animscripts/utility::func_19F6(0) && var_03 canshootenemy(0))
			{
				return 0;
			}
		}

		if(isdefined(var_03.a.aimidlethread) && var_03 animscripts/utility::func_19F6(0) && var_03 canshootenemy(0))
		{
			return 0;
		}
	}
