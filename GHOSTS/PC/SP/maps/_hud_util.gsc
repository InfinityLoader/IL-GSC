 ...
 * Timestamp: 10/27/2023 1:27:46 AM
*******************************************************************/
...
func_70A5(param_00,param_01,param_02,param_03)
{
	...
	{
		self.bar.x = self.x - int(self.width - self.var_8E6D * 2 / 2);
	}
...
func_86CD(param_00)
{
	var_01 = int(self.width - self.var_8E6D * 2 * param_00);
	if(!var_01)
	{
		var_01 = 1;
	}
	...
	self.bar setshader(self.bar.shader,var_01,self.height - self.var_8E9B * 2);
}
...
func_79BE(param_00)
{
	...
	level.var_79BC setshader("stance_carry",64,64);
