 ...
 * Platform: PC
 * Function Count: 150
 * Decompile Time: 2115 ms
 * Timestamp: 10/27/2023 1:16:14 AM
*******************************************************************/
...
func_269D()
{
	...
	for(;;)
	{
		...
		if(var_07 == "splash")
		{
			...
			func_2697(int(var_00),var_03,var_04,var_05,var_07);
			continue;
		}
...
destructible_update_part(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07)
{
	...
	for(;;)
	{
		...
		param_00 = int(abs(self.destructible_parts[var_0A].var_880E["health"]));
		if(param_00 < 0)
		{
		}
