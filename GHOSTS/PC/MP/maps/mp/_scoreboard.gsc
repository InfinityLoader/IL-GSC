...
func_61D4()
{
	...
	foreach(var_01 in level.players)
	{
		...
		var_01 setcommonplayerdatareservedint("common_entitlement_xp",var_01.pers["summary"]["entitlementXP"]);
		var_01 setcommonplayerdatareservedint("common_clan_wars_xp",var_01.pers["summary"]["clanWarsXP"]);
	}
}
