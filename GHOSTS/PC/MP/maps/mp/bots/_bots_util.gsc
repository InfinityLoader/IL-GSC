 ...
 * Platform: PC
 * Function Count: 77
 * Decompile Time: 1416 ms
 * Timestamp: 10/27/2023 1:17:47 AM
*******************************************************************/
...
bot_get_nodes_in_cone(param_00,param_01,param_02)
{
	...
	foreach(var_09 in var_03)
	{
		...
		if(var_0B > param_01)
		{
			if(!param_02 || isdefined(var_05) && nodesvisible(var_09,var_05,1))
			{
...
func_1672()
{
	...
	var_03 = common_scripts\utility::func_6306(botgetmemoryevents(0,gettime() - 10000,1,"death",var_01,self));
	if(isdefined(var_03))
	{
		var_00 = var_03;
...
bot_watch_nodes(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07)
{
	...
	for(;;)
	{
		...
		if(self.watch_nodes.size > 0)
		{
			...
			if(isdefined(var_17))
			{
				var_25 = (0,0,self getplayerviewheight());
