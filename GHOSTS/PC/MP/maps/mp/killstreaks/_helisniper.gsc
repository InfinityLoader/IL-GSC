 ...
 * Timestamp: 10/27/2023 1:21:01 AM
*******************************************************************/
...
createheli(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	var_0A.attractor = missile_createattractorent(var_0A,level.heli_attract_strength,level.heli_attract_range);
	...
	var_0A vehicle_setspeed(var_0A.speed,100,40);
...
func_9373(param_00)
{
	...
	param_00 vehicle_setspeed(param_00.speed,100,40);
	self.onhelisniper = 1;
