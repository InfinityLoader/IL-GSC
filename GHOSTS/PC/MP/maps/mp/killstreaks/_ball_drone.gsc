/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\mp\killstreaks\_ball_drone.gsc
 * Game: Call of Duty: Ghosts
 * Platform: PC
 * Function Count: 43
 * Decompile Time: 781 ms
 * Timestamp: 10/27/2023 1:20:31 AM
*******************************************************************/
...
createballdrone(param_00)
{
	...
	var_09 vehicle_setspeed(var_09.speed,16,16);
	var_09 setyawspeed(120,90);
	var_09 setneargoalnotifydist(16);
	...
	{
		var_09.attractor = missile_createattractorent(var_09,var_09.attract_strength,var_09.attract_range);
	}
	...
	while(var_00.size > 0)
	{
		foreach(var_02 in var_00)
		{
			while(self istouching(var_02) || self.owner istouching(var_02))
			{
				...
				{
					self.low_entry = float(var_02.script_parameters);
					continue;
				}
