 ...
 * Timestamp: 10/27/2023 1:21:11 AM
*******************************************************************/
...
func_4632()
{
	...
	for(;;)
	{
		...
		var_07 = int(tablelookup(level.global_tables["killstreakTable"].path,level.global_tables["killstreakTable"].index_col,var_00,level.global_tables["killstreakTable"].score_col));
...
func_3C16(param_00)
{
	var_01 = int(maps\mp\_utility::func_3AFC(param_00));
		...
		if(((level.teambased && param_02.owner.team != param_00.team) || !level.teambased) && param_00 != param_02.owner)
		{
			...
			if(!issquadsmode())
			{
				...
				if(var_04 <= var_03)
				{
					...
					param_00 maps\mp\gametypes\_persistence::func_7B27("misses",int(var_03 - var_04));
					param_00 maps\mp\gametypes\_persistence::func_7B27("accuracy",int(var_04 * 10000 / var_03));
				}
			}
		}
	}
