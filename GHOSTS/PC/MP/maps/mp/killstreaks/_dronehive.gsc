 ...
 * Timestamp: 10/27/2023 1:20:40 AM
*******************************************************************/
...
func_78C2(param_00,param_01)
{
	...
	{
		if(distance2dsquared(var_0D.origin,var_09) < 262144)
		{
			var_0B missile_settargetent(var_0D);
			break;
		}
	}

	var_0B setcandamage(1);
	var_0B setmissileminimapvisible(1);
