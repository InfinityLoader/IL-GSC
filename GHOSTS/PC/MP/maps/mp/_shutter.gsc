 ...
 * Timestamp: 10/27/2023 1:22:30 AM
*******************************************************************/
...
{
	level.inc = 0;
	common_scripts\utility::array_levelthread(getentarray("wire","targetname"),::func_8E17);
	...
	for(;;)
	{
		common_scripts\utility::array_levelthread(var_00,::func_7536,var_05);
		common_scripts\utility::array_levelthread(var_04,::func_7537,var_05);
