 ...
 * Platform: PC
 * Function Count: 214
 * Decompile Time: 3620 ms
 * Timestamp: 10/27/2023 1:22:00 AM
*******************************************************************/
...
setgamblerinternal()
{
		...
		for(var_05 = 0;var_05 < var_00;var_05++)
		{
			for(var_06 = 0;var_06 < var_01;var_06++)
			{
				...
				for(var_08 = 0;tablelookupbyrow("mp/perktable.csv",var_08,0) != "";var_08++)
				{
					...
					{
						level.perkcostsforgambler[var_05][var_06] = int(tablelookupbyrow("mp/perktable.csv",var_08,10));
	...
	for(var_05 = 0;var_05 < var_00;var_05++)
	{
		for(var_06 = 0;var_06 < var_01;var_06++)
		{
			...
			var_02[var_02.size] = spawnstruct();
...
func_6FF2(param_00)
{
	...
	param_00 endon("disconnect");
	common_scripts\utility::func_8AFE();
	triggerportableradarping(self.origin,param_00);
