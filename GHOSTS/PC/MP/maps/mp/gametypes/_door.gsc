...
func_29D6()
{
	...
	{
		var_00.doormovetime = max(0.1,float(var_00.script_index) / 1000);
	}
		...
		if(!param_00)
		{
			foreach(var_03 in var_01.doors)
			{
				if(isdefined(var_03.stop_sound))
				{
					...
					var_03 playsoundonmovingent(var_03.stop_sound);
				}
			}
		}
...
door_state_update_sound(param_00,param_01)
{
	...
	if(var_02.statecurr == 3 || var_02.statecurr == 1)
	{
		foreach(var_07 in var_02.doors)
		{
			...
			{
				var_07 playsoundonmovingent(var_07.start_sound);
				var_05 = lookupsoundlength(var_07.start_sound) / 1000;
				var_03 = 0;
			}
		}
