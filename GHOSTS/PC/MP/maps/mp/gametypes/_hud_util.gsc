 ...
 * Platform: PC
 * Function Count: 50
 * Decompile Time: 884 ms
 * Timestamp: 10/27/2023 1:18:33 AM
*******************************************************************/
...
ch_gettarget(param_00,param_01)
{
	if(level.challengeinfo[param_00]["type"] == 0)
	{
		return int(tablelookup("mp/allChallengesTable.csv",0,param_00,9 + param_01 - 1 * 2));
	}

	if(level.challengeinfo[param_00]["type"] == 1)
	{
		return int(tablelookup("mp/dailyChallengesTable.csv",0,param_00,9 + param_01 - 1 * 2));
	}

	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return int(tablelookup("mp/weeklyChallengesTable.csv",0,param_00,9 + param_01 - 1 * 2));
	}
}
