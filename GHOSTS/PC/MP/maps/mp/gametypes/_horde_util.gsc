 ...
 * Timestamp: 10/27/2023 1:18:27 AM
*******************************************************************/
...
func_8F93(param_00)
{
	...
	param_00.killz = int(min(param_00.killz + 1,999));
...
func_8F94(param_00)
{
	...
	param_00.numrevives = int(min(param_00.numrevives + 1,999));
...
func_8F92(param_00)
{
	...
	param_00.numcrtaescaptured = int(min(param_00.numcrtaescaptured + 1,999));
