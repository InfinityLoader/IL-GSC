 ...
 * Timestamp: 10/27/2023 1:18:58 AM
*******************************************************************/
...
func_5977(param_00,param_01)
{
	...
	if(!maps\mp\_utility::func_47BB())
	{
		...
		if(isdefined(var_03) && var_03.size)
		{
			...
			{
				self setmlgcameradefaults(var_04,var_03[var_04].origin,var_03[var_04].angles);
...
func_194A(param_00)
{
	...
	var_01 = var_01 + int(maps\mp\_utility::func_3BE4());
...
callback_playerconnect()
{
	...
	if(!isdefined(self.pers["team"]))
	{
		...
		if(issquadsmode() && getdvarint("onlinegame") == 0 && level.gametype != "horde" && isbot(self) == 0)
		{
			thread spawnspectator();
