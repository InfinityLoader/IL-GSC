 ...
 * Timestamp: 10/27/2023 1:18:35 AM
*******************************************************************/
...
populateintelchallenges()
{
	...
	for(;;)
	{
		...
		var_03 = int(tablelookupbyrow("mp/intelChallenges.csv",var_01,2));
		var_04 = int(tablelookupbyrow("mp/intelChallenges.csv",var_01,3));
		var_05 = int(tablelookupbyrow("mp/intelChallenges.csv",var_01,4)) == 1;
		var_06 = int(tablelookupbyrow("mp/intelChallenges.csv",var_01,5)) == 1;
		var_07 = int(tablelookupbyrow("mp/intelChallenges.csv",var_01,6)) == 1;
		var_01++;
		if(var_02 == "")
		{
			break;
		...
		level.intelchallengearray[var_02] = spawnstruct();
...
func_11F5(param_00)
{
	...
	var_03 = int(var_01.challengereward);
	self setclientomnvar("ui_intel_active_index",-1);
...
func_622A(param_00)
{
	...
	{
		if(distance2dsquared(self.origin,param_00.origin) > -28672)
		{
			break;
		}
