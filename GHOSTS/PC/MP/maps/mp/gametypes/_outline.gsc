 ...
 * Timestamp: 10/27/2023 1:18:52 AM
*******************************************************************/
...
func_5A46(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	...
	if(var_09.size > 0)
	{
		param_00 hudoutlineenableforclients(var_09,var_07.colorindex,var_07.depthenable);
	}
	...
	if(isdefined(param_01))
	{
		...
		foreach(var_08 in var_02.playersvisibleto)
		{
			...
			if(isdefined(var_09))
			{
				...
				{
					param_01 hudoutlineenableforclient(var_08,var_09.colorindex,var_09.depthenable);
				}

				continue;
			}

			param_01 hudoutlinedisableforclient(var_08);
		}
	}
}
...
func_5A3C(param_00)
{
	foreach(var_02 in level.outlineents)
	{
		...
		if(isdefined(var_03))
		{
			var_02 hudoutlineenableforclient(param_00,var_03.colorindex,var_03.depthenable);
		}
	}
}
