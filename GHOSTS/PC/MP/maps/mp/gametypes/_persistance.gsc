 ...
 * Timestamp: 10/27/2023 1:18:54 AM
*******************************************************************/
...
incrementrankedreservedhistory(param_00,param_01)
{
	...
	{
		var_03 = self getrankedplayerdatareservedint("kdHistoryK" + var_02 + 1);
		self setrankedplayerdatareservedint("kdHistoryK" + var_02,var_03);
		var_03 = self getrankedplayerdatareservedint("kdHistoryD" + var_02 + 1);
		self setrankedplayerdatareservedint("kdHistoryD" + var_02,var_03);
	}

	self setrankedplayerdatareservedint("kdHistoryK4",int(clamp(param_00,0,255)));
	self setrankedplayerdatareservedint("kdHistoryD4",int(clamp(param_01,0,255)));
}
