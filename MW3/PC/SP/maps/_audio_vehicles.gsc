 ...
 * Timestamp: 10/27/2023 2:21:33 AM
*******************************************************************/
...
//Function Number: 8
vmx_waittill_endon_delete(param_00)
{
...
//Function Number: 10
vmx_play_oneshot_sound(param_00)
{
	if(self.sound_playing)
	{
		vmx_stop_sound(0);
	...
	for(;;)
	{
		...
		if(vmx_get_start_sound_playing(param_00.instance_name))
		{
			if(var_11)
			{
				...
				{
					var_1A = maps\_audio::aud_map(var_02,level._audio.veh.maps[param_00.start_alias_data.pitch_map_name]);
			...
			{
				var_1B = maps\_audio::aud_map(var_02,level._audio.veh.maps[param_00.start_alias_data.vol_map_name]);
		...
		if(vmx_get_stop_sound_playing(param_00.instance_name))
		{
			if(var_12)
			{
				...
				{
					var_1A = maps\_audio::aud_map(var_02,level._audio.veh.maps[param_00.stop_alias_data.pitch_map_name]);
					var_1A = level._audio.veh.minpitch + var_1A * level._audio.veh.maxpitch - level._audio.veh.minpitch;
			...
			{
				var_1B = maps\_audio::aud_map(var_02,level._audio.veh.maps[param_00.stop_alias_data.vol_map_name]);
...
vmx_update_sound(param_00,param_01,param_02,param_03,param_04)
{
	...
	{
		var_05 = maps\_audio::aud_map(param_02,level._audio.veh.maps[param_00.pitch_map_name]);
	...
	{
		var_06 = maps\_audio::aud_map(param_02,level._audio.veh.maps[param_00.vol_map_name]);
	}
