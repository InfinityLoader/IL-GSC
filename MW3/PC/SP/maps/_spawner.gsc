 ...
 * Platform: PC
 * Function Count: 204
 * Decompile Time: 3442 ms
 * Timestamp: 10/27/2023 2:19:29 AM
*******************************************************************/
...
spawn_prethink()
{
	...
	for(;;)
	{
		...
		var_02.spawn_funcs = self.spawn_functions;
		var_02.spawner = self;
...
run_spawn_functions()
{
	...
	{
		for(var_00 = 0;var_00 < level.spawn_funcs[self.team].size;var_00++)
		{
			var_01 = level.spawn_funcs[self.team][var_00];
			if(isdefined(var_01["param5"]))
			{
				thread [[ var_01["function"] ]](var_01["param1"],var_01["param2"],var_01["param3"],var_01["param4"],var_01["param5"]);
				continue;
...
spawn_think_script_inits()
{
	...
	{
		self.nodrop = self.script_wiiallowragdoll;
	}
}
...
//Function Number: 74
go_to_node(param_00,param_01,param_02,param_03)
{
	if(isdefined(self.used_an_mg42))
	{
		return;
	...
	go_to_node_using_funcs(var_04["destination"],var_04["get_target_func"],var_04["set_goal_func_quits"],param_02,param_03);
}
...
//Function Number: 77
go_to_node_using_funcs(param_00,param_01,param_02,param_03,param_04)
{
	...
	for(;;)
	{
		...
		if(isdefined(param_00.script_requires_player))
		{
			...
			{
				var_05 = param_00.script_requires_player;
			}
...
newfallback_overmind(param_00,param_01)
{
	...
	for(var_04 = 0;var_04 < var_05.size;var_04++)
	{
		if(isdefined(var_05[var_04].script_fallback) && var_05[var_04].script_fallback == param_00)
		{
			...
			{
				var_05[var_04] thread fallback_spawner_think(param_00,var_02[randomint(var_02.size)]);
	...
	for(var_04 = 0;var_04 < var_06.size;var_04++)
	{
		if((isdefined(var_06[var_04].script_fallback) && var_06[var_04].script_fallback == param_00) || isdefined(var_06[var_04].script_fallback_group) && isdefined(param_01) && var_06[var_04].script_fallback_group == param_01)
		{
...
fallback_text(param_00,param_01,param_02)
{
	...
	while(var_03 < param_02)
	{
		...
		param_00[var_03] animscripts/face::func_C46(undefined,var_06,1);
		return;
		var_06++;
	}
}
...
spawner_makerealai(param_00)
{
	...
	var_04 = maps\_utility::spawn_failed(var_03);
	if(var_04)
	{
	}

	var_03.vehicle_idling = param_00.vehicle_idling;
	var_03.vehicle_position = param_00.vehicle_position;
	var_03.standing = param_00.standing;
	var_03.forcecolor = param_00.forcecolor;
...
death_achievements()
{
	...
	thread achieve_serrated_edge(var_00,var_01,var_02);
...
//Function Number: 199
achieve_serrated_edge(param_00,param_01,param_02)
{
