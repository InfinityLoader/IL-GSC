 ...
 * Timestamp: 10/27/2023 2:24:05 AM
*******************************************************************/
...
burst_fire_unmanned()
{
	...
	if(isdefined(self.var_7E6))
	{
		var_01 = self.var_7E6 - var_00;
	}
	else
	{
...
burst_fire(param_00,param_01)
{
	...
	if(isdefined(param_00.var_7E6))
	{
		var_03 = param_00.var_7E6 - var_02;
	}
	else
	{
...
mg42_think()
{
	...
	for(;;)
	{
		...
		{
			wait self.script_delay_min + randomfloat(self.var_7E6 - self.script_delay_min);
			continue;
		}
...
mg42_target_drones(param_00,param_01,param_02)
{
	...
	for(;;)
	{
		...
		while(level.drones[var_06].lastindex)
		{
			...
			{
				common_scripts\utility::eog_newstar("mg42_drones");
				break;
			}
...
drone_target(param_00,param_01,param_02)
{
	...
	while(var_03 > gettime() || var_04)
	{
		...
		{
			common_scripts\utility::eog_newstar("mg42_drones_target_trace");
			break;
		}
...
{
	var_01 = [];
	return var_7B[var_01.weaponinfo];
}
...
run_to_new_spot_and_setup_gun(param_00)
{
	...
	wait 0.05;
	common_scripts\utility::set_all_exceptions(::animscripts/combat::func_114F);
...
{
	var_01 = [];
	var_7B = maps\_utility::array_randomize(var_7B);
	for(var_02 = 0;var_02 < var_7B.size;var_02++ = var_7B["spot"])
	{
		var_03 = [[ var_7B[var_02] ]](var_01);
