 ...
 * Timestamp: 10/27/2023 2:22:33 AM
*******************************************************************/
...
debugchains()
{
	...
	for(;;)
	{
		if(getdvar("chain") == "1")
		{
			...
			{
				var_06 = var_05[var_03] animscripts/utility::func_BEE();
				if(isdefined(var_06))
				{
				}
			}
...
debug_enemyposproc()
{
	...
	for(;;)
	{
		...
		var_00 = animscripts/utility::func_CEE();
	}
}
...
debug_enemyposreplay()
{
	...
	if(!var_01 animscripts/utility::func_F8C())
	{
		return;
	}

	var_06 = var_01 animscripts/utility::func_CEE();
	if(isdefined(var_01.goodshootpos))
	{
	}
}
...
debug_colornodes()
{
	...
	var_00 = getaiarray();
	var_01 = [];
	for(var_02 = 0;var_02 < var_01.size;var_02++ = var_7B["neutral"])
	{
		var_03 = var_01[var_02];
		...
		var_7B[var_03.team][var_03.currentcolorcode] = 1;
		var_04 = (1,1,1);
	...
	draw_colornodes(var_7B,"allies");
	draw_colornodes(var_7B,"axis");
}
...
draw_color_friendlies()
{
	...
	{
		var_05 = level.debug_color_friendlies[var_01[var_04]];
		var_02[var_05]++ = "p";
		var_04++ = var_7B[var_7B.size];
	}
	...
	var_08 = 25;
	var_09 = 25;
	for(var_04 = 0;var_04 < var_7B.size;var_04++ = "c")
	{
		if(var_02[var_7B[var_04]] <= 0)
		{
			continue;
		}

		var_0A = 0;
		while(var_0A < var_02[var_7B[var_04]])
		{
			var_0B = newhudelem();
			...
			var_0B.alpha = 1;
			var_0B.color = var_03[var_7B[var_04]];
			level.debug_color_huds[level.debug_color_huds.size] = var_0B;
			var_0A++ = var_7B[var_7B.size];
		}
...
colordebug()
{
	...
	for(;;)
	{
		...
		{
			var_02 = level.currentcolorforced["allies"][var_7B[var_01]];
			if(isdefined(var_02))
			{
...
draw_animsounds_in_hud()
{
	...
	{
		var_04 = level.animsound_hud[var_03];
		var_04.label = "";
		var_04.color = (1,1,1);
		var_04 = level.animsound_hud_timer[var_03];
		var_04.label = "";
		var_04.color = (1,1,1);
	...
	if(level.animsound_selected > var_06)
	{
		level.animsound_selected = var_06;
	}
	...
	for(;;)
	{
		if(isdefined(var_01[level.animsound_selected]))
		{
			break;
		}
	...
	level.animsound_hud_anime.label = "Anim: " + var_01[level.animsound_selected].anime;
	...
	{
		var_09 = var_01[level.animsound_selected];
		var_0A = get_alias_from_stored(var_09);
		if(!isdefined(var_0A))
		{
			return;
