 ...
 * Platform: PC
 * Function Count: 109
 * Decompile Time: 12058 ms
 * Timestamp: 10/27/2023 2:24:50 AM
*******************************************************************/
...
updategameskill()
{
	...
	level.so_enable_wait_for_players = level.player.gameskill;
	if(maps\_utility::is_coop() && level.player2.gameskill < level.so_enable_wait_for_players)
	{
		level.so_enable_wait_for_players = level.player2.gameskill;
	}
...
resetmisstime()
{
	...
	if(!animscripts/weaponlist::func_CCA() && !animscripts/weaponlist::func_CCB())
	{
		self.misstime = 0;
		return;
	}
...
playerhurtcheck()
{
	...
	for(;;)
	{
		self waittill(var_00,var_7B["MOD_GRENADE"],var_01,var_7B["MOD_GRENADE_SPLASH"],var_01,var_7B["MOD_PROJECTILE"],var_01,var_7B["MOD_PROJECTILE_SPLASH"],var_01,var_7B["MOD_EXPLOSIVE"],var_02,var_7B["MOD_PISTOL_BULLET"],var_02,var_7B["MOD_RIFLE_BULLET"],var_02,var_7B["MOD_EXPLOSIVE_BULLET"],"damage",var_03,var_04,var_05,var_06,var_07);
		self.hurtagain = 1;
		...
		if(!isdefined(var_08) && isdefined(var_7B[var_07]))
		{
...
auto_adust_zone_complete(param_00)
{
	...
	var_17 = [];
	level.auto_adjust_results[var_01] = var_7B;
	var_18 = "Completed AA sequence: ";
	var_18 = var_18 + level.script + "/" + var_01;
	var_19 = getarraykeys(var_7B);
	for(var_1A = 0;var_1A < var_19.size;var_1A++ = var_7B["gameskill"])
	{
		var_18 = var_18 + ", " + var_19[var_1A] + ": " + var_7B[var_19[var_1A]];
	}
...
add_fractional_data_point(param_00,param_01,param_02)
{
	...
	var_03 = [];
	level.difficultysettings_frac_data_points[param_01][level.difficultysettings_frac_data_points[param_01].size] = var_7B;
}
