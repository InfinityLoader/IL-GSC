 ...
 * Platform: PC
 * Function Count: 36
 * Decompile Time: 700 ms
 * Timestamp: 10/27/2023 2:14:33 AM
*******************************************************************/
...
setcarryingturret(param_00,param_01)
{
	...
	for(;;)
	{
		...
		if(var_02 == "cancel_turret" || var_02 == "force_cancel_placement")
		{
			...
			var_03 = maps\mp\killstreaks\_killstreaks::getkillstreakweapon(level.turretsettings[param_00.turrettype].streakname);
...
createturretforplayer(param_00,param_01)
{
	...
	var_02 thread turret_handleownerdisconnect();
	...
	var_02.damagefade = 1;
	var_02 thread turret_incrementdamagefade();
...
stopusingremoteturret()
{
	...
	if(var_00 maps\mp\_utility::isusingremote())
	{
		...
		var_01 = maps\mp\killstreaks\_killstreaks::getkillstreakweapon(level.turretsettings[self.turrettype].streakname);
...
watchenterandexit()
{
	...
	for(;;)
	{
		...
		if(maps\mp\_utility::iskillstreakweapon(var_01) && var_01 != level.turretsettings[self.turrettype].weaponinfo && var_01 != level.turretsettings[self.turrettype].laptopinfo && var_01 != level.turretsettings[self.turrettype].remoteinfo && var_01 != "none" && !var_00 maps\mp\_utility::isjuggernaut() || var_00 maps\mp\_utility::isusingremote())
		{
			if(!isdefined(var_00.var_3668) || !var_00.var_3668)
			{
				var_00.var_3668 = 1;
				var_00 maps\mp\_utility::clearlowermessage("enter_remote_turret");
			}
		...
		if(isdefined(var_00.var_3668) && var_00.var_3668 && var_01 != "none")
		{
			var_00 maps\mp\_utility::setlowermessage("enter_remote_turret",level.turretsettings[self.turrettype].hintenter,undefined,undefined,undefined,1,0.25,1.5,1);
			var_00.var_3668 = 0;
		}
