 ...
 * Platform: PC
 * Function Count: 85
 * Decompile Time: 1328 ms
 * Timestamp: 10/27/2023 2:12:42 AM
*******************************************************************/
...
ch_vehicle_kills(param_00)
{
	...
	if(!isdefined(var_01.pers[param_00.sweapon + "_streak"]))
	{
...
ch_kills(param_00,param_01)
{
	...
	foreach(var_0C in var_02.killsthislife)
	{
		...
		if(maps\mp\_utility::iskillstreakweapon(var_0C.sweapon))
		{
		...
		{
			if(!isdefined(var_07[var_0C.victim.name]) && !isdefined(var_08[var_0C.sweapon]) && !maps\mp\_utility::iskillstreakweapon(var_0C.sweapon))
			{
				var_09++;
			}
	...
	if(var_02 isitemunlocked("specialty_twoprimaries") && var_02 maps\mp\_utility::_hasperk("specialty_twoprimaries") && var_02.secondaryweapon == param_00.sweapon)
	{
	...
	if(isdefined(var_02.infinalstand) && var_02.infinalstand)
	{
		...
		if(maps\mp\_utility::isstrstart(param_00.sweapon,"c4_"))
		{
	...
	if(param_00.smeansofdeath == "MOD_PISTOL_BULLET" || param_00.smeansofdeath == "MOD_RIFLE_BULLET")
	{
		...
		ch_bulletdamagecommon(param_00,var_02,param_01,var_12);
	...
	{
		if(maps\mp\_utility::isstrstart(param_00.sweapon,"frag_grenade_short") && !isdefined(param_00.victim.explosiveinfo["throwbackKill"]) || !param_00.victim.explosiveinfo["throwbackKill"])
		{
		...
		if(isdefined(param_00.victim.explosiveinfo["damageTime"]) && param_00.victim.explosiveinfo["damageTime"] == param_01)
		{
			...
			else if(maps\mp\_utility::isstrstart(param_00.sweapon,"semtex_"))
			{
				if(isdefined(param_00.modifiers["revenge"]))
				{
			...
			else if(maps\mp\_utility::isstrstart(param_00.sweapon,"c4_"))
			{
				if(isdefined(param_00.modifiers["revenge"]))
				{
			...
			else if(maps\mp\_utility::isstrstart(param_00.sweapon,"claymore_"))
			{
				if(isdefined(param_00.modifiers["revenge"]))
				{
			...
			else if(maps\mp\_utility::isstrstart(param_00.sweapon,"bouncingbetty_"))
			{
			...
			else if(maps\mp\_utility::isstrstart(param_00.sweapon,"rpg_") || maps\mp\_utility::isstrstart(param_00.sweapon,"at4_") || maps\mp\_utility::isstrstart(param_00.sweapon,"iw5_smaw_"))
			{
				if(var_02.explosivekills[var_14] > 1)
				{
	...
	else if(issubstr(param_00.smeansofdeath,"MOD_IMPACT"))
	{
		...
		else if(maps\mp\_utility::isstrstart(param_00.sweapon,"concussion_"))
		{
			var_02 processchallenge("ch_thinkfastconcussion");
		}
		else if(maps\mp\_utility::isstrstart(param_00.sweapon,"flash_"))
		{
	...
	else if(param_00.smeansofdeath == "MOD_HEAD_SHOT")
	{
		...
		else if(maps\mp\_utility::isstrstart(param_00.sweapon,"frag_"))
		{
			var_02 processchallenge("ch_thinkfast");
		}
		else if(maps\mp\_utility::isstrstart(param_00.sweapon,"concussion_"))
	...
	if((param_00.smeansofdeath == "MOD_PISTOL_BULLET" || param_00.smeansofdeath == "MOD_RIFLE_BULLET" || param_00.smeansofdeath == "MOD_HEAD_SHOT") && !maps\mp\_utility::iskillstreakweapon(param_00.sweapon) && !maps\mp\_utility::isenvironmentweapon(param_00.sweapon))
	{
		var_15 = maps\mp\_utility::getweaponattachments(param_00.sweapon);
		var_13 = maps\mp\_utility::getbaseweaponname(param_00.sweapon);
		foreach(var_17 in var_15)
		...
		if(var_02 isitemunlocked("specialty_autospot") && var_02 maps\mp\_utility::_hasperk("specialty_autospot") && var_02.holdingbreath && var_02 playerads())
		{
			var_02 processchallenge("ch_autospot_pro");
		}

		if(var_02 isitemunlocked("specialty_bulletaccuracy") && var_02 maps\mp\_utility::_hasperk("specialty_bulletaccuracy") && !var_02 playerads())
		{
			var_02 processchallenge("ch_bulletaccuracy_pro");
		}

		if(var_02 isitemunlocked("specialty_stalker") && var_02 maps\mp\_utility::_hasperk("specialty_stalker") && var_02 playerads())
		{
		...
		if(var_02 isitemunlocked("specialty_fastreload") && var_02 maps\mp\_utility::_hasperk("specialty_fastreload"))
		{
			var_02 processchallenge("ch_sleightofhand_pro");
		}

		if(var_02 maps\mp\_utility::isbuffunlockedforweapon("specialty_marksman",var_13) && var_02 maps\mp\_utility::isbuffequippedonweapon("specialty_marksman",var_13) && var_02 maps\mp\_utility::_hasperk("specialty_marksman") && var_02 playerads())
		{
		...
		if(param_00.victim.idflagstime == param_01)
		{
			...
			{
				if(var_02 maps\mp\_utility::isbuffunlockedforweapon("specialty_bulletpenetration",var_13) && var_02 maps\mp\_utility::isbuffequippedonweapon("specialty_bulletpenetration",var_13) && var_02 maps\mp\_utility::_hasperk("specialty_bulletpenetration"))
				{
		...
		if(var_02 maps\mp\_utility::isbuffunlockedforweapon("specialty_bling",var_13) && var_02 maps\mp\_utility::isbuffequippedonweapon("specialty_bling",var_13) && var_02 maps\mp\_utility::_hasperk("specialty_bling") && var_15.size > 1)
		{
			var_02 processchallenge("ch_blingbling");
		}

		if(var_02 maps\mp\_utility::isbuffunlockedforweapon("specialty_sharp_focus",var_13) && var_02 maps\mp\_utility::isbuffequippedonweapon("specialty_sharp_focus",var_13) && var_02 maps\mp\_utility::_hasperk("specialty_sharp_focus") && var_02.health < var_02.maxhealth && isdefined(var_02.attackers))
		{
			foreach(var_1D in var_02.attackers)
			{
				if(var_1D == param_00.victim)
		...
		if(var_02 maps\mp\_utility::isbuffunlockedforweapon("specialty_holdbreathwhileads",var_13) && var_02 maps\mp\_utility::isbuffequippedonweapon("specialty_holdbreathwhileads",var_13) && var_02 maps\mp\_utility::_hasperk("specialty_holdbreathwhileads") && var_02.holdingbreath && var_02 playerads())
		{
			var_02 processchallenge("ch_holditrightthere");
		}

		if(var_02 maps\mp\_utility::isbuffunlockedforweapon("specialty_reducedsway",var_13) && var_02 maps\mp\_utility::isbuffequippedonweapon("specialty_reducedsway",var_13) && var_02 maps\mp\_utility::_hasperk("specialty_reducedsway") && var_02 playerads())
		{
			var_02 processchallenge("ch_swayless");
		}

		if(var_02 maps\mp\_utility::isbuffunlockedforweapon("specialty_longerrange",var_13) && var_02 maps\mp\_utility::isbuffequippedonweapon("specialty_longerrange",var_13) && var_02 maps\mp\_utility::_hasperk("specialty_longerrange"))
		{
			var_02 processchallenge("ch_longishshot");
		}

		if(var_02 maps\mp\_utility::isbuffunlockedforweapon("specialty_lightweight",var_13) && var_02 maps\mp\_utility::isbuffequippedonweapon("specialty_lightweight",var_13) && var_02 maps\mp\_utility::_hasperk("specialty_lightweight"))
		{
			var_02 processchallenge("ch_lightweight");
		}

		if(var_02 maps\mp\_utility::isbuffunlockedforweapon("specialty_moredamage",var_13) && var_02 maps\mp\_utility::isbuffequippedonweapon("specialty_moredamage",var_13) && var_02 maps\mp\_utility::_hasperk("specialty_moredamage"))
		{
	...
	{
		var_13 = maps\mp\_utility::getbaseweaponname(param_00.sweapon);
		if(var_02 maps\mp\_utility::isbuffunlockedforweapon("specialty_fastermelee",var_13) && var_02 maps\mp\_utility::isbuffequippedonweapon("specialty_fastermelee",var_13) && var_02 maps\mp\_utility::_hasperk("specialty_fastermelee"))
		{
	...
	if(var_02 isitemunlocked("specialty_coldblooded") && var_02 maps\mp\_utility::_hasperk("specialty_coldblooded"))
	{
		if(level.teambased)
		{
			var_27 = 0;
	...
	if(var_02 isitemunlocked("specialty_empimmune") && var_02 maps\mp\_utility::_hasperk("specialty_empimmune"))
	{
		if(level.teambased)
		{
			...
			if(var_2F || var_02 maps\mp\_utility::isemped())
			{
				var_02 processchallenge("ch_spygame");
			}
		}
		else if(var_02.isradarblocked || var_02 maps\mp\_utility::isemped())
		{
			var_02 processchallenge("ch_spygame");
		}
	}
...
vehiclekilled(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	...
	var_07.time = gettime();
	if(isdefined(param_03) && isplayer(param_03) && !isdefined(param_00) || param_03 != param_00 && !maps\mp\_utility::iskillstreakweapon(param_06))
	{
		...
		switch(param_06)
		{
			...
			case "iw5_smaw_mp":
			case "stinger_mp":
				if(param_03 isitemunlocked("specialty_fasterlockon") && param_03 maps\mp\_utility::_hasperk("specialty_fasterlockon"))
				{
		...
		if(param_03 isitemunlocked("specialty_blindeye") && param_03 maps\mp\_utility::_hasperk("specialty_blindeye"))
		{
			var_09 = 1;
...
processchallenge(param_00,param_01,param_02)
{
	...
	if(var_07)
	{
		...
		maps\mp\_matchdata::logchallenge(param_00,var_03);
...
updatechallenges()
{
	...
	foreach(var_0D, var_02 in level.challengeinfo)
	{
		...
		{
			var_03 = getweaponfromchallenge(var_0D);
			if(!self isitemunlocked(var_03))
			{
				continue;
			}

			var_04 = getweaponattachmentfromchallenge(var_0D);
			if(isdefined(var_04))
			{
		...
		else if(iskillstreakchallenge(var_0D))
		{
			...
			var_05 = getkillstreakfromchallenge(var_0D);
			if(isdefined(var_05))
			{
		...
		else
		{
			...
			{
				var_07 = getchallengefilter(var_0D);
				if(var_07 != "")
				{
					var_08 = getchallengetable(var_07);
					if(var_08 != "")
					{
						var_09 = gettierfromtable(var_08,var_0D);
						if(var_09 != "")
						{
		...
		{
			var_0B = maps\mp\gametypes\_hud_util::getweeklyref(var_0D);
			if(var_0B == "")
			{
				continue;
			}
...
isweaponchallenge(param_00)
{
	...
	for(var_03 = 0;var_03 < var_02.size;var_03++)
	{
		...
		if(maps\mp\gametypes\_class::isvalidprimary(var_04,0) || maps\mp\gametypes\_class::isvalidsecondary(var_04,"specialty_null","specialty_null",0))
		{
			return 1;
		}
	}
...
buildchallegeinfo()
{
	...
	var_00 = var_00 + buildchallengetableinfo("mp/dailychallengesTable.csv",1);
	var_00 = var_00 + buildchallengetableinfo("mp/weeklychallengesTable.csv",2);
...
monitorweaponswap()
{
	...
	for(;;)
	{
		...
		if(maps\mp\_utility::iskillstreakweapon(var_01) || maps\mp\_utility::isdeathstreakweapon(var_01))
		{
			continue;
		}
