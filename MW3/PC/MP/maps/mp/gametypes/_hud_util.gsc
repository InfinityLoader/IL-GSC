 ...
 * Platform: PC
 * Function Count: 48
 * Decompile Time: 690 ms
 * Timestamp: 10/27/2023 2:12:35 AM
*******************************************************************/
...
ch_getprogress(param_00)
{
	...
	{
		return self getplayerdata("challengeProgress",getweeklyref(param_00));
	}
}
...
ch_getstate(param_00)
{
	...
	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return self getplayerdata("challengeState",getweeklyref(param_00));
	}
}
...
ch_setprogress(param_00,param_01)
{
	...
	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return self setplayerdata("challengeProgress",getweeklyref(param_00),param_01);
	}
}
...
ch_setstate(param_00,param_01)
{
	...
	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return self setplayerdata("challengeState",getweeklyref(param_00),param_01);
	}
}
