 ...
 * Timestamp: 10/27/2023 2:12:32 AM
*******************************************************************/
...
killstreaksplashnotify(param_00,param_01,param_02)
{
	...
	var_03.sound = maps\mp\killstreaks\_killstreaks::getkillstreaksound(param_00);
...
challengesplashnotify(param_00)
{
	...
	if(param_00 == "ch_longersprint_pro")
	{
...
//Function Number: 14
splashnotify(param_00,param_01)
{
	self endon("disconnect");
	wait 0.05;
	var_02 = spawnstruct();
...
actionnotifymessage(param_00)
{
	...
	if(tablelookup("mp/splashTable.csv",0,param_00.name,0) != "")
	{
		...
		self.doingsplash[var_01] = param_00;
		var_02 = maps\mp\_utility::stringtofloat(tablelookup("mp/splashTable.csv",0,param_00.name,4));
		if(isdefined(param_00.sound))
		{
			self playlocalsound(param_00.sound);
		}
...
teamoutcomenotify(param_00,param_01,param_02)
{
	...
	{
		var_14 setvalue(lib_036E::func_2B96(var_03));
	}
	else
	{
	...
	if(!maps\mp\_utility::isroundbased() || !maps\mp\_utility::isobjectivebased())
	{
		var_15 setvalue(lib_036E::func_2B96(level.otherteam[var_03]));
	}
	else
	{
	...
	thread resetteamoutcomenotify(var_10,var_11,var_12,var_13,var_14,var_15,var_16);
}
...
outcomenotify(param_00,param_01)
{
	...
	thread updateoutcome(var_10,var_11,var_12);
	thread resetoutcomenotify(var_0D,var_0F,var_10,var_11,var_12,var_13);
}

//Function Number: 32
resetoutcomenotify(param_00,param_01,param_02,param_03,param_04,param_05)
{
	self endon("disconnect");
...
//Function Number: 33
resetteamoutcomenotify(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	self endon("disconnect");
	self waittill("reset_outcome");
	if(isdefined(param_00))
...
//Function Number: 34
updateoutcome(param_00,param_01,param_02)
{
	self endon("disconnect");
	self endon("reset_outcome");
	for(;;)
