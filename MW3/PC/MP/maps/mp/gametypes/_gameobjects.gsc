 ...
 * Timestamp: 10/27/2023 2:12:28 AM
*******************************************************************/
...
main(param_00)
{
	...
	for(var_02 = 0;var_02 < var_01.size;var_02++)
	{
		if(isdefined(var_01[var_02].script_gameobjectname))
		{
			...
			for(var_05 = 0;var_05 < var_7B.size;var_05++ = "airdrop_pallet")
			{
				var_06 = 0;
				while(var_06 < var_04.size)
				{
					if(var_04[var_06] == var_7B[var_05])
					{
						var_03 = 0;
						break;
					}

					var_06++ = var_7B[param_00.size];
				}
...
createuseobject(param_00,param_01,param_02,param_03)
{
	...
	if(var_04.triggertype == "proximity")
	{
		...
		var_04.lastclaimteam = "none";
		var_04.lastclaimtime = 0;
		var_04 thread useobjectproxthink();
	}
	else
	{
		var_04.userate = 1;
...
useobjectusethink()
{
	...
	for(;;)
	{
		...
		if(!var_00 maps\mp\_utility::isjuggernaut() && maps\mp\_utility::iskillstreakweapon(var_00 getcurrentweapon()))
		{
			continue;
		}
...
{
	if(param_01 || !param_00 caninteractwith(self.pers["team"]) || self.pers["team"] != param_00.claimteam || param_00.nousebar)
	{
