 ...
 * Timestamp: 10/27/2023 2:12:15 AM
*******************************************************************/
...
//Function Number: 13
cac_getkillstreak(param_00,param_01,param_02)
{
	var_03 = undefined;
	switch(param_01)
	{
...
cloneloadout()
{
	...
	{
		var_1A = getclassindex(var_19);
		var_04 = "none";
		var_05 = "none";
		var_06 = cac_getweapon(var_1A,0);
		var_07 = cac_getweaponattachment(var_1A,0);
		var_04 = cac_getweaponattachmenttwo(var_1A,0);
		var_08 = cac_getweaponbuff(var_1A,0);
		var_09 = cac_getweaponcamo(var_1A,0);
		var_0A = cac_getweaponreticle(var_1A,0);
		var_0B = cac_getweapon(var_1A,1);
		var_0C = cac_getweaponattachment(var_1A,1);
		var_05 = cac_getweaponattachmenttwo(var_1A,1);
		var_0D = cac_getweaponbuff(var_1A,1);
		var_0E = cac_getweaponcamo(var_1A,1);
		var_0F = cac_getweaponreticle(var_1A,1);
		var_10 = cac_getperk(var_1A,0);
		var_11 = cac_getperk(var_1A,1);
		var_12 = cac_getperk(var_1A,2);
		var_13 = cac_getperk(var_1A,3);
		var_14 = cac_getperk(var_1A,5);
		var_15 = cac_getkillstreak(var_1A,var_14,0);
		var_16 = cac_getkillstreak(var_1A,var_14,1);
		var_17 = cac_getkillstreak(var_1A,var_14,2);
		var_18 = cac_getoffhand(var_1A);
		var_19 = cac_getdeathstreak(var_1A);
	}
	else
	{
		var_1A = getclassindex(var_1A);
		var_06 = table_getweapon(level.classtablename,var_1A,0);
		var_07 = table_getweaponattachment(level.classtablename,var_1A,0,0);
		var_04 = table_getweaponattachment(level.classtablename,var_1A,0,1);
		var_08 = table_getweaponbuff(level.classtablename,var_1A,0);
		var_09 = table_getweaponcamo(level.classtablename,var_1A,0);
		var_0A = table_getweaponreticle(level.classtablename,var_1A,0);
		var_0B = table_getweapon(level.classtablename,var_1A,1);
		var_0C = table_getweaponattachment(level.classtablename,var_1A,1,0);
		var_05 = table_getweaponattachment(level.classtablename,var_1A,1,1);
		var_0D = table_getweaponbuff(level.classtablename,var_1A,1);
		var_0E = table_getweaponcamo(level.classtablename,var_1A,1);
		var_0F = table_getweaponreticle(level.classtablename,var_1A,1);
		var_10 = table_getequipment(level.classtablename,var_1A,0);
		var_11 = table_getperk(level.classtablename,var_1A,1);
		var_12 = table_getperk(level.classtablename,var_1A,2);
		var_13 = table_getperk(level.classtablename,var_1A,3);
		var_14 = table_getperk(level.classtablename,var_1A,5);
...
giveloadout(param_00,param_01,param_02,param_03)
{
	...
	else if(var_17 != "none")
	{
		...
		if(var_0C == "throwingknife" && var_12 != "none")
		{
			var_0C = var_12;
			var_0D = var_13;
			var_0E = var_14;
		...
		else if(var_0C == "throwingknife" && var_12 == "none")
		{
			var_07 = 1;
			var_0C = "iw5_usp45";
			var_0D = "tactical";
		...
		if(var_12 != "none" && !isvalidsecondary(var_12,var_1A,var_1B,0))
		{
			var_12 = table_getweapon(level.classtablename,10,1);
		}
	...
	{
		var_21 = getclassindex(var_14);
		self.class_num = var_21;
		var_0C = cac_getweapon(var_21,0);
		var_0D = cac_getweaponattachment(var_21,0);
		var_0E = cac_getweaponattachmenttwo(var_21,0);
		var_0F = cac_getweaponbuff(var_21,0);
		var_10 = cac_getweaponcamo(var_21,0);
		var_11 = cac_getweaponreticle(var_21,0);
		var_12 = cac_getweapon(var_21,1);
		var_13 = cac_getweaponattachment(var_21,1);
		var_14 = cac_getweaponattachmenttwo(var_21,1);
		var_15 = cac_getweaponbuff(var_21,1);
		var_16 = cac_getweaponcamo(var_21,1);
		var_17 = cac_getweaponreticle(var_21,1);
		var_18 = cac_getperk(var_21,0);
		var_19 = cac_getperk(var_21,1);
		var_1A = cac_getperk(var_21,2);
		var_1B = cac_getperk(var_21,3);
		var_1C = cac_getperk(var_21,5);
	...
	else if(var_14 == "gamemode")
	{
		...
		if(!maps\mp\_utility::isjuggernaut() && var_22["loadoutJuggernaut"])
		{
			self.isjuggernaut = 1;
			thread maps\mp\_utility::recipeclassapplyjuggernaut();
		}
	...
	else
	{
		var_21 = getclassindex(var_14);
		self.class_num = var_21;
		var_0C = table_getweapon(level.classtablename,var_21,0);
		var_0D = table_getweaponattachment(level.classtablename,var_21,0,0);
		var_0E = table_getweaponattachment(level.classtablename,var_21,0,1);
		var_0F = table_getweaponbuff(level.classtablename,var_21,0);
		var_10 = table_getweaponcamo(level.classtablename,var_21,0);
		var_11 = table_getweaponreticle(level.classtablename,var_21,0);
		var_12 = table_getweapon(level.classtablename,var_21,1);
		var_13 = table_getweaponattachment(level.classtablename,var_21,1,0);
		var_14 = table_getweaponattachment(level.classtablename,var_21,1,1);
		var_15 = table_getweaponbuff(level.classtablename,var_21,1);
		var_16 = table_getweaponcamo(level.classtablename,var_21,1);
		var_17 = table_getweaponreticle(level.classtablename,var_21,1);
		var_18 = table_getequipment(level.classtablename,var_21,0);
		var_19 = table_getperk(level.classtablename,var_21,1);
		var_1A = table_getperk(level.classtablename,var_21,2);
		var_1B = table_getperk(level.classtablename,var_21,3);
		var_1C = table_getperk(level.classtablename,var_21,5);
	...
	{
		if(!isvalidprimary(var_0C) || level.rankedmatch && var_23 && !self isitemunlocked(var_0C))
		{
			var_0C = table_getweapon(level.classtablename,10,0);
		}

		if(!isvalidattachment(var_0D) || level.rankedmatch && var_23 && !isattachmentunlocked(var_0C,var_0D))
		{
			var_0D = table_getweaponattachment(level.classtablename,10,0,0);
		}

		if(!isvalidattachment(var_0E) || level.rankedmatch && var_23 && !isattachmentunlocked(var_0C,var_0E))
		{
			var_0E = table_getweaponattachment(level.classtablename,10,0,1);
		}

		if(!isvalidweaponbuff(var_0F) || level.rankedmatch && var_23 && !isweaponbuffunlocked(var_0C,var_0F))
		{
			var_0F = table_getweaponbuff(level.classtablename,10,0);
		}

		if(!isvalidcamo(var_10) || level.rankedmatch && var_23 && !iscamounlocked(var_0C,var_10))
		{
			var_10 = table_getweaponcamo(level.classtablename,10,0);
		}

		if(!isvalidreticle(var_11))
		{
			var_11 = table_getweaponreticle(level.classtablenum,10,0);
		}

		if(!isvalidsecondary(var_12,var_1A,var_1B) || level.rankedmatch && level.rankedmatch && var_23 && !self isitemunlocked(var_12))
		{
			var_12 = table_getweapon(level.classtablename,10,1);
		}

		if(!isvalidattachment(var_13) || level.rankedmatch && var_23 && !isattachmentunlocked(var_12,var_13))
		{
			var_13 = table_getweaponattachment(level.classtablename,10,1,0);
		}

		if(!isvalidattachment(var_14) || level.rankedmatch && var_23 && !isattachmentunlocked(var_12,var_14))
		{
			var_14 = table_getweaponattachment(level.classtablename,10,1,1);
		}

		if((var_1A == "specialty_twoprimaries" && !isvalidweaponbuff(var_15)) || level.rankedmatch && var_23 && !self isitemunlocked(var_12 + " " + var_15))
		{
			var_15 = table_getweaponbuff(level.classtablename,10,1);
		}

		if(!isvalidcamo(var_16) || level.rankedmatch && var_23 && !iscamounlocked(var_12,var_16))
		{
			var_16 = table_getweaponcamo(level.classtablename,10,1);
		}

		if(!isvalidreticle(var_17))
		{
			var_17 = table_getweaponreticle(level.classtablename,10,1);
		}

		if(!isvalidequipment(var_18) || level.rankedmatch && var_23 && !self isitemunlocked(var_18))
		{
			var_18 = table_getequipment(level.classtablename,10,0);
		}

		if(!isvalidperk1(var_19) || level.rankedmatch && var_23 && !self isitemunlocked(var_19))
		{
			var_19 = table_getperk(level.classtablename,10,1);
		}

		if(!isvalidperk2(var_1A,var_19) || level.rankedmatch && var_23 && !self isitemunlocked(var_1A))
		{
			var_1A = table_getperk(level.classtablename,10,2);
		}

		if(!isvalidperk3(var_1B,var_19) || level.rankedmatch && var_23 && !self isitemunlocked(var_1B))
		{
			var_1B = table_getperk(level.classtablename,10,3);
		}

		if(!isvaliddeathstreak(var_1E) || level.rankedmatch && var_23 && !self isitemunlocked(var_1E))
		{
			var_1E = table_getdeathstreak(level.classtablename,10);
		}

		if(!isvalidoffhand(var_1D))
		{
	...
	{
		var_26 = buildweaponname(var_13,var_14,var_15,self.loadoutsecondarycamo,self.loadoutsecondaryreticle);
		...
		var_28 = var_7B[0];
		var_29 = maps\mp\gametypes\_rank::getweaponrank(var_28);
	...
	if(maps\mp\_utility::_hasperk("specialty_extraammo") && var_27 != "none" && maps\mp\_utility::getweaponclass(var_27) != "weapon_projectile")
	{
	...
	if(self.pers["cur_death_streak"] > 0)
	{
		...
		if(getperkupgrade(var_1B) == "specialty_rollover" || getperkupgrade(var_1C) == "specialty_rollover" || getperkupgrade(var_1D) == "specialty_rollover")
		{
			foreach(var_2E, var_2D in var_7B)
			{
				var_7B[var_2E] = var_7B[var_2E] - 1;
			}
		}
		...
		foreach(var_2E, var_2D in var_7B)
		{
			if(self.pers["cur_death_streak"] >= var_2D)
			{
				...
				thread maps\mp\gametypes\_hud_message::splashnotify(var_2E);
			}
		}
	}
	...
	setkillstreaks(var_0A,var_0B,var_0C);
	if(isdefined(self.lastclass) && self.lastclass != self.class && !issubstr(self.class,"juggernaut") && !issubstr(self.lastclass,"juggernaut") && !issubstr(param_03,"juggernaut"))
	{
		if(maps\mp\_utility::wasonlyround() || self.lastclass != "")
		{
			...
			{
				for(var_3A = 1;var_3A < 4;var_3A++ = var_7B[1] + "_" + var_7B[2])
				{
			...
			for(var_3A = 0;var_3A < var_38.size;var_3A++ = var_7B[0])
			{
	...
	var_3B = buildweaponname(var_0E,var_0F,var_10,self.loadoutprimarycamo,self.loadoutprimaryreticle);
	...
	{
		self notify("weapon_change","riotshield_mp",var_27[0] + "_" + var_27[1]);
	}
	...
	maps\mp\gametypes\_teams::playermodelforweapon(self.pers["primaryWeapon"],maps\mp\_utility::getbaseweaponname(var_27));
...
{
	if(!isdefined(level.var_3793))
	{
		level.var_3793 = makeletterstonumbers();
	}
	...
	if(isdefined(param_04) && param_04 != 0 && maps\mp\_utility::getattachmenttype(param_01) != "rail" && maps\mp\_utility::getattachmenttype(param_02) != "rail")
	{
		param_04 = undefined;
	}

	if(maps\mp\_utility::getattachmenttype(param_01) == "rail")
	{
		param_01 = maps\mp\_utility::attachmentmap(param_01,param_00);
	}
	else if(maps\mp\_utility::getattachmenttype(param_02) == "rail")
	{
		param_02 = maps\mp\_utility::attachmentmap(param_02,param_00);
	}
	...
	{
		if(level.var_3793[param_01[0]] < level.var_3793[param_02[0]])
		{
		}
		else if(level.var_3793[param_02[0]] == level.var_3793[param_03[0]])
		{
			if(level.var_3793[param_02[1]] < level.var_3793[param_03[1]])
			{
			}
			else
			{
		...
		if(maps\mp\_utility::getweaponclass(param_01) == "weapon_sniper" && maps\mp\_utility::getattachmenttype(param_02) != "rail" && maps\mp\_utility::getattachmenttype(param_03) != "rail")
		{
	...
	{
		if(maps\mp\_utility::getweaponclass(param_01) == "weapon_sniper" && maps\mp\_utility::getattachmenttype(param_02) != "rail" && param_02 != "zoomscope")
		{
		}
	}
	else if(param_03 != "none")
	{
		if(maps\mp\_utility::getweaponclass(param_01) == "weapon_sniper" && maps\mp\_utility::getattachmenttype(param_03) != "rail" && param_03 != "zoomscope")
		{
		}
	}
	...
	if(isdefined(var_7B[0]) && var_7B[0] == "vzscope")
	{
	}
	else if(isdefined(var_7B[1]) && var_7B[1] == "vzscope")
	{
	}
	else if(isdefined(var_7B[2]) && var_7B[2] == "vzscope")
	{
	}

	if(isdefined(var_7B.size) && var_7B.size)
	{
		for(var_09 = 0;var_09 < var_7B.size;var_09++ = var_7B[2])
		{
			if(isdefined(var_7B[var_09 + 1]) && common_scripts\utility::is_later_in_alphabet(var_7B[var_09],var_7B[var_09 + 1]))
			{
				var_0A = var_7B[var_09];
				var_7B[var_09] = var_7B[var_09 + 1];
				var_7B[var_09 + 1] = var_0A;
				var_09 = 0;
				continue;
			}
		}
	...
	{
		var_08 = buildweaponnamecamo(var_08,param_04);
...
//Function Number: 45
setkillstreaks(param_00,param_01,param_02)
{
	self.killstreaks = [];
	var_03 = [];
...
replenishloadout()
{
	...
	if(self getammocount(level.var_379A[var_01]["primary"]["type"]) < level.var_379A[var_01]["primary"]["count"])
	{
		self setweaponammoclip(level.var_379A[var_01]["primary"]["type"],level.var_379A[var_01]["primary"]["count"]);
	}

	if(self getammocount(level.var_379A[var_01]["secondary"]["type"]) < level.var_379A[var_01]["secondary"]["count"])
	{
		self setweaponammoclip(level.var_379A[var_01]["secondary"]["type"],level.var_379A[var_01]["secondary"]["count"]);
	}
}
...
{
	var_02 = getclassindex(param_01);
	if(issubstr(param_01,"custom"))
	{
		return cac_getperk(var_02,param_00);
	}

	return table_getperk(level.classtablename,var_02,param_00);
}
...
//Function Number: 53
isvalidsecondary(param_00,param_01,param_02,param_03)
{
	if(!isdefined(param_03))
	{
		param_03 = 1;
...
//Function Number: 54
isvalidattachment(param_00,param_01)
{
	if(!isdefined(param_01))
	{
		param_01 = 1;
...
{
	if(!isdefined(level.var_37AC))
	{
		level.var_37AC = [];
		foreach(var_02 in level.weaponlist)
		{
			level.var_37AC[var_02] = 1;
		}
	}

	if(isdefined(level.var_37AC[param_00]))
	{
		return 1;
	}
