 ...
 * Platform: PC
 * Function Count: 55
 * Decompile Time: 926 ms
 * Timestamp: 10/27/2023 2:15:32 AM
*******************************************************************/
...
init()
{
	...
	level.var_1CB8 = [];
	level.var_1CB9 = elevator_get_dvar_int("scr_elevator_callbutton_link_v","96");
	level.var_1CBA = elevator_get_dvar_int("scr_elevator_callbutton_link_h","256");
	build_elevators();
	position_elevators();
	elevator_call();
	if(!level.var_1CB8.size)
	{
		return;
	}

	foreach(var_02 in level.var_1CB8)
	{
...
elevator_update_global_dvars()
{
	for(;;)
	{
		level.var_1CBC = elevator_get_dvar("scr_elevator_accel","0.2");
		level.var_1CBD = elevator_get_dvar("scr_elevator_decel","0.2");
		level.var_1CBE = elevator_get_dvar_int("scr_elevator_music","1");
		level.var_1CBF = elevator_get_dvar_int("scr_elevator_speed","96");
		level.var_1CC0 = elevator_get_dvar_int("scr_elevator_innerdoorspeed","14");
		level.var_1CC1 = elevator_get_dvar_int("scr_elevator_outterdoorspeed","16");
		level.var_1CC2 = elevator_get_dvar_int("scr_elevator_return","0");
		level.var_1CC3 = elevator_get_dvar_int("scr_elevator_waittime","6");
		level.var_1CC4 = elevator_get_dvar_int("scr_elevator_aggressive_call","0");
		level.elevator_debug = elevator_get_dvar_int("debug_elevator","0");
		if(common_scripts\utility::issp())
		{
			level.var_1CC6 = elevator_get_dvar_int("scr_elevator_motion_detection","0");
		}
		else
		{
			level.var_1CC6 = elevator_get_dvar_int("scr_elevator_motion_detection","1");
		}
...
elevator_call()
{
	foreach(var_01 in level.var_1CC9)
	{
...
floor_override(param_00)
{
	...
	self.var_1CCB = undefined;
	for(;;)
	{
		param_00 waittill("trigger",var_01);
		self.floor_override = 1;
		self.var_1CCB = var_01;
		break;
	}
...
elevator_fsm(param_00)
{
	...
	for(;;)
	{
		if(self.var_1CCD == "[A]")
		{
			if(level.var_1CC2 && get_curfloor() != get_initfloor())
			{
				self.var_1CCE = get_initfloor();
				thread floor_override(var_02);
				waittill_or_timeout("floor_override",level.var_1CC3);
				if(self.floor_override && isdefined(self.var_1CCB) && isplayer(self.var_1CCB))
				{
					get_floor(self.var_1CCB);
				}
			...
			for(;;)
			{
				...
				if(isstring(var_03) && var_03 == "elevator_called" && self.var_1CCE != get_curfloor())
				{
					self.var_1CCD = "[B]";
					break;
				}
				...
				if(isdefined(var_03) && isplayer(var_03) && isalive(var_03))
				{
					...
					var_05 = isdefined(var_02.var_1CCF) && var_03 istouching(var_02.var_1CCF);
		...
		if(self.var_1CCD == "[D]")
		{
			if(self.var_1CCE != get_curfloor())
			{
				thread elevator_move(self.var_1CCE);
...
monitor_callbutton()
{
	for(;;)
	{
		...
		var_01 = undefined;
		var_02 = [];
		foreach(var_05, var_04 in self.var_1CD2)
		{
			var_01 = var_05;
			var_02 = var_04;
		}
...
elevator_floor_update()
{
	...
	{
		var_05 = self.var_1CD2["floor" + var_06 + "_pos"];
		if(var_01 == var_05)
		{
			self.var_1CD2["current_floor"] = var_06;
			var_02 = 0;
		}
	}
...
elevator_sound_think()
{
	...
	if(level.var_1CBE && isdefined(var_00))
	{
...
position_elevators()
{
	foreach(var_01 in level.var_1CB8)
	{
		var_01.var_1CCE = var_01 get_curfloor();
...
elevator_move(param_00)
{
	...
	self endon("elevator_moving");
	var_01 = get_housing_mainframe();
	var_02 = self.var_1CD2["floor" + param_00 + "_pos"] - var_01.origin;
	var_03 = level.var_1CBF;
	var_04 = abs(distance(self.var_1CD2["floor" + param_00 + "_pos"],var_01.origin));
	var_05 = var_04 / var_03;
	var_01 moveto(var_01.origin + var_02,var_05,var_05 * level.var_1CBC,var_05 * level.var_1CBD);
	foreach(var_07 in get_housing_children())
	{
		var_08 = var_07.origin + var_02;
		if(!issubstr(var_07.classname,"trigger_"))
		{
			var_07 moveto(var_08,var_05,var_05 * level.var_1CBC,var_05 * level.var_1CBD);
			continue;
		}
	...
	waittill_finish_moving(var_01,self.var_1CD2["floor" + param_00 + "_pos"]);
...
build_elevators()
{
	...
	foreach(var_04 in var_00)
	{
		...
		var_07 = spawnstruct();
		var_07.var_1CD2["id"] = level.var_1CB8.size;
		var_07.var_1CD2["housing"] = [];
		var_07.var_1CD2["housing"]["mainframe"] = [];
		foreach(var_09 in var_01)
		{
			if(var_09 isinbound(var_06))
			{
				var_07.var_1CD2["housing"]["mainframe"][var_07.var_1CD2["housing"]["mainframe"].size] = var_09;
				...
				var_07.var_1CD2["housing"]["left_door"] = var_0A;
				var_07.var_1CD2["housing"]["left_door_opened_pos"] = var_0A.origin;
				var_0B = getent(var_0A.target,"targetname");
				var_07.var_1CD2["housing"]["right_door"] = var_0B;
				var_07.var_1CD2["housing"]["right_door_opened_pos"] = var_0B.origin;
				var_0C = var_0A.origin - var_0B.origin * (0.5,0.5,0.5) + var_0B.origin;
				var_07.var_1CD2["housing"]["door_closed_pos"] = var_0C;
				var_0D = getent(var_0B.target,"targetname");
				var_07.var_1CD2["housing"]["door_trigger"] = var_0D;
				var_0E = getent(var_0D.target,"targetname");
				var_07.var_1CD2["housing"]["inside_trigger"] = var_0E;
				var_0E make_discrete_trigger();
				var_0E.var_1CCF = spawn("trigger_radius",var_09.origin,0,64,128);
			}
		}

		var_07.var_1CD2["outer_doorset"] = [];
		foreach(var_11 in var_02)
		{
			if(var_11 isinbound(var_06))
			{
				...
				var_13 = var_07.var_1CD2["outer_doorset"].size;
				var_07.var_1CD2["outer_doorset"][var_13] = [];
				var_07.var_1CD2["outer_doorset"][var_13]["door_closed_pos"] = var_11.origin;
				var_14 = getent(var_11.target,"targetname");
				var_07.var_1CD2["outer_doorset"][var_13]["left_door"] = var_14;
				var_07.var_1CD2["outer_doorset"][var_13]["left_door_opened_pos"] = var_14.origin;
				var_15 = getent(var_14.target,"targetname");
				var_07.var_1CD2["outer_doorset"][var_13]["right_door"] = var_15;
				var_07.var_1CD2["outer_doorset"][var_13]["right_door_opened_pos"] = var_15.origin;
				if(var_12)
				{
		...
		for(var_18 = 0;var_18 < var_07.var_1CD2["outer_doorset"].size - 1;var_18++)
		{
			for(var_19 = 0;var_19 < var_07.var_1CD2["outer_doorset"].size - 1 - var_18;var_19++)
			{
				if(var_07.var_1CD2["outer_doorset"][var_19 + 1]["door_closed_pos"][2] < var_07.var_1CD2["outer_doorset"][var_19]["door_closed_pos"][2])
				{
					var_1A = var_07.var_1CD2["outer_doorset"][var_19]["left_door"];
					var_1B = var_07.var_1CD2["outer_doorset"][var_19]["left_door_opened_pos"];
					var_1C = var_07.var_1CD2["outer_doorset"][var_19]["right_door"];
					var_1D = var_07.var_1CD2["outer_doorset"][var_19]["right_door_opened_pos"];
					var_1E = var_07.var_1CD2["outer_doorset"][var_19]["door_closed_pos"];
					var_07.var_1CD2["outer_doorset"][var_19]["left_door"] = var_07.var_1CD2["outer_doorset"][var_19 + 1]["left_door"];
					var_07.var_1CD2["outer_doorset"][var_19]["left_door_opened_pos"] = var_07.var_1CD2["outer_doorset"][var_19 + 1]["left_door_opened_pos"];
					var_07.var_1CD2["outer_doorset"][var_19]["right_door"] = var_07.var_1CD2["outer_doorset"][var_19 + 1]["right_door"];
					var_07.var_1CD2["outer_doorset"][var_19]["right_door_opened_pos"] = var_07.var_1CD2["outer_doorset"][var_19 + 1]["right_door_opened_pos"];
					var_07.var_1CD2["outer_doorset"][var_19]["door_closed_pos"] = var_07.var_1CD2["outer_doorset"][var_19 + 1]["door_closed_pos"];
					var_07.var_1CD2["outer_doorset"][var_19 + 1]["left_door"] = var_1A;
					var_07.var_1CD2["outer_doorset"][var_19 + 1]["left_door_opened_pos"] = var_1B;
					var_07.var_1CD2["outer_doorset"][var_19 + 1]["right_door"] = var_1C;
					var_07.var_1CD2["outer_doorset"][var_19 + 1]["right_door_opened_pos"] = var_1D;
					var_07.var_1CD2["outer_doorset"][var_19 + 1]["door_closed_pos"] = var_1E;
				}
			}
		}

		var_1F = [];
		foreach(var_18, var_21 in var_07.var_1CD2["outer_doorset"])
		{
			var_22 = var_07 get_housing_mainframe();
			var_1F = (var_22.origin[0],var_22.origin[1],var_21["door_closed_pos"][2]);
			var_07.var_1CD2["floor" + var_18 + "_pos"] = var_1F;
			if(var_22.origin == var_1F)
			{
				var_07.var_1CD2["initial_floor"] = var_18;
				var_07.var_1CD2["current_floor"] = var_18;
			}
		}

		level.var_1CB8[level.var_1CB8.size] = var_07;
		var_04 delete();
		var_05 delete();
	}
	...
	foreach(var_27 in level.var_1CB8)
	{
...
build_call_buttons()
{
	level.var_1CC9 = getentarray("elevator_call","targetname");
	foreach(var_01 in level.var_1CC9)
	{
		var_01.var_1CD2 = [];
		...
		var_04 = [];
		foreach(var_06 in level.var_1CB8)
		{
			foreach(var_0B, var_08 in var_06 get_outer_doorsets())
			{
				var_09 = (0,0,var_06.var_1CD2["floor" + var_0B + "_pos"][2]);
				var_0A = (var_06.var_1CD2["floor" + var_0B + "_pos"][0],var_06.var_1CD2["floor" + var_0B + "_pos"][1],0);
				if(abs(distance(var_02,var_09)) <= level.var_1CB9)
				{
					if(abs(distance(var_03,var_0A)) <= level.var_1CBA)
					{
						var_04[var_04.size] = var_06;
						var_01.var_1CD2[var_0B] = var_04;
					}
				}
			}
		}
		...
		var_01.var_1CCF = spawn("trigger_radius",var_01.origin + (0,0,-32),0,32,64);
	}
}
...
setup_hints()
{
	...
	foreach(var_07 in level.var_1CC9)
	{
...
discrete_waittill(param_00)
{
	...
	if(level.var_1CC6)
	{
		self.var_1CCF waittill(param_00,var_01);
	}
	else
	{
...
enable_trigger()
{
	if(!self.enabled)
	{
		...
		if(isdefined(self.var_1CCF))
		{
			self.var_1CCF.origin = self.var_1CCF.origin + (0,0,10000);
		}
	}
}
...
{
	return self.var_1CD2["outer_doorset"][param_00];
}

//Function Number: 29
get_outer_doorsets()
{
	return self.var_1CD2["outer_doorset"];
}

//Function Number: 30
get_outer_closedpos(param_00)
{
	return self.var_1CD2["outer_doorset"][param_00]["door_closed_pos"];
}

//Function Number: 31
get_outer_leftdoor(param_00)
{
	return self.var_1CD2["outer_doorset"][param_00]["left_door"];
}

//Function Number: 32
get_outer_rightdoor(param_00)
{
	return self.var_1CD2["outer_doorset"][param_00]["right_door"];
}

//Function Number: 33
get_outer_leftdoor_openedpos(param_00)
{
	return self.var_1CD2["outer_doorset"][param_00]["left_door_opened_pos"];
}

//Function Number: 34
get_outer_rightdoor_openedpos(param_00)
{
	return self.var_1CD2["outer_doorset"][param_00]["right_door_opened_pos"];
}
...
{
	var_00 = self.var_1CD2["housing"]["mainframe"];
	var_01 = undefined;
...
{
	return self.var_1CD2["housing"]["door_trigger"];
}

//Function Number: 41
get_housing_inside_trigger()
{
	return self.var_1CD2["housing"]["inside_trigger"];
}

//Function Number: 42
get_housing_closedpos()
{
	return self.var_1CD2["housing"]["door_closed_pos"];
}

//Function Number: 43
get_housing_leftdoor()
{
	return self.var_1CD2["housing"]["left_door"];
}

//Function Number: 44
get_housing_rightdoor()
{
	return self.var_1CD2["housing"]["right_door"];
}

//Function Number: 45
get_housing_leftdoor_opened_pos()
{
	return self.var_1CD2["housing"]["left_door_opened_pos"];
}

//Function Number: 46
get_housing_rightdoor_opened_pos()
{
	return self.var_1CD2["housing"]["right_door_opened_pos"];
}
...
get_curfloor()
{
	...
	return self.var_1CD2["current_floor"];
}

//Function Number: 48
get_initfloor()
{
	return self.var_1CD2["initial_floor"];
}
...
isinbound(param_00)
{
	...
	{
		return isinboundingspere(param_00);
	}
...
elevator_debug()
{
	...
	for(;;)
	{
		...
		foreach(var_01 in level.var_1CB8)
		{
			...
			foreach(var_05 in var_01.var_1CD2["outer_doorset"])
			{
			}
		}

		foreach(var_09 in level.var_1CC9)
		{
			foreach(var_05 in var_09.var_1CD2)
			{
				var_0B = 0;
