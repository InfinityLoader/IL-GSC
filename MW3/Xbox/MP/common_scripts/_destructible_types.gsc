 ...
 * Platform: Console
 * Function Count: 169
 * Decompile Time: 2750 ms
 * Timestamp: 10/27/2023 2:28:45 AM
*******************************************************************/
...
maketype(param_00)
{
	...
	switch(param_00)
	{
		...
		case "vehicle_bm21_mobile_bed":
			vehicle_bm21(param_00,"vehicle_bm21_mobile_bed_dstry");
			break;

		case "vehicle_bm21_cover":
			vehicle_bm21(param_00,"vehicle_bm21_mobile_cover_dstry");
			break;
		...
		case "vehicle_suburban_beige":
			vehicle_suburban(param_00,"_beige");
			break;

		case "vehicle_suburban_dull":
			vehicle_suburban(param_00,"_dull");
			break;

		case "vehicle_suburban_red":
			vehicle_suburban(param_00,"_red");
			break;
		...
		case "toy_security_camera_down":
			toy_security_camera2(param_00,"security_camera_idle_down");
			break;

		case "toy_security_camera_l_down":
			toy_security_camera2(param_00,"security_camera_idle_l_down");
			break;

		case "toy_security_camera_still":
			toy_security_camera2(param_00,"security_camera_null");
			break;

		case "toy_security_camera_still_l_down":
			toy_security_camera2(param_00,"security_camera_null_l_down");
			break;

		case "toy_security_camera_still_r_down":
			toy_security_camera2(param_00,"security_camera_null_r_down");
			break;
		...
		case "rooftop_skylight_destructible":
			rooftop_skylight_destructible(param_00);
			break;

		case "satellite_dish_big_destructible":
			satellite_dish_big_destructible(param_00);
			break;
		...
		case "berlin_hotel_lights_wall1":
			dest_onestate(param_00,"berlin_hotel_lights_wall1_destroyed","misc/light_blowout_wall2_runner");
			break;
		...
		case "berlin_hotel_lights_wall2":
			dest_onestate(param_00,"berlin_hotel_lights_wall2_destroyed","misc/light_blowout_wall_runner");
			break;
		...
		case "pb_cubical_planter":
			dest_pb_planter(param_00,"pb_cubical_planter_dam","explosions/brick_chunk");
			break;
		...
		case "toy_terracotta_pot_a_white_dest":
			toy_terracotta_pot(param_00,"a_white");
			break;

		case "toy_terracotta_pot_a_violet_dest":
			toy_terracotta_pot(param_00,"a_violet");
			break;

		case "toy_terracotta_pot_b_yellow_dest":
			toy_terracotta_pot(param_00,"b_yellow");
			break;

		case "toy_terracotta_pot_b_red_dest":
			toy_terracotta_pot(param_00,"b_red");
			break;

		case "toy_furniture_coffee_table_modern_01":
			toy_furniture_coffee_table_modern(param_00,"1",55);
			break;

		case "toy_furniture_coffee_table_modern_02":
			toy_furniture_coffee_table_modern(param_00,"2",60);
			break;
...
//Function Number: 3
prop_ac_prs_enm_barge_a(param_00)
{
	common_scripts\_destructible::destructible_create("prop_ac_prs_enm_barge_a_" + param_00,"tag_origin",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_state("tag_origin","ac_prs_enm_barge_a_" + param_00 + "_dam_animated",250,undefined,32,"no_melee");
	...
	common_scripts\_destructible::func_976(4000,5000,150,250,50,300,undefined,undefined,0.3,500);
}
...
//Function Number: 13
prop_ac_prs_enm_storage_bld(param_00,param_01)
{
	var_02 = "";
	...
	common_scripts\_destructible::destructible_create("prop_ac_prs_enm_storage_bld_" + param_00 + var_02,"p_ac_prs_enm_storage_bld_" + param_00 + var_02,250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_state("p_ac_prs_enm_storage_bld_" + param_00 + var_02 + "_dam","ac_prs_enm_storage_bld_" + param_00 + var_02 + "_dam",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"explosions/building_explosion_paris_ac130",0);
	var_03 = "a";
	switch(param_00)
	{
	...
	common_scripts\_destructible::destructible_fx(undefined,"explosions/ac_prs_fx_flir_debris_explosion_" + var_03,0);
}

//Function Number: 14
prop_ac_prs_enm_tent(param_00)
{
	common_scripts\_destructible::destructible_create("prop_ac_prs_enm_tent_" + param_00,"ac_prs_enm_tent_" + param_00 + "_lod0",250,undefined,32,"no_melee");
	var_01 = "ac_prs_enm_tent_" + param_00 + "_lod1";
	switch(param_00)
	{
		case "a":
			var_01 = "polySurface1";
	...
	common_scripts\_destructible::destructible_state(var_01,"ac_prs_enm_tent_" + param_00 + "_dam1",250,undefined,32,"no_melee");
...
//Function Number: 16
prop_ac_prs_enm_cargo_crate_a(param_00)
{
	common_scripts\_destructible::destructible_create("prop_ac_prs_enm_cargo_crate_a_" + param_00,"ac_prs_enm_cargo_crate_a_" + param_00 + "_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_state("ac_prs_enm_cargo_crate_a_" + param_00 + "_lod0","ac_prs_enm_cargo_crate_a_" + param_00 + "_dam",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"explosions/building_explosion_paris_ac130",0);
	common_scripts\_destructible::func_976(4000,5000,150,250,50,300,undefined,undefined,0.3,500);
}

//Function Number: 17
prop_ac_prs_enm_crates(param_00,param_01)
{
	common_scripts\_destructible::destructible_create("prop_ac_prs_enm_crates_" + param_00 + "_" + param_01,"ac_prs_enm_crates_" + param_00 + "_" + param_01 + "_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_state("ac_prs_enm_crates_" + param_00 + "_" + param_01 + "_dam_lod0","ac_prs_enm_crates_" + param_00 + "_" + param_01 + "_dam",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"explosions/ac_prs_fx_enm_crates_" + param_00 + "_explosion_1",0);
}
...
//Function Number: 22
prop_ac_prs_fps_hc_extc_balcony(param_00,param_01)
{
	common_scripts\_destructible::destructible_create("prop_ac_prs_fps_hc_extc_balcony_" + param_00 + param_01,"ac_prs_fps_hc_extc_balcony_" + param_00 + "_lod0",80,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_state("ac_prs_fps_hc_extc_balcony_" + param_00 + "_dam" + param_01 + "_lod0","ac_prs_fps_hc_extc_balcony_" + param_00 + "_dam" + param_01,250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"explosions/ac_prs_fx_dust_explosion_a",0);
	var_02 = "explosions/ac_prs_fps_extc_balcony_a_explosion_1";
	switch(param_00)
	{
		case "b":
			var_02 = "explosions/ac_prs_fps_extc_balcony_b_explosion_1";
			break;

		case "c":
			var_02 = "explosions/ac_prs_fps_extc_balcony_c_explosion_" + param_01;
			break;
	}

	common_scripts\_destructible::destructible_fx(undefined,var_02,0);
}

//Function Number: 23
prop_ac_prs_fps_hc_extc_column(param_00,param_01,param_02)
{
	common_scripts\_destructible::destructible_create("prop_ac_prs_fps_hc_extc_column_" + param_00 + "_" + param_01 + param_02,"ac_prs_fps_hc_extc_column_" + param_00 + "_" + param_01 + "_lod0",80,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_state("ac_prs_fps_hc_extc_column_" + param_00 + "_" + param_01 + "_dam" + param_02 + "_lod0","ac_prs_fps_hc_extc_column_" + param_00 + "_" + param_01 + "_dam" + param_02,250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"explosions/ac_prs_fx_dust_explosion_a",0);
...
prop_bv_prp_mvillage_tstore_a()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_tstore_a","bv_prp_mvillage_tstore_a_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_tstore_a_dam_lod0","bv_prp_mvillage_tstore_a_dam",250,undefined,32,"no_melee");
}

//Function Number: 26
prop_bv_prp_mvillage_tstore_b()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_tstore_b","bv_prp_mvillage_tstore_b_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_tstore_b_dam_lod0","bv_prp_mvillage_tstore_b_dam",250,undefined,32,"no_melee");
}

//Function Number: 27
prop_bv_prp_mvillage_tstore_c()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_tstore_c","bv_prp_mvillage_tstore_c_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_tstore_c_dam_lod0","bv_prp_mvillage_tstore_c_dam",250,undefined,32,"no_melee");
}

//Function Number: 28
prop_bv_prp_mvillage_tstore_d()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_tstore_d","bv_prp_mvillage_tstore_d_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_tstore_d_dam_lod0","bv_prp_mvillage_tstore_d_dam",250,undefined,32,"no_melee");
}

//Function Number: 29
prop_bv_prp_mvillage_church_a1()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_church_a1","bv_prp_mvillage_church_a1_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_church_a1_dam_lod0","bv_prp_mvillage_church_a1_dam",250,undefined,32,"no_melee");
}

//Function Number: 30
prop_bv_prp_mvillage_church_a2()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_church_a2","bv_prp_mvillage_church_a2_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_church_a2_dam_lod0","bv_prp_mvillage_church_a2_dam",250,undefined,32,"no_melee");
}

//Function Number: 31
prop_bv_prp_mvillage_church_a3()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_church_a3","bv_prp_mvillage_church_a3_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_church_a3_dam_lod0","bv_prp_mvillage_church_a3_dam",250,undefined,32,"no_melee");
}

//Function Number: 32
prop_bv_prp_mvillage_church_a4()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_church_a4","bv_prp_mvillage_church_a4_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_church_a4_dam_lod0","bv_prp_mvillage_church_a4_dam",250,undefined,32,"no_melee");
}

//Function Number: 33
prop_bv_prp_mvillage_church_a5()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_church_a5","bv_prp_mvillage_church_a5_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_church_a5_dam_lod0","bv_prp_mvillage_church_a5_dam",250,undefined,32,"no_melee");
}

//Function Number: 34
prop_bv_prp_mvillage_tudorg_a1()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_tudorg_a1","bv_prp_mvillage_tudorg_a1_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_tudorg_a1_dam_lod0","bv_prp_mvillage_tudorg_a1_dam",250,undefined,32,"no_melee");
}

//Function Number: 35
prop_bv_prp_mvillage_tudorg_a2()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_tudorg_a2","bv_prp_mvillage_tudorg_a2_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_tudorg_a2_dam_lod0","bv_prp_mvillage_tudorg_a2_dam",250,undefined,32,"no_melee");
}

//Function Number: 36
prop_bv_prp_mvillage_tudorg_a3()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_tudorg_a3","bv_prp_mvillage_tudorg_a3_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_tudorg_a3_dam_lod0","bv_prp_mvillage_tudorg_a3_dam",250,undefined,32,"no_melee");
}

//Function Number: 37
prop_bv_prp_mvillage_tudor_a()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_tudor_a","bv_prp_mvillage_tudor_a_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_tudor_a_dam_lod0","bv_prp_mvillage_tudor_a_dam",250,undefined,32,"no_melee");
}

//Function Number: 38
prop_bv_prp_mvillage_grand_house_a()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_grand_house_a","bv_prp_mvillage_grand_house_a_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_grand_house_a_dam_lod0","bv_prp_mvillage_grand_house_a_dam",250,undefined,32,"no_melee");
}

//Function Number: 39
prop_bv_prp_mvillage_grand_house_a1()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_grand_house_a1","bv_prp_mvillage_grand_house_a1_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_grand_house_a1_dam_lod0","bv_prp_mvillage_grand_house_a1_dam",250,undefined,32,"no_melee");
}

//Function Number: 40
prop_bv_prp_mvillage_grand_house_a2()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_grand_house_a2","bv_prp_mvillage_grand_house_a2_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_grand_house_a2_dam_lod0","bv_prp_mvillage_grand_house_a2_dam",250,undefined,32,"no_melee");
}

//Function Number: 41
prop_bv_prp_mvillage_hse_a()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_hse_a","bv_prp_mvillage_hse_a_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_hse_a_dam_lod0","bv_prp_mvillage_hse_a_dam",250,undefined,32,"no_melee");
}

//Function Number: 42
prop_bv_prp_mvillage_pub_a()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_pub_a","bv_prp_mvillage_pub_a_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_pub_a_dam_lod0","bv_prp_mvillage_pub_a_dam",250,undefined,32,"no_melee");
}

//Function Number: 43
prop_bv_prp_mvillage_pub_a1()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_pub_a1","bv_prp_mvillage_pub_a1_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_pub_a1_dam_lod0","bv_prp_mvillage_pub_a1_dam",250,undefined,32,"no_melee");
}

//Function Number: 44
prop_bv_prp_mvillage_thatch_cottage_a()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_thatch_cottage_a","bv_prp_mvillage_thatch_cottage_a_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_thatch_cottage_a_dam_lod0","bv_prp_mvillage_thatch_cottage_a_dam",250,undefined,32,"no_melee");
}

//Function Number: 45
prop_bv_prp_mvillage_thatch_cottage_a1()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_thatch_cottage_a1","bv_prp_mvillage_thatch_cottage_a1_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_thatch_cottage_a1_dam_lod0","bv_prp_mvillage_thatch_cottage_a1_dam",250,undefined,32,"no_melee");
}

//Function Number: 46
prop_bv_prp_mvillage_thatch_cottage_b()
{
	common_scripts\_destructible::destructible_create("prop_bv_prp_mvillage_thatch_cottage_b","bv_prp_mvillage_thatch_cottage_b_lod0",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx(undefined,"dust/scaffolding_dust_wood_debris_lg",0);
	common_scripts\_destructible::destructible_state("bv_prp_mvillage_thatch_cottage_b_dam_lod0","bv_prp_mvillage_thatch_cottage_b_dam",250,undefined,32,"no_melee");
}
...
toy_dt_mirror(param_00)
{
	...
	common_scripts\_destructible::func_976(1000,2000,32,32,32,48,undefined,0);
...
toy_icbm_consolemonitor(param_00)
{
	...
	common_scripts\_destructible::func_976(20,2000,9,9,3,3,undefined,12);
...
toy_tvs_flatscreen(param_00,param_01)
{
	...
	common_scripts\_destructible::destructible_sound("tv_shot_burst");
	common_scripts\_destructible::func_976(20,2000,10,10,3,3,undefined,15);
...
toy_transformer_ratnest01(param_00)
{
	...
	common_scripts\_destructible::func_976(7000,8000,150,256,16,100,undefined,0);
...
toy_generator(param_00)
{
	...
	common_scripts\_destructible::func_976(7000,8000,128,128,16,50,undefined,0);
	common_scripts\_destructible::destructible_anim(get_precached_anim("enerator_explode"),#animtree,"setanimknob",undefined,undefined,"generator_explode");
...
func_09B0(param_00)
{
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("enerator_vibration"),#animtree,"setanimknob",undefined,undefined,"generator_vibration");
	...
	common_scripts\_destructible::destructible_sound("generator01_explode");
	common_scripts\_destructible::func_976(7000,8000,128,128,16,50,undefined,0);
	common_scripts\_destructible::destructible_anim(get_precached_anim("enerator_explode"),#animtree,"setanimknob",undefined,0,"generator_explode");
	common_scripts\_destructible::destructible_anim(get_precached_anim("enerator_explode_02"),#animtree,"setanimknob",undefined,0,"generator_explode_02");
	common_scripts\_destructible::destructible_anim(get_precached_anim("enerator_explode_03"),#animtree,"setanimknob",undefined,0,"generator_explode_03");
	common_scripts\_destructible::destructible_state(undefined,"machinery_generator_des",undefined,undefined,"no_melee");
}
...
toy_oxygen_tank(param_00)
{
	...
	common_scripts\_destructible::func_976(7000,8000,150,256,16,150,undefined,32);
...
toy_electricbox4(param_00)
{
	...
	common_scripts\_destructible::destructible_fx("tag_fx","props/electricbox4_explode",undefined,undefined,undefined,1);
	common_scripts\_destructible::destructible_sound("exp_fusebox_sparks");
	common_scripts\_destructible::func_976(20,2000,32,32,32,48,undefined,0);
...
toy_airconditioner(param_00)
{
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("x_airconditioner_fan"),#animtree,"setanimknob",undefined,undefined,"ex_airconditioner_fan");
...
{
	common_scripts\_destructible::destructible_create(param_00,"tag_origin",0,undefined,32);
	common_scripts\_destructible::destructible_anim(get_precached_anim("e_fanceil1_spin"),#animtree,"setanimknob",undefined,undefined,"me_fanceil1_spin");
	common_scripts\_destructible::destructible_state("tag_origin","me_fanceil1",150);
	common_scripts\_destructible::destructible_anim(get_precached_anim("e_fanceil1_spin_stop"),#animtree,"setanimknob",undefined,undefined,"me_fanceil1_spin_stop");
	...
	common_scripts\_destructible::func_976(1000,2000,32,32,5,32,undefined,0);
...
toy_wall_fan(param_00)
{
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("all_fan_rotate"),#animtree,"setanimknob",undefined,undefined,"wall_fan_rotate");
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("all_fan_stop"),#animtree,"setanimknob",undefined,undefined,"wall_fan_wobble");
...
toy_propane_tank02(param_00)
{
	...
	common_scripts\_destructible::func_976(7000,8000,600,600,32,300);
...
toy_propane_tank02_small(param_00)
{
	...
	common_scripts\_destructible::destructible_fx("tag_fx","explosions/propane_large_exp",0);
	common_scripts\_destructible::destructible_sound("propanetank02_explode");
	common_scripts\_destructible::func_976(7000,8000,400,400,32,100);
...
toy_copier(param_00)
{
	...
	common_scripts\_destructible::func_976(7000,8000,96,96,32,48);
...
toy_firehydrant(param_00)
{
	...
	common_scripts\_destructible::func_976(17000,18000,96,96,32,48);
...
toy_parkingmeter(param_00)
{
	...
	common_scripts\_destructible::func_976(2800,3000,64,64,0,0,1);
...
func_09BE(param_00)
{
	...
	common_scripts\_destructible::func_976(100,2000,64,64,0,0);
...
toy_newspaper_stand_red(param_00)
{
	...
	common_scripts\_destructible::func_976(2500,2501,64,64,0,0,1);
...
func_09C1(param_00)
{
	...
	common_scripts\_destructible::destructible_sound("exp_newspaper_box");
	common_scripts\_destructible::func_976(800,2001,64,64,0,0,1);
...
toy_trashbin_01(param_00)
{
	...
	common_scripts\_destructible::func_976(1300,1351,1,1,10,20);
...
func_09C4(param_00)
{
	...
	common_scripts\_destructible::destructible_fx("tag_fx","props/garbage_spew",1,common_scripts\_destructible::damage_not("splash"));
	common_scripts\_destructible::destructible_sound("exp_trashcan_sweet");
	common_scripts\_destructible::func_976(600,800,1,1,10,20);
...
toy_recyclebin_01(param_00)
{
	...
	common_scripts\_destructible::destructible_fx("tag_fx","props/garbage_spew",1,common_scripts\_destructible::damage_not("splash"));
	common_scripts\_destructible::destructible_sound("exp_trashcan_sweet");
	common_scripts\_destructible::func_976(600,651,1,1,10,20);
...
toy_water_collector(param_00)
{
	...
	common_scripts\_destructible::func_976(500,800,32,32,1,10,undefined,32);
...
toy_paris_tree_plane_large(param_00)
{
	...
	common_scripts\_destructible::func_976(100,351,150,350,100,200,undefined,undefined,undefined,undefined,(-400,0,80),0.7);
...
toy_light_ceiling_fluorescent(param_00)
{
	...
	common_scripts\_destructible::destructible_lights_out(16);
	common_scripts\_destructible::func_976(20,2000,64,64,40,80);
	common_scripts\_destructible::destructible_anim(get_precached_anim("ight_fluorescent_swing"),#animtree,"setanimknob",undefined,0,"light_fluorescent_swing");
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("ight_fluorescent_swing_02"),#animtree,"setanimknob",undefined,1,"light_fluorescent_swing_02");
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("ight_fluorescent_null"),#animtree,"setanimknob",undefined,2,"light_fluorescent_null");
...
toy_light_ceiling_fluorescent_single(param_00)
{
	...
	common_scripts\_destructible::func_976(20,2000,64,64,40,80);
	common_scripts\_destructible::destructible_anim(get_precached_anim("ight_fluorescent_single_swing"),#animtree,"setanimknob",undefined,0,"light_fluorescent_single_swing");
	common_scripts\_destructible::destructible_sound("fluorescent_light_fall",undefined,0);
	common_scripts\_destructible::destructible_sound("fluorescent_light_bulb",undefined,0);
	common_scripts\_destructible::destructible_anim(get_precached_anim("ight_fluorescent_single_swing_02"),#animtree,"setanimknob",undefined,1,"light_fluorescent_single_swing_02");
	common_scripts\_destructible::destructible_sound("fluorescent_light_hinge",undefined,1);
	common_scripts\_destructible::destructible_sound("fluorescent_light_bulb",undefined,1);
	common_scripts\_destructible::destructible_anim(get_precached_anim("ight_fluorescent_single_swing_03"),#animtree,"setanimknob",undefined,2,"light_fluorescent_single_swing_03");
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("ight_fluorescent_single_null"),#animtree,"setanimknob",undefined,3,"light_fluorescent_single_null");
...
toy_light_ceiling_fluorescent_single_spotlight(param_00)
{
	...
	common_scripts\_destructible::destructible_fx("tag_swing_center_fx_far","misc/light_blowout_swinging_runner");
	common_scripts\_destructible::func_976(20,2000,64,64,40,80);
	common_scripts\_destructible::destructible_anim(get_precached_anim("ight_fluorescent_single_swing_02"),#animtree,"setanimknob",undefined,undefined,"light_fluorescent_single_swing_02");
	common_scripts\_destructible::destructible_sound("fluorescent_light_fall");
...
toy_bookstore_bookstand4_books(param_00)
{
	...
	common_scripts\_destructible::func_976(2000,3800,32,32,1,5,undefined,0);
...
{
	common_scripts\_destructible::destructible_create(param_00,"tag_origin",150,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_anim(get_precached_anim("ocker_broken_both_doors_1"),#animtree,"setanimknob",undefined,0,"locker_broken_both_doors_1");
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("ocker_broken_both_doors_2"),#animtree,"setanimknob",undefined,1,"locker_broken_both_doors_2");
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("ocker_broken_both_doors_4"),#animtree,"setanimknob",undefined,2,"locker_broken_both_doors_4");
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("ocker_broken_door1_fast"),#animtree,"setanimknob",undefined,3,"locker_broken_door1_fast");
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("ocker_broken_door2_fast"),#animtree,"setanimknob",undefined,4,"locker_broken_door2_fast");
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("ocker_broken_both_doors_3"),#animtree,"setanimknob",undefined,5,"locker_broken_both_doors_3");
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("ocker_broken_door1_slow"),#animtree,"setanimknob",undefined,6,"locker_broken_door1_slow");
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("ocker_broken_door2_slow"),#animtree,"setanimknob",undefined,7,"locker_broken_door2_slow");
...
toy_chicken(param_00)
{
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("hicken_cage_loop_01"),#animtree,"setanimknob",undefined,0,"chicken_cage_loop_01",1.6);
	common_scripts\_destructible::destructible_anim(get_precached_anim("hicken_cage_loop_02"),#animtree,"setanimknob",undefined,1,"chicken_cage_loop_02",1.6);
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("hicken_cage_death"),#animtree,"setanimknob",undefined,0,"chicken_cage_death");
	common_scripts\_destructible::destructible_anim(get_precached_anim("hicken_cage_death_02"),#animtree,"setanimknob",undefined,1,"chicken_cage_death_02");
...
toy_chicken_dlc()
{
	common_scripts\_destructible::destructible_create("toy_chicken_dlc","tag_origin",0,undefined,32);
	common_scripts\_destructible::destructible_anim(get_precached_anim("hicken_cage_pecking_idle"),#animtree,"setanimknob",undefined,0,"Chicken_cage_pecking_idle",1.6);
	common_scripts\_destructible::destructible_anim(get_precached_anim("hicken_cage_seated_idle"),#animtree,"setanimknob",undefined,1,"Chicken_cage_seated_idle",1.6);
	common_scripts\_destructible::destructible_loopsound("animal_chicken_idle_loop");
	common_scripts\_destructible::destructible_state("tag_origin","chicken",25);
	common_scripts\_destructible::destructible_fx("tag_origin","props/chicken_exp");
	common_scripts\_destructible::destructible_anim(get_precached_anim("hicken_cage_death"),#animtree,"setanimknob",undefined,0,"chicken_cage_death");
	common_scripts\_destructible::destructible_anim(get_precached_anim("hicken_cage_death_02"),#animtree,"setanimknob",undefined,1,"chicken_cage_death_02");
	common_scripts\_destructible::destructible_sound("animal_chicken_death");
	common_scripts\_destructible::destructible_state(undefined,"chicken",undefined,undefined,"no_melee");
}
...
vehicle_ac130_80s_sedan1(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,150,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_80s_sedan1_" + param_00 + "_destroyed",undefined,32,"o_melee");
	var_01 = "tag_hood";
	...
	lib_0F09::func_7462(%,#animtree,"setanim");
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
...
vehicle_80s_hatch1(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,150,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_80s_hatch1_" + param_00 + "_destroyed",undefined,32,"o_melee");
	var_01 = "tag_hood";
...
func_09DE(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,150,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_80s_hatch2_" + param_00 + "_destroyed",undefined,32,"o_melee");
	var_01 = "tag_hood";
...
func_09DF(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,150,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_80s_wagon1_" + param_00 + "_destroyed",undefined,32,"o_melee");
	var_01 = "tag_hood";
...
vehicle_small_hatch(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,150,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_small_hatch_" + param_00 + "_destroyed",undefined,32,"o_melee");
	var_01 = "tag_hood";
...
func_09E2()
{
	...
	common_scripts\_destructible::func_976(4000,5000,150,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_london_cab_destroyed",undefined,32,"o_melee");
	var_00 = "tag_hood";
...
vehicle_pickup(param_00)
{
	...
	common_scripts\_destructible::destructible_fx("tag_death_fx","explosions/small_vehicle_explosion",0);
	common_scripts\_destructible::destructible_sound("car_explode");
	common_scripts\_destructible::func_976(4000,5000,210,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_pickup_destroyed",undefined,32,"o_melee");
	var_01 = "tag_hood";
...
vehicle_hummer(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,210,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_hummer_destroyed",undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim");
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
	common_scripts\_destructible::destructible_part("left_wheel_02_jnt",undefined,20,undefined,undefined,"no_melee");
...
vehicle_gaz(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,210,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_gaz_tigr_harbor_destroyed",undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim");
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
	common_scripts\_destructible::destructible_part("left_wheel_02_jnt",undefined,20,undefined,undefined,"no_melee");
...
//Function Number: 108
vehicle_bm21(param_00,param_01)
{
	common_scripts\_destructible::destructible_create(param_00,"tag_body",300,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_loopfx("tag_hood_fx","smoke/car_damage_whitesmoke",0.4);
	common_scripts\_destructible::destructible_state(undefined,undefined,200,undefined,32,"no_melee");
	...
	common_scripts\_destructible::func_976(4000,5000,210,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,param_01,undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim");
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
	common_scripts\_destructible::destructible_part("left_wheel_02_jnt",undefined,20,undefined,undefined,"no_melee");
...
vehicle_moving_truck(param_00)
{
	...
	common_scripts\_destructible::destructible_sound("car_explode");
	common_scripts\_destructible::func_976(4000,5000,210,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_7476(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	if(param_00 == "ehicle_moving_truck")
	{
		common_scripts\_destructible::destructible_state(undefined,"vehicle_moving_truck_dst",undefined,32,"no_melee");
	}
	else if(param_00 == "vehicle_moving_truck_tham")
	{
		common_scripts\_destructible::destructible_state(undefined,"vehicle_moving_truck_tham_dst",undefined,32,"no_melee");
	}
	else
	{
...
//Function Number: 111
create_vehicle_subway_cart_window_single(param_00,param_01,param_02)
{
...
vehicle_luxurysedan(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,210,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_luxurysedan_2008" + param_00 + "_destroy",undefined,32,"o_melee");
	var_01 = "tag_hood";
...
vehicle_mig29_landed(param_00)
{
	...
	common_scripts\_destructible::destructible_sound("car_explode");
	common_scripts\_destructible::func_976(8000,10000,512,512,50,300,undefined,undefined,0.4,1000);
	lib_0F09::nuke_explosion(%,#animtree,"setanimknob",undefined,undefined,"vehicle_mig29_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_mig29_v2_dest",undefined,32,"plash");
...
vehicle_mack_truck_short(param_00)
{
	...
	common_scripts\_destructible::destructible_loopsound("mack_truck_fire_med");
	common_scripts\_destructible::func_976(8000,10000,512,512,100,400,undefined,undefined,0.4,1000);
...
{
	var_01 = undefined;
	var_01 = get_precached_anim("vehicle_motorcycle_destroy_" + param_00);
	...
	common_scripts\_destructible::destructible_fx("tag_death_fx","explosions/small_vehicle_explosion",0);
	common_scripts\_destructible::destructible_sound("car_explode");
	common_scripts\_destructible::func_976(3000,4000,128,150,50,300);
	lib_0F09::func_746E(var_01,#animtree,"setanimknob",undefined,undefined,"vehicle_motorcycle_destroy_" + param_00);
...
vehicle_subcompact(param_00)
{
	...
	common_scripts\_destructible::destructible_fx("tag_death_fx","explosions/small_vehicle_explosion",0);
	common_scripts\_destructible::destructible_sound("car_explode");
	common_scripts\_destructible::func_976(4000,5000,150,250,50,300,undefined,0,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_subcompact_" + param_00 + "_destroyed",undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim");
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
	common_scripts\_destructible::destructible_part("right_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
...
vehicle_van(param_00)
{
	...
	common_scripts\_destructible::destructible_fx("tag_death_fx","explosions/small_vehicle_explosion",0);
	common_scripts\_destructible::destructible_sound("car_explode");
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_van_" + param_00 + "_destroyed",undefined,32,"o_melee");
	var_01 = "tag_hood";
...
vehicle_uaz_van(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_uaz_van_destroyed",undefined,32,"o_melee");
...
vehicle_van_iw5(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,param_00 + "_destroyed",undefined,32,"o_melee");
...
//Function Number: 124
vehicle_van_iw5_gas(param_00)
{
	common_scripts\_destructible::destructible_create(param_00 + "_destructable_gas","tag_body",250,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_loopfx("tag_hood_fx","smoke/car_damage_whitesmoke",0.4);
	common_scripts\_destructible::destructible_state(undefined,undefined,200,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_loopfx("tag_hood_fx","smoke/car_damage_blacksmoke",0.4);
	common_scripts\_destructible::destructible_state(undefined,undefined,100,undefined,32,"no_melee");
	...
	common_scripts\_destructible::destructible_loopsound("fire_vehicle_med");
	common_scripts\_destructible::destructible_state(undefined,undefined,400,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx("tag_origin","explosions/vehicle_explosion_medium",0);
	common_scripts\_destructible::destructible_fx("TAG_DEATH_FX","smoke/poison_gas_mp_truck",0);
	common_scripts\_destructible::destructible_createdot_radius("tag_death_fx",0,220,92);
	common_scripts\_destructible::destructible_setdot_ontick(0,1,20,0,200,0,"poison","player");
	common_scripts\_destructible::destructible_sound("car_explode");
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,param_00 + "_destroyed",undefined,32,"o_melee");
...
vehicle_delivery_theme_park_truck_destructible(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_delivery_theme_park_truck_destroyed",undefined,32,"o_melee");
...
vehicle_suburban(param_00,param_01)
{
	...
	common_scripts\_destructible::destructible_fx("tag_death_fx","explosions/small_vehicle_explosion",0);
	common_scripts\_destructible::destructible_sound("car_explode");
	common_scripts\_destructible::func_976(4000,5000,300,300,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_suburban_destroyed" + param_01,undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim");
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
	common_scripts\_destructible::destructible_car_alarm();
...
vehicle_snowmobile(param_00)
{
	...
	common_scripts\_destructible::destructible_fx("tag_death_fx","explosions/small_vehicle_explosion",0);
	common_scripts\_destructible::destructible_sound("car_explode");
	common_scripts\_destructible::func_976(4000,5000,150,150,50,300,undefined,undefined,0.3,500);
	common_scripts\_destructible::destructible_anim(get_precached_anim("ehicle_snowmobile_destroy_01"),#animtree,"setanimknob",undefined,undefined,"vehicle_snowmobile_destroy_01");
...
destructible_gaspump(param_00)
{
	...
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"gaspump01_hose");
	common_scripts\_destructible::destructible_state(undefined,undefined,400,undefined,5,"o_melee");
	...
	common_scripts\_destructible::func_976(6000,8000,210,300,50,300,undefined,undefined,0.3,500);
...
destructible_electrical_transformer_large(param_00)
{
	...
	common_scripts\_destructible::func_976(6000,8000,210,300,20,300,undefined,undefined,0.3,500);
...
vehicle_coupe(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,150,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_coupe_" + param_00 + "_destroyed",undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim",1);
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
	common_scripts\_destructible::destructible_part("right_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim",1);
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
...
vehicle_mini(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,150,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_mini_destroyed_" + param_00,undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim",1);
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
	common_scripts\_destructible::destructible_part("right_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
...
vehicle_uk_police_estate(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"uk_police_estate_destroyed",undefined,32,"o_melee");
...
vehicle_uaz_winter(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_uaz_winter_destroy",undefined,32,"o_melee");
...
vehicle_uaz_fabric(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_uaz_fabric_dsr",undefined,32,"o_melee");
...
vehicle_uaz_hardtop(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_uaz_hardtop_dsr",undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt","vehicle_uaz_wheel_LF_d",20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim",1);
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
	common_scripts\_destructible::destructible_part("left_wheel_02_jnt","vehicle_uaz_wheel_LF_d",20,undefined,undefined,"no_melee");
...
vehicle_jeep(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_jeep_destroyed",undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim",1);
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
...
vehicle_uaz_open(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_uaz_open_dsr",undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt","vehicle_uaz_wheel_LF_d",20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim",1);
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
	common_scripts\_destructible::destructible_part("left_wheel_02_jnt","vehicle_uaz_wheel_LF_d",20,undefined,undefined,"no_melee");
...
vehicle_india_compact_destructible(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_india_compact_destroyed_" + param_00,undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim",1);
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
...
vehicle_india_rickshaw(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"india_vehicle_rksw_d",undefined,32,"o_melee");
	var_01 = "tag_glass_front";
...
vehicle_tuk_tuk(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_tuk_tuk_destroyed",undefined,32,"o_melee");
	var_01 = "tag_glass_front";
	common_scripts\_destructible::destructible_part(var_01,undefined,30,undefined,undefined,undefined,undefined,undefined,1);
	common_scripts\_destructible::destructible_state(var_01 + "_d",undefined,60,undefined,undefined,undefined,1);
	common_scripts\_destructible::destructible_fx("tag_glass_front_fx","props/car_glass_med");
...
vehicle_india_suv(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_india_suv_" + param_00 + "_dsr",undefined,32,"o_melee");
...
vehicle_policecar(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_policecar_lapd_destroy",undefined,32,"o_melee");
...
vehicle_policecar_russia(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_policecar_russia_destroy",undefined,32,"o_melee");
...
vehicle_taxi(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_taxi_yellow_destroy",undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim");
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
	common_scripts\_destructible::destructible_car_alarm();
...
vehicle_taxi_dubai(param_00)
{
	...
	common_scripts\_destructible::func_976(4000,5000,200,250,50,300,undefined,undefined,0.3,500);
	lib_0F09::func_746E(%,#animtree,"setanimknob",undefined,undefined,"vehicle_80s_sedan1_destroy");
	common_scripts\_destructible::destructible_state(undefined,"vehicle_taxi_yellow_destroy_dubai",undefined,32,"o_melee");
	common_scripts\_destructible::destructible_part("left_wheel_01_jnt",undefined,20,undefined,undefined,"no_melee");
	lib_0F09::func_7462(%,#animtree,"setanim");
	common_scripts\_destructible::destructible_sound("veh_tire_deflate","ullet");
	common_scripts\_destructible::destructible_car_alarm();
...
//Function Number: 151
toy_security_camera2(param_00,param_01)
{
	common_scripts\_destructible::destructible_create(param_00,"tag_camera_tilt",0,undefined,32);
	lib_0F09::monitor_player_distance(get_precached_anim(param_01),#animtree,"setanimknob",undefined,undefined,param_01);
	common_scripts\_destructible::destructible_state("tag_camera_tilt","om_security_camera_tilt_animated",75);
	common_scripts\_destructible::destructible_anim(get_precached_anim("ecurity_camera_destroy"),#animtree,"setanimknob",undefined,undefined,"security_camera_destroy");
...
{
	common_scripts\_destructible::destructible_create(param_00,"tag_camera_tilt",0,undefined,32);
	common_scripts\_destructible::destructible_anim(get_precached_anim("ecurity_camera_idle"),#animtree,"setanimknob",undefined,undefined,"security_camera_idle");
...
toy_building_collapse_paris_ac130(param_00)
{
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("c130_building_collapse"),#animtree,"setanimknob",undefined,undefined,"ac130_building_collapse");
...
{
	common_scripts\_destructible::destructible_create(param_00,"tag_origin",100,undefined,32);
	common_scripts\_destructible::destructible_anim(get_precached_anim("ondon_gas_attack"),#animtree,"setanimknob",undefined,undefined,"london_gas_attack");
...
toy_fortune_machine(param_00)
{
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("ortune_machine_anim"),#animtree,"setanimknob",undefined,undefined,"fortune_machine_anim");
	...
	common_scripts\_destructible::destructible_sound("pinball_machine_destroy");
	common_scripts\_destructible::destructible_anim(get_precached_anim("ortune_machine_des"),#animtree,"setanimknob",undefined,undefined,"fortune_machine_des");
	common_scripts\_destructible::func_976(20,2000,20,20,40,40,undefined,64);
...
func_0A1B(param_00)
{
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("fr_shanty01_explode"),#animtree,"setanimknob",undefined,undefined,"afr_shanty01_explode");
...
vehicle_slava_ny_harbor_zonea(param_00)
{
	...
	common_scripts\_destructible::destructible_anim(get_precached_anim("y_harbor_slava_r2a_des"),#animtree,"setanim");
...
//Function Number: 164
dest_pb_planter(param_00,param_01,param_02,param_03)
{
...
//Function Number: 165
berlin_hotel_lights_ceiling1(param_00,param_01)
{
	common_scripts\_destructible::destructible_create(param_00,"tag_origin",150,undefined,32);
...
//Function Number: 166
toy_old_wood_barrels(param_00,param_01,param_02)
{
	common_scripts\_destructible::destructible_create("toy_old_wood_" + param_00,"tag_origin",120,undefined,32,"splash");
	common_scripts\_destructible::destructible_fx("tag_origin","props/old_wood_" + param_01,1,undefined);
	common_scripts\_destructible::destructible_sound("exp_old_wood_barrel");
	common_scripts\_destructible::func_976(600,651,1,1,10,20);
	common_scripts\_destructible::destructible_state(undefined,"old_wood_barrel_dmg_" + param_02,undefined,undefined,undefined,undefined,undefined,0);
}

//Function Number: 167
toy_terracotta_pot(param_00,param_01)
{
	common_scripts\_destructible::destructible_create(param_00,"tag_origin",50,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx("tag_origin","props/prop_terracotta_pot_" + param_01 + "_dest",1,undefined);
	common_scripts\_destructible::func_976(600,651,1,1,10,20);
	common_scripts\_destructible::destructible_state(undefined,"prop_terracotta_null_mesh",undefined,undefined,undefined,undefined,undefined,0);
}
...
rus_vx_gas_canister(param_00)
{
	...
	common_scripts\_destructible::func_976(7000,8000,150,256,16,150,undefined);
}

//Function Number: 169
toy_furniture_coffee_table_modern(param_00,param_01,param_02)
{
	common_scripts\_destructible::destructible_create(param_00,"tag_origin",50,undefined,32,"no_melee");
	common_scripts\_destructible::destructible_fx("tag_fx","props/furniture_coffee_table_modern_0" + param_01,1,undefined);
	common_scripts\_destructible::func_976(600,1651,param_02,param_02,10,20,undefined,10);
	common_scripts\_destructible::destructible_state(undefined,"furniture_coffee_table_modern_0" + param_01 + "_dest",undefined,undefined,undefined,undefined,undefined,0);
}