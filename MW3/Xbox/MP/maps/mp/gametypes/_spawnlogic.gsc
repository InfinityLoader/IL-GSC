...
//Function Number: 4
func_2FD0(param_00,param_01,param_02)
{
	...
	for(var_04 = 0;var_04 < var_03.size;var_04++)
	{
		...
		level.spawnmaxs = func_2FCF(level.spawnmaxs,var_06);
...
func_2FD9(param_00)
{
	...
	for(var_02 = 0;var_02 < var_01.size;var_02++)
	{
		...
		level.spawnmaxs = func_2FCF(level.spawnmaxs,var_01[var_02].origin);
	}
}
...
func_2B8C()
{
	...
	func_2FD9("mp_tdm_spawn_allies_start");
	func_2FD9("mp_tdm_spawn_axis_start");
	level.mapcenter = func_2FCD(level.spawnmins,level.spawnmaxs);
...
spawnpointinit()
{
	...
	level.spawnmaxs = func_2FCF(level.spawnmaxs,var_01);
	...
	var_00.alternates = [];
	func_2FDE(var_00,var_00.origin + var_04 * 45);
	func_2FDE(var_00,var_00.origin - var_04 * 45);
...
getallotherplayers()
{
	...
	for(var_01 = 0;var_01 < level.players.size;var_01++)
	{
		...
		if(var_02.sessionstate == "spectating" || var_02 == self)
		{
			continue;
		}
...
func_2FE6(param_00,param_01)
{
	...
	foreach(var_07 in param_00)
	{
		if(var_07.numplayersatlastupdate > 0)
		{
			...
			if(isdefined(level.favorclosespawnentattacker))
			{
				...
				var_0A = distance(var_07.origin,level.favorclosespawnentattacker.origin);
				var_07.weight = var_07.weight - var_0A * level.favorclosespawnscalarattacker;
			}
			...
			if(isdefined(level.favorclosespawnentdefender))
			{
				...
				var_0A = distance(var_07.origin,level.favorclosespawnentdefender.origin);
				var_07.weight = var_07.weight - var_0A * level.favorclosespawnscalardefender;
			}
		}
		else
		{
	...
	func_3015(param_00,1);
	if(isdefined(self.lastdeathpos) && level.gametype != "dom")
	{
		func_3013(param_00,self.lastdeathpos);
	}

	var_0D = func_2FE0(param_00);
	return var_0D;
}
...
func_2FEF(param_00)
{
	...
	if(var_01.size > 0)
	{
		for(var_04 = 0;var_04 < param_00.size;var_04++)
		{
			...
			{
				if(var_01[var_07].sessionstate == "dead" && isdefined(var_01[var_07].bestspawnpoint))
				{
					var_08 = distance(param_00[var_04].origin,var_01[var_07].bestspawnpoint.origin);
				}
				else
				{
	...
	avoidsamespawn();
	avoidweapondamage(param_00);
	func_3015(param_00,0);
	return getspawnpoint_final_dm(param_00);
}

//Function Number: 21
getspawnpoint_final_dm(param_00)
{
	var_01 = undefined;
	if(!isdefined(param_00) || param_00.size == 0)
	{
	...
	var_01 = getbestweightedspawnpoint(param_00);
	if(!isdefined(var_01))
	{
		var_01 = param_00[randomint(param_00.size)];
	}

	self.bestspawnpoint = var_01;
	return var_01;
}
...
spawnprofile()
{
	...
	for(;;)
	{
		...
		var_00 func_2FE6(level.spawnpoints);
		wait 0.05;
	}
}
...
spawngraph()
{
	...
	for(;;)
	{
		...
		level.players[0] func_2FE6(var_03);
		...
		var_0C = 1;
		level.players[0] func_2FFE(var_03,var_00,var_01,var_02);
		wait 0.05;
	}
}

//Function Number: 29
func_2FFE(param_00,param_01,param_02,param_03)
{
	level notify("spawn_graph_stop_draw");
	var_04 = 0;
	for(var_05 = 0;var_05 < param_02;var_05++)
	{
		...
		for(var_07 = 0;var_07 < param_01;var_07++)
		{
			...
			if(var_05 > 0)
			{
				thread func_3001(param_00[var_04],param_00[var_04 - param_01],param_03);
			}

			if(var_07 > 0)
			{
				thread func_3001(param_00[var_04],param_00[var_04 - 1],param_03);
			}
...
//Function Number: 31
func_3001(param_00,param_01,param_02)
{
...
spawnpointupdate(param_00)
{
	...
	foreach(var_0A in level.players)
	{
		...
		var_41[var_07] = var_41[var_07] + var_0C;
		...
		param_00.numplayersatlastupdate++ = var_41["axis"];
		var_03[var_07]++ = 0;
		...
		else if(var_0A getstance() == "crouch")
		{
			var_0F = 54;
		}
		else
		...
		var_10 = spawnsighttrace(param_00,param_00.origin + (0,0,var_0F),var_0A.origin + (0,0,var_0F));
		...
		if(var_10 > 0)
		{
			...
			if(var_08)
			{
				param_00.sights[var_07] = param_00.sights[var_07] + var_10;
				continue;
			}
	...
	var_12 = maps\mp\_utility::func_300C("scr_spawn_enemyavoiddist",2000);
	var_13 = 2000;
	var_14 = maps\mp\_utility::func_300C("scr_spawn_enemyavoiddist_strict",750);
	var_15 = maps\mp\_utility::getintproperty("scr_spawn_enemyavoidpenalty_strict",-15536);
	foreach(var_07, var_17 in var_41)
	{
		if(var_41[var_07])
		{
			param_00.weighteddistsum[var_07] = param_00.weighteddistsum[var_07] / var_41[var_07] * var_03[var_07];
		}

		var_18 = 0;
		var_19 = param_00.mindist[var_07];
		if(var_19 < var_12)
		{
			var_18 = var_13 * 1 - var_19 / var_12;
		}
		...
		param_00.nearbypenalty[var_07] = var_18;
	}

	foreach(var_1B in level.tanks)
	{
		var_10 = spawnsighttrace(param_00,param_00.sighttracepoint,var_1B.origin + (0,0,50));
		param_00.lastsighttracetime = gettime();
		if(var_10 <= 0)
		{
			continue;
		...
		if(var_08)
		{
			param_00.sights[var_1B.team] = param_00.sights[var_1B.team] + var_10;
			continue;
		}
	...
	foreach(var_1E in level.turrets)
	{
		if(!isdefined(var_1E))
		{
			continue;
		...
		var_10 = spawnsighttrace(param_00,param_00.sighttracepoint,var_1E.origin + (0,0,50));
		param_00.lastsighttracetime = gettime();
		if(var_10 <= 0)
		{
			continue;
		...
		if(var_08)
		{
			param_00.sights[var_1E.team] = param_00.sights[var_1E.team] + var_10;
			continue;
		}
	...
	foreach(var_21 in level.ims)
	{
		...
		if(!isdefined(var_21.attackheightpos))
		{
			continue;
		}

		var_10 = spawnsighttrace(param_00,param_00.sighttracepoint,var_21.attackheightpos);
		param_00.lastsighttracetime = gettime();
		if(var_10 <= 0)
		{
			continue;
		...
		if(var_08)
		{
			param_00.sights[var_21.team] = param_00.sights[var_21.team] + var_10;
			continue;
		}
	...
	foreach(var_24 in level.ugvs)
	{
		...
		var_10 = spawnsighttrace(param_00,param_00.sighttracepoint,var_24.origin + (0,0,50));
		param_00.lastsighttracetime = gettime();
		if(var_10 <= 0)
		{
			continue;
		...
		if(var_08)
		{
			param_00.sights[var_24.team] = param_00.sights[var_24.team] + var_10;
			continue;
		}
...
func_3010(param_00)
{
	...
	if(isdefined(var_01))
	{
		...
		else if(var_02 getstance() == "crouch")
		{
			var_09 = 54;
		}
		else
		...
		var_0A = spawnsighttrace(param_00,param_00.origin + (0,0,var_09),var_01.origin + (0,0,var_09));
		if(var_0A > 0)
		{
			var_0A = adjustsightvalue(var_0A);
			return var_0A;
		}
	}
	...
	if(isdefined(var_03))
	{
		if(var_03 getstance() == "stand")
		{
			var_09 = 72;
		}
		else if(var_04 getstance() == "crouch")
		{
			var_09 = 54;
		}
		else
		...
		var_0A = spawnsighttrace(param_00,param_00.origin + (0,0,var_09),var_03.origin + (0,0,var_09));
		if(var_0A > 0)
		{
			var_0A = adjustsightvalue(var_0A);
			return var_0A;
...
func_3013(param_00,param_01)
{
	...
	{
		func_3014(param_00,self.lastattacker.origin);
	}
}

//Function Number: 45
func_3014(param_00,param_01)
{
	var_02 = getrevengespawndistancesq();
	var_03 = func_3011();
	foreach(var_05 in param_00)
