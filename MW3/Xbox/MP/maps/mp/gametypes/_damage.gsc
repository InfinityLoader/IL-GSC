...
{
	var_00 = maps\mp\gametypes\_teams::func_2764();
	var_7E[self.leaving_team];
	var_7D[self.joining_team];
	return var_7D[self.joining_team] - var_7D[self.leaving_team] < 2;
}

//Function Number: 3
func_2CC0(param_00,param_01)
{
	if(!level.teambased)
	{
		return 0;
...
isheadshot(param_00,param_01,param_02,param_03)
{
	...
	return (param_01 == "head" || param_01 == "helmet") && param_02 != "MOD_MELEE" && param_02 != "MOD_IMPACT" && !maps\mp\_utility::func_2CC3(param_00);
}
...
func_2CC4()
{
	...
	if(self.joining_team == "spectator" || !isteamswitchbalanced())
	{
		...
		maps\mp\_utility::func_26FB("suicides",1);
		self.suicides = maps\mp\_utility::getpersstat("suicides");
	}
}

//Function Number: 7
func_2CC5(param_00,param_01,param_02,param_03)
{
...
handlesuicidedeath(param_00,param_01)
{
	...
	var_02 = maps\mp\gametypes\_tweakables::func_270D("game","suicidepointloss");
...
func_2CC8(param_00)
{
	...
	if(maps\mp\gametypes\_tweakables::func_270D("team","teamkillpointloss"))
	{
...
{
	param_01 thread maps\mp\_events::func_2A97(param_00,self,param_03,param_04);
	...
	{
		param_01 maps\mp\_utility::func_26FB("headshots",1);
	...
	param_01 thread maps\mp\gametypes\_rank::func_2AB3("kill",var_05,param_03,param_04);
	param_01 maps\mp\_utility::func_26FB("kills",1);
	param_01.kills = param_01 maps\mp\_utility::getpersstat("kills");
	param_01 maps\mp\_utility::updatepersratio("kdRatio","kills","deaths");
	param_01 maps\mp\gametypes\_persistence::func_26D8("round","kills",param_01.kills);
	...
	if(maps\mp\_utility::func_27AF("specialty_copycat"))
	{
	...
	{
		if(param_01 maps\mp\_utility::func_2CCE(param_03))
		{
			param_01 thread maps\mp\killstreaks\_killstreaks::giveadrenaline("kill");
			param_01.pers["cur_kill_streak"]++;
			if(!maps\mp\_utility::func_2829(param_03))
			{
				param_01.pers["cur_kill_streak_for_nuke"]++;
			}

			var_07 = 25;
			if(param_01 maps\mp\_utility::func_27AF("specialty_hardline"))
			{
				var_07--;
			}

			if(!maps\mp\_utility::func_2829(param_03) && param_01.pers["cur_kill_streak_for_nuke"] == var_07)
			{
		...
		param_01 maps\mp\_utility::func_2AAA("killstreak",param_01.pers["cur_kill_streak"]);
		if(param_01.pers["cur_kill_streak"] > param_01 maps\mp\_utility::getpersstat("longestStreak"))
		{
			param_01 maps\mp\_utility::func_2CCF("longestStreak",param_01.pers["cur_kill_streak"]);
		}
	}
	...
	{
		param_01 maps\mp\gametypes\_persistence::func_26D8("round","killStreak",param_01.pers["cur_kill_streak"]);
	}

	if(param_01.pers["cur_kill_streak"] > param_01.kill_streak)
	{
		param_01 maps\mp\gametypes\_persistence::func_2CD1("killStreak",param_01.pers["cur_kill_streak"]);
		param_01.kill_streak = param_01.pers["cur_kill_streak"];
	}

	maps\mp\gametypes\_gamescore::func_26D3("kill",param_01,self);
	maps\mp\_skill::processkill(param_01,self);
	var_08 = maps\mp\gametypes\_tweakables::func_270D("game","deathpointloss");
	...
	if(isdefined(self.lastattackedshieldplayer) && isdefined(self.lastattackedshieldtime) && self.lastattackedshieldplayer != param_01)
	{
		...
		{
			self.lastattackedshieldplayer thread maps\mp\gametypes\_gamescore::func_2700(self);
			if(self.lastattackedshieldplayer maps\mp\_utility::func_27AF("specialty_assists"))
			{
	...
	if(isdefined(self.attackers))
	{
		foreach(var_0C in self.attackers)
		{
			...
			var_0C thread maps\mp\gametypes\_gamescore::func_26F9(self);
			if(var_0C maps\mp\_utility::func_27AF("specialty_assists"))
			{
				...
				if(!var_0C.pers["assistsToKill"] % 2)
				{
					...
					if(!maps\mp\_utility::func_2829(param_03))
					{
						var_0C.pers["cur_kill_streak_for_nuke"]++;
					}

					var_07 = 25;
					if(var_0C maps\mp\_utility::func_27AF("specialty_hardline"))
					{
						var_07--;
					}

					if(!maps\mp\_utility::func_2829(param_03) && var_0C.pers["cur_kill_streak_for_nuke"] == var_07)
					{
...
{
	func_2CDB(param_00,param_01,self,param_02,param_03,param_04,param_05,param_06,param_07,param_08,0);
}
...
//Function Number: 15
func_2CDB(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09,param_0A)
{
	...
	{
		param_02 func_2CD8(param_03,param_04);
	}
	...
	var_11 = func_2CC0(param_02,param_01);
	if(isdefined(param_01))
	{
		...
		{
			param_01 = param_01.owner;
			if(!func_2CC0(param_02,param_01) && param_01 != param_02)
			{
	...
	{
		param_02 maps\mp\_utility::func_26FB("deaths",1);
		...
		param_02 maps\mp\gametypes\_persistence::func_26D8("round","deaths",param_02.deaths);
		param_02 maps\mp\_utility::incplayerstat("deaths",1);
	}

	if(isdefined(param_01) && isplayer(param_01))
	{
		param_01 func_2CF0(param_02);
	}

	obituary(param_02,param_01,param_05,param_04);
	var_12 = 0;
	var_13 = maps\mp\_utility::func_28D8();
	param_02 func_2D55(var_13,param_01,param_03,param_04,param_05,var_0C,param_07);
	param_02 maps\mp\_matchdata::func_28B6(var_13);
	param_02 maps\mp\_matchdata::func_28CF(var_13,param_01,param_03,param_04,param_05,var_0C,param_07);
	...
	if(param_02 func_2CBE())
	{
		func_2CC4();
	}
	else if(!isplayer(param_01) || isplayer(param_01) && param_04 == "MOD_FALLING")
	{
		func_2CC5(param_01,var_13,param_04,param_07);
	}
	...
	else
	{
		...
		{
			func_2D2E(param_02,param_01,param_00,param_05,param_03,(0,0,0),param_06,param_07,param_08,param_04);
		}

		var_12 = 1;
		handlenormaldeath(var_13,param_01,param_00,param_05,param_04);
		param_02 thread maps\mp\gametypes\_missions::func_2CE6(param_00,param_01,param_03,param_04,param_05,var_0C,param_07,param_01.modifiers);
		param_02.pers["cur_death_streak"]++;
		if(!maps\mp\_utility::getgametypenumlives() && !maps\mp\_utility::matchmakinggame())
		{
			param_02 maps\mp\_utility::func_2AAA("deathstreak",param_02.pers["cur_death_streak"]);
		}
	...
	if(maps\mp\killstreaks\_killstreaks::func_2CEC(param_02.streaktype))
	{
	...
	{
		func_2CFF(5,param_02,param_01,var_17,var_19,var_1A,param_05,var_0B,param_08);
	}
	...
	if(!param_0A)
	{
		...
		{
			if(param_02 maps\mp\_utility::func_27AF("specialty_copycat") && isdefined(param_02.pers["copyCatLoadout"]))
			{
				param_02 thread maps\mp\gametypes\_killcam::func_2BA9(param_01);
				wait 1;
			}
		}
		...
		var_1B = maps\mp\gametypes\_playerlogic::func_2B00(1);
		if(var_1B < 1)
		{
			var_1B = 1;
		}
	...
	if(!isdefined(param_02.cancelkillcam) && param_02.cancelkillcam && var_12 && level.killcam && game["state"] == "playing" && !param_02 maps\mp\_utility::isusingremote() && !level.showingfinalkillcam)
	{
		...
		param_02 maps\mp\gametypes\_killcam::killcam(var_17,var_19,var_1A,param_05,var_1C + var_0B,param_08,var_1B,maps\mp\gametypes\_gamelogic::func_2CEE(),param_01,param_02);
	}
	...
	if(game["state"] != "playing")
	{
		...
		{
			param_02.sessionstate = "dead";
			param_02 maps\mp\_utility::func_2B28();
		}

		return;
	}

	if(maps\mp\_utility::func_2B5F(param_02.class))
	{
...
//Function Number: 19
func_2CFF(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08)
{
	if(level.teambased && isdefined(param_02.team))
	{
		...
		level.finalkillcam_timerecorded[param_02.team] = maps\mp\_utility::func_2D00();
		level.finalkillcam_timegameended[param_02.team] = maps\mp\_utility::func_2D00();
	}
	...
	level.finalkillcam_timerecorded["none"] = maps\mp\_utility::func_2D00();
	level.finalkillcam_timegameended["none"] = maps\mp\_utility::func_2D00();
}
...
func_2D02()
{
		...
		if(level.gametype == "conf" && isdefined(level.finalkillcam_attacker[var_03.team]) && level.finalkillcam_attacker[var_03.team] == var_03)
		{
			...
			switch(level.finalkillcam_sweapon[var_03.team])
			{
				...
				case "pavelow_minigun_mp":
					var_03 maps\mp\gametypes\_missions::processchallenge("ch_transformer");
					break;
				...
				case "cobra_20mm_mp":
					var_03 maps\mp\gametypes\_missions::processchallenge("ch_og");
					break;
	...
	foreach(var_10 in level.players)
	{
		...
		if((var_10 != var_02 || !maps\mp\_utility::func_26EC() || maps\mp\_utility::func_2B08()) && var_10 maps\mp\_utility::func_27AF("specialty_copycat"))
		{
			var_10 maps\mp\_utility::func_282E("specialty_copycat");
		}
...
getkillcamentity(param_00,param_01,param_02)
{
	...
	{
		if(isdefined(param_01.killcament) && !param_00 func_2D09())
		{
			return param_01.killcament;
		}
		else
...
//Function Number: 26
func_2D0D(param_00,param_01,param_02,param_03,param_04)
{
	var_05 = [];
	...
	{
		for(var_06 = 0;var_06 < 6;var_06++ = var_41[3])
		{
	...
	for(var_06 = var_07 - 1;var_06 > 0;var_06-- = var_41[2])
	{
	...
	if(isdefined(param_01.damageinfovictim) && param_01.damageinfovictim != param_02)
	{
		...
		if(param_01.damageinfocolorindex == var_41.size)
		{
			param_01.damageinfocolorindex = 0;
		}
	}
	...
	for(var_06 = 0;var_06 < var_07;var_06++ = var_41[1])
	{
		var_08 = "^" + var_41[param_01.damageinfo[var_06].colorindex];
...
//Function Number: 28
func_2D16(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09,param_0A)
{
	...
	if(param_06 == "bouncingbetty_mp" && !maps\mp\gametypes\_weapons::func_28A2(param_00,param_02))
	{
		return;
	}
	...
	var_0C = level.teambased && isdefined(param_01) && param_02 != param_01 && isdefined(param_01.team) && param_02.pers["team"] == param_01.team || isdefined(param_01.teamchangedthisframe);
	...
	else if(param_09 == "shield")
	{
		...
		if(param_05 == "MOD_PISTOL_BULLET" || param_05 == "MOD_RIFLE_BULLET" || param_05 == "MOD_EXPLOSIVE_BULLET" && !var_0C)
		{
			...
			if(maps\mp\_utility::func_2CC3(param_06))
			{
				var_0F = 25;
			}
			else
			{
				var_0F = maps\mp\perks\_perks::func_297C(param_03,param_02,param_04,param_06,param_07,param_08,param_09,param_0A);
			}

			param_02.shielddamage = param_02.shielddamage + var_0F;
			if(!maps\mp\_utility::func_2CC3(param_06) || common_scripts\utility::cointoss())
			{
			...
			if(param_02.shieldbullethits >= level.riotshieldxpbullets)
			{
				...
				param_02 thread maps\mp\gametypes\_rank::func_2AB3("shield_damage",var_10);
				param_02 thread func_2D15();
	...
	if(!var_0C)
	{
		param_03 = maps\mp\perks\_perks::func_297C(param_02,param_01,param_03,param_05,param_06,param_07,param_08,param_09);
	}
	...
	if(maps\mp\gametypes\_tweakables::func_270D("game","onlyheadshots"))
	{
	...
	if(gettime() < param_02.spawntime + level.killstreakspawnshield)
	{
		...
		if(param_03 >= var_12 && maps\mp\_utility::func_2829(param_06))
		{
			param_03 = var_12;
		}
	}
	...
	if(!param_04 & level.idflags_no_protection)
	{
		...
		if((issubstr(param_05,"MOD_GRENADE") || issubstr(param_05,"MOD_EXPLOSIVE") || issubstr(param_05,"MOD_PROJECTILE")) && isdefined(param_00) && isdefined(param_01))
		{
			...
			{
				maps\mp\gametypes\_gamelogic::func_2D23(param_00,param_01,param_06);
			}
		}

		if(issubstr(param_05,"MOD_IMPACT") && param_06 == "m320_mp" || issubstr(param_06,"gl") || issubstr(param_06,"gp25") || param_06 == "xm25_mp")
		{
			if(isplayer(param_01) && param_01 != self)
			{
				maps\mp\gametypes\_gamelogic::func_2D23(param_00,param_01,param_06);
		...
		if(var_0C)
		{
			...
			if(level.friendlyfire == 0 || !isplayer(param_01) && level.friendlyfire != 1)
			{
				...
				{
					param_02 func_2D49(param_00,param_06,param_05,param_03,param_04,param_01);
				}
		...
		else
		{
			...
			if(isdefined(param_01) && isplayer(param_01))
			{
				func_2D2E(param_02,param_01,param_00,param_06,param_03,param_07,param_08,param_09,param_0A,param_05);
			}
			...
			{
				param_01 thread maps\mp\_events::func_2A96(self,param_03,param_06);
		...
		if(isdefined(var_15) && var_15 != param_02 && param_03 > 0 && !isdefined(param_09) || param_09 != "shield")
		{
			...
			else if(isexplosivedamagemod(param_06) && param_03 maps\mp\_utility::func_27AF("_specialty_blastshield"))
			{
				var_16 = "hitBodyArmor";
			}
			else if(param_03 maps\mp\_utility::func_27AF("specialty_combathigh"))
			{
				var_16 = "hitEndGame";
			}
	...
	func_2D0D(param_01,param_02,param_03,param_09,param_04);
...
//Function Number: 30
func_2D2A(param_00,param_01,param_02,param_03,param_04)
{
...
//Function Number: 32
func_2D2E(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09)
{
	...
	if(maps\mp\gametypes\_weapons::isprimaryweapon(param_03) && !maps\mp\gametypes\_weapons::func_287D(param_03))
	{
...
//Function Number: 34
func_2D32(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09)
{
	func_2D16(param_00,param_01,self,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09);
}
...
finishplayerdamagewrapper(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09,param_0A)
{
	if(maps\mp\_utility::isusingremote() && param_02 >= self.health && !param_03 & level.idflags_stun)
	{
		...
		func_2CDB(param_00,param_01,self,param_02,param_04,param_05,param_07,param_08,param_09,0,1);
	}
	else
	{
		if(!func_2D50(param_00,param_01,param_02 - param_02 * param_0A,param_03,param_04,param_05,param_06,param_07,param_08,param_09))
		{
			return;
		}
	...
	func_2D49(param_00,param_05,param_04,param_02,param_03,param_01);
}

//Function Number: 36
func_2D34(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08)
{
	var_09 = spawnstruct();
	...
	var_0A = func_2D42(param_04,param_03,param_06);
	...
	self.inlaststand = 1;
	var_0B = spawnstruct();
	if(maps\mp\_utility::func_27AF("specialty_finalstand"))
	{
		var_0B.titletext = game["strings"]["final_stand"];
		var_0B.iconname = "specialty_finalstand";
	}
	else if(maps\mp\_utility::func_27AF("specialty_c4death"))
	{
	...
	var_0B.duration = 2;
	self.health = 1;
	thread maps\mp\gametypes\_hud_message::func_EBE(var_0B);
	...
	if(maps\mp\_utility::func_27AF("specialty_finalstand"))
	{
		...
		thread func_2D3B(20,1);
		return;
	}

	if(maps\mp\_utility::func_27AF("specialty_c4death"))
	{
	...
	{
		if(maps\mp\gametypes\_weapons::func_287D(var_0F))
		{
			var_11 = var_0F;
		}
	}
	...
	common_scripts\utility::_disableusability();
	if(!maps\mp\_utility::func_27AF("specialty_laststandoffhand"))
	{
		self disableoffhandweapons();
	}

	self switchtoweapon(var_11);
	thread func_2D3B(10,0);
}
...
func_2D3B(param_00,param_01)
{
	...
	if(level.diehardmode == 1 && level.diehardmode != 2)
	{
		...
		if(param_01)
		{
			...
			{
				thread func_2D3D(param_01,var_02);
			}
		}
	...
	else if(level.diehardmode == 2)
	{
		...
		wait 0.05;
		thread func_2D3D(param_01);
		return;
	}

	thread func_2D40();
	wait var_02;
	thread func_2D3D(var_03);
}
...
func_2D3D(param_00,param_01)
{
	if(param_00)
	{
		...
		maps\mp\gametypes\_playerlogic::func_2B11();
		if(isdefined(param_01))
		{
			param_01 delete();
			return;
...
//Function Number: 48
func_2D42(param_00,param_01,param_02)
{
...
//Function Number: 54
func_2D49(param_00,param_01,param_02,param_03,param_04,param_05)
{
...
revivetriggerthink(param_00)
{
	...
	for(;;)
	{
		...
		if(var_02)
		{
			var_01 thread maps\mp\gametypes\_hud_message::func_2701("reviver",200);
			var_01 thread maps\mp\gametypes\_rank::func_2AB3("reviver",200);
			self.owner.laststand = undefined;
			self.owner maps\mp\_utility::clearlowermessage("last_stand");
			self.owner.movespeedscaler = 1;
			if(self.owner maps\mp\_utility::func_27AF("specialty_lightweight"))
			{
				self.owner.movespeedscaler = maps\mp\_utility::func_80F2();
			}

			self.owner.maxhealth = 100;
			self.owner maps\mp\gametypes\_weapons::func_2884();
			self.owner maps\mp\gametypes\_playerlogic::func_2B11();
	...
	while(maps\mp\_utility::isreallyalive(self) && isdefined(param_00) && param_00.inuse && !level.gameended && isdefined(self))
	{
		if(var_05 != param_00.userate)
		{
			...
			else
			{
				...
				var_04 maps\mp\gametypes\_hud_util::func_26BD();
			}
		}
...
//Function Number: 64
func_2D50(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09)
{
...
//Function Number: 68
func_2D54(param_00,param_01,param_02,param_03)
{
...
//Function Number: 69
func_2D55(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
...
//Function Number: 71
func_2D57(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07)
{
