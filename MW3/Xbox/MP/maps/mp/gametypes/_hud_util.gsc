 ...
 * Timestamp: 10/27/2023 2:25:34 AM
*******************************************************************/
...
//Function Number: 14
func_26A9(param_00,param_01,param_02,param_03)
{
	if(isdefined(param_03))
	{
...
//Function Number: 15
func_26AA(param_00,param_01,param_02,param_03,param_04,param_05)
{
	if(isdefined(param_04))
	{
...
func_26B5(param_00)
{
	var_01 = func_26AA((1,0,0),level.teamprogressbarwidth,level.teamprogressbarheight,undefined,param_00);
...
func_26C9(param_00)
{
	...
	{
		var_02 = self getplayerdata("weeklyChallengeId",var_01);
...
//Function Number: 43
getdailyref(param_00)
{
	for(var_01 = 0;var_01 < 3;var_01++)
	{
		var_02 = self getplayerdata("dailyChallengeId",var_01);
...
ch_getprogress(param_00)
{
	...
	{
		return self getplayerdata("challengeProgress",getdailyref(param_00));
	}

	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return self getplayerdata("challengeProgress",func_26C9(param_00));
	}
}
...
ch_getstate(param_00)
{
	...
	if(level.challengeinfo[param_00]["type"] == 1)
	{
		return self getplayerdata("challengeState",getdailyref(param_00));
	}

	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return self getplayerdata("challengeState",func_26C9(param_00));
	}
}
...
ch_setprogress(param_00,param_01)
{
	...
	if(level.challengeinfo[param_00]["type"] == 1)
	{
		return self setplayerdata("challengeProgress",getdailyref(param_00),param_01);
	}

	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return self setplayerdata("challengeProgress",func_26C9(param_00),param_01);
	}
}
...
ch_setstate(param_00,param_01)
{
	...
	if(level.challengeinfo[param_00]["type"] == 1)
	{
		return self setplayerdata("challengeState",getdailyref(param_00),param_01);
	}

	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return self setplayerdata("challengeState",func_26C9(param_00),param_01);
	}
}
...
ch_gettarget(param_00,param_01)
{
	if(level.challengeinfo[param_00]["type"] == 0)
	{
		return int(tablelookup("mp/allChallengesTable.csv",0,param_00,6 + param_01 - 1 * 2));
	}

	if(level.challengeinfo[param_00]["type"] == 1)
	{
		return int(tablelookup("mp/dailyChallengesTable.csv",0,param_00,6 + param_01 - 1 * 2));
	}

	if(level.challengeinfo[param_00]["type"] == 2)
	{
		return int(tablelookup("mp/weeklyChallengesTable.csv",0,param_00,6 + param_01 - 1 * 2));
	}
}