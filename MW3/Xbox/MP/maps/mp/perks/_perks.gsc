 ...
 * Timestamp: 10/27/2023 2:27:33 AM
*******************************************************************/
...
init()
{
	...
	level.perksetfuncs["specialty_blastshield"] = ::maps\mp\perks\_perkfunctions::func_2923;
	level.perkunsetfuncs["specialty_blastshield"] = ::maps\mp\perks\_perkfunctions::func_2924;
	level.perksetfuncs["specialty_siege"] = ::maps\mp\perks\_perkfunctions::func_2925;
	level.perkunsetfuncs["specialty_siege"] = ::maps\mp\perks\_perkfunctions::unsetsiege;
	level.perksetfuncs["specialty_falldamage"] = ::maps\mp\perks\_perkfunctions::func_2927;
	level.perkunsetfuncs["specialty_falldamage"] = ::maps\mp\perks\_perkfunctions::func_2928;
	...
	level.perkunsetfuncs["specialty_thermal"] = ::maps\mp\perks\_perkfunctions::func_292C;
	level.perksetfuncs["specialty_blackbox"] = ::maps\mp\perks\_perkfunctions::setblackbox;
	level.perkunsetfuncs["specialty_blackbox"] = ::maps\mp\perks\_perkfunctions::func_292E;
	level.perksetfuncs["specialty_lightweight"] = ::maps\mp\perks\_perkfunctions::setlightweight;
	level.perkunsetfuncs["specialty_lightweight"] = ::maps\mp\perks\_perkfunctions::func_2930;
	level.perksetfuncs["specialty_steelnerves"] = ::maps\mp\perks\_perkfunctions::func_2931;
	level.perkunsetfuncs["specialty_steelnerves"] = ::maps\mp\perks\_perkfunctions::unsetsteelnerves;
	level.perksetfuncs["specialty_delaymine"] = ::maps\mp\perks\_perkfunctions::func_2933;
	level.perkunsetfuncs["specialty_delaymine"] = ::maps\mp\perks\_perkfunctions::unsetdelaymine;
	level.perksetfuncs["specialty_challenger"] = ::maps\mp\perks\_perkfunctions::func_2935;
	level.perkunsetfuncs["specialty_challenger"] = ::maps\mp\perks\_perkfunctions::unsetchallenger;
	level.perksetfuncs["specialty_saboteur"] = ::maps\mp\perks\_perkfunctions::func_2937;
	level.perkunsetfuncs["specialty_saboteur"] = ::maps\mp\perks\_perkfunctions::func_2938;
	level.perksetfuncs["specialty_endgame"] = ::maps\mp\perks\_perkfunctions::func_2939;
	level.perkunsetfuncs["specialty_endgame"] = ::maps\mp\perks\_perkfunctions::func_293A;
	level.perksetfuncs["specialty_rearview"] = ::maps\mp\perks\_perkfunctions::func_293B;
	level.perkunsetfuncs["specialty_rearview"] = ::maps\mp\perks\_perkfunctions::func_293C;
	level.perksetfuncs["specialty_ac130"] = ::maps\mp\perks\_perkfunctions::func_293D;
	level.perkunsetfuncs["specialty_ac130"] = ::maps\mp\perks\_perkfunctions::unsetac130;
	level.perksetfuncs["specialty_sentry_minigun"] = ::maps\mp\perks\_perkfunctions::func_293F;
	level.perkunsetfuncs["specialty_sentry_minigun"] = ::maps\mp\perks\_perkfunctions::func_2940;
	level.perksetfuncs["specialty_predator_missile"] = ::maps\mp\perks\_perkfunctions::setpredatormissile;
	level.perkunsetfuncs["specialty_predator_missile"] = ::maps\mp\perks\_perkfunctions::func_2942;
	level.perksetfuncs["specialty_tank"] = ::maps\mp\perks\_perkfunctions::func_2943;
	level.perkunsetfuncs["specialty_tank"] = ::maps\mp\perks\_perkfunctions::func_2944;
	...
	level.perksetfuncs["specialty_helicopter_minigun"] = ::maps\mp\perks\_perkfunctions::func_2947;
	level.perkunsetfuncs["specialty_helicopter_minigun"] = ::maps\mp\perks\_perkfunctions::unsethelicopterminigun;
	level.perksetfuncs["specialty_onemanarmy"] = ::maps\mp\perks\_perkfunctions::func_2949;
	...
	level.perkunsetfuncs["specialty_littlebird_support"] = ::maps\mp\perks\_perkfunctions::func_294C;
	level.perksetfuncs["specialty_tacticalinsertion"] = ::maps\mp\perks\_perkfunctions::settacticalinsertion;
	level.perkunsetfuncs["specialty_tacticalinsertion"] = ::maps\mp\perks\_perkfunctions::func_294E;
	level.perksetfuncs["specialty_scrambler"] = ::maps\mp\gametypes\_scrambler::func_28FD;
	...
	level.perkunsetfuncs["specialty_steadyaimpro"] = ::maps\mp\perks\_perkfunctions::func_2950;
	level.perksetfuncs["specialty_stun_resistance"] = ::maps\mp\perks\_perkfunctions::func_2951;
	...
	level.perksetfuncs["specialty_double_load"] = ::maps\mp\perks\_perkfunctions::func_2955;
	level.perkunsetfuncs["specialty_double_load"] = ::maps\mp\perks\_perkfunctions::unsetdoubleload;
	level.perksetfuncs["specialty_sharp_focus"] = ::maps\mp\perks\_perkfunctions::func_2957;
	level.perkunsetfuncs["specialty_sharp_focus"] = ::maps\mp\perks\_perkfunctions::func_2958;
	level.perksetfuncs["specialty_hard_shell"] = ::maps\mp\perks\_perkfunctions::func_2959;
	level.perkunsetfuncs["specialty_hard_shell"] = ::maps\mp\perks\_perkfunctions::unsethardshell;
	level.perksetfuncs["specialty_regenspeed"] = ::maps\mp\perks\_perkfunctions::func_295B;
	level.perkunsetfuncs["specialty_regenspeed"] = ::maps\mp\perks\_perkfunctions::func_295C;
	level.perksetfuncs["specialty_autospot"] = ::maps\mp\perks\_perkfunctions::func_295D;
	level.perkunsetfuncs["specialty_autospot"] = ::maps\mp\perks\_perkfunctions::func_295E;
	level.perksetfuncs["specialty_empimmune"] = ::maps\mp\perks\_perkfunctions::func_295F;
	level.perkunsetfuncs["specialty_empimmune"] = ::maps\mp\perks\_perkfunctions::func_2960;
	...
	level.perksetfuncs["specialty_light_armor"] = ::maps\mp\perks\_perkfunctions::func_2965;
	...
	level.perksetfuncs["specialty_c4death"] = ::maps\mp\perks\_perkfunctions::func_2969;
	level.perkunsetfuncs["specialty_c4death"] = ::maps\mp\perks\_perkfunctions::func_296A;
	...
	level.perkunsetfuncs["specialty_juiced"] = ::maps\mp\perks\_perkfunctions::func_296E;
	...
	level.perksetfuncs["specialty_stopping_power"] = ::maps\mp\perks\_perkfunctions::func_2971;
	level.perkunsetfuncs["specialty_stopping_power"] = ::maps\mp\perks\_perkfunctions::func_2972;
...
onplayerspawned()
{
	...
	for(;;)
	{
		...
		self.omaclasschanged = 0;
		thread func_2979();
		thread maps\mp\gametypes\_scrambler::func_290C();
	}
}
...
//Function Number: 8
func_297C(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07)
{
	var_08 = 0;
	if(maps\mp\_utility::func_297E(param_03))
	{
		if(isplayer(param_01) && param_01 maps\mp\_utility::func_27AF("specialty_paint_pro") && !maps\mp\_utility::func_2829(param_04))
		{
			...
			param_00 thread maps\mp\perks\_perkfunctions::func_2980();
		}
		...
		if(isplayer(param_01) && (param_01 maps\mp\_utility::func_27AF("specialty_stopping_power") && param_01 maps\mp\_utility::func_27AF("specialty_bulletdamage")) || param_01 maps\mp\_utility::func_27AF("specialty_moredamage"))
		{
	...
	{
		if(isplayer(param_01) && param_01 != param_00 && param_01 isitemunlocked("specialty_paint") && param_01 maps\mp\_utility::func_27AF("specialty_paint") && !maps\mp\_utility::func_2829(param_04))
		{
			if(!param_00 maps\mp\perks\_perkfunctions::ispainted())
			{
		...
		if(isplayer(param_01) && weaponinheritsperks(param_04) && param_01 maps\mp\_utility::func_27AF("specialty_explosivedamage") && param_00 maps\mp\_utility::func_27AF("_specialty_blastshield"))
		{
			var_08 = var_08 + 0;
		}
		else if(isplayer(param_01) && weaponinheritsperks(param_04) && param_01 maps\mp\_utility::func_27AF("specialty_explosivedamage"))
		{
			var_08 = var_08 + param_02 * level.explosivedamagemod;
		}
		else if(param_00 maps\mp\_utility::func_27AF("_specialty_blastshield") && param_04 != "semtex_mp" || param_02 != 120)
		{
			var_08 = var_08 - int(param_02 * 1 - level.blastshieldmod);
		}

		if(maps\mp\_utility::func_2829(param_04) && isplayer(param_01) && param_01 maps\mp\_utility::func_27AF("specialty_dangerclose"))
		{
	...
	{
		if(param_00 maps\mp\_utility::func_27AF("specialty_falldamage"))
		{
			if(param_02 > 0)
			{
	...
	if(param_00 maps\mp\_utility::func_27AF("specialty_combathigh"))
	{
...
giveblindeyeafterspawn()
{
	...
	maps\mp\_utility::func_282E("specialty_blindeye");
	self.spawnperk = 0;
}