 ...
 * Timestamp: 10/27/2023 2:26:35 AM
*******************************************************************/
...
init_sounds()
{
	...
	func_3028("ai","in_sight",0,"ac130_fco_moreenemy");
	func_3028("ai","in_sight",1,"ac130_fco_getthatguy");
	func_3028("ai","in_sight",2,"ac130_fco_guymovin");
	func_3028("ai","in_sight",3,"ac130_fco_getperson");
	func_3028("ai","in_sight",4,"ac130_fco_guyrunnin");
	func_3028("ai","in_sight",5,"ac130_fco_gotarunner");
	func_3028("ai","in_sight",6,"ac130_fco_backonthose");
	func_3028("ai","in_sight",7,"ac130_fco_gonnagethim");
	func_3028("ai","in_sight",8,"ac130_fco_personnelthere");
	func_3028("ai","in_sight",9,"ac130_fco_nailthoseguys");
	func_3028("ai","in_sight",11,"ac130_fco_lightemup");
	func_3028("ai","in_sight",12,"ac130_fco_takehimout");
	func_3028("ai","in_sight",14,"ac130_plt_yeahcleared");
	func_3028("ai","in_sight",15,"ac130_plt_copysmoke");
	func_3028("ai","in_sight",16,"ac130_fco_rightthere");
	func_3028("ai","in_sight",17,"ac130_fco_tracking");
	func_3028("ai","wounded_crawl",0,"ac130_fco_movingagain");
	add_context_sensative_timeout("ai","wounded_crawl",undefined,6);
	func_3028("ai","wounded_pain",0,"ac130_fco_doveonground");
	func_3028("ai","wounded_pain",1,"ac130_fco_knockedwind");
	func_3028("ai","wounded_pain",2,"ac130_fco_downstillmoving");
	func_3028("ai","wounded_pain",3,"ac130_fco_gettinbackup");
	func_3028("ai","wounded_pain",4,"ac130_fco_yepstillmoving");
	func_3028("ai","wounded_pain",5,"ac130_fco_stillmoving");
	add_context_sensative_timeout("ai","wounded_pain",undefined,12);
	func_3028("weapons","105mm_ready",0,"ac130_gnr_gunready1");
	func_3028("weapons","105mm_fired",0,"ac130_gnr_shot1");
	func_3028("plane","rolling_in",0,"ac130_plt_rollinin");
	func_3028("explosion","secondary",0,"ac130_nav_secondaries1");
	func_3028("explosion","secondary",1,"ac130_tvo_directsecondary1");
	func_3028("explosion","secondary",1,"ac130_tvo_directsecondary2");
	add_context_sensative_timeout("explosion","secondary",undefined,7);
	func_3028("kill","single",0,"ac130_plt_gottahurt");
	func_3028("kill","single",1,"ac130_fco_iseepieces");
	func_3028("kill","single",2,"ac130_fco_oopsiedaisy");
	func_3028("kill","single",3,"ac130_fco_goodkill");
	func_3028("kill","single",4,"ac130_fco_yougothim");
	func_3028("kill","single",5,"ac130_fco_yougothim2");
	func_3028("kill","single",6,"ac130_fco_thatsahit");
	func_3028("kill","single",7,"ac130_fco_directhit");
	func_3028("kill","single",8,"ac130_fco_rightontarget");
	func_3028("kill","single",9,"ac130_fco_okyougothim");
	func_3028("kill","single",10,"ac130_fco_within2feet");
	func_3028("kill","small_group",0,"ac130_fco_nice");
	func_3028("kill","small_group",1,"ac130_fco_directhits");
	func_3028("kill","small_group",2,"ac130_fco_iseepieces");
	func_3028("kill","small_group",3,"ac130_fco_goodkill");
	func_3028("kill","small_group",4,"ac130_fco_yougothim");
	func_3028("kill","small_group",5,"ac130_fco_yougothim2");
	func_3028("kill","small_group",6,"ac130_fco_thatsahit");
	func_3028("kill","small_group",7,"ac130_fco_directhit");
	func_3028("kill","small_group",8,"ac130_fco_rightontarget");
	func_3028("kill","small_group",9,"ac130_fco_okyougothim");
	func_3028("misc","action",0,"ac130_plt_scanrange");
	add_context_sensative_timeout("misc","action",0,70);
	func_3028("misc","action",1,"ac130_plt_cleanup");
	add_context_sensative_timeout("misc","action",1,80);
	func_3028("misc","action",2,"ac130_plt_targetreset");
	add_context_sensative_timeout("misc","action",2,55);
	func_3028("misc","action",3,"ac130_plt_azimuthsweep");
	add_context_sensative_timeout("misc","action",3,100);
}

//Function Number: 4
func_3028(param_00,param_01,param_02,param_03)
{
...
setac130player(param_00)
{
	...
	level.ac130.planemodel thread func_3031();
	...
	param_00 thread func_3044(param_00);
	param_00 thread changeweapons();
	param_00 thread func_3046();
	param_00 thread func_3050();
	param_00 thread shotfired();
	param_00 thread func_3048();
...
removeac130playeraftertime(param_00)
{
	...
	maps\mp\gametypes\_hostmigration::func_2740(var_01);
	level thread func_303C(self,0);
}

//Function Number: 26
func_303C(param_00,param_01)
{
	...
	if(!param_01)
	{
		...
		var_02 = maps\mp\killstreaks\_killstreaks::func_2C01("ac130");
...
damagetracker()
{
	...
	for(;;)
	{
		...
		maps\mp\killstreaks\_killstreaks::killstreakhit(var_01,var_09,level.ac130);
		...
		if(self.damagetaken >= self.maxhealth)
		{
			if(isplayer(var_01))
			{
				...
				var_01 thread maps\mp\gametypes\_rank::func_2AB3("kill",400,var_09,var_04);
				var_01 notify("destroyed_killstreak");
			}

			level thread func_3067(10);
		}
	}
}
...
shotfired()
{
	...
	for(;;)
	{
		...
		{
			thread func_304D(var_01,var_00);
		}
...
func_3056()
{
	...
	for(;;)
	{
		...
		thread func_3057(var_00,level.ac130player);
	}
}

//Function Number: 53
func_3057(param_00,param_01)
{
...
{
	common_scripts\utility::array_thread(getentarray("context_dialog_car","targetname"),::func_305B,"car");
	common_scripts\utility::array_thread(getentarray("context_dialog_truck","targetname"),::func_305B,"truck");
	common_scripts\utility::array_thread(getentarray("context_dialog_building","targetname"),::func_305B,"building");
	common_scripts\utility::array_thread(getentarray("context_dialog_wall","targetname"),::func_305B,"wall");
	common_scripts\utility::array_thread(getentarray("context_dialog_field","targetname"),::func_305B,"field");
	common_scripts\utility::array_thread(getentarray("context_dialog_road","targetname"),::func_305B,"road");
	common_scripts\utility::array_thread(getentarray("context_dialog_church","targetname"),::func_305B,"church");
	common_scripts\utility::array_thread(getentarray("context_dialog_ditch","targetname"),::func_305B,"ditch");
	thread func_305A();
}
...
context_sensative_dialog_play_random_group_sound(param_00,param_01,param_02)
{
	...
	if(func_3061(param_00,param_01,var_03))
	{
		return;
	}
	...
	func_3062(level.scr_sound[param_00][param_01][var_03].sounds[var_06],param_02);
}

//Function Number: 62
func_3061(param_00,param_01,param_02)
{
	if(!isdefined(level.context_sensative_dialog_timeouts))
	{
		return 0;
...
//Function Number: 63
func_3062(param_00,param_01,param_02)
{
	...
	while(!var_04)
	{
		...
		var_04 = func_3063(level.radioforcedtransmissionqueue[0]);
...
func_2C53()
{
	...
	for(;;)
	{
		...
		level thread func_3066(var_00,var_00.team,var_01);
	}
}

//Function Number: 72
func_3066(param_00,param_01,param_02)
{
	if(isdefined(level.ac130player))
	{
		level.ac130player playlocalsound("missile_incoming");
	...
	for(;;)
	{
		...
		var_08 = 0;
		while(var_08 < var_41.size)
		{
			if(isdefined(var_41[var_08]))
			{
				if(var_41[var_08] < 3000 && var_04 == level.ac130.planemodel && level.ac130.numflares > 0)
				{
				...
				var_0D = vectornormalize(var_41 - var_05[var_09].origin);
