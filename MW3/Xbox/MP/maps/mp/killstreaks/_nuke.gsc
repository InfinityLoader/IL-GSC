 ...
 * Timestamp: 10/27/2023 2:27:10 AM
*******************************************************************/
...
cancelnukeondeath(param_00)
{
	...
	{
		param_00 thread maps\mp\killstreaks\_emp::func_30E0(0,0);
	}
...
nukeeffects()
{
	...
	foreach(var_01 in level.players)
	{
		...
		var_04 thread func_30F5(var_01);
	}
}
...
func_30FC()
{
	...
	level maps\mp\killstreaks\_emp::func_30E8(level.nukeinfo.player,maps\mp\_utility::getotherteam(level.nukeinfo.team));
	...
	level thread func_80FB();
	maps\mp\gametypes\_hostmigration::func_2740(level.nukeemptimeout);
	if(level.teambased)
	{
...
nuke_empteamtracker()
{
	...
	for(;;)
	{
		...
		foreach(var_01 in level.players)
		{
			...
			if(!level.teamnukeemped[var_01.team] && !var_01 maps\mp\_utility::func_27E5())
			{
