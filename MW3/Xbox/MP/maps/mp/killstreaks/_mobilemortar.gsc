 ...
 * Timestamp: 10/27/2023 2:27:09 AM
*******************************************************************/
...
init()
{
	...
	level.killstreakfuncs["mobile_mortar"] = ::func_340B;
}

//Function Number: 2
func_340B(param_00,param_01)
{
...
func_2EB2()
{
	...
	{
		self.locationobjectives[var_01] = maps\mp\gametypes\_gameobjects::func_2A31();
...
createmobilemortar(param_00,param_01)
{
	...
	if(level.teambased)
	{
		var_08 = maps\mp\gametypes\_gameobjects::func_2A31();
	...
	var_05 thread maps\mp\killstreaks\_helicopter::func_2447();
	var_05 thread func_28F6();
	var_05 thread func_341D();
...
func_3417()
{
	...
	foreach(var_02 in level.players)
	{
		...
		if(var_02 maps\mp\_utility::func_27AF("specialty_blindeye"))
		{
			continue;
		}
...
firemortar(param_00,param_01,param_02)
{
	...
	var_05 = maps\mp\gametypes\_gameobjects::func_2A31();
	...
	var_06 = maps\mp\gametypes\_gameobjects::func_2A31();
	...
	var_08 thread func_341B(param_00);
}
