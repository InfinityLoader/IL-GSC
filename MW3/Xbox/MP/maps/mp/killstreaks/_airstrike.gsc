 ...
 * Timestamp: 10/27/2023 2:26:42 AM
*******************************************************************/
...
init()
{
	...
	level.var_80F7 = loadfx("explosions/clusterbomb_no_fount");
	...
	level.killstreakfuncs["airstrike"] = ::func_2FA5;
	level.killstreakfuncs["precision_airstrike"] = ::func_2FA6;
	level.killstreakfuncs["super_airstrike"] = ::func_2FA7;
	level.killstreakfuncs["harrier_airstrike"] = ::tryuseharrierairstrike;
	level.killstreakfuncs["stealth_airstrike"] = ::func_2FA9;
	level.planes = [];
}
...
func_2FA5(param_00)
{
	return func_2FAA(param_00,"airstrike");
}

//Function Number: 3
func_2FA6(param_00)
{
	return func_2FAA(param_00,"precision_airstrike");
}

//Function Number: 4
func_2FA7(param_00)
{
	return func_2FAA(param_00,"super_airstrike");
}

//Function Number: 5
tryuseharrierairstrike(param_00)
{
	return func_2FAA(param_00,"harrier_airstrike");
}

//Function Number: 6
func_2FA9(param_00)
{
	return func_2FAA(param_00,"stealth_airstrike");
}

//Function Number: 7
func_2FAA(param_00,param_01)
{
	...
	var_02 = func_2FC8(param_00,param_01);
...
//Function Number: 8
func_2ED4(param_00,param_01,param_02,param_03,param_04,param_05)
{
...
//Function Number: 13
func_2FAF(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	var_07 = maps\mp\gametypes\_weapons::func_17BE(param_00,param_01,1);
...
//Function Number: 15
func_2FB5(param_00,param_01,param_02,param_03,param_04)
{
	...
	foreach(var_07 in level.players)
	{
		...
		var_07 thread func_2FB6("default",var_0A);
	}
}

//Function Number: 16
func_2FB6(param_00,param_01)
{
...
dobomberstrike(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09)
{
	...
	thread func_2FBB(var_0E,var_0D,param_07,param_09);
	thread func_2FB9(var_0E,param_03,param_01);
	var_0E endon("death");
	wait param_07 * 0.65;
...
//Function Number: 18
func_2FB9(param_00,param_01,param_02)
{
	param_00 endon("death");
	while(!func_18DB(param_00,param_01,5000))
	{
		wait 0.05;
	}
	...
	for(var_05 = func_2FC6(param_00,param_01);var_05 < 5000;var_05 = func_2FC6(param_00,param_01))
	{
...
//Function Number: 20
func_2FBB(param_00,param_01,param_02,param_03)
{
...
{
	if(!isdefined(param_01) || param_01 maps\mp\_utility::func_27E5() || param_01 maps\mp\_utility::func_2BE7())
	{
	...
	thread maps\mp\_utility::func_2ED2("exp_airstrike_bomb",var_06);
	func_2FB5(var_06,512,8,4,param_01.team);
	func_2FAF(var_06 + (0,0,16),896,300,50,param_01,self,"stealth_bomb_mp");
}

//Function Number: 22
func_2FBE(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09)
{
	if(!isdefined(param_01))
	{
		return;
...
callstrike_bombeffect(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	param_00 endon("death");
	wait param_03;
	if(!isdefined(param_04) || param_04 maps\mp\_utility::func_27E5() || param_04 maps\mp\_utility::func_2BE7())
	{
		return;
	}
	...
	{
		playfxontag(level.var_80F7,var_0A,"tag_origin");
	}
	else
	{
	...
	for(var_12 = 0;var_12 < var_0D;var_12++)
	{
		...
		thread func_2FAF(var_16 + (0,0,16),512,200,30,param_04,var_08,"artillery_mp");
		if(var_12 % 3 == 0)
		{
			thread maps\mp\_utility::func_2ED2("exp_airstrike_bomb",var_16);
...
callstrike(param_00,param_01,param_02,param_03,param_04)
{
	...
	{
		level thread func_2FBE(param_00,param_01,var_10,param_02,var_0B + (0,0,randomint(500)),var_0C + (0,0,randomint(500)),var_0F,var_0E,var_07,param_04);
		wait randomfloatrange(1.5,2.5);
		maps\mp\gametypes\_hostmigration::func_273E();
		level thread func_2FBE(param_00,param_01,var_10,param_02,var_0B + (0,0,randomint(200)),var_0C + (0,0,randomint(200)),var_0F,var_0E,var_07,param_04);
		wait randomfloatrange(1.5,2.5);
		maps\mp\gametypes\_hostmigration::func_273E();
	...
	level thread func_2FBE(param_01,param_02,var_11,param_03,var_0C + (0,0,randomint(500)),var_0D + (0,0,randomint(500)),var_10,var_0F,var_08,var_05);
	wait randomfloatrange(1.5,2.5);
	maps\mp\gametypes\_hostmigration::func_273E();
	level thread func_2FBE(param_01,param_02,var_11,param_03,var_0C + (0,0,randomint(200)),var_0D + (0,0,randomint(200)),var_10,var_0F,var_08,var_05);
	wait randomfloatrange(1.5,2.5);
	maps\mp\gametypes\_hostmigration::func_273E();
	level thread func_2FBE(param_01,param_02,var_11,param_03,var_0C + (0,0,randomint(200)),var_0D + (0,0,randomint(200)),var_10,var_0F,var_08,var_05);
...
//Function Number: 33
func_18DB(param_00,param_01,param_02)
{
	...
	var_03 = func_18DA(param_00,param_01);
	if(var_03)
	{
		var_04 = 1;
	}
...
finishairstrikeusage(param_00,param_01,param_02,param_03)
{
	...
	thread func_2ED4(param_00,param_01,param_02,self,self.pers["team"],param_03);
}

//Function Number: 38
func_2FCA(param_00,param_01,param_02)
{
}
...
{
	self endon("death");
	if(param_00 maps\mp\_utility::func_27E5())
	{
		self notify("death");
		return;
	}
