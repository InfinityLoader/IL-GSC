 ...
 * Timestamp: 10/27/2023 2:26:51 AM
*******************************************************************/
...
beginharrier(param_00,param_01,param_02)
{
	...
	var_06 = func_2F6B(param_00,self,param_01,var_05);
...
//Function Number: 3
func_2F6B(param_00,param_01,param_02,param_03)
{
	...
	var_05 thread func_2F7A();
	var_05 setdamagestage(3);
	var_05.missiles = 6;
...
{
	self endon("death");
	maps\mp\gametypes\_hostmigration::func_2740(45);
	harrierleave();
}
...
getnewpoint(param_00,param_01)
{
	...
	for(;;)
	{
		var_11 = func_2F78(var_07,var_08,var_0B);
		if(var_11 != 0)
		{
			return var_11;
		}
...
//Function Number: 12
func_2F78(param_00,param_01,param_02)
{
	self endon("stopRand");
	self endon("death");
	self endon("acquiringTarget");
...
func_2F86()
{
	...
	for(;;)
	{
		...
		if(isdefined(level.chopper) && level.chopper.team != self.team && isalive(level.chopper))
		{
			...
			{
				thread func_2F92(level.chopper);
				return;
			}
			else
			{
...
callback_vehicledamage(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07,param_08,param_09,param_0A,param_0B)
{
	...
	if(isplayer(param_01) && param_01 maps\mp\_utility::func_27AF("specialty_armorpiercing"))
	{
...
harrierdestroyed()
{
	...
	if(!isdefined(self.largeprojectiledamage))
	{
		...
		thread func_2F91(randomintrange(180,220));
