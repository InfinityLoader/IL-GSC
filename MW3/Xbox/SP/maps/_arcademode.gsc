 ...
 * Timestamp: 10/27/2023 2:33:58 AM
*******************************************************************/
...
arcademode_update_score()
{
	...
	for(var_00 = 0;var_00 < level.var_603;var_00++)
	{
...
arcademode_define_damage_multipliers()
{
	...
	level.arcademode_extra_lives_range = var_41;
	var_01 = [];
	for(var_02 = 0;var_02 < 4;var_02++ = var_41[3])
	{
		var_01[var_02] = var_41[var_02] * 0.15;
	}
...
extra_lives_display(param_00)
{
	...
	var_02 = func_0610("center",0.2,0,-100);
...
func_061B()
{
	var_00 = 60;
	var_01 = 90;
	if(level.player.var_61C > 0)
	{
		if(level.player.var_61C == 1)
		{
			var_02 = randomint(1);
		...
		else if(level.player.var_61C == 2)
		{
		...
		else if(level.player.var_61C <= 4)
		{
			var_01 = randomfloatrange(0,180);
			var_00 = randomfloatrange(60,120);
		}
		else if(level.player.var_61C <= 8)
		{
			var_01 = randomfloatrange(0,180);
...
arcademode_add_points_for_individual_kill(param_00,param_01,param_02)
{
	...
	{
		var_03 = level.arcademode_killbase + level.var_623[param_00["damage_location"]] + level.var_624[param_00["type"]];
	}
	else
	{
		var_03 = level.arcademode_killbase + level.var_624[param_01["type"]];
	}
...
player_kill(param_00,param_01,param_02)
{
	...
	level.arcademode_multikills[var_05][level.arcademode_multikills[var_05].size] = var_41;
}
...
create_total_score_hud(param_00,param_01)
{
	...
	for(var_02 = 0;var_02 < level.var_603;var_02++)
	{
...
arcademode_ends()
{
	...
	var_09 = 100;
	var_0A = 300;
	var_0B = func_0610("center",var_04,0,var_05);
	if(level.arcademode_success)
	{
		var_0B.color = (1,1,1);
	...
	{
		var_11 = func_0610("left",var_04,20,var_06);
	...
	var_12 = func_0610("left",var_04,20,var_07);
	var_12 settext(&"SCRIPT_MISSION_SCORE");
	for(var_0C = 0;var_0C < level.var_603;var_0C++)
	{
	...
	var_15 = var_02;
	var_16 = func_0610("left",var_04,20,var_08);
	var_16 settext(&"SCRIPT_TIME_REMAINING");
	level.arcademode_hud_timer_minutes_tens = func_0610("right",var_04,-265 + var_0D,var_08);
	level.arcademode_hud_timer_minutes_ones = func_0610("right",var_04,-235 + var_0D,var_08);
	var_17 = func_0610("right",var_04,-215 + var_0D,var_08 - 5);
	var_17 settext(&"SCRIPT_COLON");
	level.arcademode_hud_timer_seconds_tens = func_0610("right",var_04,-180 + var_0D,var_08);
	level.arcademode_hud_timer_seconds_ones = func_0610("right",var_04,-150 + var_0D,var_08);
	...
	if(var_30)
	{
		...
		wait 1;
		var_37 = func_0610("center",var_04,0,var_09);
...
{
	var_07 = func_0610("center",param_06,0,param_05);
...
{
	param_00 = param_00 * param_02;
	var_03 = func_0610("center",0.1,param_00,90);
...
arcademode_killstreak_complete_display()
{
	...
	var_00 = func_0610("right",0.2,-10,-57);
