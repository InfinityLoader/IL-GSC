 ...
 * Timestamp: 10/27/2023 2:35:04 AM
*******************************************************************/
...
give_default_loadout()
{
	if(maps\_utility::func_E89() || maps\_utility::is_survival())
	{
...
func_1824()
{
	...
	if(!isdefined(var_01[level.var_181E]) && !isdefined(var_01["dragunov"]))
	{
		level.player giveweapon(level.var_181E);
		level.player switchtoweapon(level.var_181E);
	}
}
...
coop_gamesetup_menu()
{
	...
	{
		if(maps\_utility::func_E89() && var_06 == level.script)
		{
...
{
	if(level.var_1827 == "so_char_host")
	{
		return level.players[0];
	}

	if(level.var_1827 == "so_char_client")
	{
...
func_182C(param_00)
{
	...
	level.var_182C[var_01] = param_00;
}
...
so_player_give_loadout(param_00)
{
	...
	if(isdefined(level.var_182C[param_00]))
	{
		var_01 setviewmodel(level.var_182C[param_00]);
	}
}
