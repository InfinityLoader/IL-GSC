 ...
 * Platform: Console
 * Function Count: 109
 * Decompile Time: 4447 ms
 * Timestamp: 10/27/2023 2:32:09 AM
*******************************************************************/
...
setskill(param_00)
{
	...
	if(!isdefined(param_00) || param_00 == 0)
	{
		...
		if(!isdefined(level.var_1E5D))
		{
			level.var_1E5D = ::return_false;
		}

		level.global_damage_func_ads = ::empty_kill_func;
		level.var_5D2 = ::empty_kill_func;
		...
		foreach(var_02 in level.players)
		{
			...
			var_02 maps\_utility::func_FA4("near_death_vision_enabled");
			var_02.var_1C74 = spawnstruct();
			var_02 func_1E68();
		...
		level.var_1E5F[0] = "easy";
		level.var_1E5F[1] = "normal";
		level.var_1E5F[2] = "hardened";
		level.var_1E5F[3] = "veteran";
		level.var_1E60["easy"] = &"GAMESKILL_EASY";
		level.var_1E60["normal"] = &"GAMESKILL_NORMAL";
		level.var_1E60["hardened"] = &"GAMESKILL_HARDENED";
		level.var_1E60["veteran"] = &"GAMESKILL_VETERAN";
	...
	level.difficultysettings["playerGrenadeBaseTime"]["easy"] = -25536;
	level.difficultysettings["playerGrenadeBaseTime"]["normal"] = -30536;
	...
	level.difficultysettings["pain_test"]["easy"] = ::func_1E8F;
	level.difficultysettings["pain_test"]["normal"] = ::func_1E8F;
...
func_1E68()
{
	...
	foreach(var_03 in var_01)
	{
		...
		{
			self.var_1C74.screeneffect[var_03][var_05] = 0;
			self.var_1C74.screeneffect[var_03 + "_count"][var_05] = 0;
		}
	}
}
...
updatealldifficulty()
{
	...
	{
		level.players[var_00] func_139A();
	}
}
...
setglobaldifficulty()
{
	...
	var_01 = func_1E73(level.gameskill);
...
updategameskill()
{
	foreach(var_01 in level.players)
	{
		...
		var_01.gameskill = var_01 maps\_utility::func_152D();
	}

	level.gameskill = level.player.gameskill;
	if(maps\_utility::func_E89() && level.player2.gameskill > level.gameskill)
	{
		level.gameskill = level.player2.gameskill;
	}

	level.specops_reward_gameskill = level.player.gameskill;
	if(maps\_utility::func_E89() && level.player2.gameskill < level.specops_reward_gameskill)
	{
		level.specops_reward_gameskill = level.player2.gameskill;
	}

	if(isdefined(level.var_1507))
	{
		level.gameskill = level.var_1507;
	}
...
func_1E73(param_00)
{
	return level.var_1E5F[param_00];
}
...
//Function Number: 14
func_1E75(param_00,param_01)
{
	self.var_1C74.invultime_preshield = [[ param_00 ]]("invulTime_preShield",param_01);
	self.var_1C74.invultime_onshield = [[ param_00 ]]("invulTime_onShield",param_01);
	self.var_1C74.invultime_postshield = [[ param_00 ]]("invulTime_postShield",param_01);
	self.var_1C74.playerhealth_regularregendelay = [[ param_00 ]]("playerHealth_RegularRegenDelay",param_01);
	self.var_1C74.worthydamageratio = [[ param_00 ]]("worthyDamageRatio",param_01);
	self.threatbias = int([[ param_00 ]]("threatbias",param_01));
	self.var_1C74.longregentime = [[ param_00 ]]("longRegenTime",param_01);
	self.var_1C74.healthoverlaycutoff = [[ param_00 ]]("healthOverlayCutoff",param_01);
	self.var_1C74.regenrate = [[ param_00 ]]("health_regenRate",param_01);
	self.var_1C74.player_attacker_accuracy = [[ param_00 ]]("base_enemy_accuracy",param_01);
	update_player_attacker_accuracy();
	self.var_1C74.playergrenadebasetime = int([[ param_00 ]]("playerGrenadeBaseTime",param_01));
	self.var_1C74.var_1C75 = int([[ param_00 ]]("playerGrenadeRangeTime",param_01));
	self.var_1C74.var_1C76 = int([[ param_00 ]]("playerDoubleGrenadeTime",param_01));
	self.var_1C74.min_sniper_burst_delay_time = [[ param_00 ]]("min_sniper_burst_delay_time",param_01);
	self.var_1C74.max_sniper_burst_delay_time = [[ param_00 ]]("max_sniper_burst_delay_time",param_01);
	self.var_1C74.var_1E80 = [[ param_00 ]]("dog_presstime",param_01);
...
update_player_attacker_accuracy()
{
	...
	self.attackeraccuracy = self.var_1C74.player_attacker_accuracy;
}

//Function Number: 16
apply_difficulty_step_with_func(param_00,param_01)
{
	self.var_1C74.misstimeconstant = [[ param_00 ]]("missTimeConstant",param_01);
	self.var_1C74.misstimedistancefactor = [[ param_00 ]]("missTimeDistanceFactor",param_01);
	self.var_1C74.dog_hits_before_kill = [[ param_00 ]]("dog_hits_before_kill",param_01);
	self.var_1C74.double_grenades_allowed = [[ param_00 ]]("double_grenades_allowed",param_01);
}

//Function Number: 17
set_difficulty_from_locked_settings()
{
	func_1E75(::get_locked_difficulty_val_player,1);
	apply_difficulty_step_with_func(::func_1E88,1);
}

//Function Number: 18
func_1E88(param_00,param_01)
{
	return level.difficultysettings[param_00][func_1E73(self.gameskill)];
}

//Function Number: 19
func_1E89(param_00,param_01)
{
	return level.difficultysettings[param_00][func_1E73(level.gameskill)];
}
...
//Function Number: 22
func_1E8C(param_00,param_01,param_02)
{
	return level.difficultysettings[param_00][level.var_1E5F[param_01]] * 100 - getdvarint("autodifficulty_frac") + level.difficultysettings[param_00][level.var_1E5F[param_02]] * getdvarint("autodifficulty_frac") * 0.01;
}
...
func_1E92()
{
	...
	if(self.script == "move")
	{
		...
		{
			self.accuracy = level.var_1E62 * self.baseaccuracy;
		}
		else
		{
			self.accuracy = level.var_1E61 * self.baseaccuracy;
		}
...
resetmisstime()
{
	...
	setmisstime(self.enemy.var_1C74.misstimeconstant + var_00 * self.enemy.var_1C74.misstimedistancefactor);
}

//Function Number: 37
resetmissdebouncetime()
{
	self.a.var_1C32 = gettime() + 3000;
}

//Function Number: 38
setmisstime(param_00)
{
	if(self.a.var_1C32 > gettime())
	{
		return;
	}
	...
	self.a.var_1556 = gettime() + param_00;
...
//Function Number: 40
func_1EA0(param_00,param_01,param_02)
{
...
func_1EA4(param_00)
{
	...
	thread display_screen_effect("dirt",param_00,var_01,var_02,randomfloatrange(0.55,0.66));
}
...
blood_splat_on_screen(param_00)
{
	...
	thread display_screen_effect("bloodsplat",param_00,var_01,undefined,randomfloatrange(0.45,0.56));
}
...
display_screen_effect(param_00,param_01,param_02,param_03,param_04)
{
	...
	if(isdefined(self.var_1DDB))
	{
		return;
	}

	var_05 = gettime();
	if(self.var_1C74.screeneffect[param_00][param_01] == var_05)
	{
		return;
	}

	if(self.var_1C74.screeneffect[param_00 + "_count"][param_01] == 1)
	{
		return;
	}

	self.var_1C74.screeneffect[param_00 + "_count"][param_01]++;
	self.var_1C74.screeneffect[param_00][param_01] = var_05;
	self endon("death");
	switch(param_01)
	{
		case "bottom":
			...
			if(param_00 == "dirt")
			{
				var_08 = maps\_hud_util::create_client_overlay_custom_size(param_02,1,var_06,var_07);
				var_08 thread func_1EA0(param_00,param_04,1);
				var_08 screen_detailed_alpha();
			}
			else
			{
				var_08 = maps\_hud_util::create_client_overlay_custom_size(param_03,0,var_07,var_08);
				var_08 func_1EA0(param_00,param_04);
			}
	
			if(isdefined(param_03))
			{
				var_09 = maps\_hud_util::create_client_overlay_custom_size(param_03,0,var_06,var_07);
				var_09 func_1EA0(param_00,param_04);
			}
			break;
...
playerhurtcheck()
{
	...
	for(;;)
	{
		self waittill(var_00,var_41["MOD_GRENADE"],var_01,var_41["MOD_GRENADE_SPLASH"],var_01,var_41["MOD_PROJECTILE"],var_01,var_41["MOD_PROJECTILE_SPLASH"],var_01,var_41["MOD_EXPLOSIVE"],var_02,var_41["MOD_PISTOL_BULLET"],var_02,var_41["MOD_RIFLE_BULLET"],var_02,var_41["MOD_EXPLOSIVE_BULLET"],"damage",var_03,var_04,var_05,var_06,var_07);
		self.hurtagain = 1;
		self.damagepoint = var_06;
		self.var_1EAC = var_04;
		var_08 = undefined;
		...
		if(!isdefined(var_08) && isdefined(var_41[var_07]))
		{
...
playerhealthregen()
{
	...
	var_02 = 0;
	var_03 = 0;
	thread func_1EB5(self.maxhealth * 0.35);
	var_04 = 0;
	var_05 = 0;
	var_06 = 0;
	var_07 = 1;
	...
	for(;;)
	{
		...
		if(maps\_utility::laststand_enabled())
		{
			thread maps\_laststand::player_laststand_proc();
		}
		...
		if(var_09 <= self.var_1C74.healthoverlaycutoff && self.player_health_packets > 1)
		{
			var_02 = 1;
			if(!var_08)
			{
				...
				{
					thread func_1EB4(3.6,2);
					thread maps\_audio::set_deathsdoor();
					self painvisionon();
				}

				maps\_utility::func_FA4("player_has_red_flashing_overlay");
				var_03 = 1;
			}
		}
		...
		{
			if(gettime() - var_05 < self.var_1C74.playerhealth_regularregendelay)
			{
				continue;
			}
			...
			{
				var_06 = var_09;
				if(gettime() > var_05 + self.var_1C74.longregentime)
				{
					var_06 = var_06 + self.var_1C74.regenrate;
				}
		...
		var_00 = var_07;
		var_0A = self.var_1C74.worthydamageratio;
		...
		maps\_utility::func_FA4("player_is_invulnerable");
		level notify("player_becoming_invulnerable");
		if(var_03)
		{
			var_04 = self.var_1C74.invultime_onshield;
			var_03 = 0;
		}
		else if(var_02)
		{
			var_04 = self.var_1C74.invultime_postshield;
		}
		else
		{
			var_04 = self.var_1C74.invultime_preshield;
		}

		var_07 = self.health / self.maxhealth;
		thread func_1EB2(var_04);
	}
}
...
func_1EB5(param_00)
{
	...
	for(;;)
	{
		...
		if(var_01 > self.var_1C74.healthoverlaycutoff)
		{
			continue;
		}
...
func_1EB6()
{
	...
	if(issplitscreen())
	{
		var_00 setshader("splatter_alt_sp",640,960);
...
func_1EB7()
{
	while(isalive(self))
	{
		maps\_utility::func_121C("player_has_red_flashing_overlay");
		func_1EC6();
	}
}
...
func_1EBC(param_00)
{
	...
	func_1EBB();
	var_01 = !isalive(self);
	param_00 thread func_1EBE(var_01);
}
...
may_change_cover_warning_alpha(param_00)
{
	...
	if(isdefined(param_00.var_1EBF))
	{
		return 0;
	}
...
//Function Number: 67
func_1EC2(param_00,param_01,param_02,param_03)
{
	var_04 = 0.8;
	var_05 = 0.5;
	var_06 = var_04 * 0.1;
...
func_1EC6()
{
	...
	var_01 = gettime() + self.var_1C74.longregentime;
	func_1EC2(var_00,1,1,0);
	while(gettime() < var_01 && isalive(self) && maps\_utility::ent_flag("player_has_red_flashing_overlay"))
	{
		func_1EC2(var_00,0.9,1,0);
	}

	if(isalive(self))
	{
		func_1EC2(var_00,0.65,0.8,0);
	}
...
{
	var_00 = level.script == "sp_intro" || level.script == "ny_manhattan";
...
auto_adjust_difficulty_player_positioner()
{
	...
	{
		level.var_1ECC[level.var_1ECC.size] = var_00;
	}
}
...
auto_adjust_difficulty_player_movement_check()
{
	...
	for(;;)
	{
		...
		level.player.movedrecently = 1;
		var_00 = [];
		var_01 = level.var_1ECC.size - 5;
		if(var_01 < 0)
		{
			var_01 = 0;
		}

		for(var_02 = var_01;var_02 < level.var_1ECC.size;var_02++)
		{
			if(!level.player autospot_is_close_to_player(level.var_1ECC[var_02]))
			{
				continue;
			}

			var_00[var_00.size] = level.var_1ECC[var_02];
			level.player.movedrecently = 0;
		}

		level.var_1ECC = var_00;
		wait 1;
	}
}
...
hud_debug_add_message(param_00)
{
	...
	if(!isdefined(level.hudmsgshare[param_00]))
	{
		...
		var_01.y = level.var_1EDB + level.hudnum * 15;
		var_01.foreground = 1;
		var_01.sort = 100;
		var_01.alpha = 1;
		var_01.alignx = "left";
...
hud_debug_add_display(param_00,param_01,param_02)
{
	...
	if(param_02)
	{
		var_0A = newhudelem();
		var_0A.x = 204.5;
		var_0A.y = level.var_1EDB + level.hudnum * 15;
		var_0A.foreground = 1;
		var_0A.sort = 100;
		var_0A.alpha = 1;
		var_0A.alignx = "left";
	...
	if(var_03)
	{
		var_0B = newhudelem();
		var_0B.x = 195.5;
		var_0B.y = level.var_1EDB + level.hudnum * 15;
		var_0B.foreground = 1;
		var_0B.sort = 100;
		var_0B.alpha = 1;
		var_0B.alignx = "left";
...
hud_debug_add_num(param_00,param_01)
{
	...
	var_02.y = level.var_1EDB + level.hudnum * 15;
	var_02.foreground = 1;
	var_02.sort = 100;
	var_02.alpha = 1;
	var_02.alignx = "left";
...
func_1A1C()
{
	level.sp_stat_tracking_func = ::func_1EE6;
...
auto_adust_zone_complete(param_00)
{
	...
	var_17 = [];
	level.auto_adjust_results[var_01] = var_41;
	var_18 = "Completed AA sequence: ";
	var_18 = var_18 + level.script + "/" + var_01;
	var_19 = getarraykeys(var_41);
	for(var_1A = 0;var_1A < var_19.size;var_1A++ = var_41["gameskill"])
	{
		var_18 = var_18 + ", " + var_19[var_1A] + ": " + var_41[var_19[var_1A]];
	}
...
//Function Number: 104
func_1EF0(param_00,param_01,param_02,param_03)
{
...
//Function Number: 105
//Function Number: 106
func_1EF1(param_00,param_01,param_02)
{
	aa_add_event("aa_player_damage_dealt",param_00);
	if(!level.player maps\_utility::isads())
	{
		[[ level.var_5D2 ]](param_01,self.damagelocation,param_02);
		return 0;
	}
...
//Function Number: 108
func_1EF3(param_00,param_01,param_02)
{
	...
	var_03 = [];
	level.difficultysettings_frac_data_points[param_01][level.difficultysettings_frac_data_points[param_01].size] = var_41;
}

//Function Number: 109
coop_with_one_player_downed()
{
	return maps\_utility::func_E89() && maps\_utility::func_1608().size == 1;
}