/*******************************************************************
 * Decompiled By: Bog
 * Decompiled File: maps\_audio_dynamic_ambi.gsc
 * Game: Call of Duty: Modern Warfare 3
 * Platform: Console
 * Function Count: 55
 * Decompile Time: 1583 ms
 * Timestamp: 10/27/2023 2:33:04 AM
*******************************************************************/
...
{
	dambx_start_preset("free",param_00,param_01,param_02,undefined,undefined,param_03);
}

//Function Number: 7
func_1067(param_00,param_01,param_02,param_03,param_04,param_05)
{
	if(isdefined(param_03))
	{
		thread func_106C(param_00,param_01,param_02,param_03,param_04,param_05);
		return;
	}

	dambx_start_preset("free",param_00,param_02,undefined,param_01,param_05);
}
...
damb_make_linked_damb(param_00,param_01,param_02,param_03,param_04)
{
	...
	var_05.var_106A = param_03;
	var_05.max_delay = param_04;
	return var_05;
}

//Function Number: 10
func_106C(param_00,param_01,param_02,param_03,param_04,param_05)
{
	...
	for(;;)
	{
		...
		else if(!var_07)
		{
			...
			{
				func_107D("free",param_02,var_06);
			}
			else
			{
				func_107D("free",param_00,var_06);
			}
		}
...
{
	func_107D("zone",undefined,param_00);
}

//Function Number: 14
damb_zone_stop_preset(param_00,param_01)
{
	func_107D("zone",param_00,param_01);
}

//Function Number: 15
damb_stop_preset(param_00,param_01)
{
	func_107D("free",param_00,param_01);
}
...
func_1075(param_00,param_01)
{
	...
	else
	{
		...
		if(var_02.size == 0)
		{
			var_02 = maps\_audio::audio_presets_dynamic_ambience(param_00,var_02);
		}
...
damb_link_to_damb(param_00,param_01,param_02,param_03)
{
	...
	if(isdefined(level._audio.damb.playing[var_04][param_00]) && isdefined(level._audio.damb.playing[var_04][param_01]))
	{
		...
		level._audio.damb.playing[var_04][param_00]["linked_dambs"][var_05].var_106A = max(param_02,0);
...
dambx_start_linked_dambs(param_00,param_01)
{
	if(isarray(param_01))
	{
		foreach(var_03 in param_01)
		{
			...
			damb_link_to_damb(param_00,var_03.label,var_03.var_106A,var_03.max_delay);
		}
	...
	damb_link_to_damb(param_00,param_01.label,param_01.var_106A,param_01.max_delay);
}

//Function Number: 25
func_107D(param_00,param_01,param_02)
{
	var_03 = 2;
	if(isdefined(param_02))
	{
...
dambx_update_serially(param_00,param_01,param_02)
{
	...
	for(;;)
	{
		...
		var_09 = func_10AD(param_00,param_01);
		if(!isdefined(var_09))
		{
			continue;
		}
		...
		if(var_0A.var_107F)
		{
			if(var_0A.var_1080 && !isdefined(var_0A.ent))
			{
				level notify(param_00 + "_" + param_01 + "_stop");
				break;
			}

			var_0B = func_109C(var_0A,param_01,var_09);
			if(var_0B.success)
			{
				if(level._audio.damb.serial_playback_lock)
				{
					func_10A7(param_00,param_01,var_0B);
				}
				else
				{
					thread func_10A7(param_00,param_01,var_0B);
				}
			}
		}
		else
...
//Function Number: 28
//Function Number: 29
func_109B(param_00,param_01,param_02)
{
	for(;;)
	{
		if(!isdefined(param_02))
...
//Function Number: 30
func_109C(param_00,param_01,param_02,param_03)
{
	var_04 = spawnstruct();
	if(randomfloat(1) < param_00.var_109A)
	{
		var_04.success = 1;
		...
		{
			var_04.alias = func_10AE(param_02);
			var_04.point = param_03;
			var_04.ent = param_00.ent;
			var_04.mode = param_00.mode;
			var_05 = randomfloatrange(param_00.var_1086,param_00.max_radius);
			var_06 = undefined;
			...
			{
				var_04.var_109E = randomfloatrange(param_00.min_trav_time,param_00.max_trav_time);
				if(isdefined(param_00.var_1091))
				{
					var_05 = randomfloatrange(param_00.var_1091,param_00.max_delta);
					var_06 = randomfloatrange(0,360);
					var_07 = var_05 * cos(var_06);
					var_08 = var_05 * sin(var_06);
			...
			if(isdefined(param_00.min_pitch_time))
			{
				...
				var_04.pitch_time = randomfloatrange(param_00.min_pitch_time,param_00.var_1096);
			}
		}
	}
	else
...
dambx_make_first_wait(param_00)
{
	...
	{
		var_01 = randomfloatrange(param_00.var_1088,param_00.max_time);
	}
...
dambx_update(param_00,param_01,param_02,param_03)
{
	...
	if(var_04.single_loops)
	{
		...
		if(var_04.var_1080 && !var_04.var_107F)
		{
			thread func_109B(param_00,param_01,var_04.ent);
		}
	}
	...
	if(var_04.var_107F)
	{
		...
		for(;;)
		{
			...
			if(var_04.var_1080 && !isdefined(var_04.ent))
			{
				level notify(param_00 + "_" + param_01 + "_stop");
				break;
			}
			...
			if(isdefined(level._audio.damb.playing[param_00][param_01]["linked_dambs"]))
			{
				...
				{
					var_08 = randomfloatrange(var_07.var_106A,var_07.max_delay);
					thread dambx_trigger_linked_damb(var_07.name,var_08);
				}
			}

			var_04.var_109A = level._audio.damb.playing[param_00][param_01]["prob_scale"];
			var_0A = func_109C(var_04,param_01,param_02,param_03);
			if(var_0A.success)
			{
				thread func_10A7(param_00,param_01,var_0A);
			}

			var_05 = randomfloatrange(var_04.var_1088,var_04.max_time);
		}
	}
}

//Function Number: 34
func_10A6(param_00,param_01,param_02,param_03)
{
	level endon(param_00 + "_" + param_01 + "_stop");
...
//Function Number: 35
func_10A7(param_00,param_01,param_02)
{
	level endon(param_00 + "_" + param_01 + "_stop");
...
dambx_perform_oneshot_event(param_00,param_01,param_02)
{
	...
	if(level._audio.damb.entity_ref_count < level._audio.damb.max_entities)
	{
		...
		var_04 thread maps\_audio::aud_check_sound_done();
		if(!var_04.sounddone)
		{
			...
			{
				var_06 = 0.1 * param_02.var_109E;
				var_04 moveto(var_03 + param_02.end_position,param_02.var_109E,var_06,var_06);
			}
			...
			thread func_10A6(param_00,param_01,var_05,var_04);
...
dambx_perform_loop_event(param_00,param_01,param_02)
{
	...
	if(level._audio.damb.entity_ref_count < level._audio.damb.max_entities)
	{
		...
		var_0D thread maps\_audio::aud_check_sound_done();
		if(!var_0D.sounddone)
		{
			...
			if(var_0F)
			{
				var_10 = 0.1 * param_02.var_109E;
				var_0D moveto(var_03 + param_02.end_position,param_02.var_109E,var_10,var_10);
			}
			...
			if(!var_0D.sounddone)
			{
				if(isdefined(level._audio.damb.playing[param_00][param_01]["loops"][var_0E]))
				{
					if(isdefined(var_0C))
					{
						...
						func_10C2();
						thread func_10A6(param_00,param_01,var_12,var_11);
					}

					if(isdefined(var_0B))
					{
						thread maps\_audio::aud_fade_loop_out_and_delete(var_0D,var_0B);
					}
					else
					{
...
{
	var_01 = [];
	if(isdefined(level._audio.damb.var_105E[param_00]))
	{
	...
	{
		var_01 = dambx_get_loop_def_from_string_table(param_00,0);
		if(!isdefined(var_01) || var_01.size == 0)
		{
			var_01 = maps\_audio::audio_presets_dynamic_ambience_loop_definitions(param_00,var_01);
		}
	}
	...
	level._audio.damb.var_105E[param_00] = var_01;
	return var_01;
}
...
{
	if(!isdefined(level._audio.damb.var_105D))
	{
		level._audio.damb.var_105D = [];
	}

	var_01 = [];
	if(isdefined(level._audio.damb.var_105D[param_00]))
	{
		var_01 = level._audio.damb.var_105D[param_00];
	}
	else if(level._audio.damb.use_string_table_presets)
	{
	...
	{
		var_01 = dambx_get_component_from_string_table(param_00,0);
		if(!isdefined(var_01) || var_01.size == 0)
		{
			var_01 = maps\_audio::audio_presets_dynamic_ambience_components(param_00,var_01);
		}
	}
	...
	level._audio.damb.var_105D[param_00] = var_01;
	return var_01;
}
...
dambx_play(param_00,param_01,param_02)
{
	...
	{
		thread func_10B4(var_08,level._audio.damb.playing[param_00][param_01]["fade"]);
	}
...
{
	var_02 = "soundtables/common_damb_loops.csv";
	var_03 = maps\_audio::get_damb_loops_stringtable();
	var_04 = [];
	if(param_01)
	{
		var_04 = func_10B9(var_03,param_00);
	}

	if(!isdefined(var_04) || var_04.size == 0)
	{
		var_04 = func_10B9(var_02,param_00);
	}
...
func_10B9(param_00,param_01)
{
	...
	{
		var_0A = tablelookup(param_00,0,"loop_defs",var_09);
		if(!isdefined(var_0A) || var_0A == "")
		{
			return;
		}

		var_0B = tablelookup(param_00,0,param_01,var_09);
		if(var_0B != "" && var_0A != "comments")
		{
			switch(var_0A)
			{
				case "loop_alias":
...
dambx_get_component_from_string_table_internal(param_00,param_01)
{
	...
	var_0F = [];
	var_10 = 0;
	for(var_11 = 1;var_11 < var_03;var_11++)
	{
		var_12 = tablelookup(param_00,0,"components",var_11);
		if(!isdefined(var_12))
		{
			return;
		}

		var_13 = tablelookup(param_00,0,param_01,var_11);
		if(var_13 != "" && var_12 != "comments")
		{
			var_10++;
			switch(var_12)
			{
				case "oneshots":
					var_05 = dambx_get_list_value_from_string_table(var_13,"component definition","oneshots",1);
					break;

				case "loops":
					var_06 = dambx_get_list_value_from_string_table(var_13,"component definition","loops",1);
					break;

				case "single_loops":
					var_07 = dambx_get_list_value_from_string_table(var_13,"component definition","single_loops",0);
					break;

				case "first_event_min":
					var_08[0] = float(var_13);
					break;

				case "first_event_max":
					var_08[1] = float(var_13);
					break;

				case "event_time_min":
					var_09[0] = float(var_13);
					break;

				case "event_time_max":
					var_09[1] = float(var_13);
					break;

				case "dist_min":
					var_0A[0] = float(var_13);
					break;

				case "dist_max":
					var_0A[1] = float(var_13);
					break;

				case "cone_min":
					var_0B[0] = float(var_13);
					break;

				case "cone_max":
					var_0B[1] = float(var_13);
					break;

				case "travel_min":
					var_0C[0] = float(var_13);
					break;

				case "travel_max":
					var_0C[1] = float(var_13);
					break;

				case "travel_time_min":
					var_0D[0] = float(var_13);
					break;

				case "travel_time_max":
					var_0D[1] = float(var_13);
					break;

				case "pitch_min":
					var_0E[0] = float(var_13);
					break;

				case "pitch_max":
					var_0E[1] = float(var_13);
					break;

				case "pitch_time_min":
					var_0F[0] = float(var_13);
					break;

				case "pitch_time_max":
					var_0F[1] = float(var_13);
					break;
...
{
	var_02 = maps\_audio::get_damb_component_stringtable();
	var_03 = "soundtables/common_damb_components.csv";
	var_04 = [];
	if(param_01)
	{
...
dambx_get_preset_from_stringtable_internal(param_00,param_01)
{
	...
	var_05 = [];
	var_06 = [];
	for(var_07 = 1;var_07 < var_02;var_07++)
	{
		var_08 = tablelookup(param_00,0,"dynamic_ambience",var_07);
		var_09 = tablelookup(param_00,0,param_01,var_07);
		var_0A = 0;
		if(var_09 != "" && var_08 != "comments")
		{
			switch(var_08)
			{
				case "components":
					var_04 = dambx_get_list_value_from_string_table(var_09,"preset definition","components");
					break;

				case "first_event_min":
					if(isdefined(var_09) && var_09 != "")
					{
						var_05[0] = float(var_09);
					}
					break;
	...
	if(var_0A)
	{
		...
		{
			var_03["components"] = [];
			for(var_07 = 0;var_07 < var_04.size;var_07++)
			{
...
{
	var_02 = maps\_audio::get_damb_stringtable();
	var_03 = "soundtables/common_damb.csv";
	var_04 = [];
	if(param_01)
	{
