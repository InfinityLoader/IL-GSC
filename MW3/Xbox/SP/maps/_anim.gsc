 ...
 * Timestamp: 10/27/2023 2:31:55 AM
*******************************************************************/
...
{
	var_03 = [];
	anim_single(var_41,param_02,var_03,0,"generic");
}
...
{
	var_03 = [];
	anim_single(var_41,param_02,var_03,0.25,"generic");
}
...
{
	var_03 = [];
	anim_reach(var_41,param_02,var_03,"generic");
}
...
{
	var_03 = [];
	anim_reach_with_funcs(var_41,param_02,var_03,"generic",::reach_with_arrivals_begin,::reach_with_standard_adjustments_end);
}
...
{
	anim_reach_with_funcs(param_00,param_01,param_02,undefined,::func_0E0B,::reach_with_standard_adjustments_end);
}
...
anim_generic_loop(param_00,param_01,param_02,param_03)
{
	var_04 = [];
	param_00[0] = var_41;
	anim_loop_packet(var_41,param_01,param_02,"generic");
}
...
//Function Number: 18
func_0DB9(param_00,param_01,param_02,param_03)
{
	var_04 = [];
	anim_custom_animmode(var_41,param_02,param_03,var_04);
}
...
{
	var_03 = [];
	anim_first_frame(var_41,param_02,var_03);
}
...
anim_last_frame_solo(param_00,param_01,param_02)
{
	var_03 = [];
	anim_first_frame(var_41,param_02,var_03);
	anim_set_time(var_41,param_02,1);
}
...
//Function Number: 24
func_0DC1(param_00,param_01,param_02,param_03)
{
	var_04 = [];
...
{
	var_03 = [];
	anim_loop_packet(var_41,param_02,var_03);
}
...
anim_loop_packet(param_00,param_01,param_02,param_03)
{
	...
	thread func_0DA8(param_02,param_00);
	self endon(param_02);
	var_09 = "looping anim";
	var_0A = undefined;
		...
		foreach(var_1D, var_05 in param_00)
		{
			...
			if(var_15 || var_16)
			{
				if(isai(var_06))
				{
					if(var_17)
					{
						var_06 animscripts/face::sayspecificdialogue(var_19,var_1A,1);
					}
					else
					{
						var_06 animscripts/face::sayspecificdialogue(var_19,var_1A,1,var_09);
					}
				}
				else
				{
...
//Function Number: 31
func_0DC9(param_00,param_01,param_02,param_03)
{
...
anim_single_internal(param_00,param_01,param_02,param_03,param_04)
{
	...
	foreach(var_1D, var_07 in param_00)
	{
		...
		if(var_13 || var_14)
		{
			if(var_13)
			{
				...
				thread func_0E31(var_07,param_01,level.scr_face[var_19][param_01]);
				var_0F = var_1D;
			}
			else if(isai(var_07))
			{
				if(var_15)
				{
					var_07 animscripts/face::sayspecificdialogue(var_18,var_17,1);
				}
				else
				{
					var_07 thread anim_facialfiller("single dialogue");
					var_07 animscripts/face::sayspecificdialogue(var_18,var_17,1,"single dialogue");
				}
			}
			else
			{
	...
	else if(isdefined(var_0F))
	{
		...
		var_1E thread func_0DCC(param_00[var_0F],param_01,var_10);
		var_1E waittill(param_01);
	}
...
//Function Number: 34
func_0DCC(param_00,param_01,param_02)
{
	self endon(param_01);
...
animsound_tracker(param_00,param_01,param_02)
{
	...
	if(func_0DD5(param_00,param_01))
	{
		return;
	}
...
animsound_start_tracker(param_00,param_01)
{
	...
	if(func_0DD5(param_00,var_02.notetrack))
	{
		return;
	}
...
//Function Number: 42
func_0DDA(param_00,param_01,param_02)
{
	add_to_animsound();
	...
	var_03.animname = param_02;
	var_03.end_time = gettime() + -5536;
	if(func_0DD5(param_00,var_03.notetrack))
	{
		return;
	}
...
notetrack_wait(param_00,param_01,param_02,param_03,param_04)
{
	...
	foreach(var_11, var_0A in var_41)
	{
		foreach(var_0C in level.scr_notetrack[var_07][var_11])
		{
			foreach(var_0E in var_0C)
			{
				...
				{
					var_08.var_DDC[var_0E["dialog"]] = 1;
				}
			}
		}
	}
	...
	for(;;)
	{
		var_08.var_DDD = 0;
		var_12 = undefined;
		param_01 waittill(level.scr_notetrack[var_06][param_03],var_41[param_03],level.scr_notetrack[var_07]["any"],var_41["any"],param_02,var_12);
		if(var_12 == "end")
		{
			return;
		}
		...
		if(var_16 == "psm")
		{
			...
			maps\_audio::func_121F(var_18,param_01);
			continue;
		}
...
anim_handle_notetrack(param_00,param_01,param_02,param_03)
{
	...
	if(!param_02.var_DDD)
	{
		if(isdefined(param_00["dialog"]) && isdefined(param_02.var_DDC[param_00["dialog"]]))
		{
			param_01 animscripts/face::sayspecificdialogue(undefined,param_00["dialog"],1);
			param_02.var_DDC[param_00["dialog"]] = undefined;
			param_02.var_DDD = 1;
		}
	}
...
idle_on_reach(param_00,param_01,param_02,param_03,param_04)
{
	...
	if(isalive(param_00))
	{
		func_0E16(param_00,param_01,param_02,param_03);
	}
}
...
anim_reach_with_funcs(param_00,param_01,param_02,param_03,param_04,param_05,param_06)
{
	...
	foreach(var_0E in param_00)
	{
		...
		var_0C++;
		var_0E thread func_0DFE(var_0A,var_10,param_04,param_05);
	}
...
//Function Number: 68
func_0DFE(param_00,param_01,param_02,param_03)
{
	self endon("death");
...
//Function Number: 76
func_0E0E(param_00,param_01,param_02,param_03,param_04)
{
	self endon("death");
	var_05[0] = param_00;
	if(!isdefined(param_03))
...
//Function Number: 77
func_0E0F(param_00,param_01,param_02)
{
	self endon("death");
	var_03[0] = param_00;
...
//Function Number: 80
func_0E12(param_00,param_01,param_02)
{
	self endon("death");
	var_03[0] = param_00;
...
anim_reach_and_approach_solo(param_00,param_01,param_02,param_03)
{
	self endon("death");
	var_04[0] = param_00;
	func_0E15(var_04,param_01,param_02,param_03);
}
...
anim_reach_and_approach_node_solo(param_00,param_01,param_02)
{
	...
	func_0E15(var_03,param_01,param_02);
...
//Function Number: 83
func_0E15(param_00,param_01,param_02,param_03)
{
	self endon("death");
...
func_0E16(param_00,param_01,param_02,param_03)
{
	...
	param_00 endon("death");
	var_04[0] = param_00;
	func_0DC1(var_04,param_01,param_02,param_03);
}
...
anim_single_queue(param_00,param_01,param_02,param_03)
{
	...
	maps\_utility::func_E1D(::func_0E0E,param_00,param_01,param_02,param_03);
	if(isalive(param_00))
	{
...
anim_generic_queue(param_00,param_01,param_02,param_03,param_04)
{
	...
	if(isdefined(param_04))
	{
		maps\_utility::function_stack_timeout(param_04,::func_0E0E,param_00,param_01,param_02,param_03,"generic");
	}
	else
	{
		maps\_utility::func_E1D(::func_0E0E,param_00,param_01,param_02,param_03,"generic");
	}
...
{
	param_01 = tolower(param_01);
	func_0E24(param_00,param_01,param_02);
...
//Function Number: 96
func_0E27(param_00,param_01,param_02)
{
...
addnotetrack_animsound(param_00,param_01,param_02,param_03)
{
	...
	var_05 = [];
	level.scr_notetrack[param_01][param_02][param_03][var_05] = var_41;
}

//Function Number: 98
func_0E29(param_00,param_01,param_02,param_03,param_04)
{
	param_01 = tolower(param_01);
	param_04 = get_generic_anime(param_04);
	var_05 = add_notetrack_and_get_index(param_00,param_01,param_04);
	var_06 = [];
	level.scr_notetrack[param_01][var_05][param_02][var_06] = var_41;
}
...
addnotetrack_detach_gun(param_00,param_01,param_02,param_03)
{
	...
	level.scr_notetrack[param_01][param_03][param_02][var_05] = var_41;
}
...
addnotetrack_customfunction(param_00,param_01,param_02,param_03)
{
	...
	var_05 = [];
	level.scr_notetrack[param_01][var_04][param_02][var_05] = var_41;
}

//Function Number: 102
addnotetrack_startfxontag(param_00,param_01,param_02,param_03,param_04)
{
	common_scripts\utility::func_539(param_03);
	param_01 = tolower(param_01);
	param_02 = get_generic_anime(param_02);
	var_05 = add_notetrack_and_get_index(param_00,param_01,param_02);
	var_06 = [];
	level.scr_notetrack[param_01][param_03][param_02][var_06] = var_41;
}

//Function Number: 103
func_0E2E(param_00,param_01,param_02,param_03,param_04)
{
	common_scripts\utility::func_539(param_03);
	param_01 = tolower(param_01);
	param_02 = get_generic_anime(param_02);
...
//Function Number: 105
func_0E30(param_00,param_01,param_02,param_03)
{
	param_01 = tolower(param_01);
	param_03 = get_generic_anime(param_03);
	var_04 = add_notetrack_and_get_index(param_00,param_01,param_03);
...
//Function Number: 106
func_0E31(param_00,param_01,param_02)
{
	param_00 endon("death");
	self endon(param_01);
	var_03 = 0.05;
	...
	thread func_0E32(param_00,param_01,param_02);
	thread clearfaceanimonanimdone(param_00,"face_done_" + param_01,param_01);
}

//Function Number: 107
func_0E32(param_00,param_01,param_02)
{
	param_00 endon("death");
...
{
	func_0E12(param_00,param_01);
	param_03.count--;
	param_03 notify("reached_goal");
	if(param_03.count > 0)
	{
		func_0E16(param_00,param_02,"stopReachIdle");
	}
}
...
set_start_pos(param_00,param_01,param_02,param_03,param_04)
{
	...
	if(isai(self))
	{
		...
		{
			var_07 = maps\_utility::func_E3F(var_07);
		}
...
//Function Number: 123
func_0E43(param_00,param_01,param_02)
{
...
{
	common_scripts\utility::array_thread(param_00,::func_0E48,param_01,param_02);
}

//Function Number: 127
func_0E48(param_00,param_01)
{
...
//Function Number: 129
func_0E4C(param_00,param_01)
{
	param_00.var_D8B = ::animscripts/cover_arrival::custommovetransitionfunc;
