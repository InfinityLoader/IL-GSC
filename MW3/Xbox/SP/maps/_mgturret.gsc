 ...
 * Timestamp: 10/27/2023 2:31:47 AM
*******************************************************************/

//Function Number: 1
init_mgturretsettings()
{
	level.var_1DF1["easy"]["convergenceTime"] = 2.5;
	level.var_1DF1["easy"]["suppressionTime"] = 3;
	level.var_1DF1["easy"]["accuracy"] = 0.38;
	level.var_1DF1["easy"]["aiSpread"] = 2;
	level.var_1DF1["easy"]["playerSpread"] = 0.5;
	level.var_1DF1["medium"]["convergenceTime"] = 1.5;
	level.var_1DF1["medium"]["suppressionTime"] = 3;
	level.var_1DF1["medium"]["accuracy"] = 0.38;
	level.var_1DF1["medium"]["aiSpread"] = 2;
	level.var_1DF1["medium"]["playerSpread"] = 0.5;
	level.var_1DF1["hard"]["convergenceTime"] = 0.8;
	level.var_1DF1["hard"]["suppressionTime"] = 3;
	level.var_1DF1["hard"]["accuracy"] = 0.38;
	level.var_1DF1["hard"]["aiSpread"] = 2;
	level.var_1DF1["hard"]["playerSpread"] = 0.5;
	level.var_1DF1["fu"]["convergenceTime"] = 0.4;
	level.var_1DF1["fu"]["suppressionTime"] = 3;
	level.var_1DF1["fu"]["accuracy"] = 0.38;
	level.var_1DF1["fu"]["aiSpread"] = 2;
	level.var_1DF1["fu"]["playerSpread"] = 0.5;
}
...
mgturret_auto(param_00)
{
	...
	maps\_spawner::func_1CBC(param_00);
}
...
func_1DFA()
{
	...
	if(isdefined(self.var_1DFB))
	{
		var_02 = self.var_1DFB;
	}
	else
	{
	...
	if(isdefined(self.var_1DFC))
	{
		var_03 = self.var_1DFC - var_02;
	}
	else
	{
...
func_1DFF()
{
	...
	for(;;)
	{
		...
		playfxontag(self.var_1DFD,self,"tag_origin");
...
turret_shell_sound()
{
	...
	var_01 = maps\_utility::drop_to_ground(var_00,-30);
	var_02 = var_00[2] - var_01[2];
	var_03 = var_02 / 300;
	wait var_03;
	level thread common_scripts\utility::play_sound_in_space(self.var_1E00,var_01);
	wait 1;
	self.shell_sound_enabled = 1;
}
...
func_1E06(param_00,param_01)
{
	...
	if(isdefined(param_00.var_1DFB))
	{
		var_04 = param_00.var_1DFB;
	}
	else
	{
	...
	if(isdefined(param_00.var_1DFC))
	{
		var_05 = param_00.var_1DFC - var_04;
	}
	else
	{
...
_spawner_mg42_think()
{
	...
	for(;;)
	{
		...
		if(var_02.size)
		{
			var_03 = maps\_utility::func_1E0A(var_00.origin,undefined,var_02);
		}
		else
		{
		...
		if(isdefined(var_03))
		{
			...
			var_03 thread maps\_spawner::func_1D26(var_00);
...
mg42_gunner_manual_think(param_00,param_01)
{
	...
	self endon("auto_ai");
	self.pacifist = 1;
	self setgoalpos(param_00.var_1AE7);
	...
	if(var_05.size > 0)
	{
		...
		while(!isdefined(level.player_covertrigger))
		{
			...
			if(distance(var_07,var_05[self.var_1E15].origin) > var_08)
			{
				var_0C = vectornormalize(var_05[self.var_1E15].origin - var_07);
		...
		for(;;)
		{
			...
			{
				var_02.origin = var_07 * 1 - var_0D + level.player getorigin() + func_1E11() * var_0D;
				if(player_safe())
				{
					var_0D = 2;
				}
			...
			while(!player_safe())
			{
				...
				var_02.origin = var_02.origin + var_0F + func_1E11();
				var_0E = level.player getorigin();
				wait 0.1;
			}
	...
	for(;;)
	{
		...
		while(!isdefined(level.player_covertrigger))
		{
			if(!param_00.var_1E13)
			{
				param_00 settargetentity(level.player);
				param_00.var_1E13 = 1;
				var_03.var_1E16 = level.player;
			}
...
func_1E17(param_00)
{
	...
	for(;;)
	{
		...
		for(var_02 = 0;var_02 < param_00.size;var_02++)
		{
			self.var_1E15 = randomint(param_00.size);
			self waittill("next_target");
			while(var_01[self.var_1E15])
			{
				self.var_1E15++;
				if(self.var_1E15 >= param_00.size)
				{
					self.var_1E15 = 0;
				}
			}

			var_01[self.var_1E15] = 1;
		}
	}
}
...
func_1E1A(param_00)
{
	var_01 = getent(param_00.var_1E1B,"targetname");
	var_02 = 0.5;
...
func_139A()
{
	...
	for(var_02 = 0;var_02 < var_00.size;var_02++)
	{
		...
		func_1E21(var_00[var_02],var_01);
	}
}

//Function Number: 30
func_1E21(param_00,param_01)
{
	param_00.convergencetime = level.var_1DF1[param_01]["convergenceTime"];
	param_00.var_1E22 = level.var_1DF1[param_01]["suppressionTime"];
	param_00.accuracy = level.var_1DF1[param_01]["accuracy"];
	param_00.var_1E23 = level.var_1DF1[param_01]["aiSpread"];
	param_00.var_1E24 = level.var_1DF1[param_01]["playerSpread"];
}
...
mg42_target_drones(param_00,param_01,param_02)
{
	...
	for(;;)
	{
		...
		while(level.drones[var_06].var_1E2B)
		{
			common_scripts\utility::lock("mg42_drones");
			if(!level.drones[var_06].var_1E2B)
			{
...
{
	if(level.drones[param_00].var_1E2B < 1)
	{
		return;
	}
	...
	for(var_04 = 0;var_04 < level.drones[param_00].var_1E2B;var_04++)
	{
...
saw_mgturretlink(param_00)
{
	...
	for(var_03 = 0;var_03 < var_01.size;var_03++)
	{
		...
		if(isdefined(var_01[var_03].var_1E31))
		{
			continue;
		}
...
func_1AA4(param_00)
{
	...
	for(var_03 = 0;var_03 < var_01.size;var_03++)
	{
		...
		if(!isdefined(var_01[var_03].var_1DEB))
		{
			continue;
		}
...
func_1E33()
{
	...
	if(!isdefined(self.var_1DEB))
	{
		return;
	}

	level.shared_portable_turrets[self.var_1DEB] = self;
	if(isdefined(self.var_1E35))
	{
		var_00 = strtok(self.var_1E35," ");
		for(var_01 = 0;var_01 < var_00.size;var_01++)
		{
...
dropturretproc()
{
	...
	var_00.origin = self gettagorigin(level.var_1C8D);
	var_00.angles = self gettagangles(level.var_1C8D);
	var_00 setmodel(self.turretmodel);
	var_01 = anglestoforward(self.angles);
	var_01 = var_01 * 100;
	var_00 movegravity(var_01,0.5);
	self detach(self.turretmodel,level.var_1C8D);
...
{
	var_01 = [];
	return var_41[var_01.weaponinfo];
}
...
run_to_new_spot_and_setup_gun(param_00)
{
	...
	self attach(self.turretmodel,level.var_1C8D);
	...
	common_scripts\utility::set_exception("cover_crouch",::func_1E4B);
...
func_1E4D()
{
	...
	var_02 = self.node;
	if(!isdefined(var_02) || !maps\_utility::func_1E4E(var_01,var_02))
	{
		var_03 = func_1E50();
...
use_the_turret(param_00)
{
	...
	if(var_01)
	{
		common_scripts\utility::set_exception("move",::func_1E4D);
		self.turret = param_00;
		thread mg42_firing(param_00);
		param_00 setmode("manual_ai");
		param_00 thread func_1E3C();
		self.turret = param_00;
		param_00.owner = self;
		return 1;
	}
...
{
	var_01 = [];
	var_41 = maps\_utility::array_randomize(var_41);
	for(var_02 = 0;var_02 < var_41.size;var_02++ = var_41["spot"])
	{
		var_03 = [[ var_41[var_02] ]](var_01);
...
find_connected_turrets(param_00)
{
	...
	for(var_05 = 0;var_05 < var_03.size;var_05++)
	{
		...
		{
			if(var_01[var_06].var_1DEB + "" != var_07[var_08])
			{
				continue;
			}

			if(isdefined(var_01[var_06].var_1DF4))
			{
				continue;
			}
...
find_different_way_to_attack_last_seen_position(param_00)
{
	...
	{
		if(!maps\_utility::within_fov(var_02[var_04].origin,var_02[var_04].angles,param_00.origin,0.75))
		{
			continue;
		}
...
portable_mg_spot()
{
	...
	var_00 = 1;
	self.issetup = 1;
	self.var_1DF4 = undefined;
	if(isdefined(self.var_1E31))
	{
		return;
	}
...
func_1E5C(param_00)
{
	param_00.var_1DF4 = self;
	thread func_1E5A(param_00);
}