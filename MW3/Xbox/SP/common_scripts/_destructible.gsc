 ...
 * Timestamp: 10/27/2023 2:32:15 AM
*******************************************************************/
...
find_destructibles()
{
	...
	var_04 = getentarray("destructible_toy","targetname");
			...
			if(isdefined(var_02.v["fx_filename"]))
			{
				for(var_03 = 0;var_03 < var_02.v["fx_filename"].size;var_03++)
				{
					...
					if(isdefined(var_04))
					{
						...
						{
							level.destructible_type[self.destructibleinfo].var_A2D[var_00][var_01].v["fx"][var_03][var_07] = common_scripts\utility::_loadfx(var_06);
						}
					}
				}
			}

			var_08 = level.destructible_type[self.destructibleinfo].var_A2D[var_00][var_01].v["loopfx_filename"];
			if(isdefined(var_08))
			{
				...
				{
					level.destructible_type[self.destructibleinfo].var_A2D[var_00][var_01].v["loopfx"][var_07] = common_scripts\utility::_loadfx(var_0A);
				}
			}
		}
	}
...
destructible_update_part(param_00,param_01,param_02,param_03,param_04,param_05,param_06,param_07)
{
	...
	for(;;)
	{
		...
		{
			var_0D = 1;
			var_2F = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["explode_force_min"];
			var_30 = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["explode_force_max"];
			var_31 = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["explode_range"];
			var_32 = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["explode_mindamage"];
			var_33 = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["explode_maxdamage"];
			var_34 = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["continueDamage"];
			var_35 = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["originOffset"];
			var_36 = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["earthQuakeScale"];
			var_37 = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["earthQuakeRadius"];
			var_38 = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["originOffset3d"];
			var_39 = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["delaytime"];
		...
		if(isdefined(level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["physics"]))
		{
			...
			{
				var_3A = undefined;
				var_3B = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["physics_tagName"][var_1C];
				var_3C = level.destructible_type[self.destructibleinfo].var_A2D[var_0A][var_19].v["physics_velocity"][var_1C];
				var_3D = undefined;
				if(isdefined(var_3C))
				{
					var_3E = undefined;
				...
				{
					var_46 = undefined;
					for(var_47 = 0;var_47 < level.destructible_type[self.destructibleinfo].var_A2D.size;var_47++)
					{
						if(!isdefined(level.destructible_type[self.destructibleinfo].var_A2D[var_47][0].v["tagName"]))
						{
							continue;
						}

						if(level.destructible_type[self.destructibleinfo].var_A2D[var_47][0].v["tagName"] != var_3B)
						{
							continue;
						}
